...
namespace LD.Client.Contract
{
    ...
    public class ReqFuncpdfutuL_7_1DTO : ReqBaseDTO
    {
        public ReqFuncpdfutuL_7_1DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pdfutuL.7.1";
        ...
        public override LDsdkDefine.LDPackerAdapter CreatePacker()
        {
            ...
            packer.AddField("futu_acco_status", ELDDATATYPE.LD_DATATYPE_STRING);
            ...
            packer.AddStr(futu_acco_status);
            packer.EndPack();
        ...
        public override LDsdkDefineEx.LDFastMessageAdapter CreateFastMessage()
        {
            ...
            fastMsg.SetString(LDBizTagDefine.LDBizTag.LDBIZ_FUTU_ACCO_STATUS_STR,futu_acco_status);
    ...
    public class ReqFuncpdfutuL_7_11DTO : ReqBaseDTO
    {
        public ReqFuncpdfutuL_7_11DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pdfutuL.7.11";
            CommonDTO.func_code = CommonDTO.function_code;
        }
    ...
    public class ReqFuncpdfutuL_7_2DTO : ReqBaseDTO
    {
        public ReqFuncpdfutuL_7_2DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pdfutuL.7.2";
            CommonDTO.func_code = CommonDTO.function_code;
            co_no = 0;
            busi_opor_no = 0;
            pd_no = 0;
    ...
    public class ReqFuncpdfutuL_7_3DTO : ReqBaseDTO
    {
        public ReqFuncpdfutuL_7_3DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pdfutuL.7.3";
            CommonDTO.func_code = CommonDTO.function_code;
            co_no = 0;
            busi_opor_no = 0;
            pd_no = 0;
    ...
    public class ReqFuncpdfutuL_7_4DTO : ReqBaseDTO
    {
        public ReqFuncpdfutuL_7_4DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pdfutuL.7.4";
            CommonDTO.func_code = CommonDTO.function_code;
            co_no = 0;
            busi_opor_no = 0;
            pd_no = 0;
    ...
    public class ReqFuncpdfutuL_7_5DTO : ReqBaseDTO
    {
        public ReqFuncpdfutuL_7_5DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pdfutuL.7.5";
            CommonDTO.func_code = CommonDTO.function_code;
            co_no = 0;
            pd_no = 0;
            asset_acco_no = 0;
    ...
    //逻辑_产品期货_账户运维_冻结期货账户
    public class ReqFuncpdfutuL_7_6DTO : ReqBaseDTO
    {
        public ReqFuncpdfutuL_7_6DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pdfutuL.7.6";
            CommonDTO.func_code = CommonDTO.function_code;
            co_no = 0;
            busi_opor_no = 0;
            pd_no = 0;
    ...
    //逻辑_产品期货_账户运维_恢复期货账户
    public class ReqFuncpdfutuL_7_7DTO : ReqBaseDTO
    {
        public ReqFuncpdfutuL_7_7DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pdfutuL.7.7";
            CommonDTO.func_code = CommonDTO.function_code;
            co_no = 0;
            busi_opor_no = 0;
            pd_no = 0;
    ...
    //逻辑_产品期货_账户运维_注销期货账户
    public class ReqFuncpdfutuL_7_8DTO : ReqBaseDTO
    {
        public ReqFuncpdfutuL_7_8DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pdfutuL.7.8";
            CommonDTO.func_code = CommonDTO.function_code;
            co_no = 0;
            busi_opor_no = 0;
            pd_no = 0;
