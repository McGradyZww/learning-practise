...
{
    //逻辑_产品期货_账户_检查期货账户存在
    public class ReqFuncpdfutuL_1_40DTO : ReqBaseDTO
    {
        public ReqFuncpdfutuL_1_40DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pdfutuL.1.40";
    ...
    //逻辑_产品期货_账户_新增期货账户信息
    public class ReqFuncpdfutuL_1_41DTO : ReqBaseDTO
    {
        public ReqFuncpdfutuL_1_41DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pdfutuL.1.41";
            CommonDTO.func_code = CommonDTO.function_code;
            pd_no = 0;
            asset_acco_no = 0;
            exch_no = 0;
    ...
    //逻辑_产品期货_账户_修改期货账户信息
    public class ReqFuncpdfutuL_1_42DTO : ReqBaseDTO
    {
        public ReqFuncpdfutuL_1_42DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pdfutuL.1.42";
            CommonDTO.func_code = CommonDTO.function_code;
            pd_no = 0;
            asset_acco_no = 0;
            futu_acco_no = 0;
    ...
    //逻辑_产品期货_账户_删除期货账户信息
    public class ReqFuncpdfutuL_1_43DTO : ReqBaseDTO
    {
        public ReqFuncpdfutuL_1_43DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pdfutuL.1.43";
            CommonDTO.func_code = CommonDTO.function_code;
            pd_no = 0;
            asset_acco_no = 0;
            futu_acco_no = 0;
    ...
    //逻辑_产品期货_账户_查询期货账户信息
    public class ReqFuncpdfutuL_1_44DTO : ReqBaseDTO
    {
        public ReqFuncpdfutuL_1_44DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pdfutuL.1.44";
            CommonDTO.func_code = CommonDTO.function_code;
            pd_no = 0;
            asset_acco_no = 0;
            futu_acco_no = 0;
    ...
    public class ReqFuncpdfutuL_1_45DTO : ReqBaseDTO
    {
        public ReqFuncpdfutuL_1_45DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pdfutuL.1.45";
            CommonDTO.func_code = CommonDTO.function_code;
            pd_no = 0;
            asset_acco_no = 0;
            futu_acco_no = 0;
    ...
    public class ReqFuncpdfutuL_1_46DTO : ReqBaseDTO
    {
        public ReqFuncpdfutuL_1_46DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pdfutuL.1.46";
            CommonDTO.func_code = CommonDTO.function_code;
            begin_date = 0;
            end_date = 0;
            pd_no = 0;
    ...
    //逻辑_产品期货_账户_冻结期货账户
    public class ReqFuncpdfutuL_1_47DTO : ReqBaseDTO
    {
        public ReqFuncpdfutuL_1_47DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pdfutuL.1.47";
            CommonDTO.func_code = CommonDTO.function_code;
            pd_no = 0;
            asset_acco_no = 0;
            futu_acco_no = 0;
    ...
    //逻辑_产品期货_账户_恢复期货账户
    public class ReqFuncpdfutuL_1_48DTO : ReqBaseDTO
    {
        public ReqFuncpdfutuL_1_48DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pdfutuL.1.48";
            CommonDTO.func_code = CommonDTO.function_code;
            pd_no = 0;
            asset_acco_no = 0;
            futu_acco_no = 0;
    ...
    //逻辑_产品期货_账户_注销期货账户
    public class ReqFuncpdfutuL_1_49DTO : ReqBaseDTO
    {
        public ReqFuncpdfutuL_1_49DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pdfutuL.1.49";
            CommonDTO.func_code = CommonDTO.function_code;
            pd_no = 0;
            asset_acco_no = 0;
            futu_acco_no = 0;
    ...
    //逻辑_产品期货_账户_查询期货账户列表
    public class ReqFuncpdfutuL_1_51DTO : ReqBaseDTO
    {
        public ReqFuncpdfutuL_1_51DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pdfutuL.1.51";
            CommonDTO.func_code = CommonDTO.function_code;
        }
    ...
    public class ReqFuncpdfutuL_1_501DTO : ReqBaseDTO
    {
        public ReqFuncpdfutuL_1_501DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pdfutuL.1.501";
            CommonDTO.func_code = CommonDTO.function_code;
            pass_no = 0;
        }
