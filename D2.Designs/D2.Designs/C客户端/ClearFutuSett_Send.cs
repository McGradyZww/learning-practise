...
{
    //逻辑_清算期货_结算_结算处理
    public class ReqFuncclfutuL_3_31DTO : ReqBaseDTO
    {
        public ReqFuncclfutuL_3_31DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "clfutuL.3.31";
    ...
    //逻辑_清算期货_结算_查询待入账记录
    public class ReqFuncclfutuL_3_45DTO : ReqBaseDTO
    {
        public ReqFuncclfutuL_3_45DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "clfutuL.3.45";
            CommonDTO.func_code = CommonDTO.function_code;
            co_no = 0;
            pd_no = 0;
            exch_group_no = 0;
    ...
    //逻辑_清算期货_结算_入账处理
    public class ReqFuncclfutuL_3_46DTO : ReqBaseDTO
    {
        public ReqFuncclfutuL_3_46DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "clfutuL.3.46";
            CommonDTO.func_code = CommonDTO.function_code;
            row_id = 0;
        }
    ...
    //逻辑_清算期货_结算_入账回滚处理
    public class ReqFuncclfutuL_3_47DTO : ReqBaseDTO
    {
        public ReqFuncclfutuL_3_47DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "clfutuL.3.47";
            CommonDTO.func_code = CommonDTO.function_code;
            qry_no = 0;
        }
    ...
    //逻辑_清算期货_结算_结算处理定时任务
    public class ReqFuncclfutuL_3_105DTO : ReqBaseDTO
    {
        public ReqFuncclfutuL_3_105DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "clfutuL.3.105";
            CommonDTO.func_code = CommonDTO.function_code;
            task_no = 0;
            exec_count = 0;
            exec_date = 0;
    ...
    //逻辑_清算期货_结算_入账处理定时任务
    public class ReqFuncclfutuL_3_104DTO : ReqBaseDTO
    {
        public ReqFuncclfutuL_3_104DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "clfutuL.3.104";
            CommonDTO.func_code = CommonDTO.function_code;
            task_no = 0;
            exec_count = 0;
            exec_date = 0;
