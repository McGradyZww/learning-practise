...
{
    //逻辑_公共_用户_新增操作员信息
    public class ReqFuncpubL_5_1DTO : ReqBaseDTO
    {
        public ReqFuncpubL_5_1DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.5.1";
    ...
    //逻辑_公共_用户_修改操作员信息
    public class ReqFuncpubL_5_2DTO : ReqBaseDTO
    {
        public ReqFuncpubL_5_2DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.5.2";
            CommonDTO.func_code = CommonDTO.function_code;
            target_opor_no = 0;
            opor_name = " ";
            opor_type = 0;
    ...
    //逻辑_公共_用户_查询操作员信息
    public class ReqFuncpubL_5_4DTO : ReqBaseDTO
    {
        public ReqFuncpubL_5_4DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.5.4";
            CommonDTO.func_code = CommonDTO.function_code;
            query_opor_no = 0;
            co_no = 0;
            is_trader = 0;
    ...
    //逻辑_公共_用户_冻结操作员
    public class ReqFuncpubL_5_5DTO : ReqBaseDTO
    {
        public ReqFuncpubL_5_5DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.5.5";
            CommonDTO.func_code = CommonDTO.function_code;
            target_opor_no = 0;
            oper_remark_info = " ";
        }
    ...
    //逻辑_公共_用户_解冻操作员
    public class ReqFuncpubL_5_6DTO : ReqBaseDTO
    {
        public ReqFuncpubL_5_6DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.5.6";
            CommonDTO.func_code = CommonDTO.function_code;
            target_opor_no = 0;
            oper_remark_info = " ";
        }
    ...
    //逻辑_公共_用户_注销操作员
    public class ReqFuncpubL_5_7DTO : ReqBaseDTO
    {
        public ReqFuncpubL_5_7DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.5.7";
            CommonDTO.func_code = CommonDTO.function_code;
            target_opor_no = 0;
            oper_remark_info = " ";
        }
    ...
    //逻辑_公共_用户_修改操作员密码
    public class ReqFuncpubL_5_9DTO : ReqBaseDTO
    {
        public ReqFuncpubL_5_9DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.5.9";
            CommonDTO.func_code = CommonDTO.function_code;
            opor_old_pwd = " ";
            opor_new_pwd = " ";
        }
    ...
    //逻辑_公共_用户_重置操作员密码
    public class ReqFuncpubL_5_10DTO : ReqBaseDTO
    {
        public ReqFuncpubL_5_10DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.5.10";
            CommonDTO.func_code = CommonDTO.function_code;
            target_opor_no = 0;
            opor_new_pwd = " ";
        }
    ...
    //逻辑_公共_用户_查询操作员信息流水
    public class ReqFuncpubL_5_11DTO : ReqBaseDTO
    {
        public ReqFuncpubL_5_11DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.5.11";
            CommonDTO.func_code = CommonDTO.function_code;
            co_no = 0;
            target_opor_no = 0;
            row_id = 0;
    ...
    public class ReqFuncpubL_5_12DTO : ReqBaseDTO
    {
        public ReqFuncpubL_5_12DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.5.12";
            CommonDTO.func_code = CommonDTO.function_code;
            begin_date = 0;
            end_date = 0;
            co_no = 0;
    ...
    //逻辑_公共_用户_检查操作员存在
    public class ReqFuncpubL_5_13DTO : ReqBaseDTO
    {
        public ReqFuncpubL_5_13DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.5.13";
            CommonDTO.func_code = CommonDTO.function_code;
            target_opor_no = 0;
        }
    ...
    //逻辑_公共_用户_获取操作员编号
    public class ReqFuncpubL_5_14DTO : ReqBaseDTO
    {
        public ReqFuncpubL_5_14DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.5.14";
            CommonDTO.func_code = CommonDTO.function_code;
            co_no = 0;
        }
    ...
    //逻辑_公共_用户_操作员登录
    public class ReqFuncpubL_5_21DTO : ReqBaseDTO
    {
        public ReqFuncpubL_5_21DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.5.21";
            CommonDTO.func_code = CommonDTO.function_code;
            client_version = " ";
        }
    ...
    //逻辑_公共_用户_操作员退出
    public class ReqFuncpubL_5_22DTO : ReqBaseDTO
    {
        public ReqFuncpubL_5_22DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.5.22";
            CommonDTO.func_code = CommonDTO.function_code;
        }
    ...
    //逻辑_公共_用户_新增操作员可操作机构
    public class ReqFuncpubL_5_41DTO : ReqBaseDTO
    {
        public ReqFuncpubL_5_41DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.5.41";
            CommonDTO.func_code = CommonDTO.function_code;
            target_opor_no = 0;
            co_no = 0;
            oper_remark_info = " ";
    ...
    //逻辑_公共_用户_删除操作员可操作机构
    public class ReqFuncpubL_5_42DTO : ReqBaseDTO
    {
        public ReqFuncpubL_5_42DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.5.42";
            CommonDTO.func_code = CommonDTO.function_code;
            target_opor_no = 0;
            co_no = 0;
            oper_remark_info = " ";
    ...
    //逻辑_公共_用户_查询操作员可操作机构
    public class ReqFuncpubL_5_44DTO : ReqBaseDTO
    {
        public ReqFuncpubL_5_44DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.5.44";
            CommonDTO.func_code = CommonDTO.function_code;
            query_opor_no = 0;
            row_id = 0;
            row_count = -1;
    ...
    //逻辑_公共_用户_查询全部交易组
    public class ReqFuncpubL_5_65DTO : ReqBaseDTO
    {
        public ReqFuncpubL_5_65DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.5.65";
            CommonDTO.func_code = CommonDTO.function_code;
            co_no = 0;
            pd_no = 0;
            exch_group_no = 0;
    ...
    //逻辑_公共_用户_查询全部操作员信息
    public class ReqFuncpubL_5_201DTO : ReqBaseDTO
    {
        public ReqFuncpubL_5_201DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.5.201";
            CommonDTO.func_code = CommonDTO.function_code;
            query_opor_no = 0;
            co_no = 0;
            is_trader = 0;
    ...
    public class ReqFuncpubL_5_202DTO : ReqBaseDTO
    {
        public ReqFuncpubL_5_202DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.5.202";
            CommonDTO.func_code = CommonDTO.function_code;
        }
    ...
    //逻辑_公共_用户_获取操作员交易组权限
    public class ReqFuncpubL_5_203DTO : ReqBaseDTO
    {
        public ReqFuncpubL_5_203DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.5.203";
            CommonDTO.func_code = CommonDTO.function_code;
        }
    ...
    public class ReqFuncpubL_5_204DTO : ReqBaseDTO
    {
        public ReqFuncpubL_5_204DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.5.204";
            CommonDTO.func_code = CommonDTO.function_code;
            query_opor_no = 0;
            co_no = 0;
            row_id = 0;
    ...
    //逻辑_公共_用户_冻结交易组
    public class ReqFuncpubL_5_205DTO : ReqBaseDTO
    {
        public ReqFuncpubL_5_205DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.5.205";
            CommonDTO.func_code = CommonDTO.function_code;
            exch_group_no = 0;
            oper_remark_info = " ";
        }
    ...
    //逻辑_公共_用户_解冻交易组
    public class ReqFuncpubL_5_206DTO : ReqBaseDTO
    {
        public ReqFuncpubL_5_206DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.5.206";
            CommonDTO.func_code = CommonDTO.function_code;
            exch_group_no = 0;
            oper_remark_info = " ";
        }
    ...
    public class ReqFuncpubL_5_207DTO : ReqBaseDTO
    {
        public ReqFuncpubL_5_207DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.5.207";
            CommonDTO.func_code = CommonDTO.function_code;
            co_no = 0;
            exch_group_no = 0;
            oper_remark_info = " ";
    ...
    //逻辑_公共_用户_新增交易组信息
    public class ReqFuncpubL_5_208DTO : ReqBaseDTO
    {
        public ReqFuncpubL_5_208DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.5.208";
            CommonDTO.func_code = CommonDTO.function_code;
            co_no = 0;
            busi_opor_no = 0;
            exch_group_code = " ";
    ...
    //逻辑_公共_用户_查询交易组信息
    public class ReqFuncpubL_5_209DTO : ReqBaseDTO
    {
        public ReqFuncpubL_5_209DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.5.209";
            CommonDTO.func_code = CommonDTO.function_code;
            co_no = 0;
            exch_group_no = 0;
    ...
    //逻辑_公共_用户_修改交易组信息
    public class ReqFuncpubL_5_210DTO : ReqBaseDTO
    {
        public ReqFuncpubL_5_210DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.5.210";
            CommonDTO.func_code = CommonDTO.function_code;
            co_no = 0;
            busi_opor_no = 0;
            exch_group_no = 0;
    ...
    //逻辑_公共_用户_注销交易组
    public class ReqFuncpubL_5_211DTO : ReqBaseDTO
    {
        public ReqFuncpubL_5_211DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.5.211";
            CommonDTO.func_code = CommonDTO.function_code;
            co_no = 0;
            busi_opor_no = 0;
            exch_group_no = 0;
    ...
    public class ReqFuncpubL_5_212DTO : ReqBaseDTO
    {
        public ReqFuncpubL_5_212DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.5.212";
            CommonDTO.func_code = CommonDTO.function_code;
            co_no = 0;
            target_opor_no = 0;
            allow_opor_no = 0;
    ...
    public class ReqFuncpubL_5_213DTO : ReqBaseDTO
    {
        public ReqFuncpubL_5_213DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.5.213";
            CommonDTO.func_code = CommonDTO.function_code;
            co_no = 0;
            target_opor_no = 0;
            allow_opor_no = 0;
    ...
    //逻辑_公共_用户_新增操作员可操作产品
    public class ReqFuncpubL_5_214DTO : ReqBaseDTO
    {
        public ReqFuncpubL_5_214DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.5.214";
            CommonDTO.func_code = CommonDTO.function_code;
            co_no = 0;
            target_opor_no = 0;
            pd_no = 0;
    ...
    //逻辑_公共_用户_删除操作员可操作产品
    public class ReqFuncpubL_5_215DTO : ReqBaseDTO
    {
        public ReqFuncpubL_5_215DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.5.215";
            CommonDTO.func_code = CommonDTO.function_code;
            co_no = 0;
            target_opor_no = 0;
            pd_no = 0;
    ...
    //逻辑_公共_用户_新增操作员所属交易组
    public class ReqFuncpubL_5_216DTO : ReqBaseDTO
    {
        public ReqFuncpubL_5_216DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.5.216";
            CommonDTO.func_code = CommonDTO.function_code;
            co_no = 0;
            target_opor_no = 0;
            exch_group_no = 0;
    ...
    //逻辑_公共_用户_删除操作员所属交易组
    public class ReqFuncpubL_5_217DTO : ReqBaseDTO
    {
        public ReqFuncpubL_5_217DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.5.217";
            CommonDTO.func_code = CommonDTO.function_code;
            co_no = 0;
            target_opor_no = 0;
            exch_group_no = 0;
