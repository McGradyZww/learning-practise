...
namespace LdNet.ClientSdk.Request
{
    ...
    public class rksecuL_3_24_Request : BaseRequest, IRequest<rksecuL_3_24_Response>
    {
        public rksecuL_3_24_Request(ClientOperator CurrOpeartor) : base(CurrOpeartor)
        {
    ...
    public class rksecuL_3_25_Request : BaseRequest, IRequest<rksecuL_3_25_Response>
    {
        public rksecuL_3_25_Request(ClientOperator CurrOpeartor) : base(CurrOpeartor)
        {
        ...
        {
            InitCommomParams(packer,FunctionNo);
            packer.AddField("index_name", 'S', index_name);
            packer.AddField("exch_no", 'I', exch_no);
            packer.AddField("stock_code", 'S', stock_code);
            packer.AddField("stock_name", 'S', stock_name);
            packer.AddField("weight_ratio", 'D', weight_ratio);
