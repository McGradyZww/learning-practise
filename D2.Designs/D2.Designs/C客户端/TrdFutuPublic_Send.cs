...
{
    //逻辑_交易期货_公用_更新报盘机状态
    public class ReqFunctdfutuL_1_1DTO : ReqBaseDTO
    {
        public ReqFunctdfutuL_1_1DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "tdfutuL.1.1";
    ...
    //逻辑_交易期货_公用_获取业务记录编号
    public class ReqFunctdfutuL_1_2DTO : ReqBaseDTO
    {
        public ReqFunctdfutuL_1_2DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "tdfutuL.1.2";
            CommonDTO.func_code = CommonDTO.function_code;
            co_no = 0;
            record_no_type = 0;
        }
    ...
    //逻辑_交易期货_公用_数据归历史
    public class ReqFunctdfutuL_1_3DTO : ReqBaseDTO
    {
        public ReqFunctdfutuL_1_3DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "tdfutuL.1.3";
            CommonDTO.func_code = CommonDTO.function_code;
            task_no = 0;
            exec_count = 0;
            exec_date = 0;
