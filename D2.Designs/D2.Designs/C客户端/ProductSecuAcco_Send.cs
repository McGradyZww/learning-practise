...
namespace LD.Client.Contract
{
    ...
    public class ReqFuncpdsecuL_1_1DTO : ReqBaseDTO
    {
        public ReqFuncpdsecuL_1_1DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pdsecuL.1.1";
        ...
        public override LDsdkDefine.LDPackerAdapter CreatePacker()
        {
            ...
            packer.AddField("sh_stock_acco", ELDDATATYPE.LD_DATATYPE_STRING);
            packer.AddField("sz_stock_acco", ELDDATATYPE.LD_DATATYPE_STRING);
            packer.AddField("acco_amt", ELDDATATYPE.LD_DATATYPE_DOUBLE);
            packer.AddField("commis_ratio", ELDDATATYPE.LD_DATATYPE_DOUBLE);
            ...
            packer.AddStr(sh_stock_acco);
            packer.AddStr(sz_stock_acco);
            packer.AddDouble(acco_amt);
            packer.AddDouble(commis_ratio);
            packer.EndPack();
    ...
    public class ReqFuncpdsecuL_1_2DTO : ReqBaseDTO
    {
        public ReqFuncpdsecuL_1_2DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pdsecuL.1.2";
            CommonDTO.func_code = CommonDTO.function_code;
            co_no = 0;
            combo_code = " ";
            out_acco = " ";
    ...
    //逻辑_产品证券_账户_检查证券账户存在
    public class ReqFuncpdsecuL_1_40DTO : ReqBaseDTO
    {
        public ReqFuncpdsecuL_1_40DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pdsecuL.1.40";
            CommonDTO.func_code = CommonDTO.function_code;
            asset_acco_no = 0;
            exch_no = 0;
            stock_acco = " ";
    ...
    //逻辑_产品证券_账户_新增证券账户信息
    public class ReqFuncpdsecuL_1_41DTO : ReqBaseDTO
    {
        public ReqFuncpdsecuL_1_41DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pdsecuL.1.41";
            CommonDTO.func_code = CommonDTO.function_code;
            pd_no = 0;
            asset_acco_no = 0;
            exch_no = 0;
    ...
    //逻辑_产品证券_账户_修改证券账户信息
    public class ReqFuncpdsecuL_1_42DTO : ReqBaseDTO
    {
        public ReqFuncpdsecuL_1_42DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pdsecuL.1.42";
            CommonDTO.func_code = CommonDTO.function_code;
            pd_no = 0;
            asset_acco_no = 0;
            stock_acco_no = 0;
    ...
    //逻辑_产品证券_账户_删除证券账户信息
    public class ReqFuncpdsecuL_1_43DTO : ReqBaseDTO
    {
        public ReqFuncpdsecuL_1_43DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pdsecuL.1.43";
            CommonDTO.func_code = CommonDTO.function_code;
            pd_no = 0;
            asset_acco_no = 0;
            stock_acco_no = 0;
    ...
    //逻辑_产品证券_账户_查询证券账户信息
    public class ReqFuncpdsecuL_1_44DTO : ReqBaseDTO
    {
        public ReqFuncpdsecuL_1_44DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pdsecuL.1.44";
            CommonDTO.func_code = CommonDTO.function_code;
            pd_no = 0;
            asset_acco_no = 0;
            stock_acco_no = 0;
    ...
    public class ReqFuncpdsecuL_1_45DTO : ReqBaseDTO
    {
        public ReqFuncpdsecuL_1_45DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pdsecuL.1.45";
            CommonDTO.func_code = CommonDTO.function_code;
            pd_no = 0;
            asset_acco_no = 0;
            stock_acco_no = 0;
    ...
    public class ReqFuncpdsecuL_1_46DTO : ReqBaseDTO
    {
        public ReqFuncpdsecuL_1_46DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pdsecuL.1.46";
            CommonDTO.func_code = CommonDTO.function_code;
            begin_date = 0;
            end_date = 0;
            pd_no = 0;
    ...
    //逻辑_产品证券_账户_冻结证券账户
    public class ReqFuncpdsecuL_1_47DTO : ReqBaseDTO
    {
        public ReqFuncpdsecuL_1_47DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pdsecuL.1.47";
            CommonDTO.func_code = CommonDTO.function_code;
            pd_no = 0;
            asset_acco_no = 0;
            stock_acco_no = 0;
    ...
    //逻辑_产品证券_账户_恢复证券账户
    public class ReqFuncpdsecuL_1_48DTO : ReqBaseDTO
    {
        public ReqFuncpdsecuL_1_48DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pdsecuL.1.48";
            CommonDTO.func_code = CommonDTO.function_code;
            pd_no = 0;
            asset_acco_no = 0;
            stock_acco_no = 0;
    ...
    //逻辑_产品证券_账户_注销证券账户
    public class ReqFuncpdsecuL_1_49DTO : ReqBaseDTO
    {
        public ReqFuncpdsecuL_1_49DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pdsecuL.1.49";
            CommonDTO.func_code = CommonDTO.function_code;
            pd_no = 0;
            asset_acco_no = 0;
            stock_acco_no = 0;
    ...
    //逻辑_产品证券_账户_查询证券账户列表
    public class ReqFuncpdsecuL_1_51DTO : ReqBaseDTO
    {
        public ReqFuncpdsecuL_1_51DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pdsecuL.1.51";
            CommonDTO.func_code = CommonDTO.function_code;
        }
    ...
    public class ReqFuncpdsecuL_1_61DTO : ReqBaseDTO
    {
        public ReqFuncpdsecuL_1_61DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pdsecuL.1.61";
            CommonDTO.func_code = CommonDTO.function_code;
            pd_no = 0;
            asset_acco_no = 0;
            exch_no = 0;
    ...
    public class ReqFuncpdsecuL_1_62DTO : ReqBaseDTO
    {
        public ReqFuncpdsecuL_1_62DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pdsecuL.1.62";
            CommonDTO.func_code = CommonDTO.function_code;
            pd_no = 0;
            asset_acco_no = 0;
            stock_acco_no = 0;
    ...
    public class ReqFuncpdsecuL_1_63DTO : ReqBaseDTO
    {
        public ReqFuncpdsecuL_1_63DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pdsecuL.1.63";
            CommonDTO.func_code = CommonDTO.function_code;
            pd_no = 0;
            asset_acco_no = 0;
            stock_acco_no = 0;
    ...
    public class ReqFuncpdsecuL_1_64DTO : ReqBaseDTO
    {
        public ReqFuncpdsecuL_1_64DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pdsecuL.1.64";
            CommonDTO.func_code = CommonDTO.function_code;
            pd_no = 0;
            asset_acco_no = 0;
            exch_no = 0;
    ...
    public class ReqFuncpdsecuL_1_501DTO : ReqBaseDTO
    {
        public ReqFuncpdsecuL_1_501DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pdsecuL.1.501";
            CommonDTO.func_code = CommonDTO.function_code;
            pass_no = 0;
        }
    ...
    public class ReqFuncpdsecuL_1_71DTO : ReqBaseDTO
    {
        public ReqFuncpdsecuL_1_71DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pdsecuL.1.71";
            CommonDTO.func_code = CommonDTO.function_code;
            pass_no = 0;
            out_acco = " ";
            exch_no = 0;
    ...
    public class ReqFuncpdsecuL_1_72DTO : ReqBaseDTO
    {
        public ReqFuncpdsecuL_1_72DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pdsecuL.1.72";
            CommonDTO.func_code = CommonDTO.function_code;
            pd_no = 0;
            asset_acco_no = 0;
            oper_remark_info = " ";
    ...
    public class ReqFuncpdsecuL_1_73DTO : ReqBaseDTO
    {
        public ReqFuncpdsecuL_1_73DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pdsecuL.1.73";
            CommonDTO.func_code = CommonDTO.function_code;
            co_no = 0;
            pd_no = 0;
            exch_group_no = 0;
    ...
    public class ReqFuncpdsecuL_1_74DTO : ReqBaseDTO
    {
        public ReqFuncpdsecuL_1_74DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pdsecuL.1.74";
            CommonDTO.func_code = CommonDTO.function_code;
            co_no = 0;
            pd_no = 0;
            exch_group_no = 0;
    ...
    public class ReqFuncpdsecuL_1_75DTO : ReqBaseDTO
    {
        public ReqFuncpdsecuL_1_75DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pdsecuL.1.75";
            CommonDTO.func_code = CommonDTO.function_code;
            co_no = 0;
            pd_no = 0;
            exch_group_no = 0;
    ...
    public class ReqFuncpdsecuL_1_76DTO : ReqBaseDTO
    {
        public ReqFuncpdsecuL_1_76DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pdsecuL.1.76";
            CommonDTO.func_code = CommonDTO.function_code;
            co_no = 0;
            pd_no = 0;
            exch_group_no = 0;
    ...
    public class ReqFuncpdsecuL_1_77DTO : ReqBaseDTO
    {
        public ReqFuncpdsecuL_1_77DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pdsecuL.1.77";
            CommonDTO.func_code = CommonDTO.function_code;
            asset_acco_no = 0;
            pd_no = 0;
            exch_group_no = 0;
