...
{
    //逻辑_清算外盘期货_清算_转入订单记录
    public class ReqFuncclfofuL_2_1DTO : ReqBaseDTO
    {
        public ReqFuncclfofuL_2_1DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "clfofuL.2.1";
    ...
    //逻辑_清算外盘期货_清算_查询订单记录
    public class ReqFuncclfofuL_2_4DTO : ReqBaseDTO
    {
        public ReqFuncclfofuL_2_4DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "clfofuL.2.4";
            CommonDTO.func_code = CommonDTO.function_code;
            order_date = 0;
            order_no = 0;
            pass_no = 0;
    ...
    //逻辑_清算外盘期货_清算_转入成交记录
    public class ReqFuncclfofuL_2_6DTO : ReqBaseDTO
    {
        public ReqFuncclfofuL_2_6DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "clfofuL.2.6";
            CommonDTO.func_code = CommonDTO.function_code;
        }
    ...
    //逻辑_清算外盘期货_清算_查询成交记录
    public class ReqFuncclfofuL_2_9DTO : ReqBaseDTO
    {
        public ReqFuncclfofuL_2_9DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "clfofuL.2.9";
            CommonDTO.func_code = CommonDTO.function_code;
            strike_date = 0;
            strike_no = " ";
            pass_no = 0;
    ...
    //逻辑_清算外盘期货_清算_清算处理
    public class ReqFuncclfofuL_2_31DTO : ReqBaseDTO
    {
        public ReqFuncclfofuL_2_31DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "clfofuL.2.31";
            CommonDTO.func_code = CommonDTO.function_code;
        }
    ...
    //逻辑_清算外盘期货_清算_订单费用处理
    public class ReqFuncclfofuL_2_32DTO : ReqBaseDTO
    {
        public ReqFuncclfofuL_2_32DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "clfofuL.2.32";
            CommonDTO.func_code = CommonDTO.function_code;
        }
    ...
    //逻辑_清算外盘期货_清算_合并清算处理
    public class ReqFuncclfofuL_2_33DTO : ReqBaseDTO
    {
        public ReqFuncclfofuL_2_33DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "clfofuL.2.33";
            CommonDTO.func_code = CommonDTO.function_code;
        }
    ...
    public class ReqFuncclfofuL_2_34DTO : ReqBaseDTO
    {
        public ReqFuncclfofuL_2_34DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "clfofuL.2.34";
            CommonDTO.func_code = CommonDTO.function_code;
            strike_date = 0;
            busi_flag = 0;
            deal_flag = 0;
    ...
    public class ReqFuncclfofuL_2_35DTO : ReqBaseDTO
    {
        public ReqFuncclfofuL_2_35DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "clfofuL.2.35";
            CommonDTO.func_code = CommonDTO.function_code;
            co_no = 0;
            pd_no = 0;
            exch_group_no = 0;
    ...
    //逻辑_清算外盘期货_清算_入账处理
    public class ReqFuncclfofuL_2_51DTO : ReqBaseDTO
    {
        public ReqFuncclfofuL_2_51DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "clfofuL.2.51";
            CommonDTO.func_code = CommonDTO.function_code;
        }
    ...
    //逻辑_清算外盘期货_清算_入账回滚处理
    public class ReqFuncclfofuL_2_52DTO : ReqBaseDTO
    {
        public ReqFuncclfofuL_2_52DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "clfofuL.2.52";
            CommonDTO.func_code = CommonDTO.function_code;
            row_id = 0;
        }
    ...
    //逻辑_清算外盘期货_清算_数据归历史
    public class ReqFuncclfofuL_2_71DTO : ReqBaseDTO
    {
        public ReqFuncclfofuL_2_71DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "clfofuL.2.71";
            CommonDTO.func_code = CommonDTO.function_code;
            init_date = 0;
        }
    ...
    public class ReqFuncclfofuL_2_101DTO : ReqBaseDTO
    {
        public ReqFuncclfofuL_2_101DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "clfofuL.2.101";
            CommonDTO.func_code = CommonDTO.function_code;
            task_no = 0;
            exec_count = 0;
            exec_date = 0;
    ...
    public class ReqFuncclfutuL_2_102DTO : ReqBaseDTO
    {
        public ReqFuncclfutuL_2_102DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "clfutuL.2.102";
            CommonDTO.func_code = CommonDTO.function_code;
            task_no = 0;
            exec_count = 0;
            exec_date = 0;
    ...
    public class ReqFuncclfofuL_2_103DTO : ReqBaseDTO
    {
        public ReqFuncclfofuL_2_103DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "clfofuL.2.103";
            CommonDTO.func_code = CommonDTO.function_code;
            task_no = 0;
            exec_count = 0;
            exec_date = 0;
    ...
    //逻辑_清算外盘期货_清算_入账定时任务
    public class ReqFuncclfofuL_2_104DTO : ReqBaseDTO
    {
        public ReqFuncclfofuL_2_104DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "clfofuL.2.104";
            CommonDTO.func_code = CommonDTO.function_code;
            task_no = 0;
            exec_count = 0;
            exec_date = 0;
    ...
    public class ReqFuncclfofuL_2_106DTO : ReqBaseDTO
    {
        public ReqFuncclfofuL_2_106DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "clfofuL.2.106";
            CommonDTO.func_code = CommonDTO.function_code;
            task_no = 0;
            exec_count = 0;
            exec_date = 0;
