...
{
    //逻辑_产品_资金运维_查询产品资金
    public class ReqFuncprodL_4_1DTO : ReqBaseDTO
    {
        public ReqFuncprodL_4_1DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "prodL.4.1";
    ...
    //逻辑_产品_资金运维_查询历史产品资金
    public class ReqFuncprodL_4_2DTO : ReqBaseDTO
    {
        public ReqFuncprodL_4_2DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "prodL.4.2";
            CommonDTO.func_code = CommonDTO.function_code;
            begin_date = 0;
            end_date = 0;
            co_no = 0;
    ...
    //逻辑_产品_资金运维_查询产品资金流水
    public class ReqFuncprodL_4_5DTO : ReqBaseDTO
    {
        public ReqFuncprodL_4_5DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "prodL.4.5";
            CommonDTO.func_code = CommonDTO.function_code;
            co_no = 0;
            pd_no = 0;
            crncy_type_str = " ";
    ...
    public class ReqFuncprodL_4_6DTO : ReqBaseDTO
    {
        public ReqFuncprodL_4_6DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "prodL.4.6";
            CommonDTO.func_code = CommonDTO.function_code;
            begin_date = 0;
            end_date = 0;
            co_no = 0;
    ...
    //逻辑_产品_资金运维_查询产品资产
    public class ReqFuncprodL_4_7DTO : ReqBaseDTO
    {
        public ReqFuncprodL_4_7DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "prodL.4.7";
            CommonDTO.func_code = CommonDTO.function_code;
            co_no = 0;
            pd_no_str = " ";
            crncy_type_str = " ";
    ...
    //逻辑_产品_资金运维_查询历史产品资产
    public class ReqFuncprodL_4_8DTO : ReqBaseDTO
    {
        public ReqFuncprodL_4_8DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "prodL.4.8";
            CommonDTO.func_code = CommonDTO.function_code;
            begin_date = 0;
            end_date = 0;
            co_no = 0;
