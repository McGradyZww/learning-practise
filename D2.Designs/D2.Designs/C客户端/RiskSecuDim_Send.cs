...
{
    //逻辑_风控证券_维度_查询指数类型
    public class ReqFuncrksecuL_3_1DTO : ReqBaseDTO
    {
        public ReqFuncrksecuL_3_1DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "rksecuL.3.1";
    ...
    //逻辑_风控证券_维度_查询指数证券代码
    public class ReqFuncrksecuL_3_2DTO : ReqBaseDTO
    {
        public ReqFuncrksecuL_3_2DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "rksecuL.3.2";
            CommonDTO.func_code = CommonDTO.function_code;
            index_code = " ";
        }
        ...
        public override LDsdkDefine.LDPackerAdapter CreatePacker()
        {
            ...
            packer.AddField("index_code", ELDDATATYPE.LD_DATATYPE_STRING);
    ...
    //逻辑_风控证券_维度_查询行业类型
    public class ReqFuncrksecuL_3_3DTO : ReqBaseDTO
    {
        public ReqFuncrksecuL_3_3DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "rksecuL.3.3";
            CommonDTO.func_code = CommonDTO.function_code;
        }
    ...
    //逻辑_风控证券_维度_查询行业层级
    public class ReqFuncrksecuL_3_4DTO : ReqBaseDTO
    {
        public ReqFuncrksecuL_3_4DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "rksecuL.3.4";
            CommonDTO.func_code = CommonDTO.function_code;
            indu_type_no = 0;
        }
        ...
        public override LDsdkDefine.LDPackerAdapter CreatePacker()
        {
            ...
            packer.AddField("indu_type_no", ELDDATATYPE.LD_DATATYPE_INT);
    ...
    //逻辑_风控证券_维度_查询行业证券代码
    public class ReqFuncrksecuL_3_5DTO : ReqBaseDTO
    {
        public ReqFuncrksecuL_3_5DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "rksecuL.3.5";
            CommonDTO.func_code = CommonDTO.function_code;
            indu_type_no = 0;
            indu_code = " ";
        }
        ...
        public override LDsdkDefine.LDPackerAdapter CreatePacker()
        {
            ...
            packer.AddField("indu_type_no", ELDDATATYPE.LD_DATATYPE_INT);
            packer.AddField("indu_code", ELDDATATYPE.LD_DATATYPE_STRING);
    ...
    public class ReqFuncrksecuL_3_6DTO : ReqBaseDTO
    {
        public ReqFuncrksecuL_3_6DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "rksecuL.3.6";
            CommonDTO.func_code = CommonDTO.function_code;
        }
    ...
    public class ReqFuncrksecuL_3_7DTO : ReqBaseDTO
    {
        public ReqFuncrksecuL_3_7DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "rksecuL.3.7";
            CommonDTO.func_code = CommonDTO.function_code;
            dime_type_code = " ";
        }
        ...
        public override LDsdkDefine.LDPackerAdapter CreatePacker()
        {
            ...
            packer.AddField("dime_type_code", ELDDATATYPE.LD_DATATYPE_STRING);
    ...
    //逻辑_风控证券_维度_新增机构维度类型
    public class ReqFuncrksecuL_3_8DTO : ReqBaseDTO
    {
        public ReqFuncrksecuL_3_8DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "rksecuL.3.8";
            CommonDTO.func_code = CommonDTO.function_code;
            co_no = 0;
            user_dim_type = 0;
            dime_type_code = " ";
        ...
        public override LDsdkDefine.LDPackerAdapter CreatePacker()
        {
            ...
            packer.AddField("user_dim_type", ELDDATATYPE.LD_DATATYPE_INT);
            packer.AddField("dime_type_code", ELDDATATYPE.LD_DATATYPE_STRING);
            packer.AddField("dime_type_name", ELDDATATYPE.LD_DATATYPE_STRING);
            ...
            packer.AddInt(co_no);
            packer.AddInt(user_dim_type);
            packer.AddStr(dime_type_code);
            packer.AddStr(dime_type_name);
    ...
    //逻辑_风控证券_维度_修改机构维度类型
    public class ReqFuncrksecuL_3_9DTO : ReqBaseDTO
    {
        public ReqFuncrksecuL_3_9DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "rksecuL.3.9";
            CommonDTO.func_code = CommonDTO.function_code;
            co_no = 0;
            user_dim_type = 0;
            dime_type_code = " ";
    ...
    //逻辑_风控证券_维度_删除机构维度类型
    public class ReqFuncrksecuL_3_10DTO : ReqBaseDTO
    {
        public ReqFuncrksecuL_3_10DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "rksecuL.3.10";
            CommonDTO.func_code = CommonDTO.function_code;
            co_no = 0;
            user_dim_type = 0;
            dime_type_code = " ";
    ...
    //逻辑_风控证券_维度_查询机构维度类型
    public class ReqFuncrksecuL_3_11DTO : ReqBaseDTO
    {
        public ReqFuncrksecuL_3_11DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "rksecuL.3.11";
            CommonDTO.func_code = CommonDTO.function_code;
            co_no = 0;
        }
    ...
    public class ReqFuncrksecuL_3_12DTO : ReqBaseDTO
    {
        public ReqFuncrksecuL_3_12DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "rksecuL.3.12";
            CommonDTO.func_code = CommonDTO.function_code;
            co_no = 0;
            dime_type_code = " ";
            exch_no = 0;
    ...
    public class ReqFuncrksecuL_3_13DTO : ReqBaseDTO
    {
        public ReqFuncrksecuL_3_13DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "rksecuL.3.13";
            CommonDTO.func_code = CommonDTO.function_code;
            co_no = 0;
            dime_type_code = " ";
            exch_no = 0;
    ...
    public class ReqFuncrksecuL_3_14DTO : ReqBaseDTO
    {
        public ReqFuncrksecuL_3_14DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "rksecuL.3.14";
            CommonDTO.func_code = CommonDTO.function_code;
            co_no = 0;
            dime_type_code = " ";
        }
    ...
    public class ReqFuncrksecuL_3_15DTO : ReqBaseDTO
    {
        public ReqFuncrksecuL_3_15DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "rksecuL.3.15";
            CommonDTO.func_code = CommonDTO.function_code;
            dime_id = 0;
        }
    ...
    public class ReqFuncrksecuL_3_16DTO : ReqBaseDTO
    {
        public ReqFuncrksecuL_3_16DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "rksecuL.3.16";
            CommonDTO.func_code = CommonDTO.function_code;
            co_no = 0;
            dime_type = 0;
            ctrl_cond_dim_code_str = " ";
        }
        ...
        public override LDsdkDefine.LDPackerAdapter CreatePacker()
        {
            ...
            packer.AddField("co_no", ELDDATATYPE.LD_DATATYPE_INT);
            packer.AddField("dime_type", ELDDATATYPE.LD_DATATYPE_INT);
            packer.AddField("ctrl_cond_dim_code_str", ELDDATATYPE.LD_DATATYPE_STRING);
            ...
            packer.AddInt(co_no);
            packer.AddInt(dime_type);
            packer.AddStr(ctrl_cond_dim_code_str);
            packer.EndPack();
    ...
    public class ReqFuncrksecuL_3_17DTO : ReqBaseDTO
    {
        public ReqFuncrksecuL_3_17DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "rksecuL.3.17";
            CommonDTO.func_code = CommonDTO.function_code;
            dime_type_code = " ";
        }
    ...
    public class ReqFuncrksecuL_3_24DTO : ReqBaseDTO
    {
        public ReqFuncrksecuL_3_24DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "rksecuL.3.24";
            CommonDTO.func_code = CommonDTO.function_code;
            stock_code_no_str = " ";
        }
    ...
    public class ReqFuncrksecuL_3_25DTO : ReqBaseDTO
    {
        public ReqFuncrksecuL_3_25DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "rksecuL.3.25";
            CommonDTO.func_code = CommonDTO.function_code;
            index_name = " ";
            exch_no = 0;
            stock_code = " ";
        ...
        public override LDsdkDefine.LDPackerAdapter CreatePacker()
        {
            ...
            packer.AddField("index_name", ELDDATATYPE.LD_DATATYPE_STRING);
            packer.AddField("exch_no", ELDDATATYPE.LD_DATATYPE_INT);
            packer.AddField("stock_code", ELDDATATYPE.LD_DATATYPE_STRING);
            packer.AddField("stock_name", ELDDATATYPE.LD_DATATYPE_STRING);
            packer.AddField("weight_ratio", ELDDATATYPE.LD_DATATYPE_DOUBLE);
        ...
        public override LDsdkDefineEx.LDFastMessageAdapter CreateFastMessage()
        {
            ...
            fastMsg.SetString(LDBizTagDefine.LDBizTag.LDBIZ_INDEX_NAME_STR,index_name);
            fastMsg.SetInt32(LDBizTagDefine.LDBizTag.LDBIZ_EXCH_NO_INT,exch_no);
            fastMsg.SetString(LDBizTagDefine.LDBizTag.LDBIZ_STOCK_CODE_STR,stock_code);
            fastMsg.SetString(LDBizTagDefine.LDBizTag.LDBIZ_STOCK_NAME_STR,stock_name);
            fastMsg.SetDouble(LDBizTagDefine.LDBizTag.LDBIZ_WEIGHT_RATIO_FLOAT,weight_ratio);
