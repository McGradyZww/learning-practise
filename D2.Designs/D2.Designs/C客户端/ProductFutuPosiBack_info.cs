...
{
    public class pdfutuL_9_1_Info : ObservableObject
    {
    }

    public class pdfutuL_9_2_Info : ObservableObject
    {
        ...
        private double _acco_rece_margin;
        /// <summary>
        /// 账户应收保证金
        /// </summary>
        public double acco_rece_margin
        {
            get { return _acco_rece_margin; }

            set
            {
                _acco_rece_margin = value;
                RaisePropertyChanged(() => acco_rece_margin);
            }
        }
        ...
        private double _out_rece_margin;
        /// <summary>
        /// 外部应收保证金
        /// </summary>
        public double out_rece_margin
        {
            get { return _out_rece_margin; }

            set
            {
                _out_rece_margin = value;
                RaisePropertyChanged(() => out_rece_margin);
            }
        }
        ...
        private double _acco_rece_margin_diff;
        /// <summary>
        /// 账户应收保证金差额
        /// </summary>
        public double acco_rece_margin_diff
        {
            get { return _acco_rece_margin_diff; }

            set
            {
                _acco_rece_margin_diff = value;
                RaisePropertyChanged(() => acco_rece_margin_diff);
            }
        }
    ...
    public class pdfutuL_9_3_Info : ObservableObject
    {
    ...
    public class pdfutuL_9_71_Info : ObservableObject
    {
    ...
    public class pdfutuL_9_72_Info : ObservableObject
    {
    ...
    public class pdfutuL_9_8_Info : ObservableObject
    {
    }

    public class pdfutuL_9_9_Info : ObservableObject
    {
    }

    public class pdfutuL_9_73_Info : ObservableObject
    {
