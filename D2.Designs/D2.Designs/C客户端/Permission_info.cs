...
{
    public class pubL_7_1_Info : ObservableObject
    {
    }

    public class pubL_7_2_Info : ObservableObject
    {
    }

    public class pubL_7_3_Info : ObservableObject
    {
    }

    public class pubL_7_4_Info : ObservableObject
    {
    }

    public class pubL_7_5_Info : ObservableObject
    {
    ...
    public class pubL_7_6_Info : ObservableObject
    {
    ...
    public class pubL_7_13_Info : ObservableObject
    {
    }

    public class pubL_7_14_Info : ObservableObject
    {
    }

    public class pubL_7_15_Info : ObservableObject
    {
    ...
    public class pubL_7_21_Info : ObservableObject
    {
    ...
    public class pubL_7_22_Info : ObservableObject
    {
    }

    public class pubL_7_23_Info : ObservableObject
    {
    }

    public class pubL_7_24_Info : ObservableObject
    {
    ...
    public class pubL_7_27_Info : ObservableObject
    {
    }

    public class pubL_7_28_Info : ObservableObject
    {
    }

    public class pubL_7_33_Info : ObservableObject
    {
    ...
    public class pubL_7_34_Info : ObservableObject
    {
        ...
        public String func_name
        {
            ...
            {
                _func_name = value;
                RaisePropertyChanged(() => func_name);
            }
        }
    }

    public class pubL_7_29_Info : ObservableObject
    {
    ...
    public class pubL_7_30_Info : ObservableObject
    {
    ...
    public class pubL_7_31_Info : ObservableObject
    {
    ...
    public class pubL_7_32_Info : ObservableObject
    {
    ...
    public class pubL_7_51_Info : ObservableObject
    {
    }

    public class pubL_7_52_Info : ObservableObject
    {
    }
