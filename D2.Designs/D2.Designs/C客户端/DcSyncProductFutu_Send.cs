...
namespace LD.Client.Contract
{
    ...
    public class ReqFuncdcsyncL_4_12DTO : ReqBaseDTO
    {
        public ReqFuncdcsyncL_4_12DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "dcsyncL.4.12";
    ...
    public class ReqFuncdcsyncL_4_13DTO : ReqBaseDTO
    {
        public ReqFuncdcsyncL_4_13DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "dcsyncL.4.13";
            CommonDTO.func_code = CommonDTO.function_code;
        }
    ...
    public class ReqFuncdcsyncL_4_14DTO : ReqBaseDTO
    {
        public ReqFuncdcsyncL_4_14DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "dcsyncL.4.14";
            CommonDTO.func_code = CommonDTO.function_code;
        }
    ...
    public class ReqFuncdcsyncL_4_15DTO : ReqBaseDTO
    {
        public ReqFuncdcsyncL_4_15DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "dcsyncL.4.15";
            CommonDTO.func_code = CommonDTO.function_code;
        }
    ...
    public class ReqFuncdcsyncL_4_16DTO : ReqBaseDTO
    {
        public ReqFuncdcsyncL_4_16DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "dcsyncL.4.16";
            CommonDTO.func_code = CommonDTO.function_code;
        }
