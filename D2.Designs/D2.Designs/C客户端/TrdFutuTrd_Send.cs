...
{
    //逻辑_交易期货_交易_新增订单
    public class ReqFunctdfutuL_4_11DTO : ReqBaseDTO
    {
        public ReqFunctdfutuL_4_11DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "tdfutuL.4.11";
    ...
    //逻辑_交易期货_交易_撤销订单
    public class ReqFunctdfutuL_4_12DTO : ReqBaseDTO
    {
        public ReqFunctdfutuL_4_12DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "tdfutuL.4.12";
            CommonDTO.func_code = CommonDTO.function_code;
            order_date = 0;
            order_id = 0;
        }
    ...
    //逻辑_交易期货_交易_更新订单状态
    public class ReqFunctdfutuL_4_21DTO : ReqBaseDTO
    {
        public ReqFunctdfutuL_4_21DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "tdfutuL.4.21";
            CommonDTO.func_code = CommonDTO.function_code;
            order_id = 0;
            order_status = "0";
            order_date = 0;
    ...
    //逻辑_交易期货_交易_查询报盘订单
    public class ReqFunctdfutuL_4_31DTO : ReqBaseDTO
    {
        public ReqFunctdfutuL_4_31DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "tdfutuL.4.31";
            CommonDTO.func_code = CommonDTO.function_code;
            init_date = 0;
            pass_no = 0;
            row_count = -1;
    ...
    //逻辑_交易期货_交易_查询报盘撤单
    public class ReqFunctdfutuL_4_32DTO : ReqBaseDTO
    {
        public ReqFunctdfutuL_4_32DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "tdfutuL.4.32";
            CommonDTO.func_code = CommonDTO.function_code;
            init_date = 0;
            pass_no = 0;
            row_count = -1;
    ...
    //逻辑_交易期货_交易_查询订单
    public class ReqFunctdfutuL_4_101DTO : ReqBaseDTO
    {
        public ReqFunctdfutuL_4_101DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "tdfutuL.4.101";
            CommonDTO.func_code = CommonDTO.function_code;
            busi_opor_no = 0;
            co_no = 0;
            pd_no = 0;
    ...
    //逻辑_交易期货_交易_查询订单历史
    public class ReqFunctdfutuL_4_102DTO : ReqBaseDTO
    {
        public ReqFunctdfutuL_4_102DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "tdfutuL.4.102";
            CommonDTO.func_code = CommonDTO.function_code;
            begin_date = 0;
            end_date = 0;
            busi_opor_no = 0;
    ...
    public class ReqFunctdfutuL_4_103DTO : ReqBaseDTO
    {
        public ReqFunctdfutuL_4_103DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "tdfutuL.4.103";
            CommonDTO.func_code = CommonDTO.function_code;
            busi_opor_no = 0;
            co_no = 0;
            pd_no = 0;
    ...
    public class ReqFunctdfutuL_4_104DTO : ReqBaseDTO
    {
        public ReqFunctdfutuL_4_104DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "tdfutuL.4.104";
            CommonDTO.func_code = CommonDTO.function_code;
            begin_date = 0;
            end_date = 0;
            busi_opor_no = 0;
    ...
    //逻辑_交易期货_交易_新增改单
    public class ReqFunctdfutuL_4_33DTO : ReqBaseDTO
    {
        public ReqFunctdfutuL_4_33DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "tdfutuL.4.33";
            CommonDTO.func_code = CommonDTO.function_code;
            external_no = 0;
            order_date = 0;
            order_id = 0;
    ...
    //逻辑_交易期货_交易_查询报盘订单主推
    public class ReqFunctdfutuL_4_41DTO : ReqBaseDTO
    {
        public ReqFunctdfutuL_4_41DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "tdfutuL.4.41";
            CommonDTO.func_code = CommonDTO.function_code;
            init_date = 0;
            pass_no = 0;
            row_count = -1;
    ...
    //逻辑_交易期货_交易_查询报盘撤单主推
    public class ReqFunctdfutuL_4_42DTO : ReqBaseDTO
    {
        public ReqFunctdfutuL_4_42DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "tdfutuL.4.42";
            CommonDTO.func_code = CommonDTO.function_code;
            init_date = 0;
            pass_no = 0;
            row_count = -1;
