...
{
    public class clfofuL_2_1_Info : ObservableObject
    {
    ...
    public class clfofuL_2_4_Info : ObservableObject
    {
    ...
    public class clfofuL_2_6_Info : ObservableObject
    {
    ...
    public class clfofuL_2_9_Info : ObservableObject
    {
        ...
        public String match_status
        {
            ...
            {
                _match_status = value;
                RaisePropertyChanged(() => match_status);
            }
        }
    ...
    public class clfutuL_2_21_Info : ObservableObject
    {
    }

    public class clfofuL_2_31_Info : ObservableObject
    {
    ...
    public class clfofuL_2_32_Info : ObservableObject
    {
    ...
    public class clfofuL_2_33_Info : ObservableObject
    {
    ...
    public class clfofuL_2_34_Info : ObservableObject
    {
        ...
        private double _split_rece_margin;
        /// <summary>
        /// 分笔累计应收保证金
        /// </summary>
        public double split_rece_margin
        {
            get { return _split_rece_margin; }

            set
            {
                _split_rece_margin = value;
                RaisePropertyChanged(() => split_rece_margin);
            }
        }
        ...
        private double _split_report_fee;
        /// <summary>
        /// 分笔累计申报费用
        /// </summary>
        public double split_report_fee
        {
            get { return _split_report_fee; }

            set
            {
                _split_report_fee = value;
                RaisePropertyChanged(() => split_report_fee);
            }
        }

        private double _split_cancel_fee;
        /// <summary>
        /// 分笔累计撤单费用
        /// </summary>
        public double split_cancel_fee
        {
            get { return _split_cancel_fee; }

            set
            {
                _split_cancel_fee = value;
                RaisePropertyChanged(() => split_cancel_fee);
            }
        }

        private double _split_deli_fee;
        /// <summary>
        /// 分笔累计交割费用
        /// </summary>
        public double split_deli_fee
        {
            get { return _split_deli_fee; }

            set
            {
                _split_deli_fee = value;
                RaisePropertyChanged(() => split_deli_fee);
            }
        }
        ...
        private double _split_out_strike_qty;
        /// <summary>
        /// 分笔累计外部成交数量
        /// </summary>
        public double split_out_strike_qty
        {
            get { return _split_out_strike_qty; }

            set
            {
                _split_out_strike_qty = value;
                RaisePropertyChanged(() => split_out_strike_qty);
            }
        }

        private double _split_out_strike_amt;
        /// <summary>
        /// 分笔累计外部成交金额
        /// </summary>
        public double split_out_strike_amt
        {
            get { return _split_out_strike_amt; }

            set
            {
                _split_out_strike_amt = value;
                RaisePropertyChanged(() => split_out_strike_amt);
            }
        }

        private double _split_out_report_fee;
        /// <summary>
        /// 分笔累计外部申报费用
        /// </summary>
        public double split_out_report_fee
        {
            get { return _split_out_report_fee; }

            set
            {
                _split_out_report_fee = value;
                RaisePropertyChanged(() => split_out_report_fee);
            }
        }

        private double _split_out_cancel_fee;
        /// <summary>
        /// 分笔累计外部撤单费用
        /// </summary>
        public double split_out_cancel_fee
        {
            get { return _split_out_cancel_fee; }

            set
            {
                _split_out_cancel_fee = value;
                RaisePropertyChanged(() => split_out_cancel_fee);
            }
        }

        private double _split_out_deli_fee;
        /// <summary>
        /// 分笔累计外部交割费用
        /// </summary>
        public double split_out_deli_fee
        {
            get { return _split_out_deli_fee; }

            set
            {
                _split_out_deli_fee = value;
                RaisePropertyChanged(() => split_out_deli_fee);
            }
        }

        private double _split_out_other_fee;
        /// <summary>
        /// 分笔累计外部其他费用
        /// </summary>
        public double split_out_other_fee
        {
            get { return _split_out_other_fee; }

            set
            {
                _split_out_other_fee = value;
                RaisePropertyChanged(() => split_out_other_fee);
            }
        }

        private double _split_out_brkage_commis;
        /// <summary>
        /// 分笔累计外部交易佣金
        /// </summary>
        public double split_out_brkage_commis
        {
            get { return _split_out_brkage_commis; }

            set
            {
                _split_out_brkage_commis = value;
                RaisePropertyChanged(() => split_out_brkage_commis);
            }
        }

        private double _split_out_other_commis;
        /// <summary>
        /// 分笔累计外部其他佣金
        /// </summary>
        public double split_out_other_commis
        {
            get { return _split_out_other_commis; }

            set
            {
                _split_out_other_commis = value;
                RaisePropertyChanged(() => split_out_other_commis);
            }
        }
    ...
    public class clfofuL_2_35_Info : ObservableObject
    {
    ...
    public class clfofuL_2_51_Info : ObservableObject
    {
    ...
    public class clfofuL_2_52_Info : ObservableObject
    {
    }

    public class clfofuL_2_71_Info : ObservableObject
    {
    }

    public class clfofuL_2_101_Info : ObservableObject
    {
    ...
    public class clfutuL_2_102_Info : ObservableObject
    {
    ...
    public class clfofuL_2_103_Info : ObservableObject
    {
    ...
    public class clfofuL_2_104_Info : ObservableObject
    {
    ...
    public class clfofuL_2_106_Info : ObservableObject
    {
