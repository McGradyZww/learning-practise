...
namespace LD.Client.Contract
{
    ...
    public class ReqFuncpdfutuL_9_1DTO : ReqBaseDTO
    {
        public ReqFuncpdfutuL_9_1DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pdfutuL.9.1";
    ...
    public class ReqFuncpdfutuL_9_2DTO : ReqBaseDTO
    {
        public ReqFuncpdfutuL_9_2DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pdfutuL.9.2";
            CommonDTO.func_code = CommonDTO.function_code;
            co_no = 0;
            pd_no = 0;
            asset_acco_no = 0;
    ...
    public class ReqFuncpdfutuL_9_3DTO : ReqBaseDTO
    {
        public ReqFuncpdfutuL_9_3DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pdfutuL.9.3";
            CommonDTO.func_code = CommonDTO.function_code;
            row_id = 0;
            sync_deal_type = 0;
        }
    ...
    public class ReqFuncpdfutuL_9_71DTO : ReqBaseDTO
    {
        public ReqFuncpdfutuL_9_71DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pdfutuL.9.71";
            CommonDTO.func_code = CommonDTO.function_code;
            co_no = 0;
            pd_no = 0;
            asset_acco_no = 0;
    ...
    public class ReqFuncpdfutuL_9_72DTO : ReqBaseDTO
    {
        public ReqFuncpdfutuL_9_72DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pdfutuL.9.72";
            CommonDTO.func_code = CommonDTO.function_code;
            begin_date = 0;
            end_date = 0;
            co_no = 0;
    ...
    //逻辑_产品期货_持仓运维_同步内外差异
    public class ReqFuncpdfutuL_9_8DTO : ReqBaseDTO
    {
        public ReqFuncpdfutuL_9_8DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pdfutuL.9.8";
            CommonDTO.func_code = CommonDTO.function_code;
            co_no = 0;
            pd_no = 0;
        }
    ...
    public class ReqFuncpdfutuL_9_9DTO : ReqBaseDTO
    {
        public ReqFuncpdfutuL_9_9DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pdfutuL.9.9";
            CommonDTO.func_code = CommonDTO.function_code;
            co_no = 0;
            pd_no = 0;
        }
    ...
    public class ReqFuncpdfutuL_9_73DTO : ReqBaseDTO
    {
        public ReqFuncpdfutuL_9_73DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pdfutuL.9.73";
            CommonDTO.func_code = CommonDTO.function_code;
            co_no = 0;
            pd_no = 0;
            exch_group_no = 0;
