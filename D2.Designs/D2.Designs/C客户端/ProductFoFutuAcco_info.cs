...
{
    public class pdfofuL_1_40_Info : ObservableObject
    {
    }

    public class pdfofuL_1_41_Info : ObservableObject
    {
    ...
    public class pdfofuL_1_42_Info : ObservableObject
    {
    }

    public class pdfofuL_1_43_Info : ObservableObject
    {
    }

    public class pdfofuL_1_44_Info : ObservableObject
    {
        ...
        private String _futu_acco_name;
        /// <summary>
        /// 交易编码名称
        /// </summary>
        public String futu_acco_name
        {
            get { return _futu_acco_name; }

            set
            {
                _futu_acco_name = value;
                RaisePropertyChanged(() => futu_acco_name);
            }
        }

        private String _futu_acco_status;
        /// <summary>
        /// 交易编码状态
        /// </summary>
        public String futu_acco_status
        {
            get { return _futu_acco_status; }

            set
            {
                _futu_acco_status = value;
                RaisePropertyChanged(() => futu_acco_status);
            }
        }

        private String _allow_contrc_type;
        /// <summary>
        /// 允许操作合约类型
        /// </summary>
        public String allow_contrc_type
        {
            get { return _allow_contrc_type; }

            set
            {
                _allow_contrc_type = value;
                RaisePropertyChanged(() => allow_contrc_type);
            }
        }
    ...
    public class pdfofuL_1_45_Info : ObservableObject
    {
    ...
    public class pdfofuL_1_46_Info : ObservableObject
    {
    ...
    public class pdfofuL_1_47_Info : ObservableObject
    {
    }

    public class pdfofuL_1_48_Info : ObservableObject
    {
    }

    public class pdfofuL_1_49_Info : ObservableObject
    {
    }

    public class pdfofuL_1_51_Info : ObservableObject
    {
    ...
    public class pdfufuL_1_61_Info : ObservableObject
    {
    }

    public class pdfufuL_1_62_Info : ObservableObject
    {
    }

    public class pdfufuL_1_101_Info : ObservableObject
    {
    ...
    public class pdfufuL_1_102_Info : ObservableObject
    {
