...
{
    //逻辑_公共_权限_新增角色
    public class ReqFuncpubL_7_1DTO : ReqBaseDTO
    {
        public ReqFuncpubL_7_1DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.7.1";
        ...
        public override LDsdkDefine.LDPackerAdapter CreatePacker()
        {
            ...
            packer.AddField("role_code", ELDDATATYPE.LD_DATATYPE_STRING);
            packer.AddField("role_name", ELDDATATYPE.LD_DATATYPE_STRING);
            packer.AddField("co_no", ELDDATATYPE.LD_DATATYPE_INT);
            packer.AddField("role_type", ELDDATATYPE.LD_DATATYPE_INT);
            ...
            packer.AddStr(role_code);
            packer.AddStr(role_name);
            packer.AddInt(co_no);
            packer.AddInt(role_type);
    ...
    //逻辑_公共_权限_修改角色
    public class ReqFuncpubL_7_2DTO : ReqBaseDTO
    {
        public ReqFuncpubL_7_2DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.7.2";
            CommonDTO.func_code = CommonDTO.function_code;
            role_no = 0;
            role_name = " ";
            oper_remark_info = " ";
        ...
        public override LDsdkDefine.LDPackerAdapter CreatePacker()
        {
            ...
            packer.AddField("role_no", ELDDATATYPE.LD_DATATYPE_INT);
            packer.AddField("role_name", ELDDATATYPE.LD_DATATYPE_STRING);
            packer.AddField("oper_remark_info", ELDDATATYPE.LD_DATATYPE_STRING);
    ...
    //逻辑_公共_权限_删除角色
    public class ReqFuncpubL_7_3DTO : ReqBaseDTO
    {
        public ReqFuncpubL_7_3DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.7.3";
            CommonDTO.func_code = CommonDTO.function_code;
            role_no = 0;
            oper_remark_info = " ";
        }
    ...
    //逻辑_公共_权限_复制角色
    public class ReqFuncpubL_7_4DTO : ReqBaseDTO
    {
        public ReqFuncpubL_7_4DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.7.4";
            CommonDTO.func_code = CommonDTO.function_code;
            co_no = 0;
            role_code = " ";
            role_name = " ";
        ...
        public override LDsdkDefine.LDPackerAdapter CreatePacker()
        {
            ...
            packer.AddField("role_code", ELDDATATYPE.LD_DATATYPE_STRING);
            packer.AddField("role_name", ELDDATATYPE.LD_DATATYPE_STRING);
            packer.AddField("source_role_no", ELDDATATYPE.LD_DATATYPE_INT);
            packer.AddField("oper_remark_info", ELDDATATYPE.LD_DATATYPE_STRING);
    ...
    //逻辑_公共_权限_查询角色列表
    public class ReqFuncpubL_7_5DTO : ReqBaseDTO
    {
        public ReqFuncpubL_7_5DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.7.5";
            CommonDTO.func_code = CommonDTO.function_code;
            co_no = 0;
            role_no = 0;
        }
    ...
    //逻辑_公共_权限_检查角色存在
    public class ReqFuncpubL_7_6DTO : ReqBaseDTO
    {
        public ReqFuncpubL_7_6DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.7.6";
            CommonDTO.func_code = CommonDTO.function_code;
            co_no = 0;
            role_code = " ";
        }
    ...
    //逻辑_公共_权限_批量新增角色菜单功能
    public class ReqFuncpubL_7_13DTO : ReqBaseDTO
    {
        public ReqFuncpubL_7_13DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.7.13";
            CommonDTO.func_code = CommonDTO.function_code;
            role_no = 0;
            menu_func_str = " ";
        }
        ...
        public override LDsdkDefine.LDPackerAdapter CreatePacker()
        {
            ...
            packer.AddField("role_no", ELDDATATYPE.LD_DATATYPE_INT);
            packer.AddField("menu_func_str", ELDDATATYPE.LD_DATATYPE_STRING);
    ...
    //逻辑_公共_权限_批量删除角色菜单功能
    public class ReqFuncpubL_7_14DTO : ReqBaseDTO
    {
        public ReqFuncpubL_7_14DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.7.14";
            CommonDTO.func_code = CommonDTO.function_code;
            role_no = 0;
            menu_func_str = " ";
        }
    ...
    //逻辑_公共_权限_查询角色菜单功能列表
    public class ReqFuncpubL_7_15DTO : ReqBaseDTO
    {
        public ReqFuncpubL_7_15DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.7.15";
            CommonDTO.func_code = CommonDTO.function_code;
            role_no = 0;
            row_id = 0;
            row_count = -1;
    ...
    public class ReqFuncpubL_7_21DTO : ReqBaseDTO
    {
        public ReqFuncpubL_7_21DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.7.21";
            CommonDTO.func_code = CommonDTO.function_code;
        }
    ...
    //逻辑_公共_权限_新增操作员角色
    public class ReqFuncpubL_7_22DTO : ReqBaseDTO
    {
        public ReqFuncpubL_7_22DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.7.22";
            CommonDTO.func_code = CommonDTO.function_code;
            target_opor_no = 0;
            role_no = 0;
        }
    ...
    //逻辑_公共_权限_删除操作员角色
    public class ReqFuncpubL_7_23DTO : ReqBaseDTO
    {
        public ReqFuncpubL_7_23DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.7.23";
            CommonDTO.func_code = CommonDTO.function_code;
            target_opor_no = 0;
            role_no = 0;
        }
    ...
    //逻辑_公共_权限_查询操作员角色列表
    public class ReqFuncpubL_7_24DTO : ReqBaseDTO
    {
        public ReqFuncpubL_7_24DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.7.24";
            CommonDTO.func_code = CommonDTO.function_code;
            query_opor_no = 0;
        }
    ...
    public class ReqFuncpubL_7_27DTO : ReqBaseDTO
    {
        public ReqFuncpubL_7_27DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.7.27";
            CommonDTO.func_code = CommonDTO.function_code;
            target_opor_no = 0;
            menu_type = 0;
            menu_func_str = " ";
        ...
        public override LDsdkDefine.LDPackerAdapter CreatePacker()
        {
            ...
            packer.AddField("target_opor_no", ELDDATATYPE.LD_DATATYPE_INT);
            packer.AddField("menu_type", ELDDATATYPE.LD_DATATYPE_INT);
            packer.AddField("menu_func_str", ELDDATATYPE.LD_DATATYPE_STRING);
    ...
    public class ReqFuncpubL_7_28DTO : ReqBaseDTO
    {
        public ReqFuncpubL_7_28DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.7.28";
            CommonDTO.func_code = CommonDTO.function_code;
            target_opor_no = 0;
            menu_type = 0;
            menu_func_str = " ";
    ...
    //逻辑_公共_权限_查询全部菜单
    public class ReqFuncpubL_7_33DTO : ReqBaseDTO
    {
        public ReqFuncpubL_7_33DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.7.33";
            CommonDTO.func_code = CommonDTO.function_code;
            menu_type = 0;
        }
    ...
    //逻辑_公共_权限_查询全部菜单功能
    public class ReqFuncpubL_7_34DTO : ReqBaseDTO
    {
        public ReqFuncpubL_7_34DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.7.34";
            CommonDTO.func_code = CommonDTO.function_code;
            menu_type = 0;
        }
    ...
    //逻辑_公共_权限_查询操作员普通菜单
    public class ReqFuncpubL_7_29DTO : ReqBaseDTO
    {
        public ReqFuncpubL_7_29DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.7.29";
            CommonDTO.func_code = CommonDTO.function_code;
            query_opor_no = 0;
            menu_type = 0;
        }
    ...
    //逻辑_公共_权限_查询操作员特殊菜单
    public class ReqFuncpubL_7_30DTO : ReqBaseDTO
    {
        public ReqFuncpubL_7_30DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.7.30";
            CommonDTO.func_code = CommonDTO.function_code;
            query_opor_no = 0;
            menu_type = 0;
        }
    ...
    public class ReqFuncpubL_7_31DTO : ReqBaseDTO
    {
        public ReqFuncpubL_7_31DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.7.31";
            CommonDTO.func_code = CommonDTO.function_code;
            query_opor_no = 0;
            menu_type = 0;
        }
    ...
    public class ReqFuncpubL_7_32DTO : ReqBaseDTO
    {
        public ReqFuncpubL_7_32DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.7.32";
            CommonDTO.func_code = CommonDTO.function_code;
            query_opor_no = 0;
            menu_type = 0;
        }
    ...
    //逻辑_公共_权限_回收菜单功能权限
    public class ReqFuncpubL_7_51DTO : ReqBaseDTO
    {
        public ReqFuncpubL_7_51DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.7.51";
            CommonDTO.func_code = CommonDTO.function_code;
            co_no = 0;
            menu_type = 0;
            menu_func_str = " ";
    ...
    //逻辑_公共_权限_主推密码权限校验
    public class ReqFuncpubL_7_52DTO : ReqBaseDTO
    {
        public ReqFuncpubL_7_52DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.7.52";
            CommonDTO.func_code = CommonDTO.function_code;
            co_no = 0;
            pd_no = 0;
            exch_group_no = 0;
