...
{
    //逻辑_公共_用户客户端_新增操作员信息
    public class ReqFuncpubL_19_1DTO : ReqBaseDTO
    {
        public ReqFuncpubL_19_1DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.19.1";
        ...
        public override LDsdkDefine.LDPackerAdapter CreatePacker()
        {
            ...
            packer.AddField("trader_no", ELDDATATYPE.LD_DATATYPE_INT);
            packer.AddField("allow_login_type", ELDDATATYPE.LD_DATATYPE_STRING);
            packer.AddField("allow_oper_ip_addr", ELDDATATYPE.LD_DATATYPE_STRING);
            packer.AddField("allow_oper_mac", ELDDATATYPE.LD_DATATYPE_STRING);
            packer.AddField("oper_remark_info", ELDDATATYPE.LD_DATATYPE_STRING);
            packer.AddField("index_value", ELDDATATYPE.LD_DATATYPE_INT);
            packer.AddField("manage_nolgn_opor_orders", ELDDATATYPE.LD_DATATYPE_INT);
            ...
            packer.AddInt(opor_type);
            packer.AddStr(target_opor_pwd);
            packer.AddStr(conta_addr);
            packer.AddInt(oper_rights);
            packer.AddStr(phone_number);
            packer.AddStr(email);
            packer.AddInt(is_trader);
            packer.AddInt(trader_no);
            packer.AddStr(allow_login_type);
            packer.AddStr(allow_oper_ip_addr);
            packer.AddStr(allow_oper_mac);
            packer.AddStr(oper_remark_info);
            packer.AddInt(index_value);
            packer.AddInt(manage_nolgn_opor_orders);
            packer.EndPack();
    ...
    //逻辑_公共_用户客户端_修改操作员信息
    public class ReqFuncpubL_19_2DTO : ReqBaseDTO
    {
        public ReqFuncpubL_19_2DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.19.2";
            CommonDTO.func_code = CommonDTO.function_code;
            target_opor_no = 0;
            opor_name = " ";
            opor_type = 0;
    ...
    //逻辑_公共_用户客户端_查询操作员信息
    public class ReqFuncpubL_19_4DTO : ReqBaseDTO
    {
        public ReqFuncpubL_19_4DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.19.4";
            CommonDTO.func_code = CommonDTO.function_code;
            query_opor_no = 0;
            is_trader = 0;
            opor_type_str = " ";
        ...
        public override LDsdkDefine.LDPackerAdapter CreatePacker()
        {
            ...
            packer.AddField("is_trader", ELDDATATYPE.LD_DATATYPE_INT);
            packer.AddField("opor_type_str", ELDDATATYPE.LD_DATATYPE_STRING);
    ...
    //逻辑_公共_用户客户端_冻结操作员
    public class ReqFuncpubL_19_5DTO : ReqBaseDTO
    {
        public ReqFuncpubL_19_5DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.19.5";
            CommonDTO.func_code = CommonDTO.function_code;
            target_opor_no = 0;
            oper_remark_info = " ";
        }
    ...
    //逻辑_公共_用户客户端_解冻操作员
    public class ReqFuncpubL_19_6DTO : ReqBaseDTO
    {
        public ReqFuncpubL_19_6DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.19.6";
            CommonDTO.func_code = CommonDTO.function_code;
            target_opor_no = 0;
            oper_remark_info = " ";
        }
    ...
    //逻辑_公共_用户客户端_注销操作员
    public class ReqFuncpubL_19_7DTO : ReqBaseDTO
    {
        public ReqFuncpubL_19_7DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.19.7";
            CommonDTO.func_code = CommonDTO.function_code;
            target_opor_no = 0;
            oper_remark_info = " ";
        }
    ...
    //逻辑_公共_用户客户端_修改操作员密码
    public class ReqFuncpubL_19_9DTO : ReqBaseDTO
    {
        public ReqFuncpubL_19_9DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.19.9";
            CommonDTO.func_code = CommonDTO.function_code;
            opor_old_pwd = " ";
            opor_new_pwd = " ";
        }
        ...
        public override LDsdkDefine.LDPackerAdapter CreatePacker()
        {
            ...
            packer.AddField("opor_old_pwd", ELDDATATYPE.LD_DATATYPE_STRING);
            packer.AddField("opor_new_pwd", ELDDATATYPE.LD_DATATYPE_STRING);
            ...
            packer.AddStr(opor_old_pwd);
            packer.AddStr(opor_new_pwd);
            packer.EndPack();
    ...
    //逻辑_公共_用户客户端_重置操作员密码
    public class ReqFuncpubL_19_10DTO : ReqBaseDTO
    {
        public ReqFuncpubL_19_10DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.19.10";
            CommonDTO.func_code = CommonDTO.function_code;
            target_opor_no = 0;
            opor_new_pwd = " ";
        }
    ...
    public class ReqFuncpubL_19_11DTO : ReqBaseDTO
    {
        public ReqFuncpubL_19_11DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.19.11";
            CommonDTO.func_code = CommonDTO.function_code;
            target_opor_no = 0;
            row_id = 0;
            row_count = -1;
    ...
    public class ReqFuncpubL_19_12DTO : ReqBaseDTO
    {
        public ReqFuncpubL_19_12DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.19.12";
            CommonDTO.func_code = CommonDTO.function_code;
            begin_date = 0;
            end_date = 0;
            target_opor_no = 0;
    ...
    //逻辑_公共_用户客户端_获取操作员编号
    public class ReqFuncpubL_19_14DTO : ReqBaseDTO
    {
        public ReqFuncpubL_19_14DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.19.14";
            CommonDTO.func_code = CommonDTO.function_code;
            co_no = 0;
        }
    ...
    //逻辑_公共_用户客户端_查询操作员列表
    public class ReqFuncpubL_19_15DTO : ReqBaseDTO
    {
        public ReqFuncpubL_19_15DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.19.15";
            CommonDTO.func_code = CommonDTO.function_code;
            is_trader = 0;
            opor_status_str = " ";
            row_id = 0;
    ...
    public class ReqFuncpubL_19_16DTO : ReqBaseDTO
    {
        public ReqFuncpubL_19_16DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.19.16";
            CommonDTO.func_code = CommonDTO.function_code;
            target_opor_no = 0;
            allow_oper_mac = " ";
            opor_rights_str = " ";
        ...
        public override LDsdkDefine.LDPackerAdapter CreatePacker()
        {
            ...
            packer.AddField("target_opor_no", ELDDATATYPE.LD_DATATYPE_INT);
            packer.AddField("allow_oper_mac", ELDDATATYPE.LD_DATATYPE_STRING);
            packer.AddField("opor_rights_str", ELDDATATYPE.LD_DATATYPE_STRING);
            packer.AddField("oper_remark_info", ELDDATATYPE.LD_DATATYPE_STRING);
    ...
    public class ReqFuncpubL_19_17DTO : ReqBaseDTO
    {
        public ReqFuncpubL_19_17DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.19.17";
            CommonDTO.func_code = CommonDTO.function_code;
            target_opor_no = 0;
            allow_oper_mac = " ";
            opor_rights_str = " ";
    ...
    public class ReqFuncpubL_19_18DTO : ReqBaseDTO
    {
        public ReqFuncpubL_19_18DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.19.18";
            CommonDTO.func_code = CommonDTO.function_code;
            target_opor_no = 0;
        }
    ...
    public class ReqFuncpubL_19_19DTO : ReqBaseDTO
    {
        public ReqFuncpubL_19_19DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.19.19";
            CommonDTO.func_code = CommonDTO.function_code;
            target_opor_no = 0;
        }
    ...
    //逻辑_公共_用户客户端_操作员登录
    public class ReqFuncpubL_19_21DTO : ReqBaseDTO
    {
        public ReqFuncpubL_19_21DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.19.21";
            CommonDTO.func_code = CommonDTO.function_code;
            client_version = " ";
        }
        ...
        public override LDsdkDefine.LDPackerAdapter CreatePacker()
        {
            ...
            packer.AddField("client_version", ELDDATATYPE.LD_DATATYPE_STRING);
    ...
    //逻辑_公共_用户客户端_操作员退出
    public class ReqFuncpubL_19_22DTO : ReqBaseDTO
    {
        public ReqFuncpubL_19_22DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.19.22";
            CommonDTO.func_code = CommonDTO.function_code;
        }
    ...
    //逻辑_公共_用户客户端_设置操作员配置
    public class ReqFuncpubL_19_31DTO : ReqBaseDTO
    {
        public ReqFuncpubL_19_31DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.19.31";
            CommonDTO.func_code = CommonDTO.function_code;
            co_no = 0;
            config_no = 0;
            config_value = " ";
    ...
    //逻辑_公共_用户客户端_查询操作员配置
    public class ReqFuncpubL_19_32DTO : ReqBaseDTO
    {
        public ReqFuncpubL_19_32DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.19.32";
            CommonDTO.func_code = CommonDTO.function_code;
            opor_no_str = " ";
            config_no = 0;
            row_id = 0;
    ...
    public class ReqFuncpubL_19_33DTO : ReqBaseDTO
    {
        public ReqFuncpubL_19_33DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.19.33";
            CommonDTO.func_code = CommonDTO.function_code;
            parent_panel = " ";
            dbgrid_name = " ";
            dbgrid_conf_str = " ";
        ...
        public override LDsdkDefine.LDPackerAdapter CreatePacker()
        {
            ...
            packer.AddField("parent_panel", ELDDATATYPE.LD_DATATYPE_STRING);
            packer.AddField("dbgrid_name", ELDDATATYPE.LD_DATATYPE_STRING);
            packer.AddField("dbgrid_conf_str", ELDDATATYPE.LD_DATATYPE_STRING);
            packer.AddField("client_type", ELDDATATYPE.LD_DATATYPE_INT);
            ...
            packer.AddStr(parent_panel);
            packer.AddStr(dbgrid_name);
            packer.AddStr(dbgrid_conf_str);
            packer.AddInt(client_type);
            packer.EndPack();
    ...
    public class ReqFuncpubL_19_34DTO : ReqBaseDTO
    {
        public ReqFuncpubL_19_34DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.19.34";
            CommonDTO.func_code = CommonDTO.function_code;
            client_type = 0;
        }
    ...
    public class ReqFuncpubL_19_45DTO : ReqBaseDTO
    {
        public ReqFuncpubL_19_45DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.19.45";
            CommonDTO.func_code = CommonDTO.function_code;
            target_opor_no = 0;
            pd_no = 0;
            oper_remark_info = " ";
    ...
    public class ReqFuncpubL_19_46DTO : ReqBaseDTO
    {
        public ReqFuncpubL_19_46DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.19.46";
            CommonDTO.func_code = CommonDTO.function_code;
            target_opor_no = 0;
            pd_no = 0;
            oper_remark_info = " ";
    ...
    public class ReqFuncpubL_19_48DTO : ReqBaseDTO
    {
        public ReqFuncpubL_19_48DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.19.48";
            CommonDTO.func_code = CommonDTO.function_code;
            query_opor_no = 0;
            row_id = 0;
            row_count = -1;
    ...
    //逻辑_公共_用户客户端_新增交易组信息
    public class ReqFuncpubL_19_51DTO : ReqBaseDTO
    {
        public ReqFuncpubL_19_51DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.19.51";
            CommonDTO.func_code = CommonDTO.function_code;
            exch_group_code = " ";
            exch_group_name = " ";
            pd_no = 0;
            first_asset = 0;
            exch_group_dist_pd_amt = 0;
            exch_group_pd_share = 0;
            allow_exch = " ";
            allow_stock_type = " ";
            busi_config_str = " ";
        ...
        public override LDsdkDefine.LDPackerAdapter CreatePacker()
        {
            ...
            packer.AddField("exch_group_code", ELDDATATYPE.LD_DATATYPE_STRING);
            packer.AddField("exch_group_name", ELDDATATYPE.LD_DATATYPE_STRING);
            packer.AddField("pd_no", ELDDATATYPE.LD_DATATYPE_INT);
            packer.AddField("first_asset", ELDDATATYPE.LD_DATATYPE_DOUBLE);
            packer.AddField("exch_group_dist_pd_amt", ELDDATATYPE.LD_DATATYPE_DOUBLE);
            packer.AddField("exch_group_pd_share", ELDDATATYPE.LD_DATATYPE_DOUBLE);
            packer.AddField("allow_exch", ELDDATATYPE.LD_DATATYPE_STRING);
            packer.AddField("allow_stock_type", ELDDATATYPE.LD_DATATYPE_STRING);
            packer.AddField("busi_config_str", ELDDATATYPE.LD_DATATYPE_STRING);
            ...
            packer.AddField("trade_acco", ELDDATATYPE.LD_DATATYPE_STRING);
            packer.AddField("weight_value", ELDDATATYPE.LD_DATATYPE_DOUBLE);
            ...
            packer.AddStr(exch_group_code);
            packer.AddStr(exch_group_name);
            packer.AddInt(pd_no);
            packer.AddDouble(first_asset);
            packer.AddDouble(exch_group_dist_pd_amt);
            packer.AddDouble(exch_group_pd_share);
            packer.AddStr(allow_exch);
            packer.AddStr(allow_stock_type);
            packer.AddStr(busi_config_str);
            packer.AddDouble(market_price_ratio);
            packer.AddStr(forbid_order_dir);
            packer.AddStr(trade_acco);
            packer.AddDouble(weight_value);
    ...
    //逻辑_公共_用户客户端_修改交易组信息
    public class ReqFuncpubL_19_52DTO : ReqBaseDTO
    {
        public ReqFuncpubL_19_52DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.19.52";
            CommonDTO.func_code = CommonDTO.function_code;
            exch_group_no = 0;
            exch_group_code = " ";
            exch_group_name = " ";
            ...
            weight_value = 0;
            remark_info = " ";
            futu_default_group_flag = 0;
            fina_loan_default_group_flag = 0;
        }
        ...
        public override LDsdkDefine.LDPackerAdapter CreatePacker()
        {
            ...
            packer.AddField("weight_value", ELDDATATYPE.LD_DATATYPE_DOUBLE);
            packer.AddField("remark_info", ELDDATATYPE.LD_DATATYPE_STRING);
            packer.AddField("futu_default_group_flag", ELDDATATYPE.LD_DATATYPE_INT);
            packer.AddField("fina_loan_default_group_flag", ELDDATATYPE.LD_DATATYPE_INT);
            ...
            packer.AddDouble(weight_value);
            packer.AddStr(remark_info);
            packer.AddInt(futu_default_group_flag);
            packer.AddInt(fina_loan_default_group_flag);
            packer.EndPack();
    ...
    //逻辑_公共_用户客户端_查询交易组信息
    public class ReqFuncpubL_19_54DTO : ReqBaseDTO
    {
        public ReqFuncpubL_19_54DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.19.54";
            CommonDTO.func_code = CommonDTO.function_code;
            exch_group_no = 0;
        ...
        public override LDsdkDefine.LDPackerAdapter CreatePacker()
        {
            ...
            packer.AddField("exch_group_no", ELDDATATYPE.LD_DATATYPE_INT);
            packer.AddField("default_group_flag", ELDDATATYPE.LD_DATATYPE_INT);
            packer.AddField("pd_no", ELDDATATYPE.LD_DATATYPE_INT);
            packer.AddField("exch_group_status_str", ELDDATATYPE.LD_DATATYPE_STRING);
            packer.AddField("row_id", ELDDATATYPE.LD_DATATYPE_LONG);
            packer.AddField("row_count", ELDDATATYPE.LD_DATATYPE_INT);
            ...
            packer.AddInt(exch_group_no);
            packer.AddInt(default_group_flag);
            packer.AddInt(pd_no);
            packer.AddStr(exch_group_status_str);
            packer.AddInt64(row_id);
            packer.AddInt(row_count);
            packer.EndPack();
    ...
    //逻辑_公共_用户客户端_冻结交易组
    public class ReqFuncpubL_19_55DTO : ReqBaseDTO
    {
        public ReqFuncpubL_19_55DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.19.55";
            CommonDTO.func_code = CommonDTO.function_code;
            exch_group_no = 0;
            oper_remark_info = " ";
        }
    ...
    //逻辑_公共_用户客户端_解冻交易组
    public class ReqFuncpubL_19_56DTO : ReqBaseDTO
    {
        public ReqFuncpubL_19_56DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.19.56";
            CommonDTO.func_code = CommonDTO.function_code;
            exch_group_no = 0;
            oper_remark_info = " ";
        }
    ...
    //逻辑_公共_用户客户端_注销交易组
    public class ReqFuncpubL_19_57DTO : ReqBaseDTO
    {
        public ReqFuncpubL_19_57DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.19.57";
            CommonDTO.func_code = CommonDTO.function_code;
            exch_group_no = 0;
            oper_remark_info = " ";
        }
    ...
    public class ReqFuncpubL_19_58DTO : ReqBaseDTO
    {
        public ReqFuncpubL_19_58DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.19.58";
            CommonDTO.func_code = CommonDTO.function_code;
            exch_group_no = 0;
            pd_no = 0;
            row_id = 0;
    ...
    public class ReqFuncpubL_19_59DTO : ReqBaseDTO
    {
        public ReqFuncpubL_19_59DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.19.59";
            CommonDTO.func_code = CommonDTO.function_code;
            begin_date = 0;
            end_date = 0;
            exch_group_no = 0;
    ...
    //逻辑_公共_用户客户端_设置默认交易组
    public class ReqFuncpubL_19_60DTO : ReqBaseDTO
    {
        public ReqFuncpubL_19_60DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.19.60";
            CommonDTO.func_code = CommonDTO.function_code;
            exch_group_no = 0;
            oper_remark_info = " ";
        }
    ...
    //逻辑_公共_用户客户端_查询可见交易组
    public class ReqFuncpubL_19_73DTO : ReqBaseDTO
    {
        public ReqFuncpubL_19_73DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.19.73";
            CommonDTO.func_code = CommonDTO.function_code;
            pd_no = 0;
        }
    ...
    public class ReqFuncpubL_19_61DTO : ReqBaseDTO
    {
        public ReqFuncpubL_19_61DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.19.61";
            CommonDTO.func_code = CommonDTO.function_code;
            target_opor_no = 0;
            exch_group_no = 0;
            oper_remark_info = " ";
    ...
    public class ReqFuncpubL_19_62DTO : ReqBaseDTO
    {
        public ReqFuncpubL_19_62DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.19.62";
            CommonDTO.func_code = CommonDTO.function_code;
            target_opor_no = 0;
            exch_group_no = 0;
            oper_remark_info = " ";
    ...
    public class ReqFuncpubL_19_64DTO : ReqBaseDTO
    {
        public ReqFuncpubL_19_64DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.19.64";
            CommonDTO.func_code = CommonDTO.function_code;
            query_opor_no = 0;
            row_id = 0;
            row_count = -1;
    ...
    public class ReqFuncpubL_19_65DTO : ReqBaseDTO
    {
        public ReqFuncpubL_19_65DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.19.65";
            CommonDTO.func_code = CommonDTO.function_code;
            group_name = " ";
            remark_info = " ";
            pd_account_group_type = 1;
        }
        ...
        public override LDsdkDefine.LDPackerAdapter CreatePacker()
        {
            ...
            packer.AddField("group_name", ELDDATATYPE.LD_DATATYPE_STRING);
            packer.AddField("remark_info", ELDDATATYPE.LD_DATATYPE_STRING);
            packer.AddField("pd_account_group_type", ELDDATATYPE.LD_DATATYPE_INT);
            ...
            packer.AddStr(group_name);
            packer.AddStr(remark_info);
            packer.AddInt(pd_account_group_type);
            packer.EndPack();
    ...
    public class ReqFuncpubL_19_66DTO : ReqBaseDTO
    {
        public ReqFuncpubL_19_66DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.19.66";
            CommonDTO.func_code = CommonDTO.function_code;
            group_no = 0;
            group_name = " ";
            remark_info = " ";
        ...
        public override LDsdkDefine.LDPackerAdapter CreatePacker()
        {
            ...
            packer.AddField("group_no", ELDDATATYPE.LD_DATATYPE_INT);
            packer.AddField("group_name", ELDDATATYPE.LD_DATATYPE_STRING);
            packer.AddField("remark_info", ELDDATATYPE.LD_DATATYPE_STRING);
    ...
    public class ReqFuncpubL_19_67DTO : ReqBaseDTO
    {
        public ReqFuncpubL_19_67DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.19.67";
            CommonDTO.func_code = CommonDTO.function_code;
            group_no = 0;
        }
    ...
    public class ReqFuncpubL_19_68DTO : ReqBaseDTO
    {
        public ReqFuncpubL_19_68DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.19.68";
            CommonDTO.func_code = CommonDTO.function_code;
            group_no = 0;
        }
    ...
    public class ReqFuncpubL_19_69DTO : ReqBaseDTO
    {
        public ReqFuncpubL_19_69DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.19.69";
            CommonDTO.func_code = CommonDTO.function_code;
            group_no = 0;
            co_no = 0;
            pd_no = 0;
        ...
        public override LDsdkDefine.LDPackerAdapter CreatePacker()
        {
            ...
            packer.AddField("exch_group_no", ELDDATATYPE.LD_DATATYPE_INT);
            packer.AddField("weight_ratio", ELDDATATYPE.LD_DATATYPE_DOUBLE);
            packer.AddField("remark_info", ELDDATATYPE.LD_DATATYPE_STRING);
    ...
    public class ReqFuncpubL_19_70DTO : ReqBaseDTO
    {
        public ReqFuncpubL_19_70DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.19.70";
            CommonDTO.func_code = CommonDTO.function_code;
            group_no = 0;
            co_no = 0;
            pd_no = 0;
    ...
    public class ReqFuncpubL_19_71DTO : ReqBaseDTO
    {
        public ReqFuncpubL_19_71DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.19.71";
            CommonDTO.func_code = CommonDTO.function_code;
            group_no = 0;
            co_no = 0;
            pd_no = 0;
    ...
    public class ReqFuncpubL_19_72DTO : ReqBaseDTO
    {
        public ReqFuncpubL_19_72DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.19.72";
            CommonDTO.func_code = CommonDTO.function_code;
            group_no = 0;
            pd_no = 0;
            asset_acco_no = 0;
        ...
        public override LDsdkDefine.LDPackerAdapter CreatePacker()
        {
            ...
            packer.AddField("pd_no", ELDDATATYPE.LD_DATATYPE_INT);
            packer.AddField("asset_acco_no", ELDDATATYPE.LD_DATATYPE_INT);
            packer.AddField("part_no", ELDDATATYPE.LD_DATATYPE_INT);
    ...
    public class ReqFuncpubL_19_77DTO : ReqBaseDTO
    {
        public ReqFuncpubL_19_77DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.19.77";
            CommonDTO.func_code = CommonDTO.function_code;
            target_opor_no = 0;
            allow_opor_no_str = " ";
            oper_remark_info = " ";
        ...
        public override LDsdkDefine.LDPackerAdapter CreatePacker()
        {
            ...
            packer.AddField("target_opor_no", ELDDATATYPE.LD_DATATYPE_INT);
            packer.AddField("allow_opor_no_str", ELDDATATYPE.LD_DATATYPE_STRING);
            packer.AddField("oper_remark_info", ELDDATATYPE.LD_DATATYPE_STRING);
            ...
            packer.AddInt(target_opor_no);
            packer.AddStr(allow_opor_no_str);
            packer.AddStr(oper_remark_info);
            packer.EndPack();
    ...
    public class ReqFuncpubL_19_74DTO : ReqBaseDTO
    {
        public ReqFuncpubL_19_74DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.19.74";
            CommonDTO.func_code = CommonDTO.function_code;
            target_opor_no = 0;
            allow_opor_no = 0;
            oper_remark_info = " ";
        ...
        public override LDsdkDefine.LDPackerAdapter CreatePacker()
        {
            ...
            packer.AddField("target_opor_no", ELDDATATYPE.LD_DATATYPE_INT);
            packer.AddField("allow_opor_no", ELDDATATYPE.LD_DATATYPE_INT);
            packer.AddField("oper_remark_info", ELDDATATYPE.LD_DATATYPE_STRING);
    ...
    public class ReqFuncpubL_19_75DTO : ReqBaseDTO
    {
        public ReqFuncpubL_19_75DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.19.75";
            CommonDTO.func_code = CommonDTO.function_code;
            target_opor_no = 0;
            allow_opor_no = 0;
            oper_remark_info = " ";
    ...
    public class ReqFuncpubL_19_78DTO : ReqBaseDTO
    {
        public ReqFuncpubL_19_78DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.19.78";
            CommonDTO.func_code = CommonDTO.function_code;
            target_opor_no = 0;
            allow_opor_no_str = " ";
            oper_remark_info = " ";
    ...
    public class ReqFuncpubL_19_76DTO : ReqBaseDTO
    {
        public ReqFuncpubL_19_76DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.19.76";
            CommonDTO.func_code = CommonDTO.function_code;
            query_opor_no = 0;
            row_id = 0;
            row_count = -1;
    ...
    public class ReqFuncpubL_19_89DTO : ReqBaseDTO
    {
        public ReqFuncpubL_19_89DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.19.89";
            CommonDTO.func_code = CommonDTO.function_code;
            begin_date = 0;
            end_date = 0;
            pd_no = 0;
    ...
    //逻辑_公共_用户客户端_查询交易组资产
    public class ReqFuncpubL_19_91DTO : ReqBaseDTO
    {
        public ReqFuncpubL_19_91DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.19.91";
            CommonDTO.func_code = CommonDTO.function_code;
            pd_no = 0;
            exch_group_no = 0;
            crncy_type = "CNY";
    ...
    public class ReqFuncpubL_19_90DTO : ReqBaseDTO
    {
        public ReqFuncpubL_19_90DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.19.90";
            CommonDTO.func_code = CommonDTO.function_code;
            init_date = 0;
            pd_no = 0;
            exch_group_no = 0;
    ...
    public class ReqFuncpubL_19_92DTO : ReqBaseDTO
    {
        public ReqFuncpubL_19_92DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.19.92";
            CommonDTO.func_code = CommonDTO.function_code;
            exch_group_no = 0;
            begin_date = 0;
        }
    ...
    public class ReqFuncpubL_19_93DTO : ReqBaseDTO
    {
        public ReqFuncpubL_19_93DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.19.93";
            CommonDTO.func_code = CommonDTO.function_code;
            exch_group_no = 0;
            begin_date = 0;
        }
    ...
    public class ReqFuncpubL_19_94DTO : ReqBaseDTO
    {
        public ReqFuncpubL_19_94DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.19.94";
            CommonDTO.func_code = CommonDTO.function_code;
            pd_no = 0;
            exch_group_no = 0;
        }
    ...
    public class ReqFuncpubL_19_95DTO : ReqBaseDTO
    {
        public ReqFuncpubL_19_95DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.19.95";
            CommonDTO.func_code = CommonDTO.function_code;
            pd_no = 0;
            exch_group_no = 0;
            begin_date = 0;
    ...
    public class ReqFuncpubL_19_202DTO : ReqBaseDTO
    {
        public ReqFuncpubL_19_202DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.19.202";
            CommonDTO.func_code = CommonDTO.function_code;
        }
    ...
    public class ReqFuncpubL_19_203DTO : ReqBaseDTO
    {
        public ReqFuncpubL_19_203DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.19.203";
            CommonDTO.func_code = CommonDTO.function_code;
            co_no = 0;
        }
    ...
    public class ReqFuncpubL_19_900DTO : ReqBaseDTO
    {
        public ReqFuncpubL_19_900DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.19.900";
            CommonDTO.func_code = CommonDTO.function_code;
            co_no = 0;
            pd_no = 0;
            exch_group_no = 0;
        ...
        public override LDsdkDefine.LDPackerAdapter CreatePacker()
        {
            ...
            packer.AddField("exch_group_no", ELDDATATYPE.LD_DATATYPE_INT);
            packer.AddField("crncy_type", ELDDATATYPE.LD_DATATYPE_STRING);
            packer.AddField("asset_item", ELDDATATYPE.LD_DATATYPE_INT);
            packer.AddField("asset_value", ELDDATATYPE.LD_DATATYPE_DOUBLE);
            ...
            packer.AddInt(exch_group_no);
            packer.AddStr(crncy_type);
            packer.AddInt(asset_item);
            packer.AddDouble(asset_value);
            packer.EndPack();
    ...
    public class ReqFuncpubL_19_901DTO : ReqBaseDTO
    {
        public ReqFuncpubL_19_901DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.19.901";
            CommonDTO.func_code = CommonDTO.function_code;
            co_no = 0;
            pd_no = 0;
            exch_group_no = 0;
    ...
    public class ReqFuncpubL_19_902DTO : ReqBaseDTO
    {
        public ReqFuncpubL_19_902DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.19.902";
            CommonDTO.func_code = CommonDTO.function_code;
            target_pd_no = 0;
        }
        ...
        public override LDsdkDefine.LDPackerAdapter CreatePacker()
        {
            ...
            packer.AddField("target_pd_no", ELDDATATYPE.LD_DATATYPE_INT);
    ...
    public class ReqFuncpubL_19_301DTO : ReqBaseDTO
    {
        public ReqFuncpubL_19_301DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.19.301";
            CommonDTO.func_code = CommonDTO.function_code;
            co_no = 0;
            comm_trd_type = 0;
            hedg_name = " ";
            futu_exch_group_no = 0;
            futu_asset_acco_no = 0;
            futu_order_pd_no = 0;
            secu_exch_group_no = 0;
            secu_asset_acco_no = 0;
            secu_order_pd_no = 0;
            remark_info = " ";
        }
        ...
        public override LDsdkDefine.LDPackerAdapter CreatePacker()
        {
            ...
            packer.AddField("hedg_name", ELDDATATYPE.LD_DATATYPE_STRING);
            packer.AddField("futu_exch_group_no", ELDDATATYPE.LD_DATATYPE_INT);
            packer.AddField("futu_asset_acco_no", ELDDATATYPE.LD_DATATYPE_INT);
            packer.AddField("futu_order_pd_no", ELDDATATYPE.LD_DATATYPE_INT);
            packer.AddField("secu_exch_group_no", ELDDATATYPE.LD_DATATYPE_INT);
            packer.AddField("secu_asset_acco_no", ELDDATATYPE.LD_DATATYPE_INT);
            packer.AddField("secu_order_pd_no", ELDDATATYPE.LD_DATATYPE_INT);
            packer.AddField("remark_info", ELDDATATYPE.LD_DATATYPE_STRING);
            ...
            packer.AddStr(hedg_name);
            packer.AddInt(futu_exch_group_no);
            packer.AddInt(futu_asset_acco_no);
            packer.AddInt(futu_order_pd_no);
            packer.AddInt(secu_exch_group_no);
            packer.AddInt(secu_asset_acco_no);
            packer.AddInt(secu_order_pd_no);
            packer.AddStr(remark_info);
            packer.EndPack();
    ...
    public class ReqFuncpubL_19_303DTO : ReqBaseDTO
    {
        public ReqFuncpubL_19_303DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.19.303";
            CommonDTO.func_code = CommonDTO.function_code;
            row_id = 0;
        }
    ...
    public class ReqFuncpubL_19_304DTO : ReqBaseDTO
    {
        public ReqFuncpubL_19_304DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.19.304";
            CommonDTO.func_code = CommonDTO.function_code;
            query_opor_no = 0;
            comm_trd_type = 0;
        }
    ...
    public class ReqFuncpubL_19_401DTO : ReqBaseDTO
    {
        public ReqFuncpubL_19_401DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.19.401";
            CommonDTO.func_code = CommonDTO.function_code;
            co_no = 0;
            comm_trd_type = 0;
            hedg_plan_name = " ";
        ...
        public override LDsdkDefine.LDPackerAdapter CreatePacker()
        {
            ...
            packer.AddField("co_no", ELDDATATYPE.LD_DATATYPE_INT);
            packer.AddField("comm_trd_type", ELDDATATYPE.LD_DATATYPE_INT);
            packer.AddField("hedg_plan_name", ELDDATATYPE.LD_DATATYPE_STRING);
            packer.AddField("contrc_code_no", ELDDATATYPE.LD_DATATYPE_INT);
            packer.AddField("futu_qty", ELDDATATYPE.LD_DATATYPE_DOUBLE);
            packer.AddField("basket_qty", ELDDATATYPE.LD_DATATYPE_DOUBLE);
            packer.AddField("basket_id", ELDDATATYPE.LD_DATATYPE_LONG);
            packer.AddField("plan_type", ELDDATATYPE.LD_DATATYPE_INT);
            packer.AddField("hedg_no", ELDDATATYPE.LD_DATATYPE_LONG);
            packer.AddField("hedging_pankou", ELDDATATYPE.LD_DATATYPE_DOUBLE);
            packer.AddField("futu_price_offset", ELDDATATYPE.LD_DATATYPE_DOUBLE);
            packer.AddField("price_offset", ELDDATATYPE.LD_DATATYPE_DOUBLE);
            packer.AddField("target_base_diff", ELDDATATYPE.LD_DATATYPE_DOUBLE);
            packer.AddField("template_base_diff", ELDDATATYPE.LD_DATATYPE_DOUBLE);
            packer.AddField("up_value_ratio", ELDDATATYPE.LD_DATATYPE_DOUBLE);
            packer.AddField("down_value_ratio", ELDDATATYPE.LD_DATATYPE_DOUBLE);
            packer.AddField("stop_value_ratio", ELDDATATYPE.LD_DATATYPE_DOUBLE);
            ...
            packer.AddInt(co_no);
            packer.AddInt(comm_trd_type);
            packer.AddStr(hedg_plan_name);
            packer.AddInt(contrc_code_no);
            packer.AddDouble(futu_qty);
            packer.AddDouble(basket_qty);
            packer.AddInt64(basket_id);
            packer.AddInt(plan_type);
            packer.AddInt64(hedg_no);
            packer.AddDouble(hedging_pankou);
            packer.AddDouble(futu_price_offset);
            packer.AddDouble(price_offset);
            packer.AddDouble(target_base_diff);
            packer.AddDouble(template_base_diff);
            packer.AddDouble(up_value_ratio);
            packer.AddDouble(down_value_ratio);
            packer.AddDouble(stop_value_ratio);
    ...
    public class ReqFuncpubL_19_402DTO : ReqBaseDTO
    {
        public ReqFuncpubL_19_402DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.19.402";
            CommonDTO.func_code = CommonDTO.function_code;
            row_id = 0;
            hedg_plan_name = " ";
            futu_qty = 0;
    ...
    public class ReqFuncpubL_19_403DTO : ReqBaseDTO
    {
        public ReqFuncpubL_19_403DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.19.403";
            CommonDTO.func_code = CommonDTO.function_code;
            row_id = 0;
        }
    ...
    public class ReqFuncpubL_19_404DTO : ReqBaseDTO
    {
        public ReqFuncpubL_19_404DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.19.404";
            CommonDTO.func_code = CommonDTO.function_code;
            query_opor_no = 0;
            comm_trd_type = 0;
        }
    ...
    public class ReqFuncpubL_19_501DTO : ReqBaseDTO
    {
        public ReqFuncpubL_19_501DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.19.501";
            CommonDTO.func_code = CommonDTO.function_code;
            target_opor_no = 0;
            allow_opor_no = 0;
            oper_remark_info = " ";
    ...
    public class ReqFuncpubL_19_502DTO : ReqBaseDTO
    {
        public ReqFuncpubL_19_502DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.19.502";
            CommonDTO.func_code = CommonDTO.function_code;
            target_opor_no = 0;
            allow_opor_no = 0;
            oper_remark_info = " ";
    ...
    public class ReqFuncpubL_19_503DTO : ReqBaseDTO
    {
        public ReqFuncpubL_19_503DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.19.503";
            CommonDTO.func_code = CommonDTO.function_code;
            query_opor_no = 0;
            row_id = 0;
            row_count = -1;
    ...
    public class ReqFuncpubL_19_504DTO : ReqBaseDTO
    {
        public ReqFuncpubL_19_504DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.19.504";
            CommonDTO.func_code = CommonDTO.function_code;
            pd_no = 0;
        }
    ...
    public class ReqFuncpubL_19_505DTO : ReqBaseDTO
    {
        public ReqFuncpubL_19_505DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.19.505";
            CommonDTO.func_code = CommonDTO.function_code;
            exch_no = 0;
            stock_code = " ";
            last_price = 0;
    ...
    public class ReqFuncpubL_19_506DTO : ReqBaseDTO
    {
        public ReqFuncpubL_19_506DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.19.506";
            CommonDTO.func_code = CommonDTO.function_code;
            co_no = 0;
            pd_no = 0;
            stock_code = " ";
    ...
    public class ReqFuncpubL_19_507DTO : ReqBaseDTO
    {
        public ReqFuncpubL_19_507DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.19.507";
            CommonDTO.func_code = CommonDTO.function_code;
            co_no = 0;
            opor_no_str = " ";
            index_value_str = " ";
    ...
    public class ReqFuncpubL_19_508DTO : ReqBaseDTO
    {
        public ReqFuncpubL_19_508DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.19.508";
            CommonDTO.func_code = CommonDTO.function_code;
            target_opor_no = 0;
            query_oper_way = " ";
        }
        ...
        public override LDsdkDefine.LDPackerAdapter CreatePacker()
        {
            ...
            packer.AddField("target_opor_no", ELDDATATYPE.LD_DATATYPE_INT);
            packer.AddField("query_oper_way", ELDDATATYPE.LD_DATATYPE_STRING);
    ...
    public class ReqFuncpubL_19_96DTO : ReqBaseDTO
    {
        public ReqFuncpubL_19_96DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.19.96";
            CommonDTO.func_code = CommonDTO.function_code;
            co_no = 0;
            exch_group_no = 0;
            default_group_flag = 0;
