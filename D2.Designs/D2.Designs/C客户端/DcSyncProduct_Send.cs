...
namespace LD.Client.Contract
{
    ...
    public class ReqFuncdcsyncL_2_12DTO : ReqBaseDTO
    {
        public ReqFuncdcsyncL_2_12DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "dcsyncL.2.12";
    ...
    public class ReqFuncdcsyncL_2_13DTO : ReqBaseDTO
    {
        public ReqFuncdcsyncL_2_13DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "dcsyncL.2.13";
            CommonDTO.func_code = CommonDTO.function_code;
        }
    ...
    public class ReqFuncdcsyncL_2_14DTO : ReqBaseDTO
    {
        public ReqFuncdcsyncL_2_14DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "dcsyncL.2.14";
            CommonDTO.func_code = CommonDTO.function_code;
        }
    ...
    public class ReqFuncdcsyncL_2_15DTO : ReqBaseDTO
    {
        public ReqFuncdcsyncL_2_15DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "dcsyncL.2.15";
            CommonDTO.func_code = CommonDTO.function_code;
        }
    ...
    public class ReqFuncdcsyncL_2_16DTO : ReqBaseDTO
    {
        public ReqFuncdcsyncL_2_16DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "dcsyncL.2.16";
            CommonDTO.func_code = CommonDTO.function_code;
        }
    ...
    public class ReqFuncdcsyncL_2_17DTO : ReqBaseDTO
    {
        public ReqFuncdcsyncL_2_17DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "dcsyncL.2.17";
            CommonDTO.func_code = CommonDTO.function_code;
        }
