...
{
    //逻辑_公共_权限客户端_新增角色
    public class ReqFuncpubL_21_1DTO : ReqBaseDTO
    {
        public ReqFuncpubL_21_1DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.21.1";
    ...
    //逻辑_公共_权限客户端_修改角色
    public class ReqFuncpubL_21_2DTO : ReqBaseDTO
    {
        public ReqFuncpubL_21_2DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.21.2";
            CommonDTO.func_code = CommonDTO.function_code;
            role_no = 0;
            role_code = " ";
            role_name = " ";
    ...
    //逻辑_公共_权限客户端_删除角色
    public class ReqFuncpubL_21_3DTO : ReqBaseDTO
    {
        public ReqFuncpubL_21_3DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.21.3";
            CommonDTO.func_code = CommonDTO.function_code;
            role_no = 0;
            oper_remark_info = " ";
        }
    ...
    //逻辑_公共_权限客户端_复制角色
    public class ReqFuncpubL_21_4DTO : ReqBaseDTO
    {
        public ReqFuncpubL_21_4DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.21.4";
            CommonDTO.func_code = CommonDTO.function_code;
            role_code = " ";
            role_name = " ";
            source_role_no = 0;
    ...
    //逻辑_公共_权限客户端_查询角色列表
    public class ReqFuncpubL_21_5DTO : ReqBaseDTO
    {
        public ReqFuncpubL_21_5DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.21.5";
            CommonDTO.func_code = CommonDTO.function_code;
            role_no = 0;
        }
    ...
    public class ReqFuncpubL_21_13DTO : ReqBaseDTO
    {
        public ReqFuncpubL_21_13DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.21.13";
            CommonDTO.func_code = CommonDTO.function_code;
            role_no = 0;
            menu_func_str = " ";
        }
    ...
    public class ReqFuncpubL_21_14DTO : ReqBaseDTO
    {
        public ReqFuncpubL_21_14DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.21.14";
            CommonDTO.func_code = CommonDTO.function_code;
            role_no = 0;
            menu_func_str = " ";
        }
    ...
    public class ReqFuncpubL_21_15DTO : ReqBaseDTO
    {
        public ReqFuncpubL_21_15DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.21.15";
            CommonDTO.func_code = CommonDTO.function_code;
            role_no = 0;
            row_id = 0;
            row_count = -1;
    ...
    public class ReqFuncpubL_21_21DTO : ReqBaseDTO
    {
        public ReqFuncpubL_21_21DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.21.21";
            CommonDTO.func_code = CommonDTO.function_code;
        }
    ...
    //逻辑_公共_权限客户端_新增操作员角色
    public class ReqFuncpubL_21_22DTO : ReqBaseDTO
    {
        public ReqFuncpubL_21_22DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.21.22";
            CommonDTO.func_code = CommonDTO.function_code;
            target_opor_no = 0;
            role_no = 0;
        }
    ...
    //逻辑_公共_权限客户端_删除操作员角色
    public class ReqFuncpubL_21_23DTO : ReqBaseDTO
    {
        public ReqFuncpubL_21_23DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.21.23";
            CommonDTO.func_code = CommonDTO.function_code;
            target_opor_no = 0;
            role_no = 0;
        }
    ...
    public class ReqFuncpubL_21_24DTO : ReqBaseDTO
    {
        public ReqFuncpubL_21_24DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.21.24";
            CommonDTO.func_code = CommonDTO.function_code;
            query_opor_no = 0;
        }
    ...
    public class ReqFuncpubL_21_27DTO : ReqBaseDTO
    {
        public ReqFuncpubL_21_27DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.21.27";
            CommonDTO.func_code = CommonDTO.function_code;
            target_opor_no = 0;
            menu_type = 0;
            menu_func_str = " ";
    ...
    public class ReqFuncpubL_21_28DTO : ReqBaseDTO
    {
        public ReqFuncpubL_21_28DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.21.28";
            CommonDTO.func_code = CommonDTO.function_code;
            target_opor_no = 0;
            menu_type = 0;
            menu_func_str = " ";
    ...
    public class ReqFuncpubL_21_29DTO : ReqBaseDTO
    {
        public ReqFuncpubL_21_29DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.21.29";
            CommonDTO.func_code = CommonDTO.function_code;
            query_opor_no = 0;
            menu_type = 0;
        }
    ...
    public class ReqFuncpubL_21_30DTO : ReqBaseDTO
    {
        public ReqFuncpubL_21_30DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.21.30";
            CommonDTO.func_code = CommonDTO.function_code;
            query_opor_no = 0;
            menu_type = 0;
        }
    ...
    public class ReqFuncpubL_21_31DTO : ReqBaseDTO
    {
        public ReqFuncpubL_21_31DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.21.31";
            CommonDTO.func_code = CommonDTO.function_code;
            query_opor_no = 0;
            menu_type = 0;
        }
    ...
    public class ReqFuncpubL_21_32DTO : ReqBaseDTO
    {
        public ReqFuncpubL_21_32DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.21.32";
            CommonDTO.func_code = CommonDTO.function_code;
            query_opor_no = 0;
            menu_type = 0;
        }
    ...
    //逻辑_公共_权限客户端_查询全部菜单
    public class ReqFuncpubL_21_33DTO : ReqBaseDTO
    {
        public ReqFuncpubL_21_33DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.21.33";
            CommonDTO.func_code = CommonDTO.function_code;
            menu_type = 0;
        }
    ...
    public class ReqFuncpubL_21_51DTO : ReqBaseDTO
    {
        public ReqFuncpubL_21_51DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.21.51";
            CommonDTO.func_code = CommonDTO.function_code;
            co_no = 0;
            menu_type = 0;
            menu_func_str = " ";
