...
# 事务_产品期货_同步接口_获取同步时间
DELIMITER ;;
DROP PROCEDURE IF EXISTS prt_pdfu_GetSyncTime;;
DELIMITER ;;
CREATE PROCEDURE prt_pdfu_GetSyncTime(
    IN p_opor_co_no int,
    IN p_opor_no int,
...
BEGIN
    ...
    /* 调用【原子_产品期货_同步接口_获取同步时间】*/
    call db_pdfutu.pra_pdfu_GetSyncTime(
        v_opor_co_no,
        v_opor_no,
        v_oper_mac,
        v_oper_ip_addr,
    ...
    if v_error_code = "1" then
        SET v_error_code = "pdfutuT.15.1.999";
        if v_mysql_message <> "" then
             SET v_error_info = CONCAT(v_error_info,"#",'调用过程原子_产品期货_同步接口_获取同步时间出现错误！',v_mysql_message);
        end if;
        leave label_pro;
...
# 事务_产品期货_同步接口_更新同步时间
DELIMITER ;;
DROP PROCEDURE IF EXISTS prt_pdfu_UpdateSyncTime;;
DELIMITER ;;
CREATE PROCEDURE prt_pdfu_UpdateSyncTime(
    IN p_opor_co_no int,
    IN p_opor_no int,
    IN p_oper_mac varchar(32),
    IN p_oper_ip_addr varchar(32),
...
BEGIN
    ...
    /* 调用【原子_产品期货_同步接口_更新同步时间】*/
    call db_pdfutu.pra_pdfu_UpdateSyncTime(
        v_opor_co_no,
        v_opor_no,
        v_oper_mac,
        v_oper_ip_addr,
        ...
        v_mach_time);
    if v_error_code = "1" then
        SET v_error_code = "pdfutuT.15.2.999";
        if v_mysql_message <> "" then
             SET v_error_info = CONCAT(v_error_info,"#",'调用过程原子_产品期货_同步接口_更新同步时间出现错误！',v_mysql_message);
        end if;
        ROLLBACK;
        leave label_pro;
    elseif v_error_code <> "0" then
...
# 事务_产品期货_同步接口_同步交易组资金表
DELIMITER ;;
DROP PROCEDURE IF EXISTS prt_pdfu_Syncpdfuca_exgp_capit;;
DELIMITER ;;
CREATE PROCEDURE prt_pdfu_Syncpdfuca_exgp_capit(
    IN p_opor_co_no int,
    IN p_opor_no int,
    IN p_oper_mac varchar(32),
    IN p_oper_ip_addr varchar(32),
...
BEGIN
    ...
    /* 调用【原子_产品期货_同步接口_同步交易组资金表】*/
    call db_pdfutu.pra_pdfu_Syncpdfuca_exgp_capit(
        v_opor_co_no,
        v_opor_no,
        v_oper_mac,
        v_oper_ip_addr,
        ...
        v_sync_field99);
    if v_error_code = "1" then
        SET v_error_code = "pdfutuT.15.12.999";
        if v_mysql_message <> "" then
             SET v_error_info = CONCAT(v_error_info,"#",'调用过程原子_产品期货_同步接口_同步交易组资金表出现错误！',v_mysql_message);
        end if;
        leave label_pro;
    elseif v_error_code <> "0" then
        leave label_pro;
...
# 事务_产品期货_同步接口_同步交易组资产表
DELIMITER ;;
DROP PROCEDURE IF EXISTS prt_pdfu_Syncpdfuca_exgp_asset;;
DELIMITER ;;
CREATE PROCEDURE prt_pdfu_Syncpdfuca_exgp_asset(
    IN p_opor_co_no int,
    IN p_opor_no int,
    IN p_oper_mac varchar(32),
    IN p_oper_ip_addr varchar(32),
...
BEGIN
    ...
    /* 调用【原子_产品期货_同步接口_同步交易组资产表】*/
    call db_pdfutu.pra_pdfu_Syncpdfuca_exgp_asset(
        v_opor_co_no,
        v_opor_no,
        v_oper_mac,
        v_oper_ip_addr,
        ...
        v_sync_field99);
    if v_error_code = "1" then
        SET v_error_code = "pdfutuT.15.13.999";
        if v_mysql_message <> "" then
             SET v_error_info = CONCAT(v_error_info,"#",'调用过程原子_产品期货_同步接口_同步交易组资产表出现错误！',v_mysql_message);
        end if;
        leave label_pro;
    elseif v_error_code <> "0" then
        leave label_pro;
...
# 事务_产品期货_同步接口_同步资产账户资金表
DELIMITER ;;
DROP PROCEDURE IF EXISTS prt_pdfu_Syncpdfuca_asac_capit;;
DELIMITER ;;
CREATE PROCEDURE prt_pdfu_Syncpdfuca_asac_capit(
    IN p_opor_co_no int,
    IN p_opor_no int,
    IN p_oper_mac varchar(32),
    IN p_oper_ip_addr varchar(32),
...
BEGIN
    ...
    /* 调用【原子_产品期货_同步接口_同步资产账户资金表】*/
    call db_pdfutu.pra_pdfu_Syncpdfuca_asac_capit(
        v_opor_co_no,
        v_opor_no,
        v_oper_mac,
        v_oper_ip_addr,
        ...
        v_sync_field99);
    if v_error_code = "1" then
        SET v_error_code = "pdfutuT.15.14.999";
        if v_mysql_message <> "" then
             SET v_error_info = CONCAT(v_error_info,"#",'调用过程原子_产品期货_同步接口_同步资产账户资金表出现错误！',v_mysql_message);
        end if;
        leave label_pro;
    elseif v_error_code <> "0" then
        leave label_pro;
...
# 事务_产品期货_同步接口_同步交易组持仓表
DELIMITER ;;
DROP PROCEDURE IF EXISTS prt_pdfu_Syncpdfupo_exgp_posi;;
DELIMITER ;;
CREATE PROCEDURE prt_pdfu_Syncpdfupo_exgp_posi(
    IN p_opor_co_no int,
    IN p_opor_no int,
    IN p_oper_mac varchar(32),
    IN p_oper_ip_addr varchar(32),
...
BEGIN
    ...
    /* 调用【原子_产品期货_同步接口_同步交易组持仓表】*/
    call db_pdfutu.pra_pdfu_Syncpdfupo_exgp_posi(
        v_opor_co_no,
        v_opor_no,
        v_oper_mac,
        v_oper_ip_addr,
        ...
        v_sync_field99);
    if v_error_code = "1" then
        SET v_error_code = "pdfutuT.15.15.999";
        if v_mysql_message <> "" then
             SET v_error_info = CONCAT(v_error_info,"#",'调用过程原子_产品期货_同步接口_同步交易组持仓表出现错误！',v_mysql_message);
        end if;
        leave label_pro;
    elseif v_error_code <> "0" then
        leave label_pro;
...
# 事务_产品期货_同步接口_同步资产账户持仓表
DELIMITER ;;
DROP PROCEDURE IF EXISTS prt_pdfu_Syncpdfupo_asac_posi;;
DELIMITER ;;
CREATE PROCEDURE prt_pdfu_Syncpdfupo_asac_posi(
    IN p_opor_co_no int,
    IN p_opor_no int,
    IN p_oper_mac varchar(32),
    IN p_oper_ip_addr varchar(32),
...
BEGIN
    ...
    /* 调用【原子_产品期货_同步接口_同步资产账户持仓表】*/
    call db_pdfutu.pra_pdfu_Syncpdfupo_asac_posi(
        v_opor_co_no,
        v_opor_no,
        v_oper_mac,
        v_oper_ip_addr,
        ...
        v_sync_field99);
    if v_error_code = "1" then
        SET v_error_code = "pdfutuT.15.16.999";
        if v_mysql_message <> "" then
             SET v_error_info = CONCAT(v_error_info,"#",'调用过程原子_产品期货_同步接口_同步资产账户持仓表出现错误！',v_mysql_message);
        end if;
        leave label_pro;
    elseif v_error_code <> "0" then
        leave label_pro;
