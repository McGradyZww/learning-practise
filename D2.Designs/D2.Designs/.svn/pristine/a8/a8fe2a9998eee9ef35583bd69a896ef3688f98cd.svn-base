...
{
    public class pdsecuL_9_1_Info : ObservableObject
    {
    }

    public class pdsecuL_9_2_Info : ObservableObject
    {
    ...
    public class pdsecuL_9_3_Info : ObservableObject
    {
    ...
    public class pdsecuL_9_5_Info : ObservableObject
    {
    }

    public class pdsecuL_9_6_Info : ObservableObject
    {
        ...
        private double _out_frozen_qty;
        /// <summary>
        /// 外部冻结数量
        /// </summary>
        public double out_frozen_qty
        {
            get { return _out_frozen_qty; }

            set
            {
                _out_frozen_qty = value;
                RaisePropertyChanged(() => out_frozen_qty);
            }
        }

        private double _out_unfroz_qty;
        /// <summary>
        /// 外部解冻数量
        /// </summary>
        public double out_unfroz_qty
        {
            get { return _out_unfroz_qty; }

            set
            {
                _out_unfroz_qty = value;
                RaisePropertyChanged(() => out_unfroz_qty);
            }
        }
    }

    public class pdsecuL_9_7_Info : ObservableObject
    {
    ...
    public class pdsecuL_9_8_Info : ObservableObject
    {
    }

    public class pdsecuL_9_9_Info : ObservableObject
    {
    }

    public class pdsecuL_9_10_Info : ObservableObject
    {
    }

    public class pdsecuL_9_11_Info : ObservableObject
    {
    }

    public class pdsecuL_9_12_Info : ObservableObject
    {
        ...
        private double _out_begin_qty;
        /// <summary>
        /// 外部期初数量
        /// </summary>
        public double out_begin_qty
        {
            get { return _out_begin_qty; }

            set
            {
                _out_begin_qty = value;
                RaisePropertyChanged(() => out_begin_qty);
            }
        }
    ...
    public class pdsecuL_9_13_Info : ObservableObject
    {
    ...
    public class pdsecuL_9_31_Info : ObservableObject
    {
    }

    public class pdsecuL_9_71_Info : ObservableObject
    {
    ...
    public class pdsecuL_9_72_Info : ObservableObject
    {
    ...
    public class pdsecuL_9_81_Info : ObservableObject
    {
    ...
    public class pdsecuL_9_82_Info : ObservableObject
    {
    ...
    public class pdsecuL_9_90_Info : ObservableObject
    {
    }

    public class pdsecuL_9_91_Info : ObservableObject
    {
        ...
        private double _sys_avail_qty_diff;
        /// <summary>
        /// 系统可用数量差额
        /// </summary>
        public double sys_avail_qty_diff
        {
            get { return _sys_avail_qty_diff; }

            set
            {
                _sys_avail_qty_diff = value;
                RaisePropertyChanged(() => sys_avail_qty_diff);
            }
        }
    ...
    public class pdsecuL_9_92_Info : ObservableObject
    {
    ...
    public class pdsecuL_9_93_Info : ObservableObject
    {
    }

    public class pdsecuL_9_94_Info : ObservableObject
    {
    }

    public class pdsecuL_9_95_Info : ObservableObject
    {
    }

    public class pdsecuL_9_96_Info : ObservableObject
    {
    ...
    public class pdsecuL_9_97_Info : ObservableObject
    {
    }

    public class pdsecuL_9_98_Info : ObservableObject
    {
    }
