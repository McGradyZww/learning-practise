...
# 事务_数据同步_交易期货同步_同步交易组业务资金表
DELIMITER ;;
DROP PROCEDURE IF EXISTS prt_dcsytdfu_Synctdfuac_exgp_busi_capit;;
DELIMITER ;;
CREATE PROCEDURE prt_dcsytdfu_Synctdfuac_exgp_busi_capit(
    IN p_opor_co_no int,
    IN p_opor_no int,
...
BEGIN
    ...
    /* 调用【原子_数据同步_交易期货同步_同步交易组业务资金表】*/
    call db_dc.pra_dcsytdfu_Synctdfuac_exgp_busi_capit(
        v_opor_co_no,
        v_opor_no,
        v_oper_mac,
        v_oper_ip_addr,
    ...
    if v_error_code = "1" then
        SET v_error_code = "dcsyncT.6.12.999";
        if v_mysql_message <> "" then
             SET v_error_info = CONCAT(v_error_info,"#",'调用过程原子_数据同步_交易期货同步_同步交易组业务资金表出现错误！',v_mysql_message);
        end if;
        ROLLBACK;
        leave label_pro;
...
# 事务_数据同步_交易期货同步_同步资产账户业务资金表
DELIMITER ;;
DROP PROCEDURE IF EXISTS prt_dcsytdfu_Synctdfuac_asac_busi_capit;;
DELIMITER ;;
CREATE PROCEDURE prt_dcsytdfu_Synctdfuac_asac_busi_capit(
    IN p_opor_co_no int,
    IN p_opor_no int,
    IN p_oper_mac varchar(32),
    IN p_oper_ip_addr varchar(32),
...
BEGIN
    ...
    /* 调用【原子_数据同步_交易期货同步_同步资产账户业务资金表】*/
    call db_dc.pra_dcsytdfu_Synctdfuac_asac_busi_capit(
        v_opor_co_no,
        v_opor_no,
        v_oper_mac,
        v_oper_ip_addr,
        ...
        v_error_info);
    if v_error_code = "1" then
        SET v_error_code = "dcsyncT.6.13.999";
        if v_mysql_message <> "" then
             SET v_error_info = CONCAT(v_error_info,"#",'调用过程原子_数据同步_交易期货同步_同步资产账户业务资金表出现错误！',v_mysql_message);
        end if;
        ROLLBACK;
        leave label_pro;
    elseif v_error_code <> "0" then
...
# 事务_数据同步_交易期货同步_同步交易组业务持仓表
DELIMITER ;;
DROP PROCEDURE IF EXISTS prt_dcsytdfu_Synctdfuac_exgp_busi_posi;;
DELIMITER ;;
CREATE PROCEDURE prt_dcsytdfu_Synctdfuac_exgp_busi_posi(
    IN p_opor_co_no int,
    IN p_opor_no int,
    IN p_oper_mac varchar(32),
    IN p_oper_ip_addr varchar(32),
...
BEGIN
    ...
    /* 调用【原子_数据同步_交易期货同步_同步交易组业务持仓表】*/
    call db_dc.pra_dcsytdfu_Synctdfuac_exgp_busi_posi(
        v_opor_co_no,
        v_opor_no,
        v_oper_mac,
        v_oper_ip_addr,
        ...
        v_error_info);
    if v_error_code = "1" then
        SET v_error_code = "dcsyncT.6.14.999";
        if v_mysql_message <> "" then
             SET v_error_info = CONCAT(v_error_info,"#",'调用过程原子_数据同步_交易期货同步_同步交易组业务持仓表出现错误！',v_mysql_message);
        end if;
        ROLLBACK;
        leave label_pro;
    elseif v_error_code <> "0" then
...
# 事务_数据同步_交易期货同步_同步资产账户业务持仓表
DELIMITER ;;
DROP PROCEDURE IF EXISTS prt_dcsytdfu_Synctdfuac_asac_busi_posi;;
DELIMITER ;;
CREATE PROCEDURE prt_dcsytdfu_Synctdfuac_asac_busi_posi(
    IN p_opor_co_no int,
    IN p_opor_no int,
    IN p_oper_mac varchar(32),
    IN p_oper_ip_addr varchar(32),
...
BEGIN
    ...
    /* 调用【原子_数据同步_交易期货同步_同步资产账户业务持仓表】*/
    call db_dc.pra_dcsytdfu_Synctdfuac_asac_busi_posi(
        v_opor_co_no,
        v_opor_no,
        v_oper_mac,
        v_oper_ip_addr,
        ...
        v_error_info);
    if v_error_code = "1" then
        SET v_error_code = "dcsyncT.6.15.999";
        if v_mysql_message <> "" then
             SET v_error_info = CONCAT(v_error_info,"#",'调用过程原子_数据同步_交易期货同步_同步资产账户业务持仓表出现错误！',v_mysql_message);
        end if;
        ROLLBACK;
        leave label_pro;
    elseif v_error_code <> "0" then
...
# 事务_数据同步_交易期货同步_同步交易组持仓明细表
DELIMITER ;;
DROP PROCEDURE IF EXISTS prt_dcsytdfu_Synctdfuac_exgp_posi_detail;;
DELIMITER ;;
CREATE PROCEDURE prt_dcsytdfu_Synctdfuac_exgp_posi_detail(
    IN p_opor_co_no int,
    IN p_opor_no int,
    IN p_oper_mac varchar(32),
    IN p_oper_ip_addr varchar(32),
...
BEGIN
    ...
    /* 调用【原子_数据同步_交易期货同步_同步交易组持仓明细表】*/
    call db_dc.pra_dcsytdfu_Synctdfuac_exgp_posi_detail(
        v_opor_co_no,
        v_opor_no,
        v_oper_mac,
        v_oper_ip_addr,
        ...
        v_error_info);
    if v_error_code = "1" then
        SET v_error_code = "dcsyncT.6.16.999";
        if v_mysql_message <> "" then
             SET v_error_info = CONCAT(v_error_info,"#",'调用过程原子_数据同步_交易期货同步_同步交易组持仓明细表出现错误！',v_mysql_message);
        end if;
        ROLLBACK;
        leave label_pro;
    elseif v_error_code <> "0" then
