...
API_EXPORT int LD_CALL_MODE QueryInterface(int iFunIndex, LPBIZ_FUNC_INFO bizFuncInfo)
{
    ...
    if (iFunIndex==0)
    {
        strcpy(bizFuncInfo->szFuncName, "tdfutuL.8.1");
        bizFuncInfo->lpFunc = fnFunc0;
    }
    else if (iFunIndex==1)
    {
        strcpy(bizFuncInfo->szFuncName, "tdfutuL.8.2");
        bizFuncInfo->lpFunc = fnFunc1;
    }
    else if (iFunIndex==2)
    {
        strcpy(bizFuncInfo->szFuncName, "tdfutuL.8.3");
        bizFuncInfo->lpFunc = fnFunc2;
    }
    else if (iFunIndex==3)
    {
        strcpy(bizFuncInfo->szFuncName, "tdfutuL.8.4");
        bizFuncInfo->lpFunc = fnFunc3;
    }
    else if (iFunIndex==4)
    {
        strcpy(bizFuncInfo->szFuncName, "tdfutuL.8.5");
        bizFuncInfo->lpFunc = fnFunc4;
    }
    else if (iFunIndex==5)
    {
        strcpy(bizFuncInfo->szFuncName, "tdfutuL.8.6");
        bizFuncInfo->lpFunc = fnFunc5;
    }
    else if (iFunIndex==6)
    {
        strcpy(bizFuncInfo->szFuncName, "tdfutuL.8.7");
        bizFuncInfo->lpFunc = fnFunc6;
    }
    else if (iFunIndex==7)
    {
        strcpy(bizFuncInfo->szFuncName, "tdfutuL.8.8");
        bizFuncInfo->lpFunc = fnFunc7;
    }
    else if (iFunIndex==8)
    {
        strcpy(bizFuncInfo->szFuncName, "tdfutuL.8.9");
        bizFuncInfo->lpFunc = fnFunc8;
    }
    else if (iFunIndex==9)
    {
        strcpy(bizFuncInfo->szFuncName, "tdfutuL.8.10");
        bizFuncInfo->lpFunc = fnFunc9;
    }
    else if (iFunIndex==10)
    {
        strcpy(bizFuncInfo->szFuncName, "tdfutuL.8.20");
        bizFuncInfo->lpFunc = fnFunc10;
    }
    else if (iFunIndex==11)
    {
        strcpy(bizFuncInfo->szFuncName, "tdfutuL.8.21");
        bizFuncInfo->lpFunc = fnFunc11;
    }
    else if (iFunIndex==12)
    {
        strcpy(bizFuncInfo->szFuncName, "tdfutuL.8.22");
...
int iPriority=lpInBizMsg->GetInt32(LDTAG_PRIORITY);
    ...
    lpTSCall1Req1=glpFastMsgFactory->CreateFastMessage("tdfutuT.8.1", 0);
    ...
    {
        lpOutBizMsg->SetInt32(LDTAG_ERRORNO, -1);
        lpOutBizMsg->SetString(LDTAG_ERRORINFO, "[tdfutuT.8.1]subcall timed out!");
        iRet=-2;
        goto ENDSYS;
    }
...
int iPriority=lpInBizMsg->GetInt32(LDTAG_PRIORITY);
    ...
    lpTSCall1Req1=glpFastMsgFactory->CreateFastMessage("tdfutuT.8.2", 0);
    lpTSCall1Req1->SetInt32(LDTAG_PRIORITY, iPriority);
    lpTSCall1Req1->SetInt32(LDBIZ_OPOR_CO_NO_INT,v_opor_co_no);
    lpTSCall1Req1->SetInt32(LDBIZ_OPOR_NO_INT,v_opor_no);
    lpTSCall1Req1->SetString(LDBIZ_OPER_MAC_STR,v_oper_mac);
    ...
    {
        lpOutBizMsg->SetInt32(LDTAG_ERRORNO, -1);
        lpOutBizMsg->SetString(LDTAG_ERRORINFO, "[tdfutuT.8.2]subcall timed out!");
        iRet=-2;
        goto ENDSYS;
    }
    else if(lpTSCall1Ans1->GetInt32(LDTAG_ERRORNO)!=0)  //  中间件层面错误
...
int iPriority=lpInBizMsg->GetInt32(LDTAG_PRIORITY);
    ...
    lpTSCall1Req1=glpFastMsgFactory->CreateFastMessage("tdfutuT.8.3", 0);
    lpTSCall1Req1->SetInt32(LDTAG_PRIORITY, iPriority);
    lpTSCall1Req1->SetInt32(LDBIZ_OPOR_CO_NO_INT,v_opor_co_no);
    lpTSCall1Req1->SetInt32(LDBIZ_OPOR_NO_INT,v_opor_no);
    lpTSCall1Req1->SetString(LDBIZ_OPER_MAC_STR,v_oper_mac);
    ...
    lpTSCall1Req1->SetString(LDBIZ_ORDER_NO_STR_STR,v_order_no_str);
    lpTSCall1Req1->SetString(LDBIZ_ORDER_DIR_STR_STR,v_order_dir_str);
    ...
    {
        lpOutBizMsg->SetInt32(LDTAG_ERRORNO, -1);
        lpOutBizMsg->SetString(LDTAG_ERRORINFO, "[tdfutuT.8.3]subcall timed out!");
        iRet=-2;
        goto ENDSYS;
    }
    else if(lpTSCall1Ans1->GetInt32(LDTAG_ERRORNO)!=0)  //  中间件层面错误
...
int iPriority=lpInBizMsg->GetInt32(LDTAG_PRIORITY);
    ...
    strncpy(v_contrc_code, lpInBizMsg->GetString(LDBIZ_CONTRC_CODE_STR),6);
    v_contrc_code[6] = '\0';
    strncpy(v_report_no_str, lpInBizMsg->GetString(LDBIZ_REPORT_NO_STR_STR),2048);
    v_report_no_str[2048] = '\0';
    strncpy(v_order_dir_str, lpInBizMsg->GetString(LDBIZ_ORDER_DIR_STR_STR),1024);
    v_order_dir_str[1024] = '\0';
    strncpy(v_deal_status_str, lpInBizMsg->GetString(LDBIZ_DEAL_STATUS_STR_STR),64);
    v_deal_status_str[64] = '\0';
    ...
    lpTSCall1Req1=glpFastMsgFactory->CreateFastMessage("tdfutuT.8.4", 0);
    lpTSCall1Req1->SetInt32(LDTAG_PRIORITY, iPriority);
    lpTSCall1Req1->SetInt32(LDBIZ_OPOR_CO_NO_INT,v_opor_co_no);
    lpTSCall1Req1->SetInt32(LDBIZ_OPOR_NO_INT,v_opor_no);
    lpTSCall1Req1->SetString(LDBIZ_OPER_MAC_STR,v_oper_mac);
    ...
    lpTSCall1Req1->SetString(LDBIZ_FUTU_ACCO_STR,v_futu_acco);
    lpTSCall1Req1->SetString(LDBIZ_CONTRC_CODE_STR,v_contrc_code);
    lpTSCall1Req1->SetString(LDBIZ_REPORT_NO_STR_STR,v_report_no_str);
    lpTSCall1Req1->SetString(LDBIZ_ORDER_DIR_STR_STR,v_order_dir_str);
    lpTSCall1Req1->SetString(LDBIZ_DEAL_STATUS_STR_STR,v_deal_status_str);
    lpTSCall1Req1->SetInt64(LDBIZ_ROW_ID_INT64,v_row_id);
    lpTSCall1Req1->SetInt32(LDBIZ_ROW_COUNT_INT,v_row_count);
    ...
    {
        lpOutBizMsg->SetInt32(LDTAG_ERRORNO, -1);
        lpOutBizMsg->SetString(LDTAG_ERRORINFO, "[tdfutuT.8.4]subcall timed out!");
        iRet=-2;
        goto ENDSYS;
    }
    else if(lpTSCall1Ans1->GetInt32(LDTAG_ERRORNO)!=0)  //  中间件层面错误
...
int iPriority=lpInBizMsg->GetInt32(LDTAG_PRIORITY);
    ...
    lpTSCall1Req1=glpFastMsgFactory->CreateFastMessage("tdfutuT.8.5", 0);
    lpTSCall1Req1->SetInt32(LDTAG_PRIORITY, iPriority);
    lpTSCall1Req1->SetInt32(LDBIZ_OPOR_CO_NO_INT,v_opor_co_no);
    lpTSCall1Req1->SetInt32(LDBIZ_OPOR_NO_INT,v_opor_no);
    lpTSCall1Req1->SetString(LDBIZ_OPER_MAC_STR,v_oper_mac);
    ...
    {
        lpOutBizMsg->SetInt32(LDTAG_ERRORNO, -1);
        lpOutBizMsg->SetString(LDTAG_ERRORINFO, "[tdfutuT.8.5]subcall timed out!");
        iRet=-2;
        goto ENDSYS;
    }
    else if(lpTSCall1Ans1->GetInt32(LDTAG_ERRORNO)!=0)  //  中间件层面错误
...
int iPriority=lpInBizMsg->GetInt32(LDTAG_PRIORITY);
    ...
    lpTSCall1Req1=glpFastMsgFactory->CreateFastMessage("tdfutuT.8.6", 0);
    lpTSCall1Req1->SetInt32(LDTAG_PRIORITY, iPriority);
    lpTSCall1Req1->SetInt32(LDBIZ_OPOR_CO_NO_INT,v_opor_co_no);
    lpTSCall1Req1->SetInt32(LDBIZ_OPOR_NO_INT,v_opor_no);
    lpTSCall1Req1->SetString(LDBIZ_OPER_MAC_STR,v_oper_mac);
    ...
    {
        lpOutBizMsg->SetInt32(LDTAG_ERRORNO, -1);
        lpOutBizMsg->SetString(LDTAG_ERRORINFO, "[tdfutuT.8.6]subcall timed out!");
        iRet=-2;
        goto ENDSYS;
    }
    else if(lpTSCall1Ans1->GetInt32(LDTAG_ERRORNO)!=0)  //  中间件层面错误
...
int iPriority=lpInBizMsg->GetInt32(LDTAG_PRIORITY);
    ...
    lpTSCall1Req1=glpFastMsgFactory->CreateFastMessage("tdfutuT.8.7", 0);
    lpTSCall1Req1->SetInt32(LDTAG_PRIORITY, iPriority);
    lpTSCall1Req1->SetInt32(LDBIZ_OPOR_CO_NO_INT,v_opor_co_no);
    lpTSCall1Req1->SetInt32(LDBIZ_OPOR_NO_INT,v_opor_no);
    lpTSCall1Req1->SetString(LDBIZ_OPER_MAC_STR,v_oper_mac);
    ...
    {
        lpOutBizMsg->SetInt32(LDTAG_ERRORNO, -1);
        lpOutBizMsg->SetString(LDTAG_ERRORINFO, "[tdfutuT.8.7]subcall timed out!");
        iRet=-2;
        goto ENDSYS;
    }
    else if(lpTSCall1Ans1->GetInt32(LDTAG_ERRORNO)!=0)  //  中间件层面错误
...
int iPriority=lpInBizMsg->GetInt32(LDTAG_PRIORITY);
    ...
    for (int i = 0; i < iRecordCount;i++) 
    {
        ...
        if(lpRecord)
        {
            ...
            v_old_trade_capt_qty = lpRecord->GetDouble(LDBIZ_OLD_TRADE_CAPT_QTY_FLOAT);
            v_today_trade_capt_qty = lpRecord->GetDouble(LDBIZ_TODAY_TRADE_CAPT_QTY_FLOAT);
            v_pre_strike_capt_qty = lpRecord->GetDouble(LDBIZ_PRE_STRIKE_CAPT_QTY_FLOAT);
            v_today_strike_capt_qty = lpRecord->GetDouble(LDBIZ_TODAY_STRIKE_CAPT_QTY_FLOAT);
            v_rece_margin = lpRecord->GetDouble(LDBIZ_RECE_MARGIN_FLOAT);
            v_pre_settle_price = lpRecord->GetDouble(LDBIZ_PRE_SETTLE_PRICE_FLOAT);
            v_open_amount = lpRecord->GetDouble(LDBIZ_OPEN_AMOUNT_FLOAT);
            v_update_times = lpRecord->GetInt32(LDBIZ_UPDATE_TIMES_INT);

        //调用过程[事务_产品期货_公共接口_获取合约代码最新价]
        //组织事务请求
        if(lpTSCall1Ans2)
        {
          lpTSCall1Ans2->FreeMsg();
        ...
        lpTSCall1Req2=glpFastMsgFactory->CreateFastMessage("pdfutuT.4.7", 0);
        lpTSCall1Req2->SetInt32(LDTAG_PRIORITY, iPriority);
        lpTSCall1Req2->SetInt32(LDBIZ_OPOR_CO_NO_INT,v_opor_co_no);
        lpTSCall1Req2->SetInt32(LDBIZ_OPOR_NO_INT,v_opor_no);
        lpTSCall1Req2->SetString(LDBIZ_OPER_MAC_STR,v_oper_mac);
        ...
        {
            lpOutBizMsg->SetInt32(LDTAG_ERRORNO, -1);
            lpOutBizMsg->SetString(LDTAG_ERRORINFO, "[pdfutuT.4.7]subcall timed out!");
            iRet=-2;
            goto ENDSYS;
        }
        ...
        lpTSCall1Req3=glpFastMsgFactory->CreateFastMessage("tdfutuT.2.20", 0);
        ...
        {
            lpOutBizMsg->SetInt32(LDTAG_ERRORNO, -1);
            lpOutBizMsg->SetString(LDTAG_ERRORINFO, "[tdfutuT.2.20]subcall timed out!");
            iRet=-2;
            goto ENDSYS;
        }
        ...
        v_marked_pandl = lpTSCall1Ans3->GetDouble(LDBIZ_MARKED_PANDL_FLOAT);
        v_pre_strike_capt_qty = lpTSCall1Ans3->GetDouble(LDBIZ_PRE_STRIKE_CAPT_QTY_FLOAT);
        v_rece_margin = lpTSCall1Ans3->GetDouble(LDBIZ_RECE_MARGIN_FLOAT);

        //调用过程[事务_产品期货_持仓_更新交易持仓]
        //组织事务请求
        if(lpTSCall1Ans4)
        {
        ...
        lpTSCall1Req4=glpFastMsgFactory->CreateFastMessage("pdfutuT.3.301", 0);
        ...
        lpTSCall1Req4->SetDouble(LDBIZ_PRE_STRIKE_CAPT_QTY_FLOAT,v_pre_strike_capt_qty);
        lpTSCall1Req4->SetDouble(LDBIZ_MARKED_PANDL_FLOAT,v_marked_pandl);
        lpTSCall1Req4->SetDouble(LDBIZ_POSI_QTY_FLOAT,v_posi_qty);
        lpTSCall1Req4->SetDouble(LDBIZ_RECE_MARGIN_FLOAT,v_rece_margin);
        glpTSSubcallSerives->SubCall(lpTSCall1Req4, &lpTSCall1Ans4, 5000);
        if(!lpTSCall1Ans4)  //  超时错误
        {
            lpOutBizMsg->SetInt32(LDTAG_ERRORNO, -1);
            lpOutBizMsg->SetString(LDTAG_ERRORINFO, "[pdfutuT.3.301]subcall timed out!");
            iRet=-2;
            goto ENDSYS;
        }
    ...
    lpTSCall1Req5=glpFastMsgFactory->CreateFastMessage("tdfutuT.2.7", 0);
    ...
    lpTSCall1Req5->SetInt32(LDBIZ_FUTU_ACCO_NO_INT,v_futu_acco_no);
    ...
    for (int i = 0; i < iRecordCount;i++) 
    {
        ...
        if(lpRecord)
        {
            ...
            v_trade_releas_qty = lpRecord->GetDouble(LDBIZ_TRADE_RELEAS_QTY_FLOAT);
            v_strike_releas_qty = lpRecord->GetDouble(LDBIZ_STRIKE_RELEAS_QTY_FLOAT);
            v_pre_comm_capt_qty = lpRecord->GetDouble(LDBIZ_PRE_COMM_CAPT_QTY_FLOAT);
            v_today_comm_capt_qty = lpRecord->GetDouble(LDBIZ_TODAY_COMM_CAPT_QTY_FLOAT);
            v_old_trade_capt_qty = lpRecord->GetDouble(LDBIZ_OLD_TRADE_CAPT_QTY_FLOAT);
            v_today_trade_capt_qty = lpRecord->GetDouble(LDBIZ_TODAY_TRADE_CAPT_QTY_FLOAT);
            v_pre_strike_capt_qty = lpRecord->GetDouble(LDBIZ_PRE_STRIKE_CAPT_QTY_FLOAT);
            v_today_strike_capt_qty = lpRecord->GetDouble(LDBIZ_TODAY_STRIKE_CAPT_QTY_FLOAT);
        ...
        lpTSCall1Req6=glpFastMsgFactory->CreateFastMessage("pdfutuT.4.7", 0);
        ...
        lpTSCall1Req7=glpFastMsgFactory->CreateFastMessage("tdfutuT.2.21", 0);
        ...
        {
            lpOutBizMsg->SetInt32(LDTAG_ERRORNO, -1);
            lpOutBizMsg->SetString(LDTAG_ERRORINFO, "[tdfutuT.2.21]subcall timed out!");
            iRet=-2;
            goto ENDSYS;
        }
        ...
        strcpy(v_error_code, lpTSCall1Ans7->GetString(LDBIZ_ERROR_CODE_STR));
        strcpy(v_error_info, lpTSCall1Ans7->GetString(LDBIZ_ERROR_INFO_STR));
        v_posi_qty = lpTSCall1Ans7->GetDouble(LDBIZ_POSI_QTY_FLOAT);
        v_marked_pandl = lpTSCall1Ans7->GetDouble(LDBIZ_MARKED_PANDL_FLOAT);
        v_pre_strike_capt_qty = lpTSCall1Ans7->GetDouble(LDBIZ_PRE_STRIKE_CAPT_QTY_FLOAT);
        v_rece_margin = lpTSCall1Ans7->GetDouble(LDBIZ_RECE_MARGIN_FLOAT);

        //调用过程[事务_产品期货_持仓_更新交易库交易组持仓]
        //组织事务请求
        if(lpTSCall1Ans8)
        {
        ...
        lpTSCall1Req8=glpFastMsgFactory->CreateFastMessage("pdfutuT.3.302", 0);
        ...
        lpTSCall1Req8->SetDouble(LDBIZ_PRE_STRIKE_CAPT_QTY_FLOAT,v_pre_strike_capt_qty);
        lpTSCall1Req8->SetDouble(LDBIZ_MARKED_PANDL_FLOAT,v_marked_pandl);
        lpTSCall1Req8->SetDouble(LDBIZ_POSI_QTY_FLOAT,v_posi_qty);
        ...
        {
            lpOutBizMsg->SetInt32(LDTAG_ERRORNO, -1);
            lpOutBizMsg->SetString(LDTAG_ERRORINFO, "[pdfutuT.3.302]subcall timed out!");
            iRet=-2;
            goto ENDSYS;
        }
...
int iPriority=lpInBizMsg->GetInt32(LDTAG_PRIORITY);
    ...
    strcpy(v_pd_no_rights_str,"; ;");
    //[事务_交易期货_账户_查询资产账户资金]
    //存在当日没进行交易的资产账户，同步资金时也需计算老仓盯市盈亏来同步可用资金。
    //调用过程[事务_产品期货_公共接口_查询资产账户资金]
    //组织事务请求
    if(lpTSCall1Ans1)
    {
      lpTSCall1Ans1->FreeMsg();
    ...
    lpTSCall1Req1=glpFastMsgFactory->CreateFastMessage("pdfutuT.4.901", 0);
    lpTSCall1Req1->SetInt32(LDTAG_PRIORITY, iPriority);
    lpTSCall1Req1->SetInt32(LDBIZ_OPOR_CO_NO_INT,v_opor_co_no);
    lpTSCall1Req1->SetInt32(LDBIZ_OPOR_NO_INT,v_opor_no);
    lpTSCall1Req1->SetString(LDBIZ_OPER_MAC_STR,v_oper_mac);
    ...
    {
        lpOutBizMsg->SetInt32(LDTAG_ERRORNO, -1);
        lpOutBizMsg->SetString(LDTAG_ERRORINFO, "[pdfutuT.4.901]subcall timed out!");
        iRet=-2;
        goto ENDSYS;
    }
    else if(lpTSCall1Ans1->GetInt32(LDTAG_ERRORNO)!=0)  //  中间件层面错误
    ...
    // [获取结果集][lpMainMsg1]
    lpMainMsg1=lpTSCall1Ans1->GetGroup(LDTAG_NO_RESULTSET);
    ...
    for (int i = 0; i < iRecordCount;i++) 
    {
        ...
        if(lpRecord)
        {
            ...
            v_capt_margin = lpRecord->GetDouble(LDBIZ_CAPT_MARGIN_FLOAT);
            ...
            v_intrst_rate = lpRecord->GetDouble(LDBIZ_INTRST_RATE_FLOAT);
            v_intrst_base_amt = lpRecord->GetDouble(LDBIZ_INTRST_BASE_AMT_FLOAT);
            v_pre_entry_intrst_amt = lpRecord->GetDouble(LDBIZ_PRE_ENTRY_INTRST_AMT_FLOAT);

        //调用过程[事务_交易期货_账户_计算资产账户资金可用同步产品库]
        //组织事务请求
        if(lpTSCall1Ans2)
        {
          lpTSCall1Ans2->FreeMsg();
        ...
        lpTSCall1Req2=glpFastMsgFactory->CreateFastMessage("tdfutuT.2.22", 0);
        lpTSCall1Req2->SetInt32(LDTAG_PRIORITY, iPriority);
        lpTSCall1Req2->SetInt32(LDBIZ_OPOR_CO_NO_INT,v_opor_co_no);
        lpTSCall1Req2->SetInt32(LDBIZ_OPOR_NO_INT,v_opor_no);
        lpTSCall1Req2->SetString(LDBIZ_OPER_MAC_STR,v_oper_mac);
        ...
        {
            lpOutBizMsg->SetInt32(LDTAG_ERRORNO, -1);
            lpOutBizMsg->SetString(LDTAG_ERRORINFO, "[tdfutuT.2.22]subcall timed out!");
            iRet=-2;
            goto ENDSYS;
        }
        else if(lpTSCall1Ans2->GetInt32(LDTAG_ERRORNO)!=0)  //  中间件层面错误
        ...
        v_margin_amt = lpTSCall1Ans2->GetDouble(LDBIZ_MARGIN_AMT_FLOAT);
        v_capit_bala = lpTSCall1Ans2->GetDouble(LDBIZ_CAPIT_BALA_FLOAT);

        //调用过程[事务_产品期货_资金_更新交易资金]
        //组织事务请求
        if(lpTSCall1Ans3)
        {
          lpTSCall1Ans3->FreeMsg();
        ...
        lpTSCall1Req3=glpFastMsgFactory->CreateFastMessage("pdfutuT.2.255", 0);
        lpTSCall1Req3->SetInt32(LDTAG_PRIORITY, iPriority);
        lpTSCall1Req3->SetInt32(LDBIZ_OPOR_CO_NO_INT,v_opor_co_no);
        lpTSCall1Req3->SetInt32(LDBIZ_OPOR_NO_INT,v_opor_no);
        lpTSCall1Req3->SetString(LDBIZ_OPER_MAC_STR,v_oper_mac);
        ...
        lpTSCall1Req3->SetInt32(LDBIZ_PD_NO_INT,v_pd_no);
        lpTSCall1Req3->SetInt32(LDBIZ_ASSET_ACCO_NO_INT,v_asset_acco_no);
        lpTSCall1Req3->SetDouble(LDBIZ_AVAIL_AMT_FLOAT,v_avail_amt);
        lpTSCall1Req3->SetDouble(LDBIZ_MARGIN_AMT_FLOAT,v_margin_amt);
        lpTSCall1Req3->SetDouble(LDBIZ_CAPIT_BALA_FLOAT,v_capit_bala);
        glpTSSubcallSerives->SubCall(lpTSCall1Req3, &lpTSCall1Ans3, 5000);
        if(!lpTSCall1Ans3)  //  超时错误
        {
            lpOutBizMsg->SetInt32(LDTAG_ERRORNO, -1);
            lpOutBizMsg->SetString(LDTAG_ERRORINFO, "[pdfutuT.2.255]subcall timed out!");
            iRet=-2;
            goto ENDSYS;
        }
        else if(lpTSCall1Ans3->GetInt32(LDTAG_ERRORNO)!=0)  //  中间件层面错误
    ...
    lpTSCall1Req4=glpFastMsgFactory->CreateFastMessage("pdfutuT.4.902", 0);
    lpTSCall1Req4->SetInt32(LDTAG_PRIORITY, iPriority);
    lpTSCall1Req4->SetInt32(LDBIZ_OPOR_CO_NO_INT,v_opor_co_no);
    lpTSCall1Req4->SetInt32(LDBIZ_OPOR_NO_INT,v_opor_no);
    lpTSCall1Req4->SetString(LDBIZ_OPER_MAC_STR,v_oper_mac);
    ...
    {
        lpOutBizMsg->SetInt32(LDTAG_ERRORNO, -1);
        lpOutBizMsg->SetString(LDTAG_ERRORINFO, "[pdfutuT.4.902]subcall timed out!");
        iRet=-2;
        goto ENDSYS;
    }
    else if(lpTSCall1Ans4->GetInt32(LDTAG_ERRORNO)!=0)  //  中间件层面错误
    ...
    for (int i = 0; i < iRecordCount;i++) 
    {
        ...
        // set @交易币种# = @本币币种#;
        strcpy(v_exch_crncy_type,v_crncy_type);
        //调用过程[事务_交易期货_账户_计算交易组资金可用同步产品库]
        //组织事务请求
        if(lpTSCall1Ans5)
        {
          lpTSCall1Ans5->FreeMsg();
        ...
        lpTSCall1Req5=glpFastMsgFactory->CreateFastMessage("tdfutuT.2.23", 0);
        lpTSCall1Req5->SetInt32(LDTAG_PRIORITY, iPriority);
        lpTSCall1Req5->SetInt32(LDBIZ_OPOR_CO_NO_INT,v_opor_co_no);
        lpTSCall1Req5->SetInt32(LDBIZ_OPOR_NO_INT,v_opor_no);
        lpTSCall1Req5->SetString(LDBIZ_OPER_MAC_STR,v_oper_mac);
        ...
        {
            lpOutBizMsg->SetInt32(LDTAG_ERRORNO, -1);
            lpOutBizMsg->SetString(LDTAG_ERRORINFO, "[tdfutuT.2.23]subcall timed out!");
            iRet=-2;
            goto ENDSYS;
        }
        else if(lpTSCall1Ans5->GetInt32(LDTAG_ERRORNO)!=0)  //  中间件层面错误
        ...
        v_margin_amt = lpTSCall1Ans5->GetDouble(LDBIZ_MARGIN_AMT_FLOAT);
        v_capit_bala = lpTSCall1Ans5->GetDouble(LDBIZ_CAPIT_BALA_FLOAT);

        //调用过程[事务_产品期货_资金_更新交易库交易组资金]
        //组织事务请求
        if(lpTSCall1Ans6)
        {
          lpTSCall1Ans6->FreeMsg();
        ...
        lpTSCall1Req6=glpFastMsgFactory->CreateFastMessage("pdfutuT.2.256", 0);
        lpTSCall1Req6->SetInt32(LDTAG_PRIORITY, iPriority);
        lpTSCall1Req6->SetInt32(LDBIZ_OPOR_CO_NO_INT,v_opor_co_no);
        lpTSCall1Req6->SetInt32(LDBIZ_OPOR_NO_INT,v_opor_no);
        lpTSCall1Req6->SetString(LDBIZ_OPER_MAC_STR,v_oper_mac);
        ...
        lpTSCall1Req6->SetDouble(LDBIZ_MARGIN_AMT_FLOAT,v_margin_amt);
        lpTSCall1Req6->SetDouble(LDBIZ_CAPIT_BALA_FLOAT,v_capit_bala);
        glpTSSubcallSerives->SubCall(lpTSCall1Req6, &lpTSCall1Ans6, 5000);
        if(!lpTSCall1Ans6)  //  超时错误
        {
            lpOutBizMsg->SetInt32(LDTAG_ERRORNO, -1);
            lpOutBizMsg->SetString(LDTAG_ERRORINFO, "[pdfutuT.2.256]subcall timed out!");
            iRet=-2;
            goto ENDSYS;
        }
        else if(lpTSCall1Ans6->GetInt32(LDTAG_ERRORNO)!=0)  //  中间件层面错误
...
int iPriority=lpInBizMsg->GetInt32(LDTAG_PRIORITY);
    ...
    lpTSCall1Req1=glpFastMsgFactory->CreateFastMessage("pubT.24.214", 0);
    lpTSCall1Req1->SetInt32(LDTAG_PRIORITY, iPriority);
    lpTSCall1Req1->SetInt32(LDBIZ_OPOR_CO_NO_INT,v_opor_co_no);
    lpTSCall1Req1->SetInt32(LDBIZ_OPOR_NO_INT,v_opor_no);
    lpTSCall1Req1->SetString(LDBIZ_OPER_MAC_STR,v_oper_mac);
    ...
    {
        lpOutBizMsg->SetInt32(LDTAG_ERRORNO, -1);
        lpOutBizMsg->SetString(LDTAG_ERRORINFO, "[pubT.24.214]subcall timed out!");
        iRet=-2;
        goto ENDSYS;
    }
    else if(lpTSCall1Ans1->GetInt32(LDTAG_ERRORNO)!=0)  //  中间件层面错误
    ...
    for (int i = 0; i < iRecordCount;i++) 
    {
      ...
      lpTSCall1Req2=glpFastMsgFactory->CreateFastMessage("pdfutuT.4.8", 0);
      lpTSCall1Req2->SetInt32(LDTAG_PRIORITY, iPriority);
      lpTSCall1Req2->SetInt32(LDBIZ_OPOR_CO_NO_INT,v_opor_co_no);
      lpTSCall1Req2->SetInt32(LDBIZ_OPOR_NO_INT,v_opor_no);
      lpTSCall1Req2->SetString(LDBIZ_OPER_MAC_STR,v_oper_mac);
      ...
      {
          lpOutBizMsg->SetInt32(LDTAG_ERRORNO, -1);
          lpOutBizMsg->SetString(LDTAG_ERRORINFO, "[pdfutuT.4.8]subcall timed out!");
          iRet=-2;
          goto ENDSYS;
      }
      else if(lpTSCall1Ans2->GetInt32(LDTAG_ERRORNO)!=0)  //  中间件层面错误
...
int iPriority=lpInBizMsg->GetInt32(LDTAG_PRIORITY);
    ...
    lpTSCall1Req1=glpFastMsgFactory->CreateFastMessage("tdfutuT.8.80", 0);
    lpTSCall1Req1->SetInt32(LDTAG_PRIORITY, iPriority);
    lpTSCall1Req1->SetInt32(LDBIZ_OPOR_CO_NO_INT,v_opor_co_no);
    lpTSCall1Req1->SetInt32(LDBIZ_OPOR_NO_INT,v_opor_no);
    lpTSCall1Req1->SetString(LDBIZ_OPER_MAC_STR,v_oper_mac);
    ...
    {
        lpOutBizMsg->SetInt32(LDTAG_ERRORNO, -1);
        lpOutBizMsg->SetString(LDTAG_ERRORINFO, "[tdfutuT.8.80]subcall timed out!");
        iRet=-2;
        goto ENDSYS;
    }
    else if(lpTSCall1Ans1->GetInt32(LDTAG_ERRORNO)!=0)  //  中间件层面错误
...
int iPriority=lpInBizMsg->GetInt32(LDTAG_PRIORITY);
    ...
    lpTSCall1Req0=glpFastMsgFactory->CreateFastMessage("tdfutuT.4.27", 0);
    lpTSCall1Req0->SetInt32(LDTAG_PRIORITY, iPriority);
    lpTSCall1Req0->SetInt32(LDBIZ_OPOR_CO_NO_INT,v_opor_co_no);
    lpTSCall1Req0->SetInt32(LDBIZ_OPOR_NO_INT,v_opor_no);
    lpTSCall1Req0->SetString(LDBIZ_OPER_MAC_STR,v_oper_mac);
    ...
    v_report_fee = lpTSCall1Ans0->GetDouble(LDBIZ_REPORT_FEE_FLOAT);
    ...
    v_wtdraw_fee = lpTSCall1Ans0->GetDouble(LDBIZ_WTDRAW_FEE_FLOAT);
    ...
    v_trade_fee = lpTSCall1Ans0->GetDouble(LDBIZ_TRADE_FEE_FLOAT);
    ...
    v_margin_ratio = lpTSCall1Ans0->GetDouble(LDBIZ_MARGIN_RATIO_FLOAT);
    ...
    strcpy(v_futu_acco, lpTSCall1Ans0->GetString(LDBIZ_FUTU_ACCO_STR));
    ...
    lpTSCall1Req1=glpFastMsgFactory->CreateFastMessage("pubT.25.137", 0);
    lpTSCall1Req1->SetInt32(LDTAG_PRIORITY, iPriority);
    lpTSCall1Req1->SetInt32(LDBIZ_OPOR_CO_NO_INT,v_opor_co_no);
    lpTSCall1Req1->SetInt32(LDBIZ_OPOR_NO_INT,v_opor_no);
    lpTSCall1Req1->SetString(LDBIZ_OPER_MAC_STR,v_oper_mac);
    ...
    {
        lpOutBizMsg->SetInt32(LDTAG_ERRORNO, -1);
        lpOutBizMsg->SetString(LDTAG_ERRORINFO, "[pubT.25.137]subcall timed out!");
        iRet=-2;
        goto ENDSYS;
    }
    else if(lpTSCall1Ans1->GetInt32(LDTAG_ERRORNO)!=0)  //  中间件层面错误
    ...
    lpTSCall1Req2=glpFastMsgFactory->CreateFastMessage("prodT.8.108", 0);
    lpTSCall1Req2->SetInt32(LDTAG_PRIORITY, iPriority);
    lpTSCall1Req2->SetInt32(LDBIZ_OPOR_CO_NO_INT,v_opor_co_no);
    lpTSCall1Req2->SetInt32(LDBIZ_OPOR_NO_INT,v_opor_no);
    lpTSCall1Req2->SetString(LDBIZ_OPER_MAC_STR,v_oper_mac);
    ...
    if (v_deal_type ==2)
    {
        ...
        if (strcmp(v_deal_status , "2")==0)
        {
            ...
            // [检查报错返回][ @订单状态# = 《订单状态-未报》 or  @订单状态# = 《订单状态-待报》 or @订单状态# = 《订单状态-正报》][770][@订单方向#,@合约类型#,@订单状态#]
            if ( strcmp(v_order_status , "1")==0 ||  strcmp(v_order_status , "a")==0 || strcmp(v_order_status , "b")==0)
            {
                strcpy(v_error_code, "tdfutuL.8.21.770");
                snprintf(v_error_info, sizeof(v_error_info), "%s%d%s%d%s%s","订单方向=",v_order_dir,"合约类型=",v_contrc_type,"订单状态=",v_order_status);
                iRet = -1;
                goto END;
            }
        ...
        lpTSCall1Req5=glpFastMsgFactory->CreateFastMessage("tdfutuT.5.11", 0);
        lpTSCall1Req5->SetInt32(LDTAG_PRIORITY, iPriority);
        lpTSCall1Req5->SetInt32(LDBIZ_OPOR_CO_NO_INT,v_opor_co_no);
        lpTSCall1Req5->SetInt32(LDBIZ_OPOR_NO_INT,v_opor_no);
        lpTSCall1Req5->SetString(LDBIZ_OPER_MAC_STR,v_oper_mac);
        ...
        lpTSCall1Req5->SetDouble(LDBIZ_WTDRAW_QTY_FLOAT,v_wtdraw_qty);
        ...
        lpTSCall1Req6=glpFastMsgFactory->CreateFastMessage("tdfutuT.4.27", 0);
        lpTSCall1Req6->SetInt32(LDTAG_PRIORITY, iPriority);
        lpTSCall1Req6->SetInt32(LDBIZ_OPOR_CO_NO_INT,v_opor_co_no);
        lpTSCall1Req6->SetInt32(LDBIZ_OPOR_NO_INT,v_opor_no);
        lpTSCall1Req6->SetString(LDBIZ_OPER_MAC_STR,v_oper_mac);
        ...
        v_lngsht_type = lpTSCall1Ans6->GetInt32(LDBIZ_LNGSHT_TYPE_INT);
        ...
        if (v_comm_id > 0)
        {
            ...
            lpTSCall1Req8=glpFastMsgFactory->CreateFastMessage("tdfutuT.3.3", 0);
            lpTSCall1Req8->SetInt32(LDTAG_PRIORITY, iPriority);
            lpTSCall1Req8->SetInt32(LDBIZ_OPOR_CO_NO_INT,v_opor_co_no);
            lpTSCall1Req8->SetInt32(LDBIZ_OPOR_NO_INT,v_opor_no);
            lpTSCall1Req8->SetString(LDBIZ_OPER_MAC_STR,v_oper_mac);
            ...
            v_capit_reback_days = lpTSCall1Ans8->GetInt32(LDBIZ_CAPIT_REBACK_DAYS_INT);
            v_posi_reback_days = lpTSCall1Ans8->GetInt32(LDBIZ_POSI_REBACK_DAYS_INT);
            ...
            v_comm_appr_oper_no = lpTSCall1Ans8->GetInt32(LDBIZ_COMM_APPR_OPER_NO_INT);
    ...
    else if (v_deal_type == 1)
    {
        ...
        if (strcmp(v_deal_status , "2")==0)
        {
            ...
            {
                strcpy(v_error_code, "tdfutuL.8.21.769");
            ...
            lpTSCall1Req12=glpFastMsgFactory->CreateFastMessage("tdfutuT.5.1", 0);
            ...
            lpTSCall1Req12->SetString(LDBIZ_OUT_ACCO_STR,v_out_acco);
            lpTSCall1Req12->SetInt32(LDBIZ_PASS_NO_INT,v_pass_no);
            lpTSCall1Req12->SetInt32(LDBIZ_EXCH_NO_INT,v_exch_no);
            lpTSCall1Req12->SetString(LDBIZ_FUTU_ACCO_STR,v_futu_acco);
            ...
            lpTSCall1Req12->SetInt32(LDBIZ_REPORT_DATE_INT,v_report_date);
            lpTSCall1Req12->SetInt32(LDBIZ_REPORT_TIME_INT,v_report_time);
            lpTSCall1Req12->SetDouble(LDBIZ_PRE_SETTLE_PRICE_FLOAT,v_pre_settle_price);
            lpTSCall1Req12->SetString(LDBIZ_RSP_INFO_STR,v_rsp_info);
            lpTSCall1Req12->SetString(LDBIZ_ORDER_RSP_STATUS_STR,v_order_rsp_status);
            lpTSCall1Req12->SetString(LDBIZ_RSP_STATUS_STR,v_rsp_status);
            lpTSCall1Req12->SetDouble(LDBIZ_EXGP_AVAIL_QTY_FLOAT,v_exgp_avail_qty);
            lpTSCall1Req12->SetDouble(LDBIZ_ASAC_AVAIL_QTY_FLOAT,v_asac_avail_qty);
            lpTSCall1Req12->SetDouble(LDBIZ_EXGP_LONG_RECE_MARGIN_FLOAT,v_exgp_long_rece_margin);
            lpTSCall1Req12->SetDouble(LDBIZ_EXGP_SHORT_RECE_MARGIN_FLOAT,v_exgp_short_rece_margin);
            lpTSCall1Req12->SetDouble(LDBIZ_ASAC_LONG_RECE_MARGIN_FLOAT,v_asac_long_rece_margin);
            lpTSCall1Req12->SetDouble(LDBIZ_ASAC_SHORT_RECE_MARGIN_FLOAT,v_asac_short_rece_margin);
            ...
            v_futu_acco_no = lpTSCall1Ans12->GetInt32(LDBIZ_FUTU_ACCO_NO_INT);
            ...
            v_calc_dir = lpTSCall1Ans12->GetInt32(LDBIZ_CALC_DIR_INT);
            v_occur_qty = lpTSCall1Ans12->GetDouble(LDBIZ_OCCUR_QTY_FLOAT);
            v_occur_amt = lpTSCall1Ans12->GetDouble(LDBIZ_OCCUR_AMT_FLOAT);
            v_comm_id = lpTSCall1Ans12->GetInt64(LDBIZ_COMM_ID_INT64);
            v_comm_batch_no = lpTSCall1Ans12->GetInt32(LDBIZ_COMM_BATCH_NO_INT);
            v_comm_limit_price = lpTSCall1Ans12->GetDouble(LDBIZ_COMM_LIMIT_PRICE_FLOAT);
            ...
            v_order_date = lpTSCall1Ans12->GetInt32(LDBIZ_ORDER_DATE_INT);
            v_order_time = lpTSCall1Ans12->GetInt32(LDBIZ_ORDER_TIME_INT);
            strcpy(v_order_status, lpTSCall1Ans12->GetString(LDBIZ_ORDER_STATUS_STR));
            ...
            v_strike_price = lpTSCall1Ans12->GetDouble(LDBIZ_STRIKE_PRICE_FLOAT);
            ...
            v_strike_fee = lpTSCall1Ans12->GetDouble(LDBIZ_STRIKE_FEE_FLOAT);
            ...
            v_trade_capt_amt = lpTSCall1Ans12->GetDouble(LDBIZ_TRADE_CAPT_AMT_FLOAT);
            v_posi_capt_amt = lpTSCall1Ans12->GetDouble(LDBIZ_POSI_CAPT_AMT_FLOAT);
            ...
            v_margin_ratio = lpTSCall1Ans12->GetDouble(LDBIZ_MARGIN_RATIO_FLOAT);
            v_comm_margin = lpTSCall1Ans12->GetDouble(LDBIZ_COMM_MARGIN_FLOAT);
            ...
            lpTSCall1Req13=glpFastMsgFactory->CreateFastMessage("tdfutuT.4.27", 0);
            ...
            v_report_fee = lpTSCall1Ans13->GetDouble(LDBIZ_REPORT_FEE_FLOAT);
            ...
            v_wtdraw_fee = lpTSCall1Ans13->GetDouble(LDBIZ_WTDRAW_FEE_FLOAT);
            v_wtdraw_qty = lpTSCall1Ans13->GetDouble(LDBIZ_WTDRAW_QTY_FLOAT);
            v_strike_price = lpTSCall1Ans13->GetDouble(LDBIZ_STRIKE_PRICE_FLOAT);
            v_trade_fee = lpTSCall1Ans13->GetDouble(LDBIZ_TRADE_FEE_FLOAT);
            ...
            v_margin_ratio = lpTSCall1Ans13->GetDouble(LDBIZ_MARGIN_RATIO_FLOAT);
            ...
            strcpy(v_futu_acco, lpTSCall1Ans13->GetString(LDBIZ_FUTU_ACCO_STR));
            ...
            if (strcmp(v_rsp_status , "1")!=0)
            {
                ...
                if (v_comm_id > 0)
                {
                    ...
                    lpTSCall1Req15=glpFastMsgFactory->CreateFastMessage("tdfutuT.3.3", 0);
                    ...
                    v_futu_acco_no = lpTSCall1Ans15->GetInt32(LDBIZ_FUTU_ACCO_NO_INT);
                    ...
                    v_capit_reback_days = lpTSCall1Ans15->GetInt32(LDBIZ_CAPIT_REBACK_DAYS_INT);
                    v_posi_reback_days = lpTSCall1Ans15->GetInt32(LDBIZ_POSI_REBACK_DAYS_INT);
                    ...
                    v_comm_appr_oper_no = lpTSCall1Ans15->GetInt32(LDBIZ_COMM_APPR_OPER_NO_INT);
                    ...
                    strcpy(v_comb_code, lpTSCall1Ans15->GetString(LDBIZ_COMB_CODE_STR));
                    ...
                    if (v_comm_batch_no > 0)
                    {
                        ...
                        lpTSCall1Req16=glpFastMsgFactory->CreateFastMessage("tdfutuT.3.4", 0);
                        ...
                        lpTSCall1Req16->SetInt32(LDBIZ_COMM_DATE_INT,v_comm_date);
                        lpTSCall1Req16->SetInt32(LDBIZ_COMM_BATCH_NO_INT,v_comm_batch_no);
                        lpTSCall1Req16->SetInt32(LDBIZ_CO_NO_INT,v_co_no);
                        lpTSCall1Req16->SetInt32(LDBIZ_COMM_EXECUTOR_INT,v_comm_executor);
                        ...
                        v_futu_acco_no = lpTSCall1Ans16->GetInt32(LDBIZ_FUTU_ACCO_NO_INT);
                        v_contrc_code_no = lpTSCall1Ans16->GetInt32(LDBIZ_CONTRC_CODE_NO_INT);
                        strcpy(v_contrc_code, lpTSCall1Ans16->GetString(LDBIZ_CONTRC_CODE_STR));
                        v_contrc_type = lpTSCall1Ans16->GetInt32(LDBIZ_CONTRC_TYPE_INT);
                        v_asset_type = lpTSCall1Ans16->GetInt32(LDBIZ_ASSET_TYPE_INT);
                        v_contrc_dir = lpTSCall1Ans16->GetInt32(LDBIZ_CONTRC_DIR_INT);
                        v_hedge_type = lpTSCall1Ans16->GetInt32(LDBIZ_HEDGE_TYPE_INT);
                        ...
                        v_comm_await_cancel_qty = lpTSCall1Ans16->GetDouble(LDBIZ_COMM_AWAIT_CANCEL_QTY_FLOAT);
                        ...
                        v_max_comm_comple_date = lpTSCall1Ans16->GetInt32(LDBIZ_MAX_COMM_COMPLE_DATE_INT);
                        v_max_comm_comple_time = lpTSCall1Ans16->GetInt32(LDBIZ_MAX_COMM_COMPLE_TIME_INT);
                        ...
                        v_comm_appr_qty = lpTSCall1Ans16->GetDouble(LDBIZ_COMM_APPR_QTY_FLOAT);
                        strcpy(v_comm_sum_approve_status, lpTSCall1Ans16->GetString(LDBIZ_COMM_SUM_APPROVE_STATUS_STR));
                        v_buy_order_qty = lpTSCall1Ans16->GetDouble(LDBIZ_BUY_ORDER_QTY_FLOAT);
                        v_sell_order_qty = lpTSCall1Ans16->GetDouble(LDBIZ_SELL_ORDER_QTY_FLOAT);
                        v_buy_comm_qty = lpTSCall1Ans16->GetDouble(LDBIZ_BUY_COMM_QTY_FLOAT);
                        v_sell_comm_qty = lpTSCall1Ans16->GetDouble(LDBIZ_SELL_COMM_QTY_FLOAT);
                        v_buy_strike_qty = lpTSCall1Ans16->GetDouble(LDBIZ_BUY_STRIKE_QTY_FLOAT);
                        v_sell_strike_qty = lpTSCall1Ans16->GetDouble(LDBIZ_SELL_STRIKE_QTY_FLOAT);
                        v_buy_strike_amt = lpTSCall1Ans16->GetDouble(LDBIZ_BUY_STRIKE_AMT_FLOAT);
                        v_sell_strike_amt = lpTSCall1Ans16->GetDouble(LDBIZ_SELL_STRIKE_AMT_FLOAT);
                        v_buy_comm_amt = lpTSCall1Ans16->GetDouble(LDBIZ_BUY_COMM_AMT_FLOAT);
                        v_sell_comm_amt = lpTSCall1Ans16->GetDouble(LDBIZ_SELL_COMM_AMT_FLOAT);
                        v_rece_margin = lpTSCall1Ans16->GetDouble(LDBIZ_RECE_MARGIN_FLOAT);
               ...
               lpTSCall1Req17=glpFastMsgFactory->CreateFastMessage("tdfutuT.2.11", 0);
               ...
               strcpy(v_error_code, lpTSCall1Ans17->GetString(LDBIZ_ERROR_CODE_STR));
               strcpy(v_error_info, lpTSCall1Ans17->GetString(LDBIZ_ERROR_INFO_STR));
               v_exgp_row_id = lpTSCall1Ans17->GetInt64(LDBIZ_EXGP_ROW_ID_INT64);
               v_co_no = lpTSCall1Ans17->GetInt32(LDBIZ_CO_NO_INT);
               v_pd_no = lpTSCall1Ans17->GetInt32(LDBIZ_PD_NO_INT);
               v_exgp_begin_amt = lpTSCall1Ans17->GetDouble(LDBIZ_EXGP_BEGIN_AMT_FLOAT);
               v_exgp_curr_amt = lpTSCall1Ans17->GetDouble(LDBIZ_EXGP_CURR_AMT_FLOAT);
               ...
               v_exgp_capt_margin = lpTSCall1Ans17->GetDouble(LDBIZ_EXGP_CAPT_MARGIN_FLOAT);
               v_exgp_trade_fee = lpTSCall1Ans17->GetDouble(LDBIZ_EXGP_TRADE_FEE_FLOAT);
               v_exgp_strike_fee = lpTSCall1Ans17->GetDouble(LDBIZ_EXGP_STRIKE_FEE_FLOAT);
               v_exgp_close_pandl = lpTSCall1Ans17->GetDouble(LDBIZ_EXGP_CLOSE_PANDL_FLOAT);
               v_exgp_marked_pandl = lpTSCall1Ans17->GetDouble(LDBIZ_EXGP_MARKED_PANDL_FLOAT);
               v_exgp_cash_update_times = lpTSCall1Ans17->GetInt32(LDBIZ_EXGP_CASH_UPDATE_TIMES_INT);
               v_asac_row_id = lpTSCall1Ans17->GetInt64(LDBIZ_ASAC_ROW_ID_INT64);
               v_asac_begin_amt = lpTSCall1Ans17->GetDouble(LDBIZ_ASAC_BEGIN_AMT_FLOAT);
               v_asac_curr_amt = lpTSCall1Ans17->GetDouble(LDBIZ_ASAC_CURR_AMT_FLOAT);
               ...
               v_asac_capt_margin = lpTSCall1Ans17->GetDouble(LDBIZ_ASAC_CAPT_MARGIN_FLOAT);
               v_asac_trade_fee = lpTSCall1Ans17->GetDouble(LDBIZ_ASAC_TRADE_FEE_FLOAT);
               v_asac_strike_fee = lpTSCall1Ans17->GetDouble(LDBIZ_ASAC_STRIKE_FEE_FLOAT);
               v_asac_close_pandl = lpTSCall1Ans17->GetDouble(LDBIZ_ASAC_CLOSE_PANDL_FLOAT);
               v_asac_marked_pandl = lpTSCall1Ans17->GetDouble(LDBIZ_ASAC_MARKED_PANDL_FLOAT);
               ...
               lpTSCall1Req18=glpFastMsgFactory->CreateFastMessage("tdfutuT.2.12", 0);
               ...
               lpTSCall1Req18->SetInt32(LDBIZ_LNGSHT_TYPE_INT,v_lngsht_type);
               lpTSCall1Req18->SetInt32(LDBIZ_HEDGE_TYPE_INT,v_hedge_type);
               lpTSCall1Req18->SetInt32(LDBIZ_FUTU_ACCO_NO_INT,v_futu_acco_no);
               lpTSCall1Req18->SetInt32(LDBIZ_CONTRC_CODE_NO_INT,v_contrc_code_no);
               ...
               strcpy(v_error_code, lpTSCall1Ans18->GetString(LDBIZ_ERROR_CODE_STR));
               strcpy(v_error_info, lpTSCall1Ans18->GetString(LDBIZ_ERROR_INFO_STR));
               v_exgp_row_id = lpTSCall1Ans18->GetInt64(LDBIZ_EXGP_ROW_ID_INT64);
               ...
               strcpy(v_comb_code, lpTSCall1Ans18->GetString(LDBIZ_COMB_CODE_STR));
               ...
               v_exgp_old_comm_capt_qty = lpTSCall1Ans18->GetDouble(LDBIZ_EXGP_OLD_COMM_CAPT_QTY_FLOAT);
               v_exgp_today_comm_capt_qty = lpTSCall1Ans18->GetDouble(LDBIZ_EXGP_TODAY_COMM_CAPT_QTY_FLOAT);
               v_exgp_old_trade_capt_qty = lpTSCall1Ans18->GetDouble(LDBIZ_EXGP_OLD_TRADE_CAPT_QTY_FLOAT);
               v_exgp_today_trade_capt_qty = lpTSCall1Ans18->GetDouble(LDBIZ_EXGP_TODAY_TRADE_CAPT_QTY_FLOAT);
               v_exgp_pre_strike_capt_qty = lpTSCall1Ans18->GetDouble(LDBIZ_EXGP_PRE_STRIKE_CAPT_QTY_FLOAT);
               v_exgp_today_strike_capt_qty = lpTSCall1Ans18->GetDouble(LDBIZ_EXGP_TODAY_STRIKE_CAPT_QTY_FLOAT);
               v_exgp_rece_margin = lpTSCall1Ans18->GetDouble(LDBIZ_EXGP_RECE_MARGIN_FLOAT);
               v_pre_settle_price = lpTSCall1Ans18->GetDouble(LDBIZ_PRE_SETTLE_PRICE_FLOAT);
               v_exgp_realize_pandl = lpTSCall1Ans18->GetDouble(LDBIZ_EXGP_REALIZE_PANDL_FLOAT);
               v_exgp_open_amount = lpTSCall1Ans18->GetDouble(LDBIZ_EXGP_OPEN_AMOUNT_FLOAT);
               v_exgp_posi_update_times = lpTSCall1Ans18->GetInt32(LDBIZ_EXGP_POSI_UPDATE_TIMES_INT);
               v_asac_row_id = lpTSCall1Ans18->GetInt64(LDBIZ_ASAC_ROW_ID_INT64);
               ...
               v_asac_old_comm_capt_qty = lpTSCall1Ans18->GetDouble(LDBIZ_ASAC_OLD_COMM_CAPT_QTY_FLOAT);
               v_asac_today_comm_capt_qty = lpTSCall1Ans18->GetDouble(LDBIZ_ASAC_TODAY_COMM_CAPT_QTY_FLOAT);
               v_asac_old_trade_capt_qty = lpTSCall1Ans18->GetDouble(LDBIZ_ASAC_OLD_TRADE_CAPT_QTY_FLOAT);
               v_asac_today_trade_capt_qty = lpTSCall1Ans18->GetDouble(LDBIZ_ASAC_TODAY_TRADE_CAPT_QTY_FLOAT);
               v_asac_pre_strike_capt_qty = lpTSCall1Ans18->GetDouble(LDBIZ_ASAC_PRE_STRIKE_CAPT_QTY_FLOAT);
               v_asac_today_strike_capt_qty = lpTSCall1Ans18->GetDouble(LDBIZ_ASAC_TODAY_STRIKE_CAPT_QTY_FLOAT);
               v_asac_rece_margin = lpTSCall1Ans18->GetDouble(LDBIZ_ASAC_RECE_MARGIN_FLOAT);
               v_asac_realize_pandl = lpTSCall1Ans18->GetDouble(LDBIZ_ASAC_REALIZE_PANDL_FLOAT);
               v_asac_open_amount = lpTSCall1Ans18->GetDouble(LDBIZ_ASAC_OPEN_AMOUNT_FLOAT);
        ...
        else
        {
            ...
            {
                strcpy(v_error_code, "tdfutuL.8.21.771");
                snprintf(v_error_info, sizeof(v_error_info), "%s%s","订单状态=",v_order_status);
                iRet = -1;
                goto END;
            }
           ...
           //对未报、待报、正报的订单 不拦截，填report_date、report_id的操作。Modify by wjp 20180928
            ...
            if (strcmp(v_order_status , "1")==0 ||  strcmp(v_order_status , "a")==0 ||  strcmp(v_order_status , "b")==0)
            {
                ...
                lpTSCall1Req19=glpFastMsgFactory->CreateFastMessage("tdfutuT.5.1", 0);
                ...
                lpTSCall1Req19->SetString(LDBIZ_FUTU_ACCO_STR,v_futu_acco);
                lpTSCall1Req19->SetString(LDBIZ_CONTRC_CODE_STR,v_contrc_code);
                lpTSCall1Req19->SetInt32(LDBIZ_CONTRC_DIR_INT,v_contrc_dir);
                lpTSCall1Req19->SetInt32(LDBIZ_LNGSHT_TYPE_INT,v_lngsht_type);
                ...
                lpTSCall1Req19->SetInt32(LDBIZ_REPORT_TIME_INT,v_report_time);
                lpTSCall1Req19->SetDouble(LDBIZ_PRE_SETTLE_PRICE_FLOAT,v_pre_settle_price);
                lpTSCall1Req19->SetString(LDBIZ_RSP_INFO_STR,v_rsp_info);
                lpTSCall1Req19->SetString(LDBIZ_ORDER_RSP_STATUS_STR,v_order_rsp_status);
                lpTSCall1Req19->SetString(LDBIZ_RSP_STATUS_STR,v_rsp_status);
                ...
                lpTSCall1Req19->SetDouble(LDBIZ_EXGP_LONG_RECE_MARGIN_FLOAT,v_exgp_long_rece_margin);
                lpTSCall1Req19->SetDouble(LDBIZ_EXGP_SHORT_RECE_MARGIN_FLOAT,v_exgp_short_rece_margin);
                lpTSCall1Req19->SetDouble(LDBIZ_ASAC_LONG_RECE_MARGIN_FLOAT,v_asac_long_rece_margin);
                lpTSCall1Req19->SetDouble(LDBIZ_ASAC_SHORT_RECE_MARGIN_FLOAT,v_asac_short_rece_margin);
                ...
                v_futu_acco_no = lpTSCall1Ans19->GetInt32(LDBIZ_FUTU_ACCO_NO_INT);
                v_contrc_code_no = lpTSCall1Ans19->GetInt32(LDBIZ_CONTRC_CODE_NO_INT);
                v_external_no = lpTSCall1Ans19->GetInt64(LDBIZ_EXTERNAL_NO_INT64);
                v_asset_type = lpTSCall1Ans19->GetInt32(LDBIZ_ASSET_TYPE_INT);
                v_contrc_type = lpTSCall1Ans19->GetInt32(LDBIZ_CONTRC_TYPE_INT);
                v_contrc_unit = lpTSCall1Ans19->GetInt32(LDBIZ_CONTRC_UNIT_INT);
                v_calc_dir = lpTSCall1Ans19->GetInt32(LDBIZ_CALC_DIR_INT);
                v_occur_qty = lpTSCall1Ans19->GetDouble(LDBIZ_OCCUR_QTY_FLOAT);
                v_occur_amt = lpTSCall1Ans19->GetDouble(LDBIZ_OCCUR_AMT_FLOAT);
                v_comm_id = lpTSCall1Ans19->GetInt64(LDBIZ_COMM_ID_INT64);
                v_comm_batch_no = lpTSCall1Ans19->GetInt32(LDBIZ_COMM_BATCH_NO_INT);
                v_comm_limit_price = lpTSCall1Ans19->GetDouble(LDBIZ_COMM_LIMIT_PRICE_FLOAT);
                strcpy(v_crncy_type, lpTSCall1Ans19->GetString(LDBIZ_CRNCY_TYPE_STR));
                v_hedge_type = lpTSCall1Ans19->GetInt32(LDBIZ_HEDGE_TYPE_INT);
                ...
                v_order_price = lpTSCall1Ans19->GetDouble(LDBIZ_ORDER_PRICE_FLOAT);
                ...
                v_strike_price = lpTSCall1Ans19->GetDouble(LDBIZ_STRIKE_PRICE_FLOAT);
                v_strike_amt = lpTSCall1Ans19->GetDouble(LDBIZ_STRIKE_AMT_FLOAT);
                v_report_fee = lpTSCall1Ans19->GetDouble(LDBIZ_REPORT_FEE_FLOAT);
                v_wtdraw_fee = lpTSCall1Ans19->GetDouble(LDBIZ_WTDRAW_FEE_FLOAT);
                v_trade_fee = lpTSCall1Ans19->GetDouble(LDBIZ_TRADE_FEE_FLOAT);
                v_strike_fee = lpTSCall1Ans19->GetDouble(LDBIZ_STRIKE_FEE_FLOAT);
                v_all_fee = lpTSCall1Ans19->GetDouble(LDBIZ_ALL_FEE_FLOAT);
                v_trade_commis = lpTSCall1Ans19->GetDouble(LDBIZ_TRADE_COMMIS_FLOAT);
                v_other_commis = lpTSCall1Ans19->GetDouble(LDBIZ_OTHER_COMMIS_FLOAT);
                v_trade_capt_amt = lpTSCall1Ans19->GetDouble(LDBIZ_TRADE_CAPT_AMT_FLOAT);
                v_posi_capt_amt = lpTSCall1Ans19->GetDouble(LDBIZ_POSI_CAPT_AMT_FLOAT);
                strcpy(v_comb_code, lpTSCall1Ans19->GetString(LDBIZ_COMB_CODE_STR));
                v_rece_margin = lpTSCall1Ans19->GetDouble(LDBIZ_RECE_MARGIN_FLOAT);
                v_margin_ratio = lpTSCall1Ans19->GetDouble(LDBIZ_MARGIN_RATIO_FLOAT);
                v_comm_margin = lpTSCall1Ans19->GetDouble(LDBIZ_COMM_MARGIN_FLOAT);
                v_compli_trig_id = lpTSCall1Ans19->GetInt64(LDBIZ_COMPLI_TRIG_ID_INT64);
            ...
            lpTSCall1Req20=glpFastMsgFactory->CreateFastMessage("pubT.25.230", 0);
            ...
            lpTSCall1Req20->SetString(LDBIZ_CONTRC_CODE_STR,v_contrc_code);
            ...
            strcpy(v_crncy_type, lpTSCall1Ans20->GetString(LDBIZ_CRNCY_TYPE_STR));
            ...
            lpTSCall1Req21=glpFastMsgFactory->CreateFastMessage("tdfutuT.5.31", 0);
            ...
            lpTSCall1Req21->SetString(LDBIZ_FUTU_ACCO_STR,v_futu_acco);
            lpTSCall1Req21->SetString(LDBIZ_CONTRC_CODE_STR,v_contrc_code);
            lpTSCall1Req21->SetInt32(LDBIZ_CONTRC_DIR_INT,v_contrc_dir);
            ...
            v_futu_acco_no = lpTSCall1Ans21->GetInt32(LDBIZ_FUTU_ACCO_NO_INT);
            v_contrc_code_no = lpTSCall1Ans21->GetInt32(LDBIZ_CONTRC_CODE_NO_INT);
            v_contrc_type = lpTSCall1Ans21->GetInt32(LDBIZ_CONTRC_TYPE_INT);
            v_contrc_unit = lpTSCall1Ans21->GetInt32(LDBIZ_CONTRC_UNIT_INT);
            v_order_date = lpTSCall1Ans21->GetInt32(LDBIZ_ORDER_DATE_INT);
            v_order_id = lpTSCall1Ans21->GetInt64(LDBIZ_ORDER_ID_INT64);
            v_rsp_time = lpTSCall1Ans21->GetInt32(LDBIZ_RSP_TIME_INT);
            v_rsp_no = lpTSCall1Ans21->GetInt32(LDBIZ_RSP_NO_INT);
            strcpy(v_comb_code, lpTSCall1Ans21->GetString(LDBIZ_COMB_CODE_STR));
            ...
            v_hedge_type = lpTSCall1Ans21->GetInt32(LDBIZ_HEDGE_TYPE_INT);
            ...
            lpTSCall1Req22=glpFastMsgFactory->CreateFastMessage("pubT.24.254", 0);
            ...
            lpTSCall1Req22->SetInt32(LDBIZ_CONTRC_TYPE_INT,v_contrc_type);
            lpTSCall1Req22->SetInt32(LDBIZ_ORDER_DIR_INT,v_order_dir);
            lpTSCall1Req22->SetInt32(LDBIZ_CONTRC_DIR_INT,v_contrc_dir);
            ...
            lpTSCall1Req22->SetInt32(LDBIZ_CONTRC_UNIT_INT,v_contrc_unit);
            ...
            strcpy(v_error_code, lpTSCall1Ans22->GetString(LDBIZ_ERROR_CODE_STR));
            strcpy(v_error_info, lpTSCall1Ans22->GetString(LDBIZ_ERROR_INFO_STR));
            v_strike_margin = lpTSCall1Ans22->GetDouble(LDBIZ_STRIKE_MARGIN_FLOAT);
            ...
            v_strike_fee = lpTSCall1Ans22->GetDouble(LDBIZ_STRIKE_FEE_FLOAT);
            v_margin_ratio = lpTSCall1Ans22->GetDouble(LDBIZ_MARGIN_RATIO_FLOAT);
            ...
            lpTSCall1Req23=glpFastMsgFactory->CreateFastMessage("tdfutuT.5.21", 0);
            ...
            lpTSCall1Req23->SetString(LDBIZ_OUT_ACCO_STR,v_out_acco);
            ...
            lpTSCall1Req23->SetString(LDBIZ_FUTU_ACCO_STR,v_futu_acco);
            lpTSCall1Req23->SetString(LDBIZ_CONTRC_CODE_STR,v_contrc_code);
            lpTSCall1Req23->SetInt32(LDBIZ_CONTRC_UNIT_INT,v_contrc_unit);
            lpTSCall1Req23->SetInt32(LDBIZ_CONTRC_TYPE_INT,v_contrc_type);
            lpTSCall1Req23->SetInt32(LDBIZ_LNGSHT_TYPE_INT,v_lngsht_type);
            lpTSCall1Req23->SetInt32(LDBIZ_HEDGE_TYPE_INT,v_hedge_type);
            lpTSCall1Req23->SetInt32(LDBIZ_REPORT_DATE_INT,v_report_date);
            lpTSCall1Req23->SetString(LDBIZ_REPORT_NO_STR,v_report_no);
            lpTSCall1Req23->SetInt64(LDBIZ_ORDER_ID_INT64,v_order_id);
            lpTSCall1Req23->SetInt32(LDBIZ_ORDER_DIR_INT,v_order_dir);
            lpTSCall1Req23->SetInt32(LDBIZ_CONTRC_DIR_INT,v_contrc_dir);
            lpTSCall1Req23->SetDouble(LDBIZ_STRIKE_PRICE_FLOAT,v_strike_price);
            lpTSCall1Req23->SetInt32(LDBIZ_STRIKE_DATE_INT,v_strike_date);
            lpTSCall1Req23->SetInt32(LDBIZ_STRIKE_TIME_INT,v_strike_time);
            lpTSCall1Req23->SetString(LDBIZ_STRIKE_NO_STR,v_strike_no);
            lpTSCall1Req23->SetDouble(LDBIZ_STRIKE_QTY_FLOAT,v_strike_qty);
            lpTSCall1Req23->SetDouble(LDBIZ_STRIKE_AMT_FLOAT,v_strike_amt);
            lpTSCall1Req23->SetDouble(LDBIZ_STRIKE_FEE_FLOAT,v_strike_fee);
            lpTSCall1Req23->SetDouble(LDBIZ_TRADE_COMMIS_FLOAT,v_trade_commis);
            lpTSCall1Req23->SetDouble(LDBIZ_OTHER_COMMIS_FLOAT,v_other_commis);
            lpTSCall1Req23->SetString(LDBIZ_RSP_INFO_STR,v_rsp_info);
            lpTSCall1Req23->SetInt32(LDBIZ_RSP_NO_INT,v_rsp_no);
            lpTSCall1Req23->SetDouble(LDBIZ_PRE_SETTLE_PRICE_FLOAT,v_pre_settle_price);
            lpTSCall1Req23->SetDouble(LDBIZ_STRIKE_MARGIN_FLOAT,v_strike_margin);
            lpTSCall1Req23->SetDouble(LDBIZ_EXGP_LONG_RECE_MARGIN_FLOAT,v_exgp_long_rece_margin);
            lpTSCall1Req23->SetDouble(LDBIZ_EXGP_SHORT_RECE_MARGIN_FLOAT,v_exgp_short_rece_margin);
            lpTSCall1Req23->SetDouble(LDBIZ_ASAC_LONG_RECE_MARGIN_FLOAT,v_asac_long_rece_margin);
            lpTSCall1Req23->SetDouble(LDBIZ_ASAC_SHORT_RECE_MARGIN_FLOAT,v_asac_short_rece_margin);
            lpTSCall1Req23->SetDouble(LDBIZ_EXGP_AVAIL_QTY_FLOAT,v_exgp_avail_qty);
            lpTSCall1Req23->SetDouble(LDBIZ_ASAC_AVAIL_QTY_FLOAT,v_asac_avail_qty);
            lpTSCall1Req23->SetString(LDBIZ_COMB_CODE_STR,v_comb_code);
            lpTSCall1Req23->SetInt32(LDBIZ_EXCH_GROUP_NO_INT,v_exch_group_no);
            lpTSCall1Req23->SetDouble(LDBIZ_EXGP_LONG_STOCK_RECE_MARGIN_FLOAT,v_exgp_long_stock_rece_margin);
            lpTSCall1Req23->SetDouble(LDBIZ_EXGP_SHORT_STOCK_RECE_MARGIN_FLOAT,v_exgp_short_stock_rece_margin);
            ...
            strcpy(v_error_code, lpTSCall1Ans23->GetString(LDBIZ_ERROR_CODE_STR));
            strcpy(v_error_info, lpTSCall1Ans23->GetString(LDBIZ_ERROR_INFO_STR));
            v_mach_date = lpTSCall1Ans23->GetInt32(LDBIZ_MACH_DATE_INT);
            v_mach_time = lpTSCall1Ans23->GetInt32(LDBIZ_MACH_TIME_INT);
            ...
            v_external_no = lpTSCall1Ans23->GetInt64(LDBIZ_EXTERNAL_NO_INT64);
            v_calc_dir = lpTSCall1Ans23->GetInt32(LDBIZ_CALC_DIR_INT);
            v_asset_type = lpTSCall1Ans23->GetInt32(LDBIZ_ASSET_TYPE_INT);
            v_invest_type = lpTSCall1Ans23->GetInt32(LDBIZ_INVEST_TYPE_INT);
            v_report_time = lpTSCall1Ans23->GetInt32(LDBIZ_REPORT_TIME_INT);
            v_order_date = lpTSCall1Ans23->GetInt32(LDBIZ_ORDER_DATE_INT);
            v_order_time = lpTSCall1Ans23->GetInt32(LDBIZ_ORDER_TIME_INT);
            v_order_qty = lpTSCall1Ans23->GetDouble(LDBIZ_ORDER_QTY_FLOAT);
            v_order_price = lpTSCall1Ans23->GetDouble(LDBIZ_ORDER_PRICE_FLOAT);
            strcpy(v_order_status, lpTSCall1Ans23->GetString(LDBIZ_ORDER_STATUS_STR));
            v_order_batch_no = lpTSCall1Ans23->GetInt32(LDBIZ_ORDER_BATCH_NO_INT);
            v_wtdraw_qty = lpTSCall1Ans23->GetDouble(LDBIZ_WTDRAW_QTY_FLOAT);
            v_record_count = lpTSCall1Ans23->GetInt32(LDBIZ_RECORD_COUNT_INT);
            v_strike_id = lpTSCall1Ans23->GetInt64(LDBIZ_STRIKE_ID_INT64);
            v_report_fee = lpTSCall1Ans23->GetDouble(LDBIZ_REPORT_FEE_FLOAT);
            v_wtdraw_fee = lpTSCall1Ans23->GetDouble(LDBIZ_WTDRAW_FEE_FLOAT);
            v_trade_fee = lpTSCall1Ans23->GetDouble(LDBIZ_TRADE_FEE_FLOAT);
            v_all_fee = lpTSCall1Ans23->GetDouble(LDBIZ_ALL_FEE_FLOAT);
            v_posi_qty = lpTSCall1Ans23->GetDouble(LDBIZ_POSI_QTY_FLOAT);
            v_rece_margin = lpTSCall1Ans23->GetDouble(LDBIZ_RECE_MARGIN_FLOAT);
            v_margin_ratio = lpTSCall1Ans23->GetDouble(LDBIZ_MARGIN_RATIO_FLOAT);
            v_trade_capt_amt = lpTSCall1Ans23->GetDouble(LDBIZ_TRADE_CAPT_AMT_FLOAT);
            v_posi_capt_amt = lpTSCall1Ans23->GetDouble(LDBIZ_POSI_CAPT_AMT_FLOAT);
            v_strike_occur_amt = lpTSCall1Ans23->GetDouble(LDBIZ_STRIKE_OCCUR_AMT_FLOAT);
            v_realize_pandl = lpTSCall1Ans23->GetDouble(LDBIZ_REALIZE_PANDL_FLOAT);
            v_close_pandl = lpTSCall1Ans23->GetDouble(LDBIZ_CLOSE_PANDL_FLOAT);
            v_order_margin = lpTSCall1Ans23->GetDouble(LDBIZ_ORDER_MARGIN_FLOAT);
            v_detail_posi_id = lpTSCall1Ans23->GetInt64(LDBIZ_DETAIL_POSI_ID_INT64);
            v_compli_trig_id = lpTSCall1Ans23->GetInt64(LDBIZ_COMPLI_TRIG_ID_INT64);
            v_order_update_times = lpTSCall1Ans23->GetInt32(LDBIZ_ORDER_UPDATE_TIMES_INT);
            strcpy(v_order_oper_way, lpTSCall1Ans23->GetString(LDBIZ_ORDER_OPER_WAY_STR));
            v_update_times = lpTSCall1Ans23->GetInt32(LDBIZ_UPDATE_TIMES_INT);
            v_busi_opor_no = lpTSCall1Ans23->GetInt32(LDBIZ_BUSI_OPOR_NO_INT);
            ...
            lpTSCall1Req24=glpFastMsgFactory->CreateFastMessage("tdfutuT.4.27", 0);
            ...
            v_co_no = lpTSCall1Ans24->GetInt32(LDBIZ_CO_NO_INT);
            ...
            v_futu_acco_no = lpTSCall1Ans24->GetInt32(LDBIZ_FUTU_ACCO_NO_INT);
            ...
            v_order_time = lpTSCall1Ans24->GetInt32(LDBIZ_ORDER_TIME_INT);
            v_order_price = lpTSCall1Ans24->GetDouble(LDBIZ_ORDER_PRICE_FLOAT);
            v_order_qty = lpTSCall1Ans24->GetDouble(LDBIZ_ORDER_QTY_FLOAT);
            strcpy(v_order_status, lpTSCall1Ans24->GetString(LDBIZ_ORDER_STATUS_STR));
            ...
            v_strike_price = lpTSCall1Ans24->GetDouble(LDBIZ_STRIKE_PRICE_FLOAT);
            ...
            v_comm_id = lpTSCall1Ans24->GetInt64(LDBIZ_COMM_ID_INT64);
            v_comm_batch_no = lpTSCall1Ans24->GetInt32(LDBIZ_COMM_BATCH_NO_INT);
            strcpy(v_comb_code, lpTSCall1Ans24->GetString(LDBIZ_COMB_CODE_STR));
            v_rece_margin = lpTSCall1Ans24->GetDouble(LDBIZ_RECE_MARGIN_FLOAT);
            v_margin_ratio = lpTSCall1Ans24->GetDouble(LDBIZ_MARGIN_RATIO_FLOAT);
            v_compli_trig_id = lpTSCall1Ans24->GetInt64(LDBIZ_COMPLI_TRIG_ID_INT64);
            v_order_batch_no = lpTSCall1Ans24->GetInt32(LDBIZ_ORDER_BATCH_NO_INT);
            ...
            strcpy(v_out_acco, lpTSCall1Ans24->GetString(LDBIZ_OUT_ACCO_STR));
            v_exch_no = lpTSCall1Ans24->GetInt32(LDBIZ_EXCH_NO_INT);
            strcpy(v_futu_acco, lpTSCall1Ans24->GetString(LDBIZ_FUTU_ACCO_STR));
            strcpy(v_contrc_code, lpTSCall1Ans24->GetString(LDBIZ_CONTRC_CODE_STR));
            v_report_time = lpTSCall1Ans24->GetInt32(LDBIZ_REPORT_TIME_INT);
            strcpy(v_report_no, lpTSCall1Ans24->GetString(LDBIZ_REPORT_NO_STR));
            v_lngsht_type = lpTSCall1Ans24->GetInt32(LDBIZ_LNGSHT_TYPE_INT);
            v_report_date = lpTSCall1Ans24->GetInt32(LDBIZ_REPORT_DATE_INT);
            strcpy(v_rsp_info, lpTSCall1Ans24->GetString(LDBIZ_RSP_INFO_STR));
            v_busi_opor_no = lpTSCall1Ans24->GetInt32(LDBIZ_BUSI_OPOR_NO_INT);
            ...
            if (v_order_batch_no>0)
            {
                ...
                lpTSCall1Req25=glpFastMsgFactory->CreateFastMessage("tdfutuT.4.19", 0);
                ...
                strcpy(v_oper_func_code, lpTSCall1Ans25->GetString(LDBIZ_OPER_FUNC_CODE_STR));
                v_init_date = lpTSCall1Ans25->GetInt32(LDBIZ_INIT_DATE_INT);
                v_pd_no = lpTSCall1Ans25->GetInt32(LDBIZ_PD_NO_INT);
                v_exch_group_no = lpTSCall1Ans25->GetInt32(LDBIZ_EXCH_GROUP_NO_INT);
                v_asset_acco_no = lpTSCall1Ans25->GetInt32(LDBIZ_ASSET_ACCO_NO_INT);
                v_pass_no = lpTSCall1Ans25->GetInt32(LDBIZ_PASS_NO_INT);
                strcpy(v_crncy_type, lpTSCall1Ans25->GetString(LDBIZ_CRNCY_TYPE_STR));
                v_exch_no = lpTSCall1Ans25->GetInt32(LDBIZ_EXCH_NO_INT);
                v_contrc_code_no = lpTSCall1Ans25->GetInt32(LDBIZ_CONTRC_CODE_NO_INT);
                strcpy(v_contrc_code, lpTSCall1Ans25->GetString(LDBIZ_CONTRC_CODE_STR));
                v_asset_type = lpTSCall1Ans25->GetInt32(LDBIZ_ASSET_TYPE_INT);
                v_contrc_type = lpTSCall1Ans25->GetInt32(LDBIZ_CONTRC_TYPE_INT);
                v_contrc_unit = lpTSCall1Ans25->GetInt32(LDBIZ_CONTRC_UNIT_INT);
                v_external_no = lpTSCall1Ans25->GetInt64(LDBIZ_EXTERNAL_NO_INT64);
                v_order_dir = lpTSCall1Ans25->GetInt32(LDBIZ_ORDER_DIR_INT);
                v_contrc_dir = lpTSCall1Ans25->GetInt32(LDBIZ_CONTRC_DIR_INT);
                v_hedge_type = lpTSCall1Ans25->GetInt32(LDBIZ_HEDGE_TYPE_INT);
                v_order_price = lpTSCall1Ans25->GetDouble(LDBIZ_ORDER_PRICE_FLOAT);
                v_order_qty = lpTSCall1Ans25->GetDouble(LDBIZ_ORDER_QTY_FLOAT);
                strcpy(v_order_sum_status, lpTSCall1Ans25->GetString(LDBIZ_ORDER_SUM_STATUS_STR));
                v_wtdraw_qty = lpTSCall1Ans25->GetDouble(LDBIZ_WTDRAW_QTY_FLOAT);
                v_waste_qty = lpTSCall1Ans25->GetDouble(LDBIZ_WASTE_QTY_FLOAT);
                v_strike_qty = lpTSCall1Ans25->GetDouble(LDBIZ_STRIKE_QTY_FLOAT);
                v_strike_aver_price = lpTSCall1Ans25->GetDouble(LDBIZ_STRIKE_AVER_PRICE_FLOAT);
                v_strike_amt = lpTSCall1Ans25->GetDouble(LDBIZ_STRIKE_AMT_FLOAT);
                v_trade_fee = lpTSCall1Ans25->GetDouble(LDBIZ_TRADE_FEE_FLOAT);
                ...
                v_strike_commis = lpTSCall1Ans25->GetDouble(LDBIZ_STRIKE_COMMIS_FLOAT);
                v_strike_other_commis = lpTSCall1Ans25->GetDouble(LDBIZ_STRIKE_OTHER_COMMIS_FLOAT);
                v_report_fee = lpTSCall1Ans25->GetDouble(LDBIZ_REPORT_FEE_FLOAT);
                v_wtdraw_fee = lpTSCall1Ans25->GetDouble(LDBIZ_WTDRAW_FEE_FLOAT);
                v_strike_all_fee = lpTSCall1Ans25->GetDouble(LDBIZ_STRIKE_ALL_FEE_FLOAT);
                v_rece_margin = lpTSCall1Ans25->GetDouble(LDBIZ_RECE_MARGIN_FLOAT);
                strcpy(v_order_oper_way, lpTSCall1Ans25->GetString(LDBIZ_ORDER_OPER_WAY_STR));
            ...
            if (v_comm_id > 0)
            {
                ...
                lpTSCall1Req26=glpFastMsgFactory->CreateFastMessage("tdfutuT.3.3", 0);
                ...
                strcpy(v_error_code, lpTSCall1Ans26->GetString(LDBIZ_ERROR_CODE_STR));
                strcpy(v_error_info, lpTSCall1Ans26->GetString(LDBIZ_ERROR_INFO_STR));
                v_row_id = lpTSCall1Ans26->GetInt64(LDBIZ_ROW_ID_INT64);
                ...
                v_futu_acco_no = lpTSCall1Ans26->GetInt32(LDBIZ_FUTU_ACCO_NO_INT);
                v_contrc_code_no = lpTSCall1Ans26->GetInt32(LDBIZ_CONTRC_CODE_NO_INT);
                strcpy(v_contrc_code, lpTSCall1Ans26->GetString(LDBIZ_CONTRC_CODE_STR));
                v_contrc_type = lpTSCall1Ans26->GetInt32(LDBIZ_CONTRC_TYPE_INT);
                v_asset_type = lpTSCall1Ans26->GetInt32(LDBIZ_ASSET_TYPE_INT);
                v_contrc_dir = lpTSCall1Ans26->GetInt32(LDBIZ_CONTRC_DIR_INT);
                v_hedge_type = lpTSCall1Ans26->GetInt32(LDBIZ_HEDGE_TYPE_INT);
                v_comm_date = lpTSCall1Ans26->GetInt32(LDBIZ_COMM_DATE_INT);
                v_comm_time = lpTSCall1Ans26->GetInt32(LDBIZ_COMM_TIME_INT);
                v_comm_batch_no = lpTSCall1Ans26->GetInt32(LDBIZ_COMM_BATCH_NO_INT);
                v_comm_opor = lpTSCall1Ans26->GetInt32(LDBIZ_COMM_OPOR_INT);
                v_comm_executor = lpTSCall1Ans26->GetInt32(LDBIZ_COMM_EXECUTOR_INT);
                v_comm_dir = lpTSCall1Ans26->GetInt32(LDBIZ_COMM_DIR_INT);
                v_comm_limit_price = lpTSCall1Ans26->GetDouble(LDBIZ_COMM_LIMIT_PRICE_FLOAT);
                v_limit_actual_price = lpTSCall1Ans26->GetDouble(LDBIZ_LIMIT_ACTUAL_PRICE_FLOAT);
                v_comm_qty = lpTSCall1Ans26->GetDouble(LDBIZ_COMM_QTY_FLOAT);
                v_comm_amt = lpTSCall1Ans26->GetDouble(LDBIZ_COMM_AMT_FLOAT);
                v_order_qty = lpTSCall1Ans26->GetDouble(LDBIZ_ORDER_QTY_FLOAT);
                v_comm_cancel_qty = lpTSCall1Ans26->GetDouble(LDBIZ_COMM_CANCEL_QTY_FLOAT);
                v_strike_amt = lpTSCall1Ans26->GetDouble(LDBIZ_STRIKE_AMT_FLOAT);
                v_strike_qty = lpTSCall1Ans26->GetDouble(LDBIZ_STRIKE_QTY_FLOAT);
                v_comm_frozen_amt = lpTSCall1Ans26->GetDouble(LDBIZ_COMM_FROZEN_AMT_FLOAT);
                v_comm_frozen_qty = lpTSCall1Ans26->GetDouble(LDBIZ_COMM_FROZEN_QTY_FLOAT);
                v_rece_margin = lpTSCall1Ans26->GetDouble(LDBIZ_RECE_MARGIN_FLOAT);
                v_capit_reback_days = lpTSCall1Ans26->GetInt32(LDBIZ_CAPIT_REBACK_DAYS_INT);
                v_posi_reback_days = lpTSCall1Ans26->GetInt32(LDBIZ_POSI_REBACK_DAYS_INT);
                strcpy(v_strike_status, lpTSCall1Ans26->GetString(LDBIZ_STRIKE_STATUS_STR));
                strcpy(v_comm_status, lpTSCall1Ans26->GetString(LDBIZ_COMM_STATUS_STR));
                v_comm_begin_date = lpTSCall1Ans26->GetInt32(LDBIZ_COMM_BEGIN_DATE_INT);
                v_comm_end_date = lpTSCall1Ans26->GetInt32(LDBIZ_COMM_END_DATE_INT);
                v_comm_begin_time = lpTSCall1Ans26->GetInt32(LDBIZ_COMM_BEGIN_TIME_INT);
                v_comm_end_time = lpTSCall1Ans26->GetInt32(LDBIZ_COMM_END_TIME_INT);
                v_comm_comple_date = lpTSCall1Ans26->GetInt32(LDBIZ_COMM_COMPLE_DATE_INT);
                v_comm_comple_time = lpTSCall1Ans26->GetInt32(LDBIZ_COMM_COMPLE_TIME_INT);
                v_comm_appr_date = lpTSCall1Ans26->GetInt32(LDBIZ_COMM_APPR_DATE_INT);
                v_comm_appr_time = lpTSCall1Ans26->GetInt32(LDBIZ_COMM_APPR_TIME_INT);
                strcpy(v_comm_appr_status, lpTSCall1Ans26->GetString(LDBIZ_COMM_APPR_STATUS_STR));
                v_comm_appr_oper_no = lpTSCall1Ans26->GetInt32(LDBIZ_COMM_APPR_OPER_NO_INT);
                v_comm_appr_oper = lpTSCall1Ans26->GetInt32(LDBIZ_COMM_APPR_OPER_INT);
                strcpy(v_comm_appr_remark, lpTSCall1Ans26->GetString(LDBIZ_COMM_APPR_REMARK_STR));
                v_external_no = lpTSCall1Ans26->GetInt64(LDBIZ_EXTERNAL_NO_INT64);
                strcpy(v_comb_code, lpTSCall1Ans26->GetString(LDBIZ_COMB_CODE_STR));
                strcpy(v_comm_oper_way, lpTSCall1Ans26->GetString(LDBIZ_COMM_OPER_WAY_STR));
                strcpy(v_remark_info, lpTSCall1Ans26->GetString(LDBIZ_REMARK_INFO_STR));
                v_comm_comple_flag = lpTSCall1Ans26->GetInt32(LDBIZ_COMM_COMPLE_FLAG_INT);
            ...
            if (v_comm_batch_no > 0 )
            {
                ...
                lpTSCall1Req27=glpFastMsgFactory->CreateFastMessage("tdfutuT.3.4", 0);
                ...
                lpTSCall1Req27->SetInt32(LDBIZ_COMM_DATE_INT,v_comm_date);
                lpTSCall1Req27->SetInt32(LDBIZ_COMM_BATCH_NO_INT,v_comm_batch_no);
                lpTSCall1Req27->SetInt32(LDBIZ_CO_NO_INT,v_co_no);
                lpTSCall1Req27->SetInt32(LDBIZ_COMM_EXECUTOR_INT,v_comm_executor);
                ...
                v_init_date = lpTSCall1Ans27->GetInt32(LDBIZ_INIT_DATE_INT);
                v_pd_no = lpTSCall1Ans27->GetInt32(LDBIZ_PD_NO_INT);
                v_exch_group_no = lpTSCall1Ans27->GetInt32(LDBIZ_EXCH_GROUP_NO_INT);
                v_asset_acco_no = lpTSCall1Ans27->GetInt32(LDBIZ_ASSET_ACCO_NO_INT);
                ...
                v_futu_acco_no = lpTSCall1Ans27->GetInt32(LDBIZ_FUTU_ACCO_NO_INT);
                v_contrc_code_no = lpTSCall1Ans27->GetInt32(LDBIZ_CONTRC_CODE_NO_INT);
                strcpy(v_contrc_code, lpTSCall1Ans27->GetString(LDBIZ_CONTRC_CODE_STR));
                v_contrc_type = lpTSCall1Ans27->GetInt32(LDBIZ_CONTRC_TYPE_INT);
                v_asset_type = lpTSCall1Ans27->GetInt32(LDBIZ_ASSET_TYPE_INT);
                v_contrc_dir = lpTSCall1Ans27->GetInt32(LDBIZ_CONTRC_DIR_INT);
                v_hedge_type = lpTSCall1Ans27->GetInt32(LDBIZ_HEDGE_TYPE_INT);
                v_comm_time = lpTSCall1Ans27->GetInt32(LDBIZ_COMM_TIME_INT);
                v_comm_opor = lpTSCall1Ans27->GetInt32(LDBIZ_COMM_OPOR_INT);
                v_comm_dir = lpTSCall1Ans27->GetInt32(LDBIZ_COMM_DIR_INT);
                v_comm_limit_price = lpTSCall1Ans27->GetDouble(LDBIZ_COMM_LIMIT_PRICE_FLOAT);
                v_limit_actual_price = lpTSCall1Ans27->GetDouble(LDBIZ_LIMIT_ACTUAL_PRICE_FLOAT);
                v_comm_qty = lpTSCall1Ans27->GetDouble(LDBIZ_COMM_QTY_FLOAT);
                v_comm_amt = lpTSCall1Ans27->GetDouble(LDBIZ_COMM_AMT_FLOAT);
                v_order_qty = lpTSCall1Ans27->GetDouble(LDBIZ_ORDER_QTY_FLOAT);
                v_comm_cancel_qty = lpTSCall1Ans27->GetDouble(LDBIZ_COMM_CANCEL_QTY_FLOAT);
                v_comm_await_cancel_qty = lpTSCall1Ans27->GetDouble(LDBIZ_COMM_AWAIT_CANCEL_QTY_FLOAT);
                v_strike_amt = lpTSCall1Ans27->GetDouble(LDBIZ_STRIKE_AMT_FLOAT);
                v_strike_qty = lpTSCall1Ans27->GetDouble(LDBIZ_STRIKE_QTY_FLOAT);
                strcpy(v_strike_status, lpTSCall1Ans27->GetString(LDBIZ_STRIKE_STATUS_STR));
                strcpy(v_comm_sum_status, lpTSCall1Ans27->GetString(LDBIZ_COMM_SUM_STATUS_STR));
                v_comm_begin_date = lpTSCall1Ans27->GetInt32(LDBIZ_COMM_BEGIN_DATE_INT);
                v_comm_end_date = lpTSCall1Ans27->GetInt32(LDBIZ_COMM_END_DATE_INT);
                v_comm_begin_time = lpTSCall1Ans27->GetInt32(LDBIZ_COMM_BEGIN_TIME_INT);
                v_comm_end_time = lpTSCall1Ans27->GetInt32(LDBIZ_COMM_END_TIME_INT);
                v_comm_comple_date = lpTSCall1Ans27->GetInt32(LDBIZ_COMM_COMPLE_DATE_INT);
                v_comm_comple_time = lpTSCall1Ans27->GetInt32(LDBIZ_COMM_COMPLE_TIME_INT);
                v_max_comm_comple_date = lpTSCall1Ans27->GetInt32(LDBIZ_MAX_COMM_COMPLE_DATE_INT);
                v_max_comm_comple_time = lpTSCall1Ans27->GetInt32(LDBIZ_MAX_COMM_COMPLE_TIME_INT);
                v_comm_appr_date = lpTSCall1Ans27->GetInt32(LDBIZ_COMM_APPR_DATE_INT);
                v_comm_appr_time = lpTSCall1Ans27->GetInt32(LDBIZ_COMM_APPR_TIME_INT);
                v_comm_appr_qty = lpTSCall1Ans27->GetDouble(LDBIZ_COMM_APPR_QTY_FLOAT);
                strcpy(v_comm_sum_approve_status, lpTSCall1Ans27->GetString(LDBIZ_COMM_SUM_APPROVE_STATUS_STR));
                v_buy_order_qty = lpTSCall1Ans27->GetDouble(LDBIZ_BUY_ORDER_QTY_FLOAT);
                v_sell_order_qty = lpTSCall1Ans27->GetDouble(LDBIZ_SELL_ORDER_QTY_FLOAT);
                v_buy_comm_qty = lpTSCall1Ans27->GetDouble(LDBIZ_BUY_COMM_QTY_FLOAT);
                v_sell_comm_qty = lpTSCall1Ans27->GetDouble(LDBIZ_SELL_COMM_QTY_FLOAT);
                v_buy_strike_qty = lpTSCall1Ans27->GetDouble(LDBIZ_BUY_STRIKE_QTY_FLOAT);
                v_sell_strike_qty = lpTSCall1Ans27->GetDouble(LDBIZ_SELL_STRIKE_QTY_FLOAT);
                v_buy_strike_amt = lpTSCall1Ans27->GetDouble(LDBIZ_BUY_STRIKE_AMT_FLOAT);
                v_sell_strike_amt = lpTSCall1Ans27->GetDouble(LDBIZ_SELL_STRIKE_AMT_FLOAT);
                v_buy_comm_amt = lpTSCall1Ans27->GetDouble(LDBIZ_BUY_COMM_AMT_FLOAT);
                v_sell_comm_amt = lpTSCall1Ans27->GetDouble(LDBIZ_SELL_COMM_AMT_FLOAT);
                v_rece_margin = lpTSCall1Ans27->GetDouble(LDBIZ_RECE_MARGIN_FLOAT);
                strcpy(v_comm_oper_way, lpTSCall1Ans27->GetString(LDBIZ_COMM_OPER_WAY_STR));
            ...
            lpTSCall1Req28=glpFastMsgFactory->CreateFastMessage("tdfutuT.2.11", 0);
            ...
            lpTSCall1Req28->SetString(LDBIZ_EXCH_CRNCY_TYPE_STR,v_exch_crncy_type);
            ...
            strcpy(v_error_code, lpTSCall1Ans28->GetString(LDBIZ_ERROR_CODE_STR));
            strcpy(v_error_info, lpTSCall1Ans28->GetString(LDBIZ_ERROR_INFO_STR));
            v_exgp_row_id = lpTSCall1Ans28->GetInt64(LDBIZ_EXGP_ROW_ID_INT64);
            v_co_no = lpTSCall1Ans28->GetInt32(LDBIZ_CO_NO_INT);
            v_pd_no = lpTSCall1Ans28->GetInt32(LDBIZ_PD_NO_INT);
            v_exgp_begin_amt = lpTSCall1Ans28->GetDouble(LDBIZ_EXGP_BEGIN_AMT_FLOAT);
            v_exgp_curr_amt = lpTSCall1Ans28->GetDouble(LDBIZ_EXGP_CURR_AMT_FLOAT);
            v_exgp_frozen_amt = lpTSCall1Ans28->GetDouble(LDBIZ_EXGP_FROZEN_AMT_FLOAT);
            v_exgp_unfroz_amt = lpTSCall1Ans28->GetDouble(LDBIZ_EXGP_UNFROZ_AMT_FLOAT);
            v_exgp_comm_frozen_amt = lpTSCall1Ans28->GetDouble(LDBIZ_EXGP_COMM_FROZEN_AMT_FLOAT);
            v_exgp_comm_unfroz_amt = lpTSCall1Ans28->GetDouble(LDBIZ_EXGP_COMM_UNFROZ_AMT_FLOAT);
            v_exgp_comm_capt_amt = lpTSCall1Ans28->GetDouble(LDBIZ_EXGP_COMM_CAPT_AMT_FLOAT);
            v_exgp_comm_releas_amt = lpTSCall1Ans28->GetDouble(LDBIZ_EXGP_COMM_RELEAS_AMT_FLOAT);
            v_exgp_trade_capt_amt = lpTSCall1Ans28->GetDouble(LDBIZ_EXGP_TRADE_CAPT_AMT_FLOAT);
            v_exgp_trade_releas_amt = lpTSCall1Ans28->GetDouble(LDBIZ_EXGP_TRADE_RELEAS_AMT_FLOAT);
            v_exgp_strike_capt_amt = lpTSCall1Ans28->GetDouble(LDBIZ_EXGP_STRIKE_CAPT_AMT_FLOAT);
            v_exgp_strike_releas_amt = lpTSCall1Ans28->GetDouble(LDBIZ_EXGP_STRIKE_RELEAS_AMT_FLOAT);
            v_exgp_capt_margin = lpTSCall1Ans28->GetDouble(LDBIZ_EXGP_CAPT_MARGIN_FLOAT);
            v_exgp_trade_fee = lpTSCall1Ans28->GetDouble(LDBIZ_EXGP_TRADE_FEE_FLOAT);
            v_exgp_strike_fee = lpTSCall1Ans28->GetDouble(LDBIZ_EXGP_STRIKE_FEE_FLOAT);
            v_exgp_close_pandl = lpTSCall1Ans28->GetDouble(LDBIZ_EXGP_CLOSE_PANDL_FLOAT);
            v_exgp_marked_pandl = lpTSCall1Ans28->GetDouble(LDBIZ_EXGP_MARKED_PANDL_FLOAT);
            v_exgp_cash_update_times = lpTSCall1Ans28->GetInt32(LDBIZ_EXGP_CASH_UPDATE_TIMES_INT);
            v_asac_row_id = lpTSCall1Ans28->GetInt64(LDBIZ_ASAC_ROW_ID_INT64);
            v_asac_begin_amt = lpTSCall1Ans28->GetDouble(LDBIZ_ASAC_BEGIN_AMT_FLOAT);
            v_asac_curr_amt = lpTSCall1Ans28->GetDouble(LDBIZ_ASAC_CURR_AMT_FLOAT);
            v_asac_frozen_amt = lpTSCall1Ans28->GetDouble(LDBIZ_ASAC_FROZEN_AMT_FLOAT);
            v_asac_unfroz_amt = lpTSCall1Ans28->GetDouble(LDBIZ_ASAC_UNFROZ_AMT_FLOAT);
            v_asac_comm_frozen_amt = lpTSCall1Ans28->GetDouble(LDBIZ_ASAC_COMM_FROZEN_AMT_FLOAT);
            v_asac_comm_unfroz_amt = lpTSCall1Ans28->GetDouble(LDBIZ_ASAC_COMM_UNFROZ_AMT_FLOAT);
            v_asac_comm_capt_amt = lpTSCall1Ans28->GetDouble(LDBIZ_ASAC_COMM_CAPT_AMT_FLOAT);
            v_asac_comm_releas_amt = lpTSCall1Ans28->GetDouble(LDBIZ_ASAC_COMM_RELEAS_AMT_FLOAT);
            v_asac_trade_capt_amt = lpTSCall1Ans28->GetDouble(LDBIZ_ASAC_TRADE_CAPT_AMT_FLOAT);
            v_asac_trade_releas_amt = lpTSCall1Ans28->GetDouble(LDBIZ_ASAC_TRADE_RELEAS_AMT_FLOAT);
            v_asac_strike_capt_amt = lpTSCall1Ans28->GetDouble(LDBIZ_ASAC_STRIKE_CAPT_AMT_FLOAT);
            v_asac_strike_releas_amt = lpTSCall1Ans28->GetDouble(LDBIZ_ASAC_STRIKE_RELEAS_AMT_FLOAT);
            v_asac_capt_margin = lpTSCall1Ans28->GetDouble(LDBIZ_ASAC_CAPT_MARGIN_FLOAT);
            v_asac_trade_fee = lpTSCall1Ans28->GetDouble(LDBIZ_ASAC_TRADE_FEE_FLOAT);
            v_asac_strike_fee = lpTSCall1Ans28->GetDouble(LDBIZ_ASAC_STRIKE_FEE_FLOAT);
            v_asac_close_pandl = lpTSCall1Ans28->GetDouble(LDBIZ_ASAC_CLOSE_PANDL_FLOAT);
            v_asac_marked_pandl = lpTSCall1Ans28->GetDouble(LDBIZ_ASAC_MARKED_PANDL_FLOAT);
            v_asac_cash_update_times = lpTSCall1Ans28->GetInt32(LDBIZ_ASAC_CASH_UPDATE_TIMES_INT);
            ...
            lpTSCall1Req29=glpFastMsgFactory->CreateFastMessage("tdfutuT.2.12", 0);
            ...
            lpTSCall1Req29->SetInt32(LDBIZ_LNGSHT_TYPE_INT,v_lngsht_type);
            lpTSCall1Req29->SetInt32(LDBIZ_HEDGE_TYPE_INT,v_hedge_type);
            lpTSCall1Req29->SetInt32(LDBIZ_FUTU_ACCO_NO_INT,v_futu_acco_no);
            lpTSCall1Req29->SetInt32(LDBIZ_CONTRC_CODE_NO_INT,v_contrc_code_no);
            ...
            strcpy(v_error_code, lpTSCall1Ans29->GetString(LDBIZ_ERROR_CODE_STR));
            strcpy(v_error_info, lpTSCall1Ans29->GetString(LDBIZ_ERROR_INFO_STR));
            v_exgp_row_id = lpTSCall1Ans29->GetInt64(LDBIZ_EXGP_ROW_ID_INT64);
            ...
            v_contrc_type = lpTSCall1Ans29->GetInt32(LDBIZ_CONTRC_TYPE_INT);
            v_contrc_unit = lpTSCall1Ans29->GetInt32(LDBIZ_CONTRC_UNIT_INT);
            strcpy(v_comb_code, lpTSCall1Ans29->GetString(LDBIZ_COMB_CODE_STR));
            ...
            v_exgp_old_comm_capt_qty = lpTSCall1Ans29->GetDouble(LDBIZ_EXGP_OLD_COMM_CAPT_QTY_FLOAT);
            v_exgp_today_comm_capt_qty = lpTSCall1Ans29->GetDouble(LDBIZ_EXGP_TODAY_COMM_CAPT_QTY_FLOAT);
            v_exgp_old_trade_capt_qty = lpTSCall1Ans29->GetDouble(LDBIZ_EXGP_OLD_TRADE_CAPT_QTY_FLOAT);
            v_exgp_today_trade_capt_qty = lpTSCall1Ans29->GetDouble(LDBIZ_EXGP_TODAY_TRADE_CAPT_QTY_FLOAT);
            v_exgp_pre_strike_capt_qty = lpTSCall1Ans29->GetDouble(LDBIZ_EXGP_PRE_STRIKE_CAPT_QTY_FLOAT);
            v_exgp_today_strike_capt_qty = lpTSCall1Ans29->GetDouble(LDBIZ_EXGP_TODAY_STRIKE_CAPT_QTY_FLOAT);
            v_exgp_rece_margin = lpTSCall1Ans29->GetDouble(LDBIZ_EXGP_RECE_MARGIN_FLOAT);
            v_pre_settle_price = lpTSCall1Ans29->GetDouble(LDBIZ_PRE_SETTLE_PRICE_FLOAT);
            v_exgp_realize_pandl = lpTSCall1Ans29->GetDouble(LDBIZ_EXGP_REALIZE_PANDL_FLOAT);
            v_exgp_open_amount = lpTSCall1Ans29->GetDouble(LDBIZ_EXGP_OPEN_AMOUNT_FLOAT);
            v_exgp_posi_update_times = lpTSCall1Ans29->GetInt32(LDBIZ_EXGP_POSI_UPDATE_TIMES_INT);
            v_asac_row_id = lpTSCall1Ans29->GetInt64(LDBIZ_ASAC_ROW_ID_INT64);
            ...
            v_asac_old_comm_capt_qty = lpTSCall1Ans29->GetDouble(LDBIZ_ASAC_OLD_COMM_CAPT_QTY_FLOAT);
            v_asac_today_comm_capt_qty = lpTSCall1Ans29->GetDouble(LDBIZ_ASAC_TODAY_COMM_CAPT_QTY_FLOAT);
            v_asac_old_trade_capt_qty = lpTSCall1Ans29->GetDouble(LDBIZ_ASAC_OLD_TRADE_CAPT_QTY_FLOAT);
            v_asac_today_trade_capt_qty = lpTSCall1Ans29->GetDouble(LDBIZ_ASAC_TODAY_TRADE_CAPT_QTY_FLOAT);
            v_asac_pre_strike_capt_qty = lpTSCall1Ans29->GetDouble(LDBIZ_ASAC_PRE_STRIKE_CAPT_QTY_FLOAT);
            v_asac_today_strike_capt_qty = lpTSCall1Ans29->GetDouble(LDBIZ_ASAC_TODAY_STRIKE_CAPT_QTY_FLOAT);
            v_asac_rece_margin = lpTSCall1Ans29->GetDouble(LDBIZ_ASAC_RECE_MARGIN_FLOAT);
            v_asac_realize_pandl = lpTSCall1Ans29->GetDouble(LDBIZ_ASAC_REALIZE_PANDL_FLOAT);
            v_asac_open_amount = lpTSCall1Ans29->GetDouble(LDBIZ_ASAC_OPEN_AMOUNT_FLOAT);
            ...
            if (v_detail_posi_id != 0)
            {
              ...
              lpTSCall1Req30=glpFastMsgFactory->CreateFastMessage("tdfutuT.2.13", 0);
              ...
              lpTSCall1Req30->SetInt64(LDBIZ_DETAIL_POSI_ID_INT64,v_detail_posi_id);
              ...
              strcpy(v_error_code, lpTSCall1Ans30->GetString(LDBIZ_ERROR_CODE_STR));
              strcpy(v_error_info, lpTSCall1Ans30->GetString(LDBIZ_ERROR_INFO_STR));
              v_open_posi_date = lpTSCall1Ans30->GetInt32(LDBIZ_OPEN_POSI_DATE_INT);
              v_open_posi_time = lpTSCall1Ans30->GetInt32(LDBIZ_OPEN_POSI_TIME_INT);
              v_open_posi_price = lpTSCall1Ans30->GetDouble(LDBIZ_OPEN_POSI_PRICE_FLOAT);
              v_open_posi_qty = lpTSCall1Ans30->GetDouble(LDBIZ_OPEN_POSI_QTY_FLOAT);
              v_open_posi_fee = lpTSCall1Ans30->GetDouble(LDBIZ_OPEN_POSI_FEE_FLOAT);
              v_close_posi_fee = lpTSCall1Ans30->GetDouble(LDBIZ_CLOSE_POSI_FEE_FLOAT);
              v_trade_capt_qty = lpTSCall1Ans30->GetDouble(LDBIZ_TRADE_CAPT_QTY_FLOAT);
              v_strike_capt_qty = lpTSCall1Ans30->GetDouble(LDBIZ_STRIKE_CAPT_QTY_FLOAT);
              v_marked_sett_price = lpTSCall1Ans30->GetDouble(LDBIZ_MARKED_SETT_PRICE_FLOAT);
              v_rece_margin = lpTSCall1Ans30->GetDouble(LDBIZ_RECE_MARGIN_FLOAT);
              v_marked_pandl = lpTSCall1Ans30->GetDouble(LDBIZ_MARKED_PANDL_FLOAT);
...
END:
    ...
    if (iRet == -1)
    {
        ...
        lpTSCall1Req31=glpFastMsgFactory->CreateFastMessage("pubT.24.154", 0);
        ...
        lpTSCall1Req31->SetString(LDBIZ_LOG_ERROR_CODE_STR,v_log_error_code);
        lpTSCall1Req31->SetString(LDBIZ_LOG_ERROR_INFO_STR,v_log_error_info);
        ...
        //获取输出参数值
            ...
            strcpy(v_error_prompt, lpTSCall1Ans31->GetString(LDBIZ_ERROR_PROMPT_STR));
            v_error_level = lpTSCall1Ans31->GetInt32(LDBIZ_ERROR_LEVEL_INT);
            strcpy(v_error_deal, lpTSCall1Ans31->GetString(LDBIZ_ERROR_DEAL_STR));
        }
...
int iPriority=lpInBizMsg->GetInt32(LDTAG_PRIORITY);
    ...
    //调用过程[事务_交易期货_交易运维_查询机构统计异常订单数量]
    //组织事务请求
    if(lpTSCall1Ans1)
    {
      lpTSCall1Ans1->FreeMsg();
    ...
    lpTSCall1Req1=glpFastMsgFactory->CreateFastMessage("tdfutuT.8.81", 0);
    lpTSCall1Req1->SetInt32(LDTAG_PRIORITY, iPriority);
    lpTSCall1Req1->SetInt32(LDBIZ_OPOR_CO_NO_INT,v_opor_co_no);
    lpTSCall1Req1->SetInt32(LDBIZ_OPOR_NO_INT,v_opor_no);
    lpTSCall1Req1->SetString(LDBIZ_OPER_MAC_STR,v_oper_mac);
    ...
    {
        lpOutBizMsg->SetInt32(LDTAG_ERRORNO, -1);
        lpOutBizMsg->SetString(LDTAG_ERRORINFO, "[tdfutuT.8.81]subcall timed out!");
        iRet=-2;
        goto ENDSYS;
    }
    else if(lpTSCall1Ans1->GetInt32(LDTAG_ERRORNO)!=0)  //  中间件层面错误
