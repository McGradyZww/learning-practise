...
namespace LD.Client.Contract
{
    ...
    //逻辑_清算证券_结算_查询配股登记信息
    public class ReqFuncclsecuL_3_204DTO : ReqBaseDTO
    {
        public ReqFuncclsecuL_3_204DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "clsecuL.3.204";
            CommonDTO.func_code = CommonDTO.function_code;
            co_no = 0;
            pd_no = 0;
            exch_group_no = 0;
        ...
        public override LDsdkDefine.LDPackerAdapter CreatePacker()
        {
            ...
            packer.AddField("stock_code_no", ELDDATATYPE.LD_DATATYPE_INT);
            packer.AddField("reg_date", ELDDATATYPE.LD_DATATYPE_INT);
            packer.AddField("placement_status", ELDDATATYPE.LD_DATATYPE_STRING);
            packer.AddField("row_id", ELDDATATYPE.LD_DATATYPE_LONG);
            packer.AddField("row_count", ELDDATATYPE.LD_DATATYPE_INT);
            ...
            packer.AddInt(stock_code_no);
            packer.AddInt(reg_date);
            packer.AddStr(placement_status);
            packer.AddInt64(row_id);
            packer.AddInt(row_count);
            packer.EndPack();
    ...
    //逻辑_清算证券_结算_确认配股登记信息
    public class ReqFuncclsecuL_3_205DTO : ReqBaseDTO
    {
        public ReqFuncclsecuL_3_205DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "clsecuL.3.205";
            CommonDTO.func_code = CommonDTO.function_code;
            co_no = 0;
            pd_no = 0;
            exch_group_no = 0;
        ...
        public override LDsdkDefine.LDPackerAdapter CreatePacker()
        {
            ...
            packer.AddField("stock_acco_no", ELDDATATYPE.LD_DATATYPE_INT);
            packer.AddField("stock_code_no", ELDDATATYPE.LD_DATATYPE_INT);
            packer.AddField("avail_pla_qty", ELDDATATYPE.LD_DATATYPE_DOUBLE);
            packer.AddField("placement_status", ELDDATATYPE.LD_DATATYPE_STRING);
            ...
            packer.AddInt(stock_acco_no);
            packer.AddInt(stock_code_no);
            packer.AddDouble(avail_pla_qty);
            packer.AddStr(placement_status);
            packer.EndPack();
    ...
    //逻辑_清算证券_结算_撤销配股登记
    public class ReqFuncclsecuL_3_206DTO : ReqBaseDTO
    {
        public ReqFuncclsecuL_3_206DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "clsecuL.3.206";
            CommonDTO.func_code = CommonDTO.function_code;
            co_no = 0;
            pd_no = 0;
            exch_group_no = 0;
