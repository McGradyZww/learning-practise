...
# 事务_数据同步_公共同步_同步证券模板表
DELIMITER ;;
DROP PROCEDURE IF EXISTS prt_dcsypub_Syncbasesedt_stock_tmplat;;
DELIMITER ;;
CREATE PROCEDURE prt_dcsypub_Syncbasesedt_stock_tmplat(
    IN p_opor_co_no int,
    IN p_opor_no int,
...
BEGIN
    ...
    /* 调用【原子_数据同步_公共同步_同步证券模板表】*/
    call db_dc.pra_dcsypub_Syncbasesedt_stock_tmplat(
        v_opor_co_no,
        v_opor_no,
        v_oper_mac,
        v_oper_ip_addr,
    ...
    if v_error_code = "1" then
        SET v_error_code = "dcsyncT.1.11.999";
        if v_mysql_message <> "" then
             SET v_error_info = CONCAT(v_error_info,"#",'调用过程原子_数据同步_公共同步_同步证券模板表出现错误！',v_mysql_message);
        end if;
        ROLLBACK;
        leave label_pro;
...
# 事务_数据同步_公共同步_同步证券类型表
DELIMITER ;;
DROP PROCEDURE IF EXISTS prt_dcsypub_Syncbasesedt_stock_type;;
DELIMITER ;;
CREATE PROCEDURE prt_dcsypub_Syncbasesedt_stock_type(
    IN p_opor_co_no int,
    IN p_opor_no int,
    IN p_oper_mac varchar(32),
    IN p_oper_ip_addr varchar(32),
...
BEGIN
    ...
    /* 调用【原子_数据同步_公共同步_同步证券类型表】*/
    call db_dc.pra_dcsypub_Syncbasesedt_stock_type(
        v_opor_co_no,
        v_opor_no,
        v_oper_mac,
        v_oper_ip_addr,
        ...
        v_error_info);
    if v_error_code = "1" then
        SET v_error_code = "dcsyncT.1.12.999";
        if v_mysql_message <> "" then
             SET v_error_info = CONCAT(v_error_info,"#",'调用过程原子_数据同步_公共同步_同步证券类型表出现错误！',v_mysql_message);
        end if;
        ROLLBACK;
        leave label_pro;
    elseif v_error_code <> "0" then
...
# 事务_数据同步_公共同步_同步证券类型订单方向表
DELIMITER ;;
DROP PROCEDURE IF EXISTS prt_dcsypub_Syncbasesedt_stock_type_order_dir;;
DELIMITER ;;
CREATE PROCEDURE prt_dcsypub_Syncbasesedt_stock_type_order_dir(
    IN p_opor_co_no int,
    IN p_opor_no int,
    IN p_oper_mac varchar(32),
    IN p_oper_ip_addr varchar(32),
...
BEGIN
    ...
    /* 调用【原子_数据同步_公共同步_同步证券类型订单方向表】*/
    call db_dc.pra_dcsypub_Syncbasesedt_stock_type_order_dir(
        v_opor_co_no,
        v_opor_no,
        v_oper_mac,
        v_oper_ip_addr,
        ...
        v_error_info);
    if v_error_code = "1" then
        SET v_error_code = "dcsyncT.1.13.999";
        if v_mysql_message <> "" then
             SET v_error_info = CONCAT(v_error_info,"#",'调用过程原子_数据同步_公共同步_同步证券类型订单方向表出现错误！',v_mysql_message);
        end if;
        ROLLBACK;
        leave label_pro;
    elseif v_error_code <> "0" then
...
# 事务_数据同步_公共同步_同步证券代码信息表
DELIMITER ;;
DROP PROCEDURE IF EXISTS prt_dcsypub_Syncbasesedt_stock_code_info;;
DELIMITER ;;
CREATE PROCEDURE prt_dcsypub_Syncbasesedt_stock_code_info(
    IN p_opor_co_no int,
    IN p_opor_no int,
    IN p_oper_mac varchar(32),
    IN p_oper_ip_addr varchar(32),
...
BEGIN
    ...
    /* 调用【原子_数据同步_公共同步_同步证券代码信息表】*/
    call db_dc.pra_dcsypub_Syncbasesedt_stock_code_info(
        v_opor_co_no,
        v_opor_no,
        v_oper_mac,
        v_oper_ip_addr,
        ...
        v_error_info);
    if v_error_code = "1" then
        SET v_error_code = "dcsyncT.1.14.999";
        if v_mysql_message <> "" then
             SET v_error_info = CONCAT(v_error_info,"#",'调用过程原子_数据同步_公共同步_同步证券代码信息表出现错误！',v_mysql_message);
        end if;
        ROLLBACK;
        leave label_pro;
    elseif v_error_code <> "0" then
...
# 事务_数据同步_公共同步_同步证券行情表
DELIMITER ;;
DROP PROCEDURE IF EXISTS prt_dcsypub_Syncbasesedt_stock_quot;;
DELIMITER ;;
CREATE PROCEDURE prt_dcsypub_Syncbasesedt_stock_quot(
    IN p_opor_co_no int,
    IN p_opor_no int,
    IN p_oper_mac varchar(32),
    IN p_oper_ip_addr varchar(32),
...
BEGIN
    ...
    /* 调用【原子_数据同步_公共同步_同步证券行情表】*/
    call db_dc.pra_dcsypub_Syncbasesedt_stock_quot(
        v_opor_co_no,
        v_opor_no,
        v_oper_mac,
        v_oper_ip_addr,
        ...
        v_error_info);
    if v_error_code = "1" then
        SET v_error_code = "dcsyncT.1.15.999";
        if v_mysql_message <> "" then
             SET v_error_info = CONCAT(v_error_info,"#",'调用过程原子_数据同步_公共同步_同步证券行情表出现错误！',v_mysql_message);
        end if;
        ROLLBACK;
        leave label_pro;
    elseif v_error_code <> "0" then
...
# 事务_数据同步_公共同步_同步债券属性信息表
DELIMITER ;;
DROP PROCEDURE IF EXISTS prt_dcsypub_Syncbasesedt_bond_info;;
DELIMITER ;;
CREATE PROCEDURE prt_dcsypub_Syncbasesedt_bond_info(
    IN p_opor_co_no int,
    IN p_opor_no int,
    IN p_oper_mac varchar(32),
    IN p_oper_ip_addr varchar(32),
...
BEGIN
    ...
    /* 调用【原子_数据同步_公共同步_同步债券属性信息表】*/
    call db_dc.pra_dcsypub_Syncbasesedt_bond_info(
        v_opor_co_no,
        v_opor_no,
        v_oper_mac,
        v_oper_ip_addr,
        ...
        v_error_info);
    if v_error_code = "1" then
        SET v_error_code = "dcsyncT.1.16.999";
        if v_mysql_message <> "" then
             SET v_error_info = CONCAT(v_error_info,"#",'调用过程原子_数据同步_公共同步_同步债券属性信息表出现错误！',v_mysql_message);
        end if;
        ROLLBACK;
        leave label_pro;
    elseif v_error_code <> "0" then
...
# 事务_数据同步_公共同步_同步系统信息表
DELIMITER ;;
DROP PROCEDURE IF EXISTS prt_dcsypub_Syncbase_sys_info;;
DELIMITER ;;
CREATE PROCEDURE prt_dcsypub_Syncbase_sys_info(
    IN p_opor_co_no int,
    IN p_opor_no int,
    IN p_oper_mac varchar(32),
    IN p_oper_ip_addr varchar(32),
...
BEGIN
    ...
    /* 调用【原子_数据同步_公共同步_同步系统信息表】*/
    call db_dc.pra_dcsypub_Syncbase_sys_info(
        v_opor_co_no,
        v_opor_no,
        v_oper_mac,
        v_oper_ip_addr,
        ...
        v_error_info);
    if v_error_code = "1" then
        SET v_error_code = "dcsyncT.1.17.999";
        if v_mysql_message <> "" then
             SET v_error_info = CONCAT(v_error_info,"#",'调用过程原子_数据同步_公共同步_同步系统信息表出现错误！',v_mysql_message);
        end if;
        ROLLBACK;
        leave label_pro;
    elseif v_error_code <> "0" then
...
# 事务_数据同步_公共同步_同步机构信息表
DELIMITER ;;
DROP PROCEDURE IF EXISTS prt_dcsypub_Syncbase_co_info;;
DELIMITER ;;
CREATE PROCEDURE prt_dcsypub_Syncbase_co_info(
    IN p_opor_co_no int,
    IN p_opor_no int,
    IN p_oper_mac varchar(32),
    IN p_oper_ip_addr varchar(32),
...
BEGIN
    ...
    /* 调用【原子_数据同步_公共同步_同步机构信息表】*/
    call db_dc.pra_dcsypub_Syncbase_co_info(
        v_opor_co_no,
        v_opor_no,
        v_oper_mac,
        v_oper_ip_addr,
        ...
        v_error_info);
    if v_error_code = "1" then
        SET v_error_code = "dcsyncT.1.18.999";
        if v_mysql_message <> "" then
             SET v_error_info = CONCAT(v_error_info,"#",'调用过程原子_数据同步_公共同步_同步机构信息表出现错误！',v_mysql_message);
        end if;
        ROLLBACK;
        leave label_pro;
    elseif v_error_code <> "0" then
...
# 事务_数据同步_公共同步_同步市场业务记录编号表
DELIMITER ;;
DROP PROCEDURE IF EXISTS prt_dcsypub_Syncbase_market_busi_record_no;;
DELIMITER ;;
CREATE PROCEDURE prt_dcsypub_Syncbase_market_busi_record_no(
    IN p_opor_co_no int,
    IN p_opor_no int,
    IN p_oper_mac varchar(32),
    IN p_oper_ip_addr varchar(32),
...
BEGIN
    ...
    /* 调用【原子_数据同步_公共同步_同步市场业务记录编号表】*/
    call db_dc.pra_dcsypub_Syncbase_market_busi_record_no(
        v_opor_co_no,
        v_opor_no,
        v_oper_mac,
        v_oper_ip_addr,
        ...
        v_error_info);
    if v_error_code = "1" then
        SET v_error_code = "dcsyncT.1.19.999";
        if v_mysql_message <> "" then
             SET v_error_info = CONCAT(v_error_info,"#",'调用过程原子_数据同步_公共同步_同步市场业务记录编号表出现错误！',v_mysql_message);
        end if;
        ROLLBACK;
        leave label_pro;
    elseif v_error_code <> "0" then
...
# 事务_数据同步_公共同步_同步数据字典表
DELIMITER ;;
DROP PROCEDURE IF EXISTS prt_dcsypub_Syncbase_dictionary;;
DELIMITER ;;
CREATE PROCEDURE prt_dcsypub_Syncbase_dictionary(
    IN p_opor_co_no int,
    IN p_opor_no int,
    IN p_oper_mac varchar(32),
    IN p_oper_ip_addr varchar(32),
...
BEGIN
    ...
    /* 调用【原子_数据同步_公共同步_同步数据字典表】*/
    call db_dc.pra_dcsypub_Syncbase_dictionary(
        v_opor_co_no,
        v_opor_no,
        v_oper_mac,
        v_oper_ip_addr,
        ...
        v_error_info);
    if v_error_code = "1" then
        SET v_error_code = "dcsyncT.1.20.999";
        if v_mysql_message <> "" then
             SET v_error_info = CONCAT(v_error_info,"#",'调用过程原子_数据同步_公共同步_同步数据字典表出现错误！',v_mysql_message);
        end if;
        ROLLBACK;
        leave label_pro;
    elseif v_error_code <> "0" then
...
# 事务_数据同步_公共同步_同步港股通汇率表
DELIMITER ;;
DROP PROCEDURE IF EXISTS prt_dcsypub_Syncbase_hk_exch_rate;;
DELIMITER ;;
CREATE PROCEDURE prt_dcsypub_Syncbase_hk_exch_rate(
    IN p_opor_co_no int,
    IN p_opor_no int,
    IN p_oper_mac varchar(32),
    IN p_oper_ip_addr varchar(32),
...
BEGIN
    ...
    /* 调用【原子_数据同步_公共同步_同步港股通汇率表】*/
    call db_dc.pra_dcsypub_Syncbase_hk_exch_rate(
        v_opor_co_no,
        v_opor_no,
        v_oper_mac,
        v_oper_ip_addr,
        ...
        v_error_info);
    if v_error_code = "1" then
        SET v_error_code = "dcsyncT.1.21.999";
        if v_mysql_message <> "" then
             SET v_error_info = CONCAT(v_error_info,"#",'调用过程原子_数据同步_公共同步_同步港股通汇率表出现错误！',v_mysql_message);
        end if;
        ROLLBACK;
        leave label_pro;
    elseif v_error_code <> "0" then
...
# 事务_数据同步_公共同步_同步操作员信息表
DELIMITER ;;
DROP PROCEDURE IF EXISTS prt_dcsypub_Syncuser_opor_info;;
DELIMITER ;;
CREATE PROCEDURE prt_dcsypub_Syncuser_opor_info(
    IN p_opor_co_no int,
    IN p_opor_no int,
    IN p_oper_mac varchar(32),
    IN p_oper_ip_addr varchar(32),
...
BEGIN
    ...
    /* 调用【原子_数据同步_公共同步_同步操作员信息表】*/
    call db_dc.pra_dcsypub_Syncuser_opor_info(
        v_opor_co_no,
        v_opor_no,
        v_oper_mac,
        v_oper_ip_addr,
        ...
        v_error_info);
    if v_error_code = "1" then
        SET v_error_code = "dcsyncT.1.22.999";
        if v_mysql_message <> "" then
             SET v_error_info = CONCAT(v_error_info,"#",'调用过程原子_数据同步_公共同步_同步操作员信息表出现错误！',v_mysql_message);
        end if;
        ROLLBACK;
        leave label_pro;
    elseif v_error_code <> "0" then
...
# 事务_数据同步_公共同步_同步操作员可操作机构表
DELIMITER ;;
DROP PROCEDURE IF EXISTS prt_dcsypub_Syncuser_opor_allow_co;;
DELIMITER ;;
CREATE PROCEDURE prt_dcsypub_Syncuser_opor_allow_co(
    IN p_opor_co_no int,
    IN p_opor_no int,
    IN p_oper_mac varchar(32),
    IN p_oper_ip_addr varchar(32),
...
BEGIN
    ...
    /* 调用【原子_数据同步_公共同步_同步操作员可操作机构表】*/
    call db_dc.pra_dcsypub_Syncuser_opor_allow_co(
        v_opor_co_no,
        v_opor_no,
        v_oper_mac,
        v_oper_ip_addr,
        ...
        v_error_info);
    if v_error_code = "1" then
        SET v_error_code = "dcsyncT.1.23.999";
        if v_mysql_message <> "" then
             SET v_error_info = CONCAT(v_error_info,"#",'调用过程原子_数据同步_公共同步_同步操作员可操作机构表出现错误！',v_mysql_message);
        end if;
        ROLLBACK;
        leave label_pro;
    elseif v_error_code <> "0" then
...
# 事务_数据同步_公共同步_同步操作员可操作产品表
DELIMITER ;;
DROP PROCEDURE IF EXISTS prt_dcsypub_Syncuser_opor_allow_prod;;
DELIMITER ;;
CREATE PROCEDURE prt_dcsypub_Syncuser_opor_allow_prod(
    IN p_opor_co_no int,
    IN p_opor_no int,
    IN p_oper_mac varchar(32),
    IN p_oper_ip_addr varchar(32),
...
BEGIN
    ...
    /* 调用【原子_数据同步_公共同步_同步操作员可操作产品表】*/
    call db_dc.pra_dcsypub_Syncuser_opor_allow_prod(
        v_opor_co_no,
        v_opor_no,
        v_oper_mac,
        v_oper_ip_addr,
        ...
        v_error_info);
    if v_error_code = "1" then
        SET v_error_code = "dcsyncT.1.24.999";
        if v_mysql_message <> "" then
             SET v_error_info = CONCAT(v_error_info,"#",'调用过程原子_数据同步_公共同步_同步操作员可操作产品表出现错误！',v_mysql_message);
        end if;
        ROLLBACK;
        leave label_pro;
    elseif v_error_code <> "0" then
...
# 事务_数据同步_公共同步_同步交易组信息表
DELIMITER ;;
DROP PROCEDURE IF EXISTS prt_dcsypub_Syncuser_exch_group_info;;
DELIMITER ;;
CREATE PROCEDURE prt_dcsypub_Syncuser_exch_group_info(
    IN p_opor_co_no int,
    IN p_opor_no int,
    IN p_oper_mac varchar(32),
    IN p_oper_ip_addr varchar(32),
...
BEGIN
    ...
    /* 调用【原子_数据同步_公共同步_同步交易组信息表】*/
    call db_dc.pra_dcsypub_Syncuser_exch_group_info(
        v_opor_co_no,
        v_opor_no,
        v_oper_mac,
        v_oper_ip_addr,
        ...
        v_error_info);
    if v_error_code = "1" then
        SET v_error_code = "dcsyncT.1.25.999";
        if v_mysql_message <> "" then
             SET v_error_info = CONCAT(v_error_info,"#",'调用过程原子_数据同步_公共同步_同步交易组信息表出现错误！',v_mysql_message);
        end if;
        ROLLBACK;
        leave label_pro;
    elseif v_error_code <> "0" then
...
# 事务_数据同步_公共同步_同步交易组资产表
DELIMITER ;;
DROP PROCEDURE IF EXISTS prt_dcsypub_Syncuser_exch_group_asset;;
DELIMITER ;;
CREATE PROCEDURE prt_dcsypub_Syncuser_exch_group_asset(
    IN p_opor_co_no int,
    IN p_opor_no int,
    IN p_oper_mac varchar(32),
    IN p_oper_ip_addr varchar(32),
...
BEGIN
    ...
    /* 调用【原子_数据同步_公共同步_同步交易组资产表】*/
    call db_dc.pra_dcsypub_Syncuser_exch_group_asset(
        v_opor_co_no,
        v_opor_no,
        v_oper_mac,
        v_oper_ip_addr,
        ...
        v_error_info);
    if v_error_code = "1" then
        SET v_error_code = "dcsyncT.1.26.999";
        if v_mysql_message <> "" then
             SET v_error_info = CONCAT(v_error_info,"#",'调用过程原子_数据同步_公共同步_同步交易组资产表出现错误！',v_mysql_message);
        end if;
        ROLLBACK;
        leave label_pro;
    elseif v_error_code <> "0" then
...
# 事务_数据同步_公共同步_同步操作员所属交易组表
DELIMITER ;;
DROP PROCEDURE IF EXISTS prt_dcsypub_Syncuser_opor_exch_group;;
DELIMITER ;;
CREATE PROCEDURE prt_dcsypub_Syncuser_opor_exch_group(
    IN p_opor_co_no int,
    IN p_opor_no int,
    IN p_oper_mac varchar(32),
    IN p_oper_ip_addr varchar(32),
...
BEGIN
    ...
    /* 调用【原子_数据同步_公共同步_同步操作员所属交易组表】*/
    call db_dc.pra_dcsypub_Syncuser_opor_exch_group(
        v_opor_co_no,
        v_opor_no,
        v_oper_mac,
        v_oper_ip_addr,
        ...
        v_error_info);
    if v_error_code = "1" then
        SET v_error_code = "dcsyncT.1.27.999";
        if v_mysql_message <> "" then
             SET v_error_info = CONCAT(v_error_info,"#",'调用过程原子_数据同步_公共同步_同步操作员所属交易组表出现错误！',v_mysql_message);
        end if;
        ROLLBACK;
        leave label_pro;
    elseif v_error_code <> "0" then
...
# 事务_数据同步_公共同步_同步期货行情表
DELIMITER ;;
DROP PROCEDURE IF EXISTS prt_dcsypub_Syncbasefudt_futu_quot;;
DELIMITER ;;
CREATE PROCEDURE prt_dcsypub_Syncbasefudt_futu_quot(
    IN p_opor_co_no int,
    IN p_opor_no int,
    IN p_oper_mac varchar(32),
    IN p_oper_ip_addr varchar(32),
...
BEGIN
    ...
    /* 调用【原子_数据同步_公共同步_同步期货行情表】*/
    call db_dc.pra_dcsypub_Syncbasefudt_futu_quot(
        v_opor_co_no,
        v_opor_no,
        v_oper_mac,
        v_oper_ip_addr,
        ...
        v_error_info);
    if v_error_code = "1" then
        SET v_error_code = "dcsyncT.1.28.999";
        if v_mysql_message <> "" then
             SET v_error_info = CONCAT(v_error_info,"#",'调用过程原子_数据同步_公共同步_同步期货行情表出现错误！',v_mysql_message);
        end if;
        ROLLBACK;
        leave label_pro;
    elseif v_error_code <> "0" then
