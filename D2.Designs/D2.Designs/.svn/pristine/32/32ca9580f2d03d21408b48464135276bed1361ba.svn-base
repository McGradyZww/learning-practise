...
{
    //逻辑_清算外盘期货_公用_更新处理记录序号
    public class ReqFuncclfofuL_1_2DTO : ReqBaseDTO
    {
        public ReqFuncclfofuL_1_2DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "clfofuL.1.2";
        ...
        public override LDsdkDefine.LDPackerAdapter CreatePacker()
        {
            ...
            packer.AddField("sys_busin", ELDDATATYPE.LD_DATATYPE_INT);
            packer.AddField("clear_data_source", ELDDATATYPE.LD_DATATYPE_INT);
            packer.AddField("clear_date", ELDDATATYPE.LD_DATATYPE_INT);
            packer.AddField("clear_deal_id", ELDDATATYPE.LD_DATATYPE_LONG);
            packer.AddField("sett_clear_status", ELDDATATYPE.LD_DATATYPE_STRING);
            ...
            packer.AddInt(sys_busin);
            packer.AddInt(clear_data_source);
            packer.AddInt(clear_date);
            packer.AddInt64(clear_deal_id);
            packer.AddStr(sett_clear_status);
            packer.EndPack();
        ...
        public override LDsdkDefineEx.LDFastMessageAdapter CreateFastMessage()
        {
            ...
            fastMsg.SetInt32(LDBizTagDefine.LDBizTag.LDBIZ_SYS_BUSIN_INT,sys_busin);
            fastMsg.SetInt32(LDBizTagDefine.LDBizTag.LDBIZ_CLEAR_DATA_SOURCE_INT,clear_data_source);
            ...
            fastMsg.SetString(LDBizTagDefine.LDBizTag.LDBIZ_SETT_CLEAR_STATUS_STR,sett_clear_status);
    ...
    public class ReqFuncclfofuL_1_4DTO : ReqBaseDTO
    {
        public ReqFuncclfofuL_1_4DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "clfofuL.1.4";
            CommonDTO.func_code = CommonDTO.function_code;
        }
    ...
    //逻辑_清算外盘期货_公用_数据归历史
    public class ReqFuncclfofuL_1_21DTO : ReqBaseDTO
    {
        public ReqFuncclfofuL_1_21DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "clfofuL.1.21";
            CommonDTO.func_code = CommonDTO.function_code;
            init_date = 0;
        }
    ...
    //逻辑_清算外盘期货_公用_重做准备
    public class ReqFuncclfofuL_1_41DTO : ReqBaseDTO
    {
        public ReqFuncclfofuL_1_41DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "clfofuL.1.41";
            CommonDTO.func_code = CommonDTO.function_code;
            sett_redo_type = 0;
            clear_date = 0;
            clear_deal_id = 0;
        ...
        public override LDsdkDefine.LDPackerAdapter CreatePacker()
        {
            ...
            packer.AddField("sett_redo_type", ELDDATATYPE.LD_DATATYPE_INT);
            packer.AddField("clear_date", ELDDATATYPE.LD_DATATYPE_INT);
            packer.AddField("clear_deal_id", ELDDATATYPE.LD_DATATYPE_LONG);
            packer.AddField("sett_date", ELDDATATYPE.LD_DATATYPE_INT);
            packer.AddField("sett_deal_id", ELDDATATYPE.LD_DATATYPE_LONG);
            ...
            packer.AddInt(sett_redo_type);
            packer.AddInt(clear_date);
            packer.AddInt64(clear_deal_id);
            packer.AddInt(sett_date);
            packer.AddInt64(sett_deal_id);
            packer.EndPack();
    ...
    //逻辑_清算外盘期货_公用_处理流程统计
    public class ReqFuncclfofuL_1_42DTO : ReqBaseDTO
    {
        public ReqFuncclfofuL_1_42DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "clfofuL.1.42";
            CommonDTO.func_code = CommonDTO.function_code;
            sett_flow_step = 0;
        }
        ...
        public override LDsdkDefine.LDPackerAdapter CreatePacker()
        {
            ...
            packer.AddField("sett_flow_step", ELDDATATYPE.LD_DATATYPE_INT);
    ...
    public class ReqFuncclfofuL_1_43DTO : ReqBaseDTO
    {
        public ReqFuncclfofuL_1_43DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "clfofuL.1.43";
            CommonDTO.func_code = CommonDTO.function_code;
            init_date = 0;
            sett_flow_step = 0;
            exch_no = 0;
    ...
    //逻辑_清算外盘期货_公用_检查处理流程正确性
    public class ReqFuncclfofuL_1_44DTO : ReqBaseDTO
    {
        public ReqFuncclfofuL_1_44DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "clfofuL.1.44";
            CommonDTO.func_code = CommonDTO.function_code;
            init_date = 0;
            sett_flow_step = 0;
            exch_no = 0;
    ...
    public class ReqFuncclfofuL_1_51DTO : ReqBaseDTO
    {
        public ReqFuncclfofuL_1_51DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "clfofuL.1.51";
            CommonDTO.func_code = CommonDTO.function_code;
            task_no = 0;
            exec_count = 0;
            exec_date = 0;
