...
namespace LD.Client.Contract
{
    ...
    public class ReqFuncpdsecuL_21_1DTO : ReqBaseDTO
    {
        public ReqFuncpdsecuL_21_1DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pdsecuL.21.1";
    ...
    public class ReqFuncpdsecuL_21_2DTO : ReqBaseDTO
    {
        public ReqFuncpdsecuL_21_2DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pdsecuL.21.2";
            CommonDTO.func_code = CommonDTO.function_code;
            pd_no = 0;
            asset_acco_no = 0;
            exch_group_no = 0;
    ...
    public class ReqFuncpdsecuL_21_3DTO : ReqBaseDTO
    {
        public ReqFuncpdsecuL_21_3DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pdsecuL.21.3";
            CommonDTO.func_code = CommonDTO.function_code;
            pd_no = 0;
            asset_acco_no = 0;
            exch_group_no = 0;
    ...
    public class ReqFuncpdsecuL_21_4DTO : ReqBaseDTO
    {
        public ReqFuncpdsecuL_21_4DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pdsecuL.21.4";
            CommonDTO.func_code = CommonDTO.function_code;
            pd_no = 0;
            asset_acco_no = 0;
            row_id = 0;
    ...
    public class ReqFuncpdsecuL_21_5DTO : ReqBaseDTO
    {
        public ReqFuncpdsecuL_21_5DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pdsecuL.21.5";
            CommonDTO.func_code = CommonDTO.function_code;
            pd_no = 0;
            asset_acco_no = 0;
            exch_no_str = " ";
    ...
    public class ReqFuncpdsecuL_21_6DTO : ReqBaseDTO
    {
        public ReqFuncpdsecuL_21_6DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pdsecuL.21.6";
            CommonDTO.func_code = CommonDTO.function_code;
            pd_no = 0;
            asset_acco_no = 0;
            exch_group_no = 0;
    ...
    public class ReqFuncpdsecuL_21_21DTO : ReqBaseDTO
    {
        public ReqFuncpdsecuL_21_21DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pdsecuL.21.21";
            CommonDTO.func_code = CommonDTO.function_code;
        }
    ...
    public class ReqFuncpdsecuL_21_22DTO : ReqBaseDTO
    {
        public ReqFuncpdsecuL_21_22DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pdsecuL.21.22";
            CommonDTO.func_code = CommonDTO.function_code;
        }
    ...
    public class ReqFuncpdsecuL_21_7DTO : ReqBaseDTO
    {
        public ReqFuncpdsecuL_21_7DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pdsecuL.21.7";
            CommonDTO.func_code = CommonDTO.function_code;
            co_no = 0;
            pd_no = 0;
            exch_group_no = 0;
        ...
        public override LDsdkDefine.LDPackerAdapter CreatePacker()
        {
            ...
            packer.AddField("debt_fee", ELDDATATYPE.LD_DATATYPE_DOUBLE);
            packer.AddField("debt_interest", ELDDATATYPE.LD_DATATYPE_DOUBLE);
            ...
            packer.AddDouble(debt_fee);
            packer.AddDouble(debt_interest);
