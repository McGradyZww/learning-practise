...
namespace LD.Client.Contract
{
    ...
    public class ReqFuncdcsyncL_6_12DTO : ReqBaseDTO
    {
        public ReqFuncdcsyncL_6_12DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "dcsyncL.6.12";
    ...
    public class ReqFuncdcsyncL_6_13DTO : ReqBaseDTO
    {
        public ReqFuncdcsyncL_6_13DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "dcsyncL.6.13";
            CommonDTO.func_code = CommonDTO.function_code;
        }
    ...
    public class ReqFuncdcsyncL_6_14DTO : ReqBaseDTO
    {
        public ReqFuncdcsyncL_6_14DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "dcsyncL.6.14";
            CommonDTO.func_code = CommonDTO.function_code;
        }
    ...
    public class ReqFuncdcsyncL_6_15DTO : ReqBaseDTO
    {
        public ReqFuncdcsyncL_6_15DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "dcsyncL.6.15";
            CommonDTO.func_code = CommonDTO.function_code;
        }
    ...
    public class ReqFuncdcsyncL_6_16DTO : ReqBaseDTO
    {
        public ReqFuncdcsyncL_6_16DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "dcsyncL.6.16";
            CommonDTO.func_code = CommonDTO.function_code;
        }
