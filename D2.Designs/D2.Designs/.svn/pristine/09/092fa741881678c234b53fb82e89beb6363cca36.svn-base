...
API_EXPORT int LD_CALL_MODE QueryInterface(int iFunIndex, LPBIZ_FUNC_INFO bizFuncInfo)
{
    ...
    if (iFunIndex==0)
    {
        strcpy(bizFuncInfo->szFuncName, "tdsecuL.1.1");
        bizFuncInfo->lpFunc = fnFunc0;
    }
    else if (iFunIndex==1)
    {
        strcpy(bizFuncInfo->szFuncName, "tdsecuL.1.11");
        bizFuncInfo->lpFunc = fnFunc1;
    }
    else if (iFunIndex==2)
    {
        strcpy(bizFuncInfo->szFuncName, "tdsecuL.1.12");
        bizFuncInfo->lpFunc = fnFunc2;
    }
    else if (iFunIndex==3)
    {
        strcpy(bizFuncInfo->szFuncName, "tdsecuL.1.13");
        bizFuncInfo->lpFunc = fnFunc3;
    }
    else if (iFunIndex==4)
    {
        strcpy(bizFuncInfo->szFuncName, "tdsecuL.1.14");
        bizFuncInfo->lpFunc = fnFunc4;
    }
    else if (iFunIndex==5)
    {
        strcpy(bizFuncInfo->szFuncName, "tdsecuL.1.21");
        bizFuncInfo->lpFunc = fnFunc5;
    }
    else if (iFunIndex==6)
    {
        strcpy(bizFuncInfo->szFuncName, "tdsecuL.1.22");
        bizFuncInfo->lpFunc = fnFunc6;
    }
    else if (iFunIndex==7)
    {
        strcpy(bizFuncInfo->szFuncName, "tdsecuL.1.23");
        bizFuncInfo->lpFunc = fnFunc7;
    }
    else if (iFunIndex==8)
    {
        strcpy(bizFuncInfo->szFuncName, "tdsecuL.1.24");
        bizFuncInfo->lpFunc = fnFunc8;
    }
    else if (iFunIndex==9)
    {
        strcpy(bizFuncInfo->szFuncName, "tdsecuL.1.51");
        bizFuncInfo->lpFunc = fnFunc9;
    }
    else if (iFunIndex==10)
    {
        strcpy(bizFuncInfo->szFuncName, "tdsecuL.1.54");
        bizFuncInfo->lpFunc = fnFunc10;
    }
    else if (iFunIndex==11)
    {
        strcpy(bizFuncInfo->szFuncName, "tdsecuL.1.901");
        bizFuncInfo->lpFunc = fnFunc11;
    }
    else if (iFunIndex==12)
    {
        strcpy(bizFuncInfo->szFuncName, "tdsecuL.1.31");
        bizFuncInfo->lpFunc = fnFunc12;
    }
    else if (iFunIndex==13)
    {
        strcpy(bizFuncInfo->szFuncName, "tdsecuL.1.32");
        bizFuncInfo->lpFunc = fnFunc13;
    }
    else if (iFunIndex==14)
    {
        strcpy(bizFuncInfo->szFuncName, "tdsecuL.1.33");
        bizFuncInfo->lpFunc = fnFunc14;
    }
    else if (iFunIndex==15)
    {
        strcpy(bizFuncInfo->szFuncName, "tdsecuL.1.34");
        bizFuncInfo->lpFunc = fnFunc15;
    }
    else if (iFunIndex==16)
    {
        strcpy(bizFuncInfo->szFuncName, "tdsecuL.1.35");
        bizFuncInfo->lpFunc = fnFunc16;
    }
    else if (iFunIndex==17)
    {
        strcpy(bizFuncInfo->szFuncName, "tdsecuL.1.36");
        bizFuncInfo->lpFunc = fnFunc17;
    }
    else if (iFunIndex==18)
    {
        strcpy(bizFuncInfo->szFuncName, "tdsecuL.1.37");
        bizFuncInfo->lpFunc = fnFunc18;
    }
    else if (iFunIndex==19)
    {
        strcpy(bizFuncInfo->szFuncName, "tdsecuL.1.38");
        bizFuncInfo->lpFunc = fnFunc19;
    }
    else if (iFunIndex==20)
    {
        strcpy(bizFuncInfo->szFuncName, "tdsecuL.1.39");
        bizFuncInfo->lpFunc = fnFunc20;
    }
    else if (iFunIndex==21)
    {
        strcpy(bizFuncInfo->szFuncName, "tdsecuL.1.56");
        bizFuncInfo->lpFunc = fnFunc21;
    }
    else if (iFunIndex==22)
    {
        strcpy(bizFuncInfo->szFuncName, "tdsecuL.1.40");
        bizFuncInfo->lpFunc = fnFunc22;
    }
    else if (iFunIndex==23)
    {
        strcpy(bizFuncInfo->szFuncName, "tdsecuL.1.41");
        bizFuncInfo->lpFunc = fnFunc23;
    }
    else if (iFunIndex==24)
    {
        strcpy(bizFuncInfo->szFuncName, "tdsecuL.1.42");
        bizFuncInfo->lpFunc = fnFunc24;
    }
    else if (iFunIndex==25)
    {
        strcpy(bizFuncInfo->szFuncName, "tdsecuL.1.43");
        bizFuncInfo->lpFunc = fnFunc25;
    }
    else if (iFunIndex==26)
    {
        strcpy(bizFuncInfo->szFuncName, "tdsecuL.1.60");
        bizFuncInfo->lpFunc = fnFunc26;
    }
    else if (iFunIndex==27)
    {
        strcpy(bizFuncInfo->szFuncName, "tdsecuL.1.61");
        bizFuncInfo->lpFunc = fnFunc27;
    }
    else if (iFunIndex==28)
    {
        strcpy(bizFuncInfo->szFuncName, "tdsecuL.1.62");
        bizFuncInfo->lpFunc = fnFunc28;
    }
    else if (iFunIndex==29)
    {
        strcpy(bizFuncInfo->szFuncName, "tdsecuL.1.63");
        bizFuncInfo->lpFunc = fnFunc29;
    }
    else if (iFunIndex==30)
    {
        strcpy(bizFuncInfo->szFuncName, "tdsecuL.1.64");
        bizFuncInfo->lpFunc = fnFunc30;
    }
    else if (iFunIndex==31)
    {
        strcpy(bizFuncInfo->szFuncName, "tdsecuL.1.65");
        bizFuncInfo->lpFunc = fnFunc31;
    }
    else if (iFunIndex==32)
    {
        strcpy(bizFuncInfo->szFuncName, "tdsecuL.1.66");
        bizFuncInfo->lpFunc = fnFunc32;
    }
    else if (iFunIndex==33)
    {
        strcpy(bizFuncInfo->szFuncName, "tdsecuL.1.67");
...
int iPriority=lpInBizMsg->GetInt32(LDTAG_PRIORITY);
    ...
    lpTSCall1Req1=glpFastMsgFactory->CreateFastMessage("tdsecuT.1.1", 0);
    ...
    {
        lpOutBizMsg->SetInt32(LDTAG_ERRORNO, -1);
        lpOutBizMsg->SetString(LDTAG_ERRORINFO, "[tdsecuT.1.1]subcall timed out!");
        iRet=-2;
        goto ENDSYS;
    }
...
int iPriority=lpInBizMsg->GetInt32(LDTAG_PRIORITY);
    ...
    strncpy(v_basket_name, lpInBizMsg->GetString(LDBIZ_BASKET_NAME_STR),64);
    v_basket_name[64] = '\0';
    v_weight_type = lpInBizMsg->GetInt32(LDBIZ_WEIGHT_TYPE_INT);
    v_is_public = lpInBizMsg->GetInt32(LDBIZ_IS_PUBLIC_INT);
    v_compos_count = lpInBizMsg->GetInt32(LDBIZ_COMPOS_COUNT_INT);
    strncpy(v_basket_status, lpInBizMsg->GetString(LDBIZ_BASKET_STATUS_STR),2);
    v_basket_status[2] = '\0';
    ...
    lpTSCall1Req1=glpFastMsgFactory->CreateFastMessage("tdsecuT.1.11", 0);
    lpTSCall1Req1->SetInt32(LDTAG_PRIORITY, iPriority);
    lpTSCall1Req1->SetInt32(LDBIZ_OPOR_CO_NO_INT,v_opor_co_no);
    lpTSCall1Req1->SetInt32(LDBIZ_OPOR_NO_INT,v_opor_no);
    lpTSCall1Req1->SetString(LDBIZ_OPER_MAC_STR,v_oper_mac);
    ...
    lpTSCall1Req1->SetString(LDBIZ_BASKET_NAME_STR,v_basket_name);
    lpTSCall1Req1->SetInt32(LDBIZ_WEIGHT_TYPE_INT,v_weight_type);
    lpTSCall1Req1->SetInt32(LDBIZ_IS_PUBLIC_INT,v_is_public);
    lpTSCall1Req1->SetInt32(LDBIZ_COMPOS_COUNT_INT,v_compos_count);
    lpTSCall1Req1->SetString(LDBIZ_BASKET_STATUS_STR,v_basket_status);
    lpTSCall1Req1->SetDouble(LDBIZ_CASH_REPLACE_AMT_FLOAT,v_cash_replace_amt);
    glpTSSubcallSerives->SubCall(lpTSCall1Req1, &lpTSCall1Ans1, 5000);
    if(!lpTSCall1Ans1)  //  超时错误
    {
        lpOutBizMsg->SetInt32(LDTAG_ERRORNO, -1);
        lpOutBizMsg->SetString(LDTAG_ERRORINFO, "[tdsecuT.1.11]subcall timed out!");
        iRet=-2;
        goto ENDSYS;
    }
    else if(lpTSCall1Ans1->GetInt32(LDTAG_ERRORNO)!=0)  //  中间件层面错误
    ...
    strcpy(v_error_code, lpTSCall1Ans1->GetString(LDBIZ_ERROR_CODE_STR));
    strcpy(v_error_info, lpTSCall1Ans1->GetString(LDBIZ_ERROR_INFO_STR));
    v_basket_id = lpTSCall1Ans1->GetInt64(LDBIZ_BASKET_ID_INT64);
...
END:
    ...
    lpOutBizMsg->SetString(LDBIZ_ERROR_PROMPT_STR,v_error_prompt);
    //对输出参数进行赋值处理
    lpOutBizMsg->SetInt64(LDBIZ_BASKET_ID_INT64,v_basket_id);
ENDSYS:
    if(lpTSCall1Ans0)
        lpTSCall1Ans0->FreeMsg();
    if(lpTSCall1Ans1)
...
int iPriority=lpInBizMsg->GetInt32(LDTAG_PRIORITY);
    ...
    lpTSCall1Req1=glpFastMsgFactory->CreateFastMessage("tdsecuT.1.12", 0);
    lpTSCall1Req1->SetInt32(LDTAG_PRIORITY, iPriority);
    lpTSCall1Req1->SetInt32(LDBIZ_OPOR_CO_NO_INT,v_opor_co_no);
    lpTSCall1Req1->SetInt32(LDBIZ_OPOR_NO_INT,v_opor_no);
    lpTSCall1Req1->SetString(LDBIZ_OPER_MAC_STR,v_oper_mac);
    ...
    {
        lpOutBizMsg->SetInt32(LDTAG_ERRORNO, -1);
        lpOutBizMsg->SetString(LDTAG_ERRORINFO, "[tdsecuT.1.12]subcall timed out!");
        iRet=-2;
        goto ENDSYS;
    }
    else if(lpTSCall1Ans1->GetInt32(LDTAG_ERRORNO)!=0)  //  中间件层面错误
...
int iPriority=lpInBizMsg->GetInt32(LDTAG_PRIORITY);
    ...
    lpTSCall1Req1=glpFastMsgFactory->CreateFastMessage("tdsecuT.1.13", 0);
    lpTSCall1Req1->SetInt32(LDTAG_PRIORITY, iPriority);
    lpTSCall1Req1->SetInt32(LDBIZ_OPOR_CO_NO_INT,v_opor_co_no);
    lpTSCall1Req1->SetInt32(LDBIZ_OPOR_NO_INT,v_opor_no);
    lpTSCall1Req1->SetString(LDBIZ_OPER_MAC_STR,v_oper_mac);
    ...
    {
        lpOutBizMsg->SetInt32(LDTAG_ERRORNO, -1);
        lpOutBizMsg->SetString(LDTAG_ERRORINFO, "[tdsecuT.1.13]subcall timed out!");
        iRet=-2;
        goto ENDSYS;
    }
    else if(lpTSCall1Ans1->GetInt32(LDTAG_ERRORNO)!=0)  //  中间件层面错误
...
int iPriority=lpInBizMsg->GetInt32(LDTAG_PRIORITY);
    ...
    lpTSCall1Req1=glpFastMsgFactory->CreateFastMessage("tdsecuT.1.14", 0);
    lpTSCall1Req1->SetInt32(LDTAG_PRIORITY, iPriority);
    lpTSCall1Req1->SetInt32(LDBIZ_OPOR_CO_NO_INT,v_opor_co_no);
    lpTSCall1Req1->SetInt32(LDBIZ_OPOR_NO_INT,v_opor_no);
    lpTSCall1Req1->SetString(LDBIZ_OPER_MAC_STR,v_oper_mac);
    ...
    {
        lpOutBizMsg->SetInt32(LDTAG_ERRORNO, -1);
        lpOutBizMsg->SetString(LDTAG_ERRORINFO, "[tdsecuT.1.14]subcall timed out!");
        iRet=-2;
        goto ENDSYS;
    }
    else if(lpTSCall1Ans1->GetInt32(LDTAG_ERRORNO)!=0)  //  中间件层面错误
...
int LD_CALL_MODE fnFunc5(const char* lpFuncID, IFastMessage* lpInBizMsg, IFastMessage* lpOutBizMsg, IDB_Connection* lpDBConnect)
{
    ...
    int v_stock_code_no;
    double v_compos_qty;
    double v_compos_ratio;
    int v_repl_stock_code_no;
    double v_repl_qty;
    char v_error_code[33];
    char v_error_info[256];
    int v_error_level;
...
int iPriority=lpInBizMsg->GetInt32(LDTAG_PRIORITY);
    ...
    v_compos_qty = lpInBizMsg->GetDouble(LDBIZ_COMPOS_QTY_FLOAT);
    v_compos_ratio = lpInBizMsg->GetDouble(LDBIZ_COMPOS_RATIO_FLOAT);
    v_repl_stock_code_no = lpInBizMsg->GetInt32(LDBIZ_REPL_STOCK_CODE_NO_INT);
    v_repl_qty = lpInBizMsg->GetDouble(LDBIZ_REPL_QTY_FLOAT);
    ...
    lpTSCall1Req1=glpFastMsgFactory->CreateFastMessage("tdsecuT.1.21", 0);
    lpTSCall1Req1->SetInt32(LDTAG_PRIORITY, iPriority);
    lpTSCall1Req1->SetInt32(LDBIZ_OPOR_CO_NO_INT,v_opor_co_no);
    lpTSCall1Req1->SetInt32(LDBIZ_OPOR_NO_INT,v_opor_no);
    lpTSCall1Req1->SetString(LDBIZ_OPER_MAC_STR,v_oper_mac);
    ...
    lpTSCall1Req1->SetDouble(LDBIZ_COMPOS_QTY_FLOAT,v_compos_qty);
    lpTSCall1Req1->SetDouble(LDBIZ_COMPOS_RATIO_FLOAT,v_compos_ratio);
    lpTSCall1Req1->SetInt32(LDBIZ_REPL_STOCK_CODE_NO_INT,v_repl_stock_code_no);
    lpTSCall1Req1->SetDouble(LDBIZ_REPL_QTY_FLOAT,v_repl_qty);
    glpTSSubcallSerives->SubCall(lpTSCall1Req1, &lpTSCall1Ans1, 5000);
    if(!lpTSCall1Ans1)  //  超时错误
    {
        lpOutBizMsg->SetInt32(LDTAG_ERRORNO, -1);
        lpOutBizMsg->SetString(LDTAG_ERRORINFO, "[tdsecuT.1.21]subcall timed out!");
        iRet=-2;
        goto ENDSYS;
    }
    else if(lpTSCall1Ans1->GetInt32(LDTAG_ERRORNO)!=0)  //  中间件层面错误
...
int iPriority=lpInBizMsg->GetInt32(LDTAG_PRIORITY);
    ...
    lpTSCall1Req1=glpFastMsgFactory->CreateFastMessage("tdsecuT.1.22", 0);
    lpTSCall1Req1->SetInt32(LDTAG_PRIORITY, iPriority);
    lpTSCall1Req1->SetInt32(LDBIZ_OPOR_CO_NO_INT,v_opor_co_no);
    lpTSCall1Req1->SetInt32(LDBIZ_OPOR_NO_INT,v_opor_no);
    lpTSCall1Req1->SetString(LDBIZ_OPER_MAC_STR,v_oper_mac);
    ...
    {
        lpOutBizMsg->SetInt32(LDTAG_ERRORNO, -1);
        lpOutBizMsg->SetString(LDTAG_ERRORINFO, "[tdsecuT.1.22]subcall timed out!");
        iRet=-2;
        goto ENDSYS;
    }
    else if(lpTSCall1Ans1->GetInt32(LDTAG_ERRORNO)!=0)  //  中间件层面错误
    ...
    strcpy(v_error_code, lpTSCall1Ans1->GetString(LDBIZ_ERROR_CODE_STR));
    strcpy(v_error_info, lpTSCall1Ans1->GetString(LDBIZ_ERROR_INFO_STR));
    v_basket_no = lpTSCall1Ans1->GetInt32(LDBIZ_BASKET_NO_INT);
...
int iPriority=lpInBizMsg->GetInt32(LDTAG_PRIORITY);
    ...
    lpTSCall1Req1=glpFastMsgFactory->CreateFastMessage("tdsecuT.1.23", 0);
    lpTSCall1Req1->SetInt32(LDTAG_PRIORITY, iPriority);
    lpTSCall1Req1->SetInt32(LDBIZ_OPOR_CO_NO_INT,v_opor_co_no);
    lpTSCall1Req1->SetInt32(LDBIZ_OPOR_NO_INT,v_opor_no);
    lpTSCall1Req1->SetString(LDBIZ_OPER_MAC_STR,v_oper_mac);
    ...
    {
        lpOutBizMsg->SetInt32(LDTAG_ERRORNO, -1);
        lpOutBizMsg->SetString(LDTAG_ERRORINFO, "[tdsecuT.1.23]subcall timed out!");
        iRet=-2;
        goto ENDSYS;
    }
    else if(lpTSCall1Ans1->GetInt32(LDTAG_ERRORNO)!=0)  //  中间件层面错误
...
int iPriority=lpInBizMsg->GetInt32(LDTAG_PRIORITY);
    ...
    lpTSCall1Req1=glpFastMsgFactory->CreateFastMessage("tdsecuT.1.24", 0);
    lpTSCall1Req1->SetInt32(LDTAG_PRIORITY, iPriority);
    lpTSCall1Req1->SetInt32(LDBIZ_OPOR_CO_NO_INT,v_opor_co_no);
    lpTSCall1Req1->SetInt32(LDBIZ_OPOR_NO_INT,v_opor_no);
    lpTSCall1Req1->SetString(LDBIZ_OPER_MAC_STR,v_oper_mac);
    ...
    {
        lpOutBizMsg->SetInt32(LDTAG_ERRORNO, -1);
        lpOutBizMsg->SetString(LDTAG_ERRORINFO, "[tdsecuT.1.24]subcall timed out!");
        iRet=-2;
        goto ENDSYS;
    }
    else if(lpTSCall1Ans1->GetInt32(LDTAG_ERRORNO)!=0)  //  中间件层面错误
...
int iPriority=lpInBizMsg->GetInt32(LDTAG_PRIORITY);
    ...
    lpTSCall1Req2=glpFastMsgFactory->CreateFastMessage("pubT.24.50", 0);
    lpTSCall1Req2->SetInt32(LDTAG_PRIORITY, iPriority);
    lpTSCall1Req2->SetInt32(LDBIZ_OPOR_CO_NO_INT,v_opor_co_no);
    lpTSCall1Req2->SetInt32(LDBIZ_OPOR_NO_INT,v_opor_no);
    lpTSCall1Req2->SetString(LDBIZ_OPER_MAC_STR,v_oper_mac);
    ...
    v_next_init_date = lpTSCall1Ans2->GetInt32(LDBIZ_NEXT_INIT_DATE_INT);

    //调用过程[事务_交易证券_公用_交易初始化]
    //组织事务请求
    if(lpTSCall1Ans3)
    {
    ...
    lpTSCall1Req3=glpFastMsgFactory->CreateFastMessage("tdsecuT.1.52", 0);
    ...
    {
        lpOutBizMsg->SetInt32(LDTAG_ERRORNO, -1);
        lpOutBizMsg->SetString(LDTAG_ERRORINFO, "[tdsecuT.1.52]subcall timed out!");
        iRet=-2;
        goto ENDSYS;
    }
    ...
    if (v_deal_flag == 0)
    {
        ...
        lpTSCall1Req4=glpFastMsgFactory->CreateFastMessage("tdsecuT.1.51", 0);
        ...
        lpTSCall1Req4->SetInt32(LDBIZ_NEXT_INIT_DATE_INT,v_next_init_date);
        glpTSSubcallSerives->SubCall(lpTSCall1Req4, &lpTSCall1Ans4, 5000);
        if(!lpTSCall1Ans4)  //  超时错误
        {
            lpOutBizMsg->SetInt32(LDTAG_ERRORNO, -1);
            lpOutBizMsg->SetString(LDTAG_ERRORINFO, "[tdsecuT.1.51]subcall timed out!");
            iRet=-2;
            goto ENDSYS;
        }
    ...
    while (true)
    {
        ...
        lpTSCall1Req5=glpFastMsgFactory->CreateFastMessage("tdsecuT.3.30", 0);
        ...
        {
            lpOutBizMsg->SetInt32(LDTAG_ERRORNO, -1);
            lpOutBizMsg->SetString(LDTAG_ERRORINFO, "[tdsecuT.3.30]subcall timed out!");
            iRet=-2;
            goto ENDSYS;
        }
        ...
        if (strcmp(v_error_code,"0")==0)
        {
            ...
            // set @临时_指令撤销数量# = @指令数量# - @指令撤销数量#;
            v_tmp_comm_cancel_qty = v_comm_qty - v_comm_cancel_qty;

            // set @临时_指令撤销数量# = @临时_指令撤销数量# - @订单数量#;
            v_tmp_comm_cancel_qty = v_tmp_comm_cancel_qty - v_order_qty;

            // if @临时_指令撤销数量# > 0 and (@指令方向# = 《指令方向-买入》 or @指令方向# = 《指令方向-卖出》) and ((@指令结束日期# <> 0 and @指令结束日期# >= @初始化日期#) or (@指令结束日期# = 0 and @指令日期# >= @初始化日期#)) and @净价标志# = 《净价标志-净价》 and @债券利率类型# <> 《债券利率类型-零息》 and (@证券类型# > 20 and @证券类型# < 50) then
            if (v_tmp_comm_cancel_qty > 0 && (v_comm_dir == 1 || v_comm_dir == 2) && ((v_comm_end_date != 0 && v_comm_end_date >= v_init_date) || (v_comm_end_date == 0 && v_comm_date >= v_init_date)) && v_net_price_flag == 1 && v_bond_rate_type != 3 && (v_stock_type > 20 && v_stock_type < 50))
            {
                //调用过程[事务_公共_公共接口_获取编号债券计提利息]
                //组织事务请求
                if(lpTSCall1Ans6)
                {
                ...
                lpTSCall1Req6=glpFastMsgFactory->CreateFastMessage("pubT.24.103", 0);
                ...
                {
                    lpOutBizMsg->SetInt32(LDTAG_ERRORNO, -1);
                    lpOutBizMsg->SetString(LDTAG_ERRORINFO, "[pubT.24.103]subcall timed out!");
                    iRet=-2;
                    goto ENDSYS;
                }
                ...
                if (strcmp(v_error_code,"0" )==0)
                {
                    ...
                    lpTSCall1Req7=glpFastMsgFactory->CreateFastMessage("tdsecuT.3.31", 0);
                    ...
                    lpTSCall1Req7->SetInt32(LDBIZ_COMM_DATE_INT,v_comm_date);
                    ...
                    {
                        lpOutBizMsg->SetInt32(LDTAG_ERRORNO, -1);
                        lpOutBizMsg->SetString(LDTAG_ERRORINFO, "[tdsecuT.3.31]subcall timed out!");
                        iRet=-2;
                        goto ENDSYS;
                    }
...
int iPriority=lpInBizMsg->GetInt32(LDTAG_PRIORITY);
    ...
    // set @组合失效判断# = 《组合失效判断-不判断》;
    strcpy(v_comb_invalid_judge,"1");
    //调用过程[事务_公共_公共接口_获取系统初始化日期和下一初始化日期]
    //组织事务请求
    if(lpTSCall1Ans2)
    {
    ...
    // if @组合失效判断# <> 《组合失效判断-不判断》 then
    if (strcmp(v_comb_invalid_judge , "1")!=0)
    {
        //调用过程[事务_交易证券_指令_获取去重指令批号]
        //组织事务请求
        if(lpTSCall1Ans3)
        {
          lpTSCall1Ans3->FreeMsg();
        ...
        lpTSCall1Req3=glpFastMsgFactory->CreateFastMessage("tdsecuT.3.83", 0);
        lpTSCall1Req3->SetInt32(LDTAG_PRIORITY, iPriority);
        lpTSCall1Req3->SetInt32(LDBIZ_OPOR_CO_NO_INT,v_opor_co_no);
        lpTSCall1Req3->SetInt32(LDBIZ_OPOR_NO_INT,v_opor_no);
        lpTSCall1Req3->SetString(LDBIZ_OPER_MAC_STR,v_oper_mac);
        ...
        {
            lpOutBizMsg->SetInt32(LDTAG_ERRORNO, -1);
            lpOutBizMsg->SetString(LDTAG_ERRORINFO, "[tdsecuT.3.83]subcall timed out!");
            iRet=-2;
            goto ENDSYS;
        }
        else if(lpTSCall1Ans3->GetInt32(LDTAG_ERRORNO)!=0)  //  中间件层面错误
        ...
        for (int i = 0; i < iRecordCount;i++) 
        {
            ...
            lpTSCall1Req4=glpFastMsgFactory->CreateFastMessage("tdsecuT.2.65", 0);
            lpTSCall1Req4->SetInt32(LDTAG_PRIORITY, iPriority);
            lpTSCall1Req4->SetInt32(LDBIZ_OPOR_CO_NO_INT,v_opor_co_no);
            lpTSCall1Req4->SetInt32(LDBIZ_OPOR_NO_INT,v_opor_no);
            lpTSCall1Req4->SetString(LDBIZ_OPER_MAC_STR,v_oper_mac);
            ...
            {
                lpOutBizMsg->SetInt32(LDTAG_ERRORNO, -1);
                lpOutBizMsg->SetString(LDTAG_ERRORINFO, "[tdsecuT.2.65]subcall timed out!");
                iRet=-2;
                goto ENDSYS;
            }
            else if(lpTSCall1Ans4->GetInt32(LDTAG_ERRORNO)!=0)  //  中间件层面错误
    ...
    lpTSCall1Req5=glpFastMsgFactory->CreateFastMessage("tdsecuT.1.42", 0);
    lpTSCall1Req5->SetInt32(LDTAG_PRIORITY, iPriority);
    lpTSCall1Req5->SetInt32(LDBIZ_OPOR_CO_NO_INT,v_opor_co_no);
    lpTSCall1Req5->SetInt32(LDBIZ_OPOR_NO_INT,v_opor_no);
    lpTSCall1Req5->SetString(LDBIZ_OPER_MAC_STR,v_oper_mac);
    ...
    {
        lpOutBizMsg->SetInt32(LDTAG_ERRORNO, -1);
        lpOutBizMsg->SetString(LDTAG_ERRORINFO, "[tdsecuT.1.42]subcall timed out!");
        iRet=-2;
        goto ENDSYS;
    }
    else if(lpTSCall1Ans5->GetInt32(LDTAG_ERRORNO)!=0)  //  中间件层面错误
    ...
    for (int i = 0; i < iRecordCount;i++) 
    {
        ...
        lpTSCall1Req6=glpFastMsgFactory->CreateFastMessage("pubT.24.83", 0);
        lpTSCall1Req6->SetInt32(LDTAG_PRIORITY, iPriority);
        lpTSCall1Req6->SetInt32(LDBIZ_OPOR_CO_NO_INT,v_opor_co_no);
        lpTSCall1Req6->SetInt32(LDBIZ_OPOR_NO_INT,v_opor_no);
        lpTSCall1Req6->SetString(LDBIZ_OPER_MAC_STR,v_oper_mac);
        ...
        strcpy(v_error_code, lpTSCall1Ans6->GetString(LDBIZ_ERROR_CODE_STR));
        strcpy(v_error_info, lpTSCall1Ans6->GetString(LDBIZ_ERROR_INFO_STR));
        strcpy(v_co_busi_config_str, lpTSCall1Ans6->GetString(LDBIZ_CO_BUSI_CONFIG_STR_STR));

        //调用过程[事务_交易证券_公用_归档更新t0资金]
        //组织事务请求
        if(lpTSCall1Ans7)
        {
          lpTSCall1Ans7->FreeMsg();
        ...
        lpTSCall1Req7=glpFastMsgFactory->CreateFastMessage("tdsecuT.1.43", 0);
        lpTSCall1Req7->SetInt32(LDTAG_PRIORITY, iPriority);
        lpTSCall1Req7->SetInt32(LDBIZ_OPOR_CO_NO_INT,v_opor_co_no);
        lpTSCall1Req7->SetInt32(LDBIZ_OPOR_NO_INT,v_opor_no);
        lpTSCall1Req7->SetString(LDBIZ_OPER_MAC_STR,v_oper_mac);
        ...
        glpTSSubcallSerives->SubCall(lpTSCall1Req7, &lpTSCall1Ans7, 600000);
        if(!lpTSCall1Ans7)  //  超时错误
        {
            lpOutBizMsg->SetInt32(LDTAG_ERRORNO, -1);
            lpOutBizMsg->SetString(LDTAG_ERRORINFO, "[tdsecuT.1.43]subcall timed out!");
            iRet=-2;
            goto ENDSYS;
        }
        else if(lpTSCall1Ans7->GetInt32(LDTAG_ERRORNO)!=0)  //  中间件层面错误
    ...
    lpTSCall1Req8=glpFastMsgFactory->CreateFastMessage("tdsecuT.1.54", 0);
    lpTSCall1Req8->SetInt32(LDTAG_PRIORITY, iPriority);
    lpTSCall1Req8->SetInt32(LDBIZ_OPOR_CO_NO_INT,v_opor_co_no);
    lpTSCall1Req8->SetInt32(LDBIZ_OPOR_NO_INT,v_opor_no);
    lpTSCall1Req8->SetString(LDBIZ_OPER_MAC_STR,v_oper_mac);
    ...
    lpTSCall1Req8->SetInt32(LDBIZ_NEXT_INIT_DATE_INT,v_next_init_date);
    ...
    glpTSSubcallSerives->SubCall(lpTSCall1Req8, &lpTSCall1Ans8, 600000);
    if(!lpTSCall1Ans8)  //  超时错误
    {
        lpOutBizMsg->SetInt32(LDTAG_ERRORNO, -1);
        lpOutBizMsg->SetString(LDTAG_ERRORINFO, "[tdsecuT.1.54]subcall timed out!");
        iRet=-2;
        goto ENDSYS;
    }
    ...
    while (true)
    {
        ...
        lpTSCall1Req9=glpFastMsgFactory->CreateFastMessage("tdsecuT.3.30", 0);
        ...
        v_trade_code_no = lpTSCall1Ans9->GetInt32(LDBIZ_TRADE_CODE_NO_INT);
        ...
        v_par_value = lpTSCall1Ans9->GetDouble(LDBIZ_PAR_VALUE_FLOAT);
        v_impawn_ratio = lpTSCall1Ans9->GetDouble(LDBIZ_IMPAWN_RATIO_FLOAT);
        v_intrst_days = lpTSCall1Ans9->GetInt32(LDBIZ_INTRST_DAYS_INT);
        ...
        strcpy(v_combo_code, lpTSCall1Ans9->GetString(LDBIZ_COMBO_CODE_STR));
        ...
        if (strcmp(v_error_code,"0")==0)
        {
            ...
            if (v_tmp_comm_cancel_qty > 0 && (v_comm_dir == 1 || v_comm_dir == 2) && ((v_comm_end_date != 0 && v_comm_end_date >= v_init_date) || (v_comm_end_date == 0 && v_comm_date >= v_init_date)) && v_net_price_flag == 1 && v_bond_rate_type != 3 && (v_stock_type > 20 && v_stock_type < 50))
            {
                ...
                lpTSCall1Req10=glpFastMsgFactory->CreateFastMessage("pubT.24.103", 0);
                ...
                v_par_value = lpTSCall1Ans10->GetDouble(LDBIZ_PAR_VALUE_FLOAT);
                ...
                if (strcmp(v_error_code,"0" )==0)
                {
                    ...
                    lpTSCall1Req11=glpFastMsgFactory->CreateFastMessage("tdsecuT.3.31", 0);
    ...
    lpTSCall1Req12=glpFastMsgFactory->CreateFastMessage("tdsecuT.2.49", 0);
    ...
    lpTSCall1Req12->SetString(LDBIZ_EXCH_NO_STR_STR,v_exch_no_str);
    lpTSCall1Req12->SetInt32(LDBIZ_STOCK_CODE_NO_INT,v_stock_code_no);
    lpTSCall1Req12->SetInt64(LDBIZ_ROW_ID_INT64,v_row_id);
    lpTSCall1Req12->SetInt32(LDBIZ_ROW_COUNT_INT,v_row_count);
    lpTSCall1Req12->SetInt32(LDBIZ_SORT_TYPE_INT,v_sort_type);
    lpTSCall1Req12->SetString(LDBIZ_CO_NO_RIGHTS_STR_STR,v_co_no_rights_str);
    lpTSCall1Req12->SetString(LDBIZ_PD_NO_RIGHTS_STR_STR,v_pd_no_rights_str);
    lpTSCall1Req12->SetString(LDBIZ_EXCH_GROUP_NO_RIGHTS_STR_STR,v_exch_group_no_rights_str);
    ...
    for (int i = 0; i < iRecordCount;i++) 
    {
        ...
        if(lpRecord)
        {
            ...
            v_pre_settle_qty = lpRecord->GetDouble(LDBIZ_PRE_SETTLE_QTY_FLOAT);
        ...
        lpTSCall1Req13=glpFastMsgFactory->CreateFastMessage("pubT.24.105", 0);
        ...
        strcpy(v_error_code, lpTSCall1Ans13->GetString(LDBIZ_ERROR_CODE_STR));
        strcpy(v_error_info, lpTSCall1Ans13->GetString(LDBIZ_ERROR_INFO_STR));
        v_up_limit_price = lpTSCall1Ans13->GetDouble(LDBIZ_UP_LIMIT_PRICE_FLOAT);
        v_down_limit_price = lpTSCall1Ans13->GetDouble(LDBIZ_DOWN_LIMIT_PRICE_FLOAT);
        v_last_price = lpTSCall1Ans13->GetDouble(LDBIZ_LAST_PRICE_FLOAT);


        // set @组合市值# = @持仓数量# * @最新价#;
        v_combo_market_value = v_posi_qty * v_last_price;
        //调用过程[事务_交易证券_账户_更新组合市值]
        //组织事务请求
        if(lpTSCall1Ans14)
        {
        ...
        lpTSCall1Req14=glpFastMsgFactory->CreateFastMessage("tdsecuT.2.47", 0);
        ...
        lpTSCall1Req14->SetDouble(LDBIZ_COMBO_MARKET_VALUE_FLOAT,v_combo_market_value);
        lpTSCall1Req14->SetInt32(LDBIZ_OPEN_POSI_DATE_INT,v_open_posi_date);
        glpTSSubcallSerives->SubCall(lpTSCall1Req14, &lpTSCall1Ans14, 5000);
        if(!lpTSCall1Ans14)  //  超时错误
        {
            lpOutBizMsg->SetInt32(LDTAG_ERRORNO, -1);
            lpOutBizMsg->SetString(LDTAG_ERRORINFO, "[tdsecuT.2.47]subcall timed out!");
            iRet=-2;
            goto ENDSYS;
        }
...
int iPriority=lpInBizMsg->GetInt32(LDTAG_PRIORITY);
    ...
    lpTSCall1Req1=glpFastMsgFactory->CreateFastMessage("tdsecuT.1.901", 0);
    lpTSCall1Req1->SetInt32(LDTAG_PRIORITY, iPriority);
    lpTSCall1Req1->SetInt32(LDBIZ_OPOR_CO_NO_INT,v_opor_co_no);
    lpTSCall1Req1->SetInt32(LDBIZ_OPOR_NO_INT,v_opor_no);
    lpTSCall1Req1->SetString(LDBIZ_OPER_MAC_STR,v_oper_mac);
...
int LD_CALL_MODE fnFunc12(const char* lpFuncID, IFastMessage* lpInBizMsg, IFastMessage* lpOutBizMsg, IDB_Connection* lpDBConnect)
{
    ...
    char v_comb_name[65];
    int v_is_public;
    int v_create_failure_validity_date;
    int v_create_end_validity_date;
    int v_rebalance_failure_validity_date;
    int v_rebalance_end_validity_date;
    int v_repair_failure_validity_date;
    int v_repair_end_validity_date;
    int v_broke_validity_date;
...
int iPriority=lpInBizMsg->GetInt32(LDTAG_PRIORITY);
    ...
    strcpy(v_comb_name, " ");
    v_is_public=0;
    v_create_failure_validity_date=0;
    v_create_end_validity_date=0;
    v_rebalance_failure_validity_date=0;
    v_rebalance_end_validity_date=0;
    v_repair_failure_validity_date=0;
    v_repair_end_validity_date=0;
    v_broke_validity_date=0;
    ...
    v_combo_code[32] = '\0';
    strncpy(v_comb_name, lpInBizMsg->GetString(LDBIZ_COMB_NAME_STR),64);
    v_comb_name[64] = '\0';
    v_is_public = lpInBizMsg->GetInt32(LDBIZ_IS_PUBLIC_INT);
    v_create_failure_validity_date = lpInBizMsg->GetInt32(LDBIZ_CREATE_FAILURE_VALIDITY_DATE_INT);
    v_create_end_validity_date = lpInBizMsg->GetInt32(LDBIZ_CREATE_END_VALIDITY_DATE_INT);
    v_rebalance_failure_validity_date = lpInBizMsg->GetInt32(LDBIZ_REBALANCE_FAILURE_VALIDITY_DATE_INT);
    v_rebalance_end_validity_date = lpInBizMsg->GetInt32(LDBIZ_REBALANCE_END_VALIDITY_DATE_INT);
    v_repair_failure_validity_date = lpInBizMsg->GetInt32(LDBIZ_REPAIR_FAILURE_VALIDITY_DATE_INT);
    v_repair_end_validity_date = lpInBizMsg->GetInt32(LDBIZ_REPAIR_END_VALIDITY_DATE_INT);
    v_broke_validity_date = lpInBizMsg->GetInt32(LDBIZ_BROKE_VALIDITY_DATE_INT);
    ...
    lpTSCall1Req1=glpFastMsgFactory->CreateFastMessage("tdsecuT.1.31", 0);
    lpTSCall1Req1->SetInt32(LDTAG_PRIORITY, iPriority);
    lpTSCall1Req1->SetInt32(LDBIZ_OPOR_CO_NO_INT,v_opor_co_no);
    lpTSCall1Req1->SetInt32(LDBIZ_OPOR_NO_INT,v_opor_no);
    lpTSCall1Req1->SetString(LDBIZ_OPER_MAC_STR,v_oper_mac);
    ...
    lpTSCall1Req1->SetString(LDBIZ_COMB_NAME_STR,v_comb_name);
    lpTSCall1Req1->SetInt32(LDBIZ_IS_PUBLIC_INT,v_is_public);
    lpTSCall1Req1->SetInt32(LDBIZ_CREATE_FAILURE_VALIDITY_DATE_INT,v_create_failure_validity_date);
    lpTSCall1Req1->SetInt32(LDBIZ_CREATE_END_VALIDITY_DATE_INT,v_create_end_validity_date);
    lpTSCall1Req1->SetInt32(LDBIZ_REBALANCE_FAILURE_VALIDITY_DATE_INT,v_rebalance_failure_validity_date);
    lpTSCall1Req1->SetInt32(LDBIZ_REBALANCE_END_VALIDITY_DATE_INT,v_rebalance_end_validity_date);
    lpTSCall1Req1->SetInt32(LDBIZ_REPAIR_FAILURE_VALIDITY_DATE_INT,v_repair_failure_validity_date);
    lpTSCall1Req1->SetInt32(LDBIZ_REPAIR_END_VALIDITY_DATE_INT,v_repair_end_validity_date);
    lpTSCall1Req1->SetInt32(LDBIZ_BROKE_VALIDITY_DATE_INT,v_broke_validity_date);
    lpTSCall1Req1->SetString(LDBIZ_REMARK_INFO_STR,v_remark_info);
    glpTSSubcallSerives->SubCall(lpTSCall1Req1, &lpTSCall1Ans1, 5000);
    if(!lpTSCall1Ans1)  //  超时错误
    {
        lpOutBizMsg->SetInt32(LDTAG_ERRORNO, -1);
        lpOutBizMsg->SetString(LDTAG_ERRORINFO, "[tdsecuT.1.31]subcall timed out!");
        iRet=-2;
        goto ENDSYS;
    }
    else if(lpTSCall1Ans1->GetInt32(LDTAG_ERRORNO)!=0)  //  中间件层面错误
    ...
    strcpy(v_error_code, lpTSCall1Ans1->GetString(LDBIZ_ERROR_CODE_STR));
    strcpy(v_error_info, lpTSCall1Ans1->GetString(LDBIZ_ERROR_INFO_STR));
    v_combo_id = lpTSCall1Ans1->GetInt64(LDBIZ_COMBO_ID_INT64);
    ...
    // [主动推送][secu.combo][证券主推_组合_组合主推消息]
    lpPubMsg = glpFastMsgFactory->CreateFastMessage("pushL.2.901", 0);
    ...
    lpPubMsg->SetString(LDBIZ_COMB_NAME_STR,v_comb_name);
    lpPubMsg->SetInt32(LDBIZ_IS_PUBLIC_INT,v_is_public);
    lpPubMsg->SetString(LDBIZ_REMARK_INFO_STR,v_remark_info);
    lpPubMsg->SetInt32(LDBIZ_UPDATE_TIMES_INT,v_update_times);
    glpPubSub_Interface->PubTopics("secu.combo", lpPubMsg);
...
END:
    ...
    lpOutBizMsg->SetString(LDBIZ_ERROR_PROMPT_STR,v_error_prompt);
    //对输出参数进行赋值处理
    lpOutBizMsg->SetInt64(LDBIZ_COMBO_ID_INT64,v_combo_id);
ENDSYS:
    if(lpTSCall1Ans0)
        lpTSCall1Ans0->FreeMsg();
    if(lpTSCall1Ans1)
...
int iPriority=lpInBizMsg->GetInt32(LDTAG_PRIORITY);
    ...
    strncpy(v_func_code, lpInBizMsg->GetString(LDBIZ_FUNC_CODE_STR),16);
    v_func_code[16] = '\0';
    v_combo_id = lpInBizMsg->GetInt64(LDBIZ_COMBO_ID_INT64);
    strncpy(v_combo_code, lpInBizMsg->GetString(LDBIZ_COMBO_CODE_STR),32);
    v_combo_code[32] = '\0';
    strncpy(v_comb_name, lpInBizMsg->GetString(LDBIZ_COMB_NAME_STR),64);
    v_comb_name[64] = '\0';
    ...
    lpTSCall1Req1=glpFastMsgFactory->CreateFastMessage("tdsecuT.1.32", 0);
    lpTSCall1Req1->SetInt32(LDTAG_PRIORITY, iPriority);
    lpTSCall1Req1->SetInt32(LDBIZ_OPOR_CO_NO_INT,v_opor_co_no);
    lpTSCall1Req1->SetInt32(LDBIZ_OPOR_NO_INT,v_opor_no);
    lpTSCall1Req1->SetString(LDBIZ_OPER_MAC_STR,v_oper_mac);
    ...
    lpTSCall1Req1->SetString(LDBIZ_OPER_WAY_STR,v_oper_way);
    lpTSCall1Req1->SetString(LDBIZ_FUNC_CODE_STR,v_func_code);
    lpTSCall1Req1->SetInt64(LDBIZ_COMBO_ID_INT64,v_combo_id);
    lpTSCall1Req1->SetString(LDBIZ_COMBO_CODE_STR,v_combo_code);
    lpTSCall1Req1->SetString(LDBIZ_COMB_NAME_STR,v_comb_name);
    lpTSCall1Req1->SetInt32(LDBIZ_IS_PUBLIC_INT,v_is_public);
    lpTSCall1Req1->SetInt32(LDBIZ_CREATE_FAILURE_VALIDITY_DATE_INT,v_create_failure_validity_date);
    ...
    {
        lpOutBizMsg->SetInt32(LDTAG_ERRORNO, -1);
        lpOutBizMsg->SetString(LDTAG_ERRORINFO, "[tdsecuT.1.32]subcall timed out!");
        iRet=-2;
        goto ENDSYS;
    }
    else if(lpTSCall1Ans1->GetInt32(LDTAG_ERRORNO)!=0)  //  中间件层面错误
    ...
    lpTSCall1Req2=glpFastMsgFactory->CreateFastMessage("tdsecuT.1.35", 0);
    lpTSCall1Req2->SetInt32(LDTAG_PRIORITY, iPriority);
    lpTSCall1Req2->SetInt32(LDBIZ_OPOR_CO_NO_INT,v_opor_co_no);
    lpTSCall1Req2->SetInt32(LDBIZ_OPOR_NO_INT,v_opor_no);
    lpTSCall1Req2->SetString(LDBIZ_OPER_MAC_STR,v_oper_mac);
    ...
    lpTSCall1Req2->SetString(LDBIZ_OPER_WAY_STR,v_oper_way);
    lpTSCall1Req2->SetString(LDBIZ_FUNC_CODE_STR,v_func_code);
    lpTSCall1Req2->SetInt64(LDBIZ_COMBO_ID_INT64,v_combo_id);
    glpTSSubcallSerives->SubCall(lpTSCall1Req2, &lpTSCall1Ans2, 5000);
    if(!lpTSCall1Ans2)  //  超时错误
    {
        lpOutBizMsg->SetInt32(LDTAG_ERRORNO, -1);
        lpOutBizMsg->SetString(LDTAG_ERRORINFO, "[tdsecuT.1.35]subcall timed out!");
        iRet=-2;
        goto ENDSYS;
    }
    else if(lpTSCall1Ans2->GetInt32(LDTAG_ERRORNO)!=0)  //  中间件层面错误
    ...
    strcpy(v_comb_name, lpTSCall1Ans2->GetString(LDBIZ_COMB_NAME_STR));
    v_is_public = lpTSCall1Ans2->GetInt32(LDBIZ_IS_PUBLIC_INT);
    v_create_failure_validity_date = lpTSCall1Ans2->GetInt32(LDBIZ_CREATE_FAILURE_VALIDITY_DATE_INT);
    v_create_end_validity_date = lpTSCall1Ans2->GetInt32(LDBIZ_CREATE_END_VALIDITY_DATE_INT);
    v_rebalance_failure_validity_date = lpTSCall1Ans2->GetInt32(LDBIZ_REBALANCE_FAILURE_VALIDITY_DATE_INT);
    v_rebalance_end_validity_date = lpTSCall1Ans2->GetInt32(LDBIZ_REBALANCE_END_VALIDITY_DATE_INT);
    v_repair_failure_validity_date = lpTSCall1Ans2->GetInt32(LDBIZ_REPAIR_FAILURE_VALIDITY_DATE_INT);
    v_repair_end_validity_date = lpTSCall1Ans2->GetInt32(LDBIZ_REPAIR_END_VALIDITY_DATE_INT);
    v_broke_validity_date = lpTSCall1Ans2->GetInt32(LDBIZ_BROKE_VALIDITY_DATE_INT);
...
int iPriority=lpInBizMsg->GetInt32(LDTAG_PRIORITY);
    ...
    lpTSCall1Req1=glpFastMsgFactory->CreateFastMessage("tdsecuT.1.33", 0);
    lpTSCall1Req1->SetInt32(LDTAG_PRIORITY, iPriority);
    lpTSCall1Req1->SetInt32(LDBIZ_OPOR_CO_NO_INT,v_opor_co_no);
    lpTSCall1Req1->SetInt32(LDBIZ_OPOR_NO_INT,v_opor_no);
    lpTSCall1Req1->SetString(LDBIZ_OPER_MAC_STR,v_oper_mac);
    ...
    {
        lpOutBizMsg->SetInt32(LDTAG_ERRORNO, -1);
        lpOutBizMsg->SetString(LDTAG_ERRORINFO, "[tdsecuT.1.33]subcall timed out!");
        iRet=-2;
        goto ENDSYS;
    }
    else if(lpTSCall1Ans1->GetInt32(LDTAG_ERRORNO)!=0)  //  中间件层面错误
    ...
    // [主动推送][secu.combodel][证券主推_组合_组合删除主推消息]
    lpPubMsg = glpFastMsgFactory->CreateFastMessage("pushL.2.902", 0);
    lpPubMsg->SetInt64(LDBIZ_COMBO_ID_INT64,v_combo_id);
    glpPubSub_Interface->PubTopics("secu.combodel", lpPubMsg);
...
int iPriority=lpInBizMsg->GetInt32(LDTAG_PRIORITY);
    ...
    lpTSCall1Req1=glpFastMsgFactory->CreateFastMessage("tdsecuT.1.34", 0);
    lpTSCall1Req1->SetInt32(LDTAG_PRIORITY, iPriority);
    lpTSCall1Req1->SetInt32(LDBIZ_OPOR_CO_NO_INT,v_opor_co_no);
    lpTSCall1Req1->SetInt32(LDBIZ_OPOR_NO_INT,v_opor_no);
    lpTSCall1Req1->SetString(LDBIZ_OPER_MAC_STR,v_oper_mac);
    ...
    {
        lpOutBizMsg->SetInt32(LDTAG_ERRORNO, -1);
        lpOutBizMsg->SetString(LDTAG_ERRORINFO, "[tdsecuT.1.34]subcall timed out!");
        iRet=-2;
        goto ENDSYS;
    }
    else if(lpTSCall1Ans1->GetInt32(LDTAG_ERRORNO)!=0)  //  中间件层面错误
...
int iPriority=lpInBizMsg->GetInt32(LDTAG_PRIORITY);
    ...
    v_stock_code[6] = '\0';
    v_combo_ratio = lpInBizMsg->GetDouble(LDBIZ_COMBO_RATIO_FLOAT);
    v_combo_qty = lpInBizMsg->GetDouble(LDBIZ_COMBO_QTY_FLOAT);
    ...
    //调用过程[事务_公共_公共接口_检查系统状态权限身份获取证券代码编号]
    //组织事务请求
    if(lpTSCall1Ans0)
    {
      lpTSCall1Ans0->FreeMsg();
    ...
    lpTSCall1Req0=glpFastMsgFactory->CreateFastMessage("pubT.24.23", 0);
    lpTSCall1Req0->SetInt32(LDTAG_PRIORITY, iPriority);
    lpTSCall1Req0->SetInt32(LDBIZ_OPOR_CO_NO_INT,v_opor_co_no);
    lpTSCall1Req0->SetInt32(LDBIZ_OPOR_NO_INT,v_opor_no);
    lpTSCall1Req0->SetString(LDBIZ_OPER_MAC_STR,v_oper_mac);
    ...
    {
        lpOutBizMsg->SetInt32(LDTAG_ERRORNO, -1);
        lpOutBizMsg->SetString(LDTAG_ERRORINFO, "[pubT.24.23]subcall timed out!");
        iRet=-2;
        goto ENDSYS;
    }
    else if(lpTSCall1Ans0->GetInt32(LDTAG_ERRORNO)!=0)  //  中间件层面错误
    ...
    lpTSCall1Req1=glpFastMsgFactory->CreateFastMessage("tdsecuT.1.36", 0);
    lpTSCall1Req1->SetInt32(LDTAG_PRIORITY, iPriority);
    lpTSCall1Req1->SetInt32(LDBIZ_OPOR_CO_NO_INT,v_opor_co_no);
    lpTSCall1Req1->SetInt32(LDBIZ_OPOR_NO_INT,v_opor_no);
    lpTSCall1Req1->SetString(LDBIZ_OPER_MAC_STR,v_oper_mac);
    ...
    lpTSCall1Req1->SetInt32(LDBIZ_STOCK_CODE_NO_INT,v_stock_code_no);
    lpTSCall1Req1->SetDouble(LDBIZ_COMBO_RATIO_FLOAT,v_combo_ratio);
    lpTSCall1Req1->SetDouble(LDBIZ_COMBO_QTY_FLOAT,v_combo_qty);
    glpTSSubcallSerives->SubCall(lpTSCall1Req1, &lpTSCall1Ans1, 5000);
    if(!lpTSCall1Ans1)  //  超时错误
    {
        lpOutBizMsg->SetInt32(LDTAG_ERRORNO, -1);
        lpOutBizMsg->SetString(LDTAG_ERRORINFO, "[tdsecuT.1.36]subcall timed out!");
        iRet=-2;
        goto ENDSYS;
    }
    else if(lpTSCall1Ans1->GetInt32(LDTAG_ERRORNO)!=0)  //  中间件层面错误
    ...
    strcpy(v_error_code, lpTSCall1Ans1->GetString(LDBIZ_ERROR_CODE_STR));
    strcpy(v_error_info, lpTSCall1Ans1->GetString(LDBIZ_ERROR_INFO_STR));
    v_combo_stock_id = lpTSCall1Ans1->GetInt64(LDBIZ_COMBO_STOCK_ID_INT64);
    ...
    // set @记录序号#= @组合证券序号#;
    v_row_id= v_combo_stock_id;

    // [主动推送][secu.combostock][证券主推_组合_组合证券主推消息]
    lpPubMsg = glpFastMsgFactory->CreateFastMessage("pushL.2.903", 0);
    lpPubMsg->SetInt64(LDBIZ_ROW_ID_INT64,v_row_id);
    lpPubMsg->SetInt32(LDBIZ_OPOR_NO_INT,v_opor_no);
    lpPubMsg->SetInt32(LDBIZ_CO_NO_INT,v_co_no);
    lpPubMsg->SetString(LDBIZ_COMBO_CODE_STR,v_combo_code);
    ...
    lpPubMsg->SetDouble(LDBIZ_COMBO_RATIO_FLOAT,v_combo_ratio);
    lpPubMsg->SetDouble(LDBIZ_COMBO_QTY_FLOAT,v_combo_qty);
    lpPubMsg->SetInt32(LDBIZ_UPDATE_TIMES_INT,v_update_times);
    glpPubSub_Interface->PubTopics("secu.combostock", lpPubMsg);
...
END:
    ...
    lpOutBizMsg->SetString(LDBIZ_ERROR_PROMPT_STR,v_error_prompt);
    //对输出参数进行赋值处理
    lpOutBizMsg->SetInt64(LDBIZ_COMBO_STOCK_ID_INT64,v_combo_stock_id);
ENDSYS:
    if(lpTSCall1Ans0)
        lpTSCall1Ans0->FreeMsg();
    if(lpTSCall1Ans1)
...
int iPriority=lpInBizMsg->GetInt32(LDTAG_PRIORITY);
    ...
    strncpy(v_func_code, lpInBizMsg->GetString(LDBIZ_FUNC_CODE_STR),16);
    v_func_code[16] = '\0';
    v_combo_stock_id = lpInBizMsg->GetInt64(LDBIZ_COMBO_STOCK_ID_INT64);
    strncpy(v_combo_code, lpInBizMsg->GetString(LDBIZ_COMBO_CODE_STR),32);
    v_combo_code[32] = '\0';
    v_exch_no = lpInBizMsg->GetInt32(LDBIZ_EXCH_NO_INT);
    strncpy(v_stock_code, lpInBizMsg->GetString(LDBIZ_STOCK_CODE_STR),6);
    ...
    lpTSCall1Req1=glpFastMsgFactory->CreateFastMessage("tdsecuT.1.37", 0);
    lpTSCall1Req1->SetInt32(LDTAG_PRIORITY, iPriority);
    lpTSCall1Req1->SetInt32(LDBIZ_OPOR_CO_NO_INT,v_opor_co_no);
    lpTSCall1Req1->SetInt32(LDBIZ_OPOR_NO_INT,v_opor_no);
    lpTSCall1Req1->SetString(LDBIZ_OPER_MAC_STR,v_oper_mac);
    ...
    lpTSCall1Req1->SetString(LDBIZ_OPER_WAY_STR,v_oper_way);
    lpTSCall1Req1->SetString(LDBIZ_FUNC_CODE_STR,v_func_code);
    lpTSCall1Req1->SetInt64(LDBIZ_COMBO_STOCK_ID_INT64,v_combo_stock_id);
    lpTSCall1Req1->SetString(LDBIZ_COMBO_CODE_STR,v_combo_code);
    lpTSCall1Req1->SetInt32(LDBIZ_EXCH_NO_INT,v_exch_no);
    lpTSCall1Req1->SetString(LDBIZ_STOCK_CODE_STR,v_stock_code);
    lpTSCall1Req1->SetInt32(LDBIZ_STOCK_CODE_NO_INT,v_stock_code_no);
    ...
    {
        lpOutBizMsg->SetInt32(LDTAG_ERRORNO, -1);
        lpOutBizMsg->SetString(LDTAG_ERRORINFO, "[tdsecuT.1.37]subcall timed out!");
        iRet=-2;
        goto ENDSYS;
    }
    else if(lpTSCall1Ans1->GetInt32(LDTAG_ERRORNO)!=0)  //  中间件层面错误
    ...
    lpTSCall1Req2=glpFastMsgFactory->CreateFastMessage("tdsecuT.1.40", 0);
    lpTSCall1Req2->SetInt32(LDTAG_PRIORITY, iPriority);
    lpTSCall1Req2->SetInt32(LDBIZ_OPOR_CO_NO_INT,v_opor_co_no);
    lpTSCall1Req2->SetInt32(LDBIZ_OPOR_NO_INT,v_opor_no);
    lpTSCall1Req2->SetString(LDBIZ_OPER_MAC_STR,v_oper_mac);
    ...
    {
        lpOutBizMsg->SetInt32(LDTAG_ERRORNO, -1);
        lpOutBizMsg->SetString(LDTAG_ERRORINFO, "[tdsecuT.1.40]subcall timed out!");
        iRet=-2;
        goto ENDSYS;
    }
    else if(lpTSCall1Ans2->GetInt32(LDTAG_ERRORNO)!=0)  //  中间件层面错误
    ...
    v_combo_ratio = lpTSCall1Ans2->GetDouble(LDBIZ_COMBO_RATIO_FLOAT);
    v_combo_qty = lpTSCall1Ans2->GetDouble(LDBIZ_COMBO_QTY_FLOAT);
    v_update_times = lpTSCall1Ans2->GetInt32(LDBIZ_UPDATE_TIMES_INT);
...
int iPriority=lpInBizMsg->GetInt32(LDTAG_PRIORITY);
    ...
    lpTSCall1Req1=glpFastMsgFactory->CreateFastMessage("tdsecuT.1.38", 0);
    lpTSCall1Req1->SetInt32(LDTAG_PRIORITY, iPriority);
    lpTSCall1Req1->SetInt32(LDBIZ_OPOR_CO_NO_INT,v_opor_co_no);
    lpTSCall1Req1->SetInt32(LDBIZ_OPOR_NO_INT,v_opor_no);
    lpTSCall1Req1->SetString(LDBIZ_OPER_MAC_STR,v_oper_mac);
    ...
    {
        lpOutBizMsg->SetInt32(LDTAG_ERRORNO, -1);
        lpOutBizMsg->SetString(LDTAG_ERRORINFO, "[tdsecuT.1.38]subcall timed out!");
        iRet=-2;
        goto ENDSYS;
    }
    else if(lpTSCall1Ans1->GetInt32(LDTAG_ERRORNO)!=0)  //  中间件层面错误
    ...
    // [主动推送][secu.combostockdel][证券主推_组合_组合证券删除主推消息]
    lpPubMsg = glpFastMsgFactory->CreateFastMessage("pushL.2.904", 0);
    lpPubMsg->SetInt64(LDBIZ_COMBO_STOCK_ID_INT64,v_combo_stock_id);
    glpPubSub_Interface->PubTopics("secu.combostockdel", lpPubMsg);
...
int iPriority=lpInBizMsg->GetInt32(LDTAG_PRIORITY);
    ...
    lpTSCall1Req1=glpFastMsgFactory->CreateFastMessage("tdsecuT.1.39", 0);
    lpTSCall1Req1->SetInt32(LDTAG_PRIORITY, iPriority);
    lpTSCall1Req1->SetInt32(LDBIZ_OPOR_CO_NO_INT,v_opor_co_no);
    lpTSCall1Req1->SetInt32(LDBIZ_OPOR_NO_INT,v_opor_no);
    lpTSCall1Req1->SetString(LDBIZ_OPER_MAC_STR,v_oper_mac);
    ...
    {
        lpOutBizMsg->SetInt32(LDTAG_ERRORNO, -1);
        lpOutBizMsg->SetString(LDTAG_ERRORINFO, "[tdsecuT.1.39]subcall timed out!");
        iRet=-2;
        goto ENDSYS;
    }
    else if(lpTSCall1Ans1->GetInt32(LDTAG_ERRORNO)!=0)  //  中间件层面错误
...
int iPriority=lpInBizMsg->GetInt32(LDTAG_PRIORITY);
    ...
    for (int i = 0; i < iRecordCount;i++) 
    {
        ...
        lpTSCall1Req2=glpFastMsgFactory->CreateFastMessage("pubT.24.105", 0);
        lpTSCall1Req2->SetInt32(LDTAG_PRIORITY, iPriority);
        lpTSCall1Req2->SetInt32(LDBIZ_OPOR_CO_NO_INT,v_opor_co_no);
        lpTSCall1Req2->SetInt32(LDBIZ_OPOR_NO_INT,v_opor_no);
        lpTSCall1Req2->SetString(LDBIZ_OPER_MAC_STR,v_oper_mac);
        ...
        lpTSCall1Req3=glpFastMsgFactory->CreateFastMessage("tdsecuT.2.47", 0);
        lpTSCall1Req3->SetInt32(LDTAG_PRIORITY, iPriority);
        lpTSCall1Req3->SetInt32(LDBIZ_OPOR_CO_NO_INT,v_opor_co_no);
        lpTSCall1Req3->SetInt32(LDBIZ_OPOR_NO_INT,v_opor_no);
        lpTSCall1Req3->SetString(LDBIZ_OPER_MAC_STR,v_oper_mac);
        ...
        lpTSCall1Req3->SetDouble(LDBIZ_COMBO_MARKET_VALUE_FLOAT,v_combo_market_value);
...
int LD_CALL_MODE fnFunc21(const char* lpFuncID, IFastMessage* lpInBizMsg, IFastMessage* lpOutBizMsg, IDB_Connection* lpDBConnect)
{
    ...
    double v_begin_debt_amt;
    double v_begin_debt_qty;
    double v_debt_amt;
    double v_debt_qty;
    double v_debt_fee;
    ...
    int v_interest_update_date;
    int v_debt_end_date;
    int v_orign_debt_end_date;
    int v_defer_times;
    int v_debt_return_date;
    int v_debt_status;
    char v_remark_info[256];
    int v_debt_order_no;
    int v_exch_group_no;
...
int iPriority=lpInBizMsg->GetInt32(LDTAG_PRIORITY);
    ...
    v_interest_update_date=0;
    v_debt_end_date=0;
    v_orign_debt_end_date=0;
    v_defer_times=0;
    v_debt_return_date=0;
    v_debt_status=0;
    strcpy(v_remark_info, " ");
    v_debt_order_no=0;
    v_exch_group_no=0;
    ...
    // set @指定行数#=-1;
    v_row_count=-1;
    //调用过程[事务_产品证券_融资融券_查询风控资产账户负债明细]
    //组织事务请求
    if(lpTSCall1Ans1)
    {
      lpTSCall1Ans1->FreeMsg();
    ...
    lpTSCall1Req1=glpFastMsgFactory->CreateFastMessage("pdsecuT.21.105", 0);
    lpTSCall1Req1->SetInt32(LDTAG_PRIORITY, iPriority);
    lpTSCall1Req1->SetInt32(LDBIZ_OPOR_CO_NO_INT,v_opor_co_no);
    lpTSCall1Req1->SetInt32(LDBIZ_OPOR_NO_INT,v_opor_no);
    lpTSCall1Req1->SetString(LDBIZ_OPER_MAC_STR,v_oper_mac);
    ...
    {
        lpOutBizMsg->SetInt32(LDTAG_ERRORNO, -1);
        lpOutBizMsg->SetString(LDTAG_ERRORINFO, "[pdsecuT.21.105]subcall timed out!");
        iRet=-2;
        goto ENDSYS;
    }
    else if(lpTSCall1Ans1->GetInt32(LDTAG_ERRORNO)!=0)  //  中间件层面错误
    ...
    for (int i = 0; i < iRecordCount;i++) 
    {
        ...
        if(lpRecord)
        {
            ...
            v_order_no = lpRecord->GetInt32(LDBIZ_ORDER_NO_INT);
            ...
            v_debt_intrst_rate = lpRecord->GetDouble(LDBIZ_DEBT_INTRST_RATE_FLOAT);
            v_begin_debt_amt = lpRecord->GetDouble(LDBIZ_BEGIN_DEBT_AMT_FLOAT);
            v_begin_debt_qty = lpRecord->GetDouble(LDBIZ_BEGIN_DEBT_QTY_FLOAT);
            ...
            v_interest_update_date = lpRecord->GetInt32(LDBIZ_INTEREST_UPDATE_DATE_INT);
            v_debt_end_date = lpRecord->GetInt32(LDBIZ_DEBT_END_DATE_INT);
            v_orign_debt_end_date = lpRecord->GetInt32(LDBIZ_ORIGN_DEBT_END_DATE_INT);
            v_defer_times = lpRecord->GetInt32(LDBIZ_DEFER_TIMES_INT);
            v_debt_return_date = lpRecord->GetInt32(LDBIZ_DEBT_RETURN_DATE_INT);
            v_debt_status = lpRecord->GetInt32(LDBIZ_DEBT_STATUS_INT);
            strcpy(v_remark_info, lpRecord->GetString(LDBIZ_REMARK_INFO_STR));


     // set @负债订单编号#=@订单编号#;
     v_debt_order_no=v_order_no;
     //调用过程[事务_交易证券_账户_转入产品证券资产账户负债明细记录]
     //组织事务请求
     if(lpTSCall1Ans2)
     {
       lpTSCall1Ans2->FreeMsg();
     ...
     lpTSCall1Req2=glpFastMsgFactory->CreateFastMessage("tdsecuT.2.81", 0);
     lpTSCall1Req2->SetInt32(LDTAG_PRIORITY, iPriority);
     lpTSCall1Req2->SetInt32(LDBIZ_OPOR_CO_NO_INT,v_opor_co_no);
     lpTSCall1Req2->SetInt32(LDBIZ_OPOR_NO_INT,v_opor_no);
     lpTSCall1Req2->SetString(LDBIZ_OPER_MAC_STR,v_oper_mac);
     ...
     lpTSCall1Req2->SetInt32(LDBIZ_DEBT_TYPE_INT,v_debt_type);
     ...
     lpTSCall1Req2->SetInt32(LDBIZ_DEBT_ORDER_NO_INT,v_debt_order_no);
     ...
     lpTSCall1Req2->SetDouble(LDBIZ_DEBT_AMT_FLOAT,v_debt_amt);
     lpTSCall1Req2->SetDouble(LDBIZ_DEBT_QTY_FLOAT,v_debt_qty);
     lpTSCall1Req2->SetDouble(LDBIZ_DEBT_FEE_FLOAT,v_debt_fee);
     lpTSCall1Req2->SetDouble(LDBIZ_DEBT_INTEREST_FLOAT,v_debt_interest);
     lpTSCall1Req2->SetDouble(LDBIZ_INTRST_BASE_AMT_FLOAT,v_intrst_base_amt);
     lpTSCall1Req2->SetDouble(LDBIZ_DEBT_RETURN_AMT_FLOAT,v_debt_return_amt);
     lpTSCall1Req2->SetDouble(LDBIZ_DEBT_RETURN_QTY_FLOAT,v_debt_return_qty);
     lpTSCall1Req2->SetDouble(LDBIZ_RETURN_INTEREST_AMT_FLOAT,v_return_interest_amt);
     lpTSCall1Req2->SetInt32(LDBIZ_DEBT_STATUS_INT,v_debt_status);
     lpTSCall1Req2->SetString(LDBIZ_REMARK_INFO_STR,v_remark_info);
     glpTSSubcallSerives->SubCall(lpTSCall1Req2, &lpTSCall1Ans2, 5000);
     if(!lpTSCall1Ans2)  //  超时错误
     {
         lpOutBizMsg->SetInt32(LDTAG_ERRORNO, -1);
         lpOutBizMsg->SetString(LDTAG_ERRORINFO, "[tdsecuT.2.81]subcall timed out!");
         iRet=-2;
         goto ENDSYS;
     }
     else if(lpTSCall1Ans2->GetInt32(LDTAG_ERRORNO)!=0)  //  中间件层面错误
    ...
    lpTSCall1Req3=glpFastMsgFactory->CreateFastMessage("pdsecuT.21.106", 0);
    lpTSCall1Req3->SetInt32(LDTAG_PRIORITY, iPriority);
    lpTSCall1Req3->SetInt32(LDBIZ_OPOR_CO_NO_INT,v_opor_co_no);
    lpTSCall1Req3->SetInt32(LDBIZ_OPOR_NO_INT,v_opor_no);
    lpTSCall1Req3->SetString(LDBIZ_OPER_MAC_STR,v_oper_mac);
    ...
    {
        lpOutBizMsg->SetInt32(LDTAG_ERRORNO, -1);
        lpOutBizMsg->SetString(LDTAG_ERRORINFO, "[pdsecuT.21.106]subcall timed out!");
        iRet=-2;
        goto ENDSYS;
    }
    else if(lpTSCall1Ans3->GetInt32(LDTAG_ERRORNO)!=0)  //  中间件层面错误
    ...
    // [获取结果集][lpMainMsgExgp]
    lpMainMsgExgp=lpTSCall1Ans3->GetGroup(LDTAG_NO_RESULTSET);


    // [遍历结果集开始][lpMainMsgExgp]
    iRecordCount = lpMainMsgExgp->GetRecordCount();
    for (int i = 0; i < iRecordCount;i++) 
    {
        IRecord* lpRecord =lpMainMsgExgp->GetRecord(i);
        if(lpRecord)
        {
     ...
     // set @负债订单编号#=@订单编号#;
     v_debt_order_no=v_order_no;
     //调用过程[事务_交易证券_账户_转入产品证券交易组负债明细记录]
     //组织事务请求
     if(lpTSCall1Ans4)
     {
       lpTSCall1Ans4->FreeMsg();
     ...
     lpTSCall1Req4=glpFastMsgFactory->CreateFastMessage("tdsecuT.2.82", 0);
     lpTSCall1Req4->SetInt32(LDTAG_PRIORITY, iPriority);
     lpTSCall1Req4->SetInt32(LDBIZ_OPOR_CO_NO_INT,v_opor_co_no);
     lpTSCall1Req4->SetInt32(LDBIZ_OPOR_NO_INT,v_opor_no);
     lpTSCall1Req4->SetString(LDBIZ_OPER_MAC_STR,v_oper_mac);
     ...
     lpTSCall1Req4->SetDouble(LDBIZ_STRIKE_FEE_FLOAT,v_strike_fee);
     lpTSCall1Req4->SetInt32(LDBIZ_DEBT_ORDER_NO_INT,v_debt_order_no);
     ...
     lpTSCall1Req4->SetDouble(LDBIZ_DEBT_AMT_FLOAT,v_debt_amt);
     lpTSCall1Req4->SetDouble(LDBIZ_DEBT_QTY_FLOAT,v_debt_qty);
     lpTSCall1Req4->SetDouble(LDBIZ_DEBT_FEE_FLOAT,v_debt_fee);
     lpTSCall1Req4->SetDouble(LDBIZ_DEBT_INTEREST_FLOAT,v_debt_interest);
     lpTSCall1Req4->SetDouble(LDBIZ_INTRST_BASE_AMT_FLOAT,v_intrst_base_amt);
     lpTSCall1Req4->SetDouble(LDBIZ_DEBT_RETURN_AMT_FLOAT,v_debt_return_amt);
     lpTSCall1Req4->SetDouble(LDBIZ_DEBT_RETURN_QTY_FLOAT,v_debt_return_qty);
     lpTSCall1Req4->SetDouble(LDBIZ_RETURN_INTEREST_AMT_FLOAT,v_return_interest_amt);
     lpTSCall1Req4->SetInt32(LDBIZ_DEBT_STATUS_INT,v_debt_status);
     lpTSCall1Req4->SetString(LDBIZ_REMARK_INFO_STR,v_remark_info);
     glpTSSubcallSerives->SubCall(lpTSCall1Req4, &lpTSCall1Ans4, 5000);
     if(!lpTSCall1Ans4)  //  超时错误
     {
         lpOutBizMsg->SetInt32(LDTAG_ERRORNO, -1);
         lpOutBizMsg->SetString(LDTAG_ERRORINFO, "[tdsecuT.2.82]subcall timed out!");
         iRet=-2;
         goto ENDSYS;
     }
     else if(lpTSCall1Ans4->GetInt32(LDTAG_ERRORNO)!=0)  //  中间件层面错误
...
int LD_CALL_MODE fnFunc22(const char* lpFuncID, IFastMessage* lpInBizMsg, IFastMessage* lpOutBizMsg, IDB_Connection* lpDBConnect)
{
    ...
    int v_distribute_last_trader;
    int v_distribute_by_jobs;
    char v_remark_info[256];
    char v_error_code[33];
    char v_error_info[256];
    int v_error_level;
...
int iPriority=lpInBizMsg->GetInt32(LDTAG_PRIORITY);
    ...
    v_distribute_last_trader=0;
    v_distribute_by_jobs=0;
    strcpy(v_remark_info, " ");
    strcpy(v_error_code, "0");
    strcpy(v_error_info, " ");
    v_error_level=0;
    ...
    v_func_code[16] = '\0';
    v_co_no = lpInBizMsg->GetInt32(LDBIZ_CO_NO_INT);
    strncpy(v_rule_name, lpInBizMsg->GetString(LDBIZ_RULE_NAME_STR),64);
    v_rule_name[64] = '\0';
    v_prior_type = lpInBizMsg->GetInt32(LDBIZ_PRIOR_TYPE_INT);
    ...
    v_distribute_last_trader = lpInBizMsg->GetInt32(LDBIZ_DISTRIBUTE_LAST_TRADER_INT);
    v_distribute_by_jobs = lpInBizMsg->GetInt32(LDBIZ_DISTRIBUTE_BY_JOBS_INT);
    strncpy(v_remark_info, lpInBizMsg->GetString(LDBIZ_REMARK_INFO_STR),255);
    v_remark_info[255] = '\0';
    ...
    lpTSCall1Req1=glpFastMsgFactory->CreateFastMessage("tdsecuT.1.44", 0);
    lpTSCall1Req1->SetInt32(LDTAG_PRIORITY, iPriority);
    lpTSCall1Req1->SetInt32(LDBIZ_OPOR_CO_NO_INT,v_opor_co_no);
    lpTSCall1Req1->SetInt32(LDBIZ_OPOR_NO_INT,v_opor_no);
    lpTSCall1Req1->SetString(LDBIZ_OPER_MAC_STR,v_oper_mac);
    ...
    lpTSCall1Req1->SetString(LDBIZ_FUNC_CODE_STR,v_func_code);
    lpTSCall1Req1->SetInt32(LDBIZ_CO_NO_INT,v_co_no);
    lpTSCall1Req1->SetString(LDBIZ_RULE_NAME_STR,v_rule_name);
    lpTSCall1Req1->SetInt32(LDBIZ_PRIOR_TYPE_INT,v_prior_type);
    ...
    lpTSCall1Req1->SetInt32(LDBIZ_DISTRIBUTE_LAST_TRADER_INT,v_distribute_last_trader);
    lpTSCall1Req1->SetInt32(LDBIZ_DISTRIBUTE_BY_JOBS_INT,v_distribute_by_jobs);
    lpTSCall1Req1->SetString(LDBIZ_REMARK_INFO_STR,v_remark_info);
    glpTSSubcallSerives->SubCall(lpTSCall1Req1, &lpTSCall1Ans1, 5000);
    if(!lpTSCall1Ans1)  //  超时错误
    {
        lpOutBizMsg->SetInt32(LDTAG_ERRORNO, -1);
        lpOutBizMsg->SetString(LDTAG_ERRORINFO, "[tdsecuT.1.44]subcall timed out!");
        iRet=-2;
        goto ENDSYS;
    }
    else if(lpTSCall1Ans1->GetInt32(LDTAG_ERRORNO)!=0)  //  中间件层面错误
    ...
    // [主动推送][secu.commautodistributerule][证券主推_指令_指令自动分发规则主推消息]
    lpPubMsg = glpFastMsgFactory->CreateFastMessage("pushL.2.937", 0);
    lpPubMsg->SetInt64(LDBIZ_ROW_ID_INT64,v_row_id);
    lpPubMsg->SetInt32(LDBIZ_OPOR_NO_INT,v_opor_no);
    lpPubMsg->SetInt32(LDBIZ_CO_NO_INT,v_co_no);
    lpPubMsg->SetString(LDBIZ_RULE_NAME_STR,v_rule_name);
    lpPubMsg->SetInt32(LDBIZ_PRIOR_TYPE_INT,v_prior_type);
    lpPubMsg->SetString(LDBIZ_EXCH_GROUP_NO_STR_STR,v_exch_group_no_str);
    lpPubMsg->SetString(LDBIZ_EXCH_NO_STR_STR,v_exch_no_str);
    lpPubMsg->SetString(LDBIZ_STOCK_TYPE_STR_STR,v_stock_type_str);
    lpPubMsg->SetString(LDBIZ_STOCK_CODE_STR_STR,v_stock_code_str);
    lpPubMsg->SetString(LDBIZ_OPOR_NO_STR_STR,v_opor_no_str);
    lpPubMsg->SetInt32(LDBIZ_DISTRIBUTE_LAST_TRADER_INT,v_distribute_last_trader);
    lpPubMsg->SetInt32(LDBIZ_DISTRIBUTE_BY_JOBS_INT,v_distribute_by_jobs);
    lpPubMsg->SetString(LDBIZ_REMARK_INFO_STR,v_remark_info);
    lpPubMsg->SetInt32(LDBIZ_UPDATE_TIMES_INT,v_update_times);
    glpPubSub_Interface->PubTopics("secu.commautodistributerule", lpPubMsg);
...
int iPriority=lpInBizMsg->GetInt32(LDTAG_PRIORITY);
    ...
    lpTSCall1Req1=glpFastMsgFactory->CreateFastMessage("tdsecuT.1.45", 0);
    lpTSCall1Req1->SetInt32(LDTAG_PRIORITY, iPriority);
    lpTSCall1Req1->SetInt32(LDBIZ_OPOR_CO_NO_INT,v_opor_co_no);
    lpTSCall1Req1->SetInt32(LDBIZ_OPOR_NO_INT,v_opor_no);
    lpTSCall1Req1->SetString(LDBIZ_OPER_MAC_STR,v_oper_mac);
    ...
    {
        lpOutBizMsg->SetInt32(LDTAG_ERRORNO, -1);
        lpOutBizMsg->SetString(LDTAG_ERRORINFO, "[tdsecuT.1.45]subcall timed out!");
        iRet=-2;
        goto ENDSYS;
    }
    else if(lpTSCall1Ans1->GetInt32(LDTAG_ERRORNO)!=0)  //  中间件层面错误
    ...
    lpTSCall1Req2=glpFastMsgFactory->CreateFastMessage("tdsecuT.1.48", 0);
    lpTSCall1Req2->SetInt32(LDTAG_PRIORITY, iPriority);
    lpTSCall1Req2->SetInt32(LDBIZ_OPOR_CO_NO_INT,v_opor_co_no);
    lpTSCall1Req2->SetInt32(LDBIZ_OPOR_NO_INT,v_opor_no);
    lpTSCall1Req2->SetString(LDBIZ_OPER_MAC_STR,v_oper_mac);
    ...
    {
        lpOutBizMsg->SetInt32(LDTAG_ERRORNO, -1);
        lpOutBizMsg->SetString(LDTAG_ERRORINFO, "[tdsecuT.1.48]subcall timed out!");
        iRet=-2;
        goto ENDSYS;
    }
    else if(lpTSCall1Ans2->GetInt32(LDTAG_ERRORNO)!=0)  //  中间件层面错误
    ...
    v_busi_opor_no = lpTSCall1Ans2->GetInt32(LDBIZ_BUSI_OPOR_NO_INT);
    v_co_no = lpTSCall1Ans2->GetInt32(LDBIZ_CO_NO_INT);
    strcpy(v_rule_name, lpTSCall1Ans2->GetString(LDBIZ_RULE_NAME_STR));
    v_prior_type = lpTSCall1Ans2->GetInt32(LDBIZ_PRIOR_TYPE_INT);
    strcpy(v_exch_group_no_str, lpTSCall1Ans2->GetString(LDBIZ_EXCH_GROUP_NO_STR_STR));
    strcpy(v_exch_no_str, lpTSCall1Ans2->GetString(LDBIZ_EXCH_NO_STR_STR));
    strcpy(v_stock_type_str, lpTSCall1Ans2->GetString(LDBIZ_STOCK_TYPE_STR_STR));
    strcpy(v_stock_code_str, lpTSCall1Ans2->GetString(LDBIZ_STOCK_CODE_STR_STR));
    strcpy(v_opor_no_str, lpTSCall1Ans2->GetString(LDBIZ_OPOR_NO_STR_STR));
    v_distribute_last_trader = lpTSCall1Ans2->GetInt32(LDBIZ_DISTRIBUTE_LAST_TRADER_INT);
    v_distribute_by_jobs = lpTSCall1Ans2->GetInt32(LDBIZ_DISTRIBUTE_BY_JOBS_INT);
    strcpy(v_remark_info, lpTSCall1Ans2->GetString(LDBIZ_REMARK_INFO_STR));
    v_update_times = lpTSCall1Ans2->GetInt32(LDBIZ_UPDATE_TIMES_INT);
...
int iPriority=lpInBizMsg->GetInt32(LDTAG_PRIORITY);
    ...
    lpTSCall1Req1=glpFastMsgFactory->CreateFastMessage("tdsecuT.1.46", 0);
    lpTSCall1Req1->SetInt32(LDTAG_PRIORITY, iPriority);
    lpTSCall1Req1->SetInt32(LDBIZ_OPOR_CO_NO_INT,v_opor_co_no);
    lpTSCall1Req1->SetInt32(LDBIZ_OPOR_NO_INT,v_opor_no);
    lpTSCall1Req1->SetString(LDBIZ_OPER_MAC_STR,v_oper_mac);
    ...
    {
        lpOutBizMsg->SetInt32(LDTAG_ERRORNO, -1);
        lpOutBizMsg->SetString(LDTAG_ERRORINFO, "[tdsecuT.1.46]subcall timed out!");
        iRet=-2;
        goto ENDSYS;
    }
    else if(lpTSCall1Ans1->GetInt32(LDTAG_ERRORNO)!=0)  //  中间件层面错误
    ...
    // [主动推送][secu.commautodistributeruledel][证券主推_指令_指令自动分发规则删除主推消息]
    lpPubMsg = glpFastMsgFactory->CreateFastMessage("pushL.2.938", 0);
    lpPubMsg->SetInt64(LDBIZ_ROW_ID_INT64,v_row_id);
    glpPubSub_Interface->PubTopics("secu.commautodistributeruledel", lpPubMsg);
...
int iPriority=lpInBizMsg->GetInt32(LDTAG_PRIORITY);
    ...
    lpTSCall1Req1=glpFastMsgFactory->CreateFastMessage("tdsecuT.1.47", 0);
    lpTSCall1Req1->SetInt32(LDTAG_PRIORITY, iPriority);
    lpTSCall1Req1->SetInt32(LDBIZ_OPOR_CO_NO_INT,v_opor_co_no);
    lpTSCall1Req1->SetInt32(LDBIZ_OPOR_NO_INT,v_opor_no);
    lpTSCall1Req1->SetString(LDBIZ_OPER_MAC_STR,v_oper_mac);
    ...
    {
        lpOutBizMsg->SetInt32(LDTAG_ERRORNO, -1);
        lpOutBizMsg->SetString(LDTAG_ERRORINFO, "[tdsecuT.1.47]subcall timed out!");
        iRet=-2;
        goto ENDSYS;
    }
    else if(lpTSCall1Ans1->GetInt32(LDTAG_ERRORNO)!=0)  //  中间件层面错误
...
int iPriority=lpInBizMsg->GetInt32(LDTAG_PRIORITY);
    ...
    lpTSCall1Req1=glpFastMsgFactory->CreateFastMessage("tdsecuT.1.60", 0);
    lpTSCall1Req1->SetInt32(LDTAG_PRIORITY, iPriority);
    lpTSCall1Req1->SetInt32(LDBIZ_OPOR_CO_NO_INT,v_opor_co_no);
    lpTSCall1Req1->SetInt32(LDBIZ_OPOR_NO_INT,v_opor_no);
    lpTSCall1Req1->SetString(LDBIZ_OPER_MAC_STR,v_oper_mac);
    ...
    glpTSSubcallSerives->SubCall(lpTSCall1Req1, &lpTSCall1Ans1, 600000);
    if(!lpTSCall1Ans1)  //  超时错误
    {
        lpOutBizMsg->SetInt32(LDTAG_ERRORNO, -1);
        lpOutBizMsg->SetString(LDTAG_ERRORINFO, "[tdsecuT.1.60]subcall timed out!");
        iRet=-2;
        goto ENDSYS;
    }
    else if(lpTSCall1Ans1->GetInt32(LDTAG_ERRORNO)!=0)  //  中间件层面错误
...
int iPriority=lpInBizMsg->GetInt32(LDTAG_PRIORITY);
    ...
    lpTSCall1Req2=glpFastMsgFactory->CreateFastMessage("tdsecuT.1.61", 0);
    lpTSCall1Req2->SetInt32(LDTAG_PRIORITY, iPriority);
    lpTSCall1Req2->SetInt32(LDBIZ_OPOR_CO_NO_INT,v_opor_co_no);
    lpTSCall1Req2->SetInt32(LDBIZ_OPOR_NO_INT,v_opor_no);
    lpTSCall1Req2->SetString(LDBIZ_OPER_MAC_STR,v_oper_mac);
    ...
    glpTSSubcallSerives->SubCall(lpTSCall1Req2, &lpTSCall1Ans2, 600000);
    if(!lpTSCall1Ans2)  //  超时错误
    {
        lpOutBizMsg->SetInt32(LDTAG_ERRORNO, -1);
        lpOutBizMsg->SetString(LDTAG_ERRORINFO, "[tdsecuT.1.61]subcall timed out!");
        iRet=-2;
        goto ENDSYS;
    }
    else if(lpTSCall1Ans2->GetInt32(LDTAG_ERRORNO)!=0)  //  中间件层面错误
...
int iPriority=lpInBizMsg->GetInt32(LDTAG_PRIORITY);
    ...
    lpTSCall1Req1=glpFastMsgFactory->CreateFastMessage("tdsecuT.1.62", 0);
    lpTSCall1Req1->SetInt32(LDTAG_PRIORITY, iPriority);
    lpTSCall1Req1->SetInt32(LDBIZ_OPOR_CO_NO_INT,v_opor_co_no);
    lpTSCall1Req1->SetInt32(LDBIZ_OPOR_NO_INT,v_opor_no);
    lpTSCall1Req1->SetString(LDBIZ_OPER_MAC_STR,v_oper_mac);
    ...
    {
        lpOutBizMsg->SetInt32(LDTAG_ERRORNO, -1);
        lpOutBizMsg->SetString(LDTAG_ERRORINFO, "[tdsecuT.1.62]subcall timed out!");
        iRet=-2;
        goto ENDSYS;
    }
    else if(lpTSCall1Ans1->GetInt32(LDTAG_ERRORNO)!=0)  //  中间件层面错误
...
int iPriority=lpInBizMsg->GetInt32(LDTAG_PRIORITY);
    ...
    lpTSCall1Req2=glpFastMsgFactory->CreateFastMessage("tdsecuT.1.42", 0);
    lpTSCall1Req2->SetInt32(LDTAG_PRIORITY, iPriority);
    lpTSCall1Req2->SetInt32(LDBIZ_OPOR_CO_NO_INT,v_opor_co_no);
    lpTSCall1Req2->SetInt32(LDBIZ_OPOR_NO_INT,v_opor_no);
    lpTSCall1Req2->SetString(LDBIZ_OPER_MAC_STR,v_oper_mac);
    ...
    // [获取结果集][lpMainMsg1]
    lpMainMsg1=lpTSCall1Ans2->GetGroup(LDTAG_NO_RESULTSET);
    ...
    for (int i = 0; i < iRecordCount;i++) 
    {
        ...
        lpTSCall1Req3=glpFastMsgFactory->CreateFastMessage("pubT.24.83", 0);
        lpTSCall1Req3->SetInt32(LDTAG_PRIORITY, iPriority);
        lpTSCall1Req3->SetInt32(LDBIZ_OPOR_CO_NO_INT,v_opor_co_no);
        lpTSCall1Req3->SetInt32(LDBIZ_OPOR_NO_INT,v_opor_no);
        lpTSCall1Req3->SetString(LDBIZ_OPER_MAC_STR,v_oper_mac);
        ...
        lpTSCall1Req4=glpFastMsgFactory->CreateFastMessage("tdsecuT.1.43", 0);
        lpTSCall1Req4->SetInt32(LDTAG_PRIORITY, iPriority);
        lpTSCall1Req4->SetInt32(LDBIZ_OPOR_CO_NO_INT,v_opor_co_no);
        lpTSCall1Req4->SetInt32(LDBIZ_OPOR_NO_INT,v_opor_no);
        lpTSCall1Req4->SetString(LDBIZ_OPER_MAC_STR,v_oper_mac);
        ...
        glpTSSubcallSerives->SubCall(lpTSCall1Req4, &lpTSCall1Ans4, 600000);
        if(!lpTSCall1Ans4)  //  超时错误
        {
            lpOutBizMsg->SetInt32(LDTAG_ERRORNO, -1);
            lpOutBizMsg->SetString(LDTAG_ERRORINFO, "[tdsecuT.1.43]subcall timed out!");
    ...
    lpTSCall1Req5=glpFastMsgFactory->CreateFastMessage("tdsecuT.1.63", 0);
    lpTSCall1Req5->SetInt32(LDTAG_PRIORITY, iPriority);
    lpTSCall1Req5->SetInt32(LDBIZ_OPOR_CO_NO_INT,v_opor_co_no);
    lpTSCall1Req5->SetInt32(LDBIZ_OPOR_NO_INT,v_opor_no);
    lpTSCall1Req5->SetString(LDBIZ_OPER_MAC_STR,v_oper_mac);
    ...
    lpTSCall1Req5->SetInt32(LDBIZ_NEXT_INIT_DATE_INT,v_next_init_date);
    glpTSSubcallSerives->SubCall(lpTSCall1Req5, &lpTSCall1Ans5, 600000);
    if(!lpTSCall1Ans5)  //  超时错误
    {
        lpOutBizMsg->SetInt32(LDTAG_ERRORNO, -1);
        lpOutBizMsg->SetString(LDTAG_ERRORINFO, "[tdsecuT.1.63]subcall timed out!");
        iRet=-2;
        goto ENDSYS;
    }
    else if(lpTSCall1Ans5->GetInt32(LDTAG_ERRORNO)!=0)  //  中间件层面错误
...
int iPriority=lpInBizMsg->GetInt32(LDTAG_PRIORITY);
    ...
    lpTSCall1Req2=glpFastMsgFactory->CreateFastMessage("tdsecuT.1.64", 0);
    lpTSCall1Req2->SetInt32(LDTAG_PRIORITY, iPriority);
    lpTSCall1Req2->SetInt32(LDBIZ_OPOR_CO_NO_INT,v_opor_co_no);
    lpTSCall1Req2->SetInt32(LDBIZ_OPOR_NO_INT,v_opor_no);
    lpTSCall1Req2->SetString(LDBIZ_OPER_MAC_STR,v_oper_mac);
    ...
    {
        lpOutBizMsg->SetInt32(LDTAG_ERRORNO, -1);
        lpOutBizMsg->SetString(LDTAG_ERRORINFO, "[tdsecuT.1.64]subcall timed out!");
        iRet=-2;
        goto ENDSYS;
    }
    else if(lpTSCall1Ans2->GetInt32(LDTAG_ERRORNO)!=0)  //  中间件层面错误
...
int iPriority=lpInBizMsg->GetInt32(LDTAG_PRIORITY);
    ...
    lpTSCall1Req1=glpFastMsgFactory->CreateFastMessage("tdsecuT.1.65", 0);
    lpTSCall1Req1->SetInt32(LDTAG_PRIORITY, iPriority);
    lpTSCall1Req1->SetInt32(LDBIZ_OPOR_CO_NO_INT,v_opor_co_no);
    lpTSCall1Req1->SetInt32(LDBIZ_OPOR_NO_INT,v_opor_no);
    lpTSCall1Req1->SetString(LDBIZ_OPER_MAC_STR,v_oper_mac);
    ...
    {
        lpOutBizMsg->SetInt32(LDTAG_ERRORNO, -1);
        lpOutBizMsg->SetString(LDTAG_ERRORINFO, "[tdsecuT.1.65]subcall timed out!");
        iRet=-2;
        goto ENDSYS;
    }
    else if(lpTSCall1Ans1->GetInt32(LDTAG_ERRORNO)!=0)  //  中间件层面错误
...
int iPriority=lpInBizMsg->GetInt32(LDTAG_PRIORITY);
    ...
    lpTSCall1Req2=glpFastMsgFactory->CreateFastMessage("tdsecuT.1.66", 0);
    lpTSCall1Req2->SetInt32(LDTAG_PRIORITY, iPriority);
    lpTSCall1Req2->SetInt32(LDBIZ_OPOR_CO_NO_INT,v_opor_co_no);
    lpTSCall1Req2->SetInt32(LDBIZ_OPOR_NO_INT,v_opor_no);
    lpTSCall1Req2->SetString(LDBIZ_OPER_MAC_STR,v_oper_mac);
    ...
    {
        lpOutBizMsg->SetInt32(LDTAG_ERRORNO, -1);
        lpOutBizMsg->SetString(LDTAG_ERRORINFO, "[tdsecuT.1.66]subcall timed out!");
        iRet=-2;
        goto ENDSYS;
    }
    else if(lpTSCall1Ans2->GetInt32(LDTAG_ERRORNO)!=0)  //  中间件层面错误
...
int iPriority=lpInBizMsg->GetInt32(LDTAG_PRIORITY);
    ...
    lpTSCall1Req2=glpFastMsgFactory->CreateFastMessage("pubT.24.41", 0);
    lpTSCall1Req2->SetInt32(LDTAG_PRIORITY, iPriority);
    lpTSCall1Req2->SetInt32(LDBIZ_OPOR_CO_NO_INT,v_opor_co_no);
    lpTSCall1Req2->SetInt32(LDBIZ_OPOR_NO_INT,v_opor_no);
    lpTSCall1Req2->SetString(LDBIZ_OPER_MAC_STR,v_oper_mac);
    ...
    lpTSCall1Req3=glpFastMsgFactory->CreateFastMessage("tdsecuT.1.67", 0);
    lpTSCall1Req3->SetInt32(LDTAG_PRIORITY, iPriority);
    lpTSCall1Req3->SetInt32(LDBIZ_OPOR_CO_NO_INT,v_opor_co_no);
    lpTSCall1Req3->SetInt32(LDBIZ_OPOR_NO_INT,v_opor_no);
    lpTSCall1Req3->SetString(LDBIZ_OPER_MAC_STR,v_oper_mac);
    ...
    glpTSSubcallSerives->SubCall(lpTSCall1Req3, &lpTSCall1Ans3, 600000);
    if(!lpTSCall1Ans3)  //  超时错误
    {
        lpOutBizMsg->SetInt32(LDTAG_ERRORNO, -1);
        lpOutBizMsg->SetString(LDTAG_ERRORINFO, "[tdsecuT.1.67]subcall timed out!");
        iRet=-2;
        goto ENDSYS;
    }
    else if(lpTSCall1Ans3->GetInt32(LDTAG_ERRORNO)!=0)  //  中间件层面错误
    ...
    while (true)
    {
        ...
        lpTSCall1Req4=glpFastMsgFactory->CreateFastMessage("tdsecuT.3.30", 0);
        lpTSCall1Req4->SetInt32(LDTAG_PRIORITY, iPriority);
        lpTSCall1Req4->SetInt32(LDBIZ_OPOR_CO_NO_INT,v_opor_co_no);
        lpTSCall1Req4->SetInt32(LDBIZ_OPOR_NO_INT,v_opor_no);
        lpTSCall1Req4->SetString(LDBIZ_OPER_MAC_STR,v_oper_mac);
        ...
        if (strcmp(v_error_code,"0")==0)
        {
            ...
            if (v_tmp_comm_cancel_qty > 0 && (v_comm_dir == 1 || v_comm_dir == 2) && ((v_comm_end_date != 0 && v_comm_end_date >= v_init_date) || (v_comm_end_date == 0 && v_comm_date >= v_init_date)) && v_net_price_flag == 1 && v_bond_rate_type != 3 && (v_stock_type > 20 && v_stock_type < 50))
            {
                ...
                lpTSCall1Req5=glpFastMsgFactory->CreateFastMessage("pubT.24.103", 0);
                lpTSCall1Req5->SetInt32(LDTAG_PRIORITY, iPriority);
                lpTSCall1Req5->SetInt32(LDBIZ_OPOR_CO_NO_INT,v_opor_co_no);
                lpTSCall1Req5->SetInt32(LDBIZ_OPOR_NO_INT,v_opor_no);
                lpTSCall1Req5->SetString(LDBIZ_OPER_MAC_STR,v_oper_mac);
                ...
                if (strcmp(v_error_code,"0" )==0)
                {
                    ...
                    lpTSCall1Req6=glpFastMsgFactory->CreateFastMessage("tdsecuT.3.31", 0);
                    lpTSCall1Req6->SetInt32(LDTAG_PRIORITY, iPriority);
                    lpTSCall1Req6->SetInt32(LDBIZ_OPOR_CO_NO_INT,v_opor_co_no);
                    lpTSCall1Req6->SetInt32(LDBIZ_OPOR_NO_INT,v_opor_no);
                    lpTSCall1Req6->SetString(LDBIZ_OPER_MAC_STR,v_oper_mac);
