...
namespace LD.Client.Contract
{
    ...
    public class ReqFuncclfofuL_3_1DTO : ReqBaseDTO
    {
        public ReqFuncclfofuL_3_1DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "clfofuL.3.1";
    ...
    public class ReqFuncclfofuL_3_2DTO : ReqBaseDTO
    {
        public ReqFuncclfofuL_3_2DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "clfofuL.3.2";
            CommonDTO.func_code = CommonDTO.function_code;
            exch_no = 0;
            contrc_code = " ";
            deli_price = 0;
    ...
    public class ReqFuncclfofuL_3_3DTO : ReqBaseDTO
    {
        public ReqFuncclfofuL_3_3DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "clfofuL.3.3";
            CommonDTO.func_code = CommonDTO.function_code;
            exch_no = 0;
            contrc_code = " ";
            row_id = 0;
    ...
    public class ReqFuncclfofuL_3_4DTO : ReqBaseDTO
    {
        public ReqFuncclfofuL_3_4DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "clfofuL.3.4";
            CommonDTO.func_code = CommonDTO.function_code;
            exch_no = 0;
            contrc_code_no = 0;
            row_id = 0;
    ...
    public class ReqFuncclfofuL_3_9DTO : ReqBaseDTO
    {
        public ReqFuncclfofuL_3_9DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "clfofuL.3.9";
            CommonDTO.func_code = CommonDTO.function_code;
            co_no = 0;
            pd_no = 0;
            exch_group_no = 0;
    ...
    //逻辑_清算外盘期货_结算_结算处理
    public class ReqFuncclfofuL_3_31DTO : ReqBaseDTO
    {
        public ReqFuncclfofuL_3_31DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "clfofuL.3.31";
            CommonDTO.func_code = CommonDTO.function_code;
        }
    ...
    public class ReqFuncclfofuL_3_35DTO : ReqBaseDTO
    {
        public ReqFuncclfofuL_3_35DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "clfofuL.3.35";
            CommonDTO.func_code = CommonDTO.function_code;
            co_no = 0;
            pd_no = 0;
            exch_group_no = 0;
    ...
    //逻辑_清算外盘期货_结算_入账处理
    public class ReqFuncclfofuL_3_51DTO : ReqBaseDTO
    {
        public ReqFuncclfofuL_3_51DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "clfofuL.3.51";
            CommonDTO.func_code = CommonDTO.function_code;
            row_id = 0;
        }
    ...
    //逻辑_清算外盘期货_结算_入账回滚处理
    public class ReqFuncclfofuL_3_52DTO : ReqBaseDTO
    {
        public ReqFuncclfofuL_3_52DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "clfofuL.3.52";
            CommonDTO.func_code = CommonDTO.function_code;
            row_id = 0;
        }
    ...
    //逻辑_清算外盘期货_结算_数据归历史
    public class ReqFuncclfofuL_3_71DTO : ReqBaseDTO
    {
        public ReqFuncclfofuL_3_71DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "clfofuL.3.71";
            CommonDTO.func_code = CommonDTO.function_code;
            init_date = 0;
        }
    ...
    public class ReqFuncclfofuL_3_102DTO : ReqBaseDTO
    {
        public ReqFuncclfofuL_3_102DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "clfofuL.3.102";
            CommonDTO.func_code = CommonDTO.function_code;
            task_no = 0;
            exec_count = 0;
            exec_date = 0;
    ...
    public class ReqFuncclfofuL_3_104DTO : ReqBaseDTO
    {
        public ReqFuncclfofuL_3_104DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "clfofuL.3.104";
            CommonDTO.func_code = CommonDTO.function_code;
            task_no = 0;
            exec_count = 0;
            exec_date = 0;
    ...
    public class ReqFuncclfofuL_3_106DTO : ReqBaseDTO
    {
        public ReqFuncclfofuL_3_106DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "clfofuL.3.106";
            CommonDTO.func_code = CommonDTO.function_code;
            task_no = 0;
            exec_count = 0;
            exec_date = 0;
