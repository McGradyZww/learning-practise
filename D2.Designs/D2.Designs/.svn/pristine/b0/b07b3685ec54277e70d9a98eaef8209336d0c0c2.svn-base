...
{
    //逻辑_清算证券_公用_数据归历史
    public class ReqFuncclsecuL_1_21DTO : ReqBaseDTO
    {
        public ReqFuncclsecuL_1_21DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "clsecuL.1.21";
    ...
    //逻辑_清算证券_公用_重做准备
    public class ReqFuncclsecuL_1_41DTO : ReqBaseDTO
    {
        public ReqFuncclsecuL_1_41DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "clsecuL.1.41";
            CommonDTO.func_code = CommonDTO.function_code;
            sett_redo_type = 0;
            clear_date = 0;
            clear_deal_id = 0;
    ...
    //逻辑_清算证券_公用_处理流程统计
    public class ReqFuncclsecuL_1_42DTO : ReqBaseDTO
    {
        public ReqFuncclsecuL_1_42DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "clsecuL.1.42";
            CommonDTO.func_code = CommonDTO.function_code;
            sett_flow_step = 0;
        }
    ...
    public class ReqFuncclsecuL_1_43DTO : ReqBaseDTO
    {
        public ReqFuncclsecuL_1_43DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "clsecuL.1.43";
            CommonDTO.func_code = CommonDTO.function_code;
            init_date = 0;
            sett_flow_step = 0;
            exch_no = 0;
    ...
    public class ReqFuncclsecuL_1_44DTO : ReqBaseDTO
    {
        public ReqFuncclsecuL_1_44DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "clsecuL.1.44";
            CommonDTO.func_code = CommonDTO.function_code;
            init_date = 0;
            sett_flow_step = 0;
            exch_no = 0;
    ...
    public class ReqFuncclsecuL_1_51DTO : ReqBaseDTO
    {
        public ReqFuncclsecuL_1_51DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "clsecuL.1.51";
            CommonDTO.func_code = CommonDTO.function_code;
            task_no = 0;
            exec_count = 0;
            exec_date = 0;
