...
# 事务_产品_同步接口_获取同步时间
DELIMITER ;;
DROP PROCEDURE IF EXISTS prt_pdsyn_GetSyncTime;;
DELIMITER ;;
CREATE PROCEDURE prt_pdsyn_GetSyncTime(
    IN p_opor_co_no int,
    IN p_opor_no int,
...
BEGIN
    ...
    /* 调用【原子_产品_同步接口_获取同步时间】*/
    call db_prod.pra_pdsyn_GetSyncTime(
        v_opor_co_no,
        v_opor_no,
        v_oper_mac,
        v_oper_ip_addr,
    ...
    if v_error_code = "1" then
        SET v_error_code = "prodT.15.1.999";
        if v_mysql_message <> "" then
             SET v_error_info = CONCAT(v_error_info,"#",'调用过程原子_产品_同步接口_获取同步时间出现错误！',v_mysql_message);
        end if;
        leave label_pro;
...
# 事务_产品_同步接口_更新同步时间
DELIMITER ;;
DROP PROCEDURE IF EXISTS prt_pdsyn_UpdateSyncTime;;
DELIMITER ;;
CREATE PROCEDURE prt_pdsyn_UpdateSyncTime(
    IN p_opor_co_no int,
    IN p_opor_no int,
    IN p_oper_mac varchar(32),
    IN p_oper_ip_addr varchar(32),
...
BEGIN
    ...
    /* 调用【原子_产品_同步接口_更新同步时间】*/
    call db_prod.pra_pdsyn_UpdateSyncTime(
        v_opor_co_no,
        v_opor_no,
        v_oper_mac,
        v_oper_ip_addr,
        ...
        v_mach_time);
    if v_error_code = "1" then
        SET v_error_code = "prodT.15.2.999";
        if v_mysql_message <> "" then
             SET v_error_info = CONCAT(v_error_info,"#",'调用过程原子_产品_同步接口_更新同步时间出现错误！',v_mysql_message);
        end if;
        ROLLBACK;
        leave label_pro;
    elseif v_error_code <> "0" then
...
# 事务_产品_同步接口_同步产品信息表
DELIMITER ;;
DROP PROCEDURE IF EXISTS prt_pdsyn_Syncpdacco_pd_info;;
DELIMITER ;;
CREATE PROCEDURE prt_pdsyn_Syncpdacco_pd_info(
    IN p_opor_co_no int,
    IN p_opor_no int,
    IN p_oper_mac varchar(32),
    IN p_oper_ip_addr varchar(32),
...
# 事务_产品_同步接口_同步产品限制信息表
DELIMITER ;;
DROP PROCEDURE IF EXISTS prt_pdsyn_Syncpdacco_pd_limit;;
DELIMITER ;;
CREATE PROCEDURE prt_pdsyn_Syncpdacco_pd_limit(
    IN p_opor_co_no int,
    IN p_opor_no int,
    IN p_oper_mac varchar(32),
    IN p_oper_ip_addr varchar(32),
...
# 事务_产品_同步接口_同步资产账户信息表
DELIMITER ;;
DROP PROCEDURE IF EXISTS prt_pdsyn_Syncpdacco_asset_acco;;
DELIMITER ;;
CREATE PROCEDURE prt_pdsyn_Syncpdacco_asset_acco(
    IN p_opor_co_no int,
    IN p_opor_no int,
    IN p_oper_mac varchar(32),
    IN p_oper_ip_addr varchar(32),
...
# 事务_产品_同步接口_同步资产账户通道信息表
DELIMITER ;;
DROP PROCEDURE IF EXISTS prt_pdsyn_Syncpdacco_asset_acco_ch;;
DELIMITER ;;
CREATE PROCEDURE prt_pdsyn_Syncpdacco_asset_acco_ch(
    IN p_opor_co_no int,
    IN p_opor_no int,
    IN p_oper_mac varchar(32),
    IN p_oper_ip_addr varchar(32),
...
# 事务_产品_同步接口_同步产品资金表
DELIMITER ;;
DROP PROCEDURE IF EXISTS prt_pdsyn_Syncpdcapit_pd_capit;;
DELIMITER ;;
CREATE PROCEDURE prt_pdsyn_Syncpdcapit_pd_capit(
    IN p_opor_co_no int,
    IN p_opor_no int,
    IN p_oper_mac varchar(32),
    IN p_oper_ip_addr varchar(32),
...
# 事务_产品_同步接口_同步产品资产表
DELIMITER ;;
DROP PROCEDURE IF EXISTS prt_pdsyn_Syncpdcapit_pd_asset;;
DELIMITER ;;
CREATE PROCEDURE prt_pdsyn_Syncpdcapit_pd_asset(
    IN p_opor_co_no int,
    IN p_opor_no int,
    IN p_oper_mac varchar(32),
    IN p_oper_ip_addr varchar(32),
