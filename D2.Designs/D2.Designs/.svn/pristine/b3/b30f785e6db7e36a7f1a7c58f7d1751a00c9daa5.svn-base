...
# 事务_交易证券_同步接口_获取同步时间
DELIMITER ;;
DROP PROCEDURE IF EXISTS prt_tdsesyn_GetSyncTime;;
DELIMITER ;;
CREATE PROCEDURE prt_tdsesyn_GetSyncTime(
    IN p_opor_co_no int,
    IN p_opor_no int,
...
BEGIN
    ...
    /* 调用【原子_交易证券_同步接口_获取同步时间】*/
    call db_tdsecu.pra_tdsesyn_GetSyncTime(
        v_opor_co_no,
        v_opor_no,
        v_oper_mac,
        v_oper_ip_addr,
    ...
    if v_error_code = "1" then
        SET v_error_code = "tdsecuT.15.1.999";
        if v_mysql_message <> "" then
             SET v_error_info = CONCAT(v_error_info,"#",'调用过程原子_交易证券_同步接口_获取同步时间出现错误！',v_mysql_message);
        end if;
        leave label_pro;
...
# 事务_交易证券_同步接口_更新同步时间
DELIMITER ;;
DROP PROCEDURE IF EXISTS prt_tdsesyn_UpdateSyncTime;;
DELIMITER ;;
CREATE PROCEDURE prt_tdsesyn_UpdateSyncTime(
    IN p_opor_co_no int,
    IN p_opor_no int,
    IN p_oper_mac varchar(32),
    IN p_oper_ip_addr varchar(32),
...
BEGIN
    ...
    /* 调用【原子_交易证券_同步接口_更新同步时间】*/
    call db_tdsecu.pra_tdsesyn_UpdateSyncTime(
        v_opor_co_no,
        v_opor_no,
        v_oper_mac,
        v_oper_ip_addr,
        ...
        v_mach_time);
    if v_error_code = "1" then
        SET v_error_code = "tdsecuT.15.2.999";
        if v_mysql_message <> "" then
             SET v_error_info = CONCAT(v_error_info,"#",'调用过程原子_交易证券_同步接口_更新同步时间出现错误！',v_mysql_message);
        end if;
        ROLLBACK;
        leave label_pro;
    elseif v_error_code <> "0" then
...
# 事务_交易证券_同步接口_同步交易组业务资金表
DELIMITER ;;
DROP PROCEDURE IF EXISTS prt_tdsesyn_Synctdseac_exgp_busi_capit;;
DELIMITER ;;
CREATE PROCEDURE prt_tdsesyn_Synctdseac_exgp_busi_capit(
    IN p_opor_co_no int,
    IN p_opor_no int,
    IN p_oper_mac varchar(32),
    IN p_oper_ip_addr varchar(32),
...
BEGIN
    ...
    /* 调用【原子_交易证券_同步接口_同步交易组业务资金表】*/
    call db_tdsecu.pra_tdsesyn_Synctdseac_exgp_busi_capit(
        v_opor_co_no,
        v_opor_no,
        v_oper_mac,
        v_oper_ip_addr,
        ...
        v_sync_field99);
    if v_error_code = "1" then
        SET v_error_code = "tdsecuT.15.12.999";
        if v_mysql_message <> "" then
             SET v_error_info = CONCAT(v_error_info,"#",'调用过程原子_交易证券_同步接口_同步交易组业务资金表出现错误！',v_mysql_message);
        end if;
        leave label_pro;
    elseif v_error_code <> "0" then
        leave label_pro;
...
# 事务_交易证券_同步接口_同步资产账户业务资金表
DELIMITER ;;
DROP PROCEDURE IF EXISTS prt_tdsesyn_Synctdseac_asac_busi_capit;;
DELIMITER ;;
CREATE PROCEDURE prt_tdsesyn_Synctdseac_asac_busi_capit(
    IN p_opor_co_no int,
    IN p_opor_no int,
    IN p_oper_mac varchar(32),
    IN p_oper_ip_addr varchar(32),
...
BEGIN
    ...
    /* 调用【原子_交易证券_同步接口_同步资产账户业务资金表】*/
    call db_tdsecu.pra_tdsesyn_Synctdseac_asac_busi_capit(
        v_opor_co_no,
        v_opor_no,
        v_oper_mac,
        v_oper_ip_addr,
        ...
        v_sync_field99);
    if v_error_code = "1" then
        SET v_error_code = "tdsecuT.15.13.999";
        if v_mysql_message <> "" then
             SET v_error_info = CONCAT(v_error_info,"#",'调用过程原子_交易证券_同步接口_同步资产账户业务资金表出现错误！',v_mysql_message);
        end if;
        leave label_pro;
    elseif v_error_code <> "0" then
        leave label_pro;
...
# 事务_交易证券_同步接口_同步交易组业务持仓表
DELIMITER ;;
DROP PROCEDURE IF EXISTS prt_tdsesyn_Synctdseac_exgp_busi_posi;;
DELIMITER ;;
CREATE PROCEDURE prt_tdsesyn_Synctdseac_exgp_busi_posi(
    IN p_opor_co_no int,
    IN p_opor_no int,
    IN p_oper_mac varchar(32),
    IN p_oper_ip_addr varchar(32),
...
BEGIN
    ...
    /* 调用【原子_交易证券_同步接口_同步交易组业务持仓表】*/
    call db_tdsecu.pra_tdsesyn_Synctdseac_exgp_busi_posi(
        v_opor_co_no,
        v_opor_no,
        v_oper_mac,
        v_oper_ip_addr,
        ...
        v_sync_field99);
    if v_error_code = "1" then
        SET v_error_code = "tdsecuT.15.14.999";
        if v_mysql_message <> "" then
             SET v_error_info = CONCAT(v_error_info,"#",'调用过程原子_交易证券_同步接口_同步交易组业务持仓表出现错误！',v_mysql_message);
        end if;
        leave label_pro;
    elseif v_error_code <> "0" then
        leave label_pro;
...
# 事务_交易证券_同步接口_同步资产账户业务持仓表
DELIMITER ;;
DROP PROCEDURE IF EXISTS prt_tdsesyn_Synctdseac_asac_busi_posi;;
DELIMITER ;;
CREATE PROCEDURE prt_tdsesyn_Synctdseac_asac_busi_posi(
    IN p_opor_co_no int,
    IN p_opor_no int,
    IN p_oper_mac varchar(32),
    IN p_oper_ip_addr varchar(32),
...
BEGIN
    ...
    /* 调用【原子_交易证券_同步接口_同步资产账户业务持仓表】*/
    call db_tdsecu.pra_tdsesyn_Synctdseac_asac_busi_posi(
        v_opor_co_no,
        v_opor_no,
        v_oper_mac,
        v_oper_ip_addr,
        ...
        v_sync_field99);
    if v_error_code = "1" then
        SET v_error_code = "tdsecuT.15.15.999";
        if v_mysql_message <> "" then
             SET v_error_info = CONCAT(v_error_info,"#",'调用过程原子_交易证券_同步接口_同步资产账户业务持仓表出现错误！',v_mysql_message);
        end if;
        leave label_pro;
    elseif v_error_code <> "0" then
        leave label_pro;
...
# 事务_交易证券_同步接口_同步交易组债券质押表
DELIMITER ;;
DROP PROCEDURE IF EXISTS prt_tdsesyn_Synctdseac_exgp_bond_impawn;;
DELIMITER ;;
CREATE PROCEDURE prt_tdsesyn_Synctdseac_exgp_bond_impawn(
    IN p_opor_co_no int,
    IN p_opor_no int,
    IN p_oper_mac varchar(32),
    IN p_oper_ip_addr varchar(32),
...
BEGIN
    ...
    /* 调用【原子_交易证券_同步接口_同步交易组债券质押表】*/
    call db_tdsecu.pra_tdsesyn_Synctdseac_exgp_bond_impawn(
        v_opor_co_no,
        v_opor_no,
        v_oper_mac,
        v_oper_ip_addr,
        ...
        v_sync_field99);
    if v_error_code = "1" then
        SET v_error_code = "tdsecuT.15.16.999";
        if v_mysql_message <> "" then
             SET v_error_info = CONCAT(v_error_info,"#",'调用过程原子_交易证券_同步接口_同步交易组债券质押表出现错误！',v_mysql_message);
        end if;
        leave label_pro;
    elseif v_error_code <> "0" then
        leave label_pro;
...
# 事务_交易证券_同步接口_同步资产账户债券质押表
DELIMITER ;;
DROP PROCEDURE IF EXISTS prt_tdsesyn_Synctdseac_asac_bond_impawn;;
DELIMITER ;;
CREATE PROCEDURE prt_tdsesyn_Synctdseac_asac_bond_impawn(
    IN p_opor_co_no int,
    IN p_opor_no int,
    IN p_oper_mac varchar(32),
    IN p_oper_ip_addr varchar(32),
...
BEGIN
    ...
    /* 调用【原子_交易证券_同步接口_同步资产账户债券质押表】*/
    call db_tdsecu.pra_tdsesyn_Synctdseac_asac_bond_impawn(
        v_opor_co_no,
        v_opor_no,
        v_oper_mac,
        v_oper_ip_addr,
        ...
        v_sync_field99);
    if v_error_code = "1" then
        SET v_error_code = "tdsecuT.15.17.999";
        if v_mysql_message <> "" then
             SET v_error_info = CONCAT(v_error_info,"#",'调用过程原子_交易证券_同步接口_同步资产账户债券质押表出现错误！',v_mysql_message);
        end if;
        leave label_pro;
    elseif v_error_code <> "0" then
        leave label_pro;
...
# 事务_交易证券_同步接口_同步指令表
DELIMITER ;;
DROP PROCEDURE IF EXISTS prt_tdsesyn_Synctdseap_command;;
DELIMITER ;;
CREATE PROCEDURE prt_tdsesyn_Synctdseap_command(
    IN p_opor_co_no int,
    IN p_opor_no int,
    IN p_oper_mac varchar(32),
    IN p_oper_ip_addr varchar(32),
...
BEGIN
    ...
    /* 调用【原子_交易证券_同步接口_同步指令表】*/
    call db_tdsecu.pra_tdsesyn_Synctdseap_command(
        v_opor_co_no,
        v_opor_no,
        v_oper_mac,
        v_oper_ip_addr,
        ...
        v_sync_field99);
    if v_error_code = "1" then
        SET v_error_code = "tdsecuT.15.18.999";
        if v_mysql_message <> "" then
             SET v_error_info = CONCAT(v_error_info,"#",'调用过程原子_交易证券_同步接口_同步指令表出现错误！',v_mysql_message);
        end if;
        leave label_pro;
    elseif v_error_code <> "0" then
        leave label_pro;
...
# 事务_交易证券_同步接口_同步指令流水表
DELIMITER ;;
DROP PROCEDURE IF EXISTS prt_tdsesyn_Synctdseap_command_jour;;
DELIMITER ;;
CREATE PROCEDURE prt_tdsesyn_Synctdseap_command_jour(
    IN p_opor_co_no int,
    IN p_opor_no int,
    IN p_oper_mac varchar(32),
    IN p_oper_ip_addr varchar(32),
...
BEGIN
    ...
    /* 调用【原子_交易证券_同步接口_同步指令流水表】*/
    call db_tdsecu.pra_tdsesyn_Synctdseap_command_jour(
        v_opor_co_no,
        v_opor_no,
        v_oper_mac,
        v_oper_ip_addr,
        ...
        v_sync_field99);
    if v_error_code = "1" then
        SET v_error_code = "tdsecuT.15.19.999";
        if v_mysql_message <> "" then
             SET v_error_info = CONCAT(v_error_info,"#",'调用过程原子_交易证券_同步接口_同步指令流水表出现错误！',v_mysql_message);
        end if;
        leave label_pro;
    elseif v_error_code <> "0" then
        leave label_pro;
...
# 事务_交易证券_同步接口_同步指令分发表
DELIMITER ;;
DROP PROCEDURE IF EXISTS prt_tdsesyn_Synctdseap_command_dispense;;
DELIMITER ;;
CREATE PROCEDURE prt_tdsesyn_Synctdseap_command_dispense(
    IN p_opor_co_no int,
    IN p_opor_no int,
    IN p_oper_mac varchar(32),
    IN p_oper_ip_addr varchar(32),
...
BEGIN
    ...
    /* 调用【原子_交易证券_同步接口_同步指令分发表】*/
    call db_tdsecu.pra_tdsesyn_Synctdseap_command_dispense(
        v_opor_co_no,
        v_opor_no,
        v_oper_mac,
        v_oper_ip_addr,
        ...
        v_sync_field99);
    if v_error_code = "1" then
        SET v_error_code = "tdsecuT.15.20.999";
        if v_mysql_message <> "" then
             SET v_error_info = CONCAT(v_error_info,"#",'调用过程原子_交易证券_同步接口_同步指令分发表出现错误！',v_mysql_message);
        end if;
        leave label_pro;
    elseif v_error_code <> "0" then
        leave label_pro;
...
# 事务_交易证券_同步接口_同步指令审批表
DELIMITER ;;
DROP PROCEDURE IF EXISTS prt_tdsesyn_Synctdseap_command_approve;;
DELIMITER ;;
CREATE PROCEDURE prt_tdsesyn_Synctdseap_command_approve(
    IN p_opor_co_no int,
    IN p_opor_no int,
    IN p_oper_mac varchar(32),
    IN p_oper_ip_addr varchar(32),
...
BEGIN
    ...
    /* 调用【原子_交易证券_同步接口_同步指令审批表】*/
    call db_tdsecu.pra_tdsesyn_Synctdseap_command_approve(
        v_opor_co_no,
        v_opor_no,
        v_oper_mac,
        v_oper_ip_addr,
        ...
        v_sync_field99);
    if v_error_code = "1" then
        SET v_error_code = "tdsecuT.15.21.999";
        if v_mysql_message <> "" then
             SET v_error_info = CONCAT(v_error_info,"#",'调用过程原子_交易证券_同步接口_同步指令审批表出现错误！',v_mysql_message);
        end if;
        leave label_pro;
    elseif v_error_code <> "0" then
        leave label_pro;
...
# 事务_交易证券_同步接口_同步订单表
DELIMITER ;;
DROP PROCEDURE IF EXISTS prt_tdsesyn_Synctdsetd_order;;
DELIMITER ;;
CREATE PROCEDURE prt_tdsesyn_Synctdsetd_order(
    IN p_opor_co_no int,
    IN p_opor_no int,
    IN p_oper_mac varchar(32),
    IN p_oper_ip_addr varchar(32),
...
BEGIN
    ...
    /* 调用【原子_交易证券_同步接口_同步订单表】*/
    call db_tdsecu.pra_tdsesyn_Synctdsetd_order(
        v_opor_co_no,
        v_opor_no,
        v_oper_mac,
        v_oper_ip_addr,
        ...
        v_sync_field99);
    if v_error_code = "1" then
        SET v_error_code = "tdsecuT.15.22.999";
        if v_mysql_message <> "" then
             SET v_error_info = CONCAT(v_error_info,"#",'调用过程原子_交易证券_同步接口_同步订单表出现错误！',v_mysql_message);
        end if;
        leave label_pro;
    elseif v_error_code <> "0" then
        leave label_pro;
...
# 事务_交易证券_同步接口_同步通道订单表
DELIMITER ;;
DROP PROCEDURE IF EXISTS prt_tdsesyn_Synctdsetd_channelorder;;
DELIMITER ;;
CREATE PROCEDURE prt_tdsesyn_Synctdsetd_channelorder(
    IN p_opor_co_no int,
    IN p_opor_no int,
    IN p_oper_mac varchar(32),
    IN p_oper_ip_addr varchar(32),
...
BEGIN
    ...
    /* 调用【原子_交易证券_同步接口_同步通道订单表】*/
    call db_tdsecu.pra_tdsesyn_Synctdsetd_channelorder(
        v_opor_co_no,
        v_opor_no,
        v_oper_mac,
        v_oper_ip_addr,
        ...
        v_sync_field99);
    if v_error_code = "1" then
        SET v_error_code = "tdsecuT.15.23.999";
        if v_mysql_message <> "" then
             SET v_error_info = CONCAT(v_error_info,"#",'调用过程原子_交易证券_同步接口_同步通道订单表出现错误！',v_mysql_message);
        end if;
        leave label_pro;
    elseif v_error_code <> "0" then
        leave label_pro;
...
# 事务_交易证券_同步接口_同步新股申购表
DELIMITER ;;
DROP PROCEDURE IF EXISTS prt_tdsesyn_Synctdsetd_purchaseorder;;
DELIMITER ;;
CREATE PROCEDURE prt_tdsesyn_Synctdsetd_purchaseorder(
    IN p_opor_co_no int,
    IN p_opor_no int,
    IN p_oper_mac varchar(32),
    IN p_oper_ip_addr varchar(32),
...
BEGIN
    ...
    /* 调用【原子_交易证券_同步接口_同步新股申购表】*/
    call db_tdsecu.pra_tdsesyn_Synctdsetd_purchaseorder(
        v_opor_co_no,
        v_opor_no,
        v_oper_mac,
        v_oper_ip_addr,
        ...
        v_sync_field99);
    if v_error_code = "1" then
        SET v_error_code = "tdsecuT.15.24.999";
        if v_mysql_message <> "" then
             SET v_error_info = CONCAT(v_error_info,"#",'调用过程原子_交易证券_同步接口_同步新股申购表出现错误！',v_mysql_message);
        end if;
        leave label_pro;
    elseif v_error_code <> "0" then
        leave label_pro;
...
# 事务_交易证券_同步接口_同步撤单表
DELIMITER ;;
DROP PROCEDURE IF EXISTS prt_tdsesyn_Synctdsetd_cancel;;
DELIMITER ;;
CREATE PROCEDURE prt_tdsesyn_Synctdsetd_cancel(
    IN p_opor_co_no int,
    IN p_opor_no int,
    IN p_oper_mac varchar(32),
    IN p_oper_ip_addr varchar(32),
...
BEGIN
    ...
    /* 调用【原子_交易证券_同步接口_同步撤单表】*/
    call db_tdsecu.pra_tdsesyn_Synctdsetd_cancel(
        v_opor_co_no,
        v_opor_no,
        v_oper_mac,
        v_oper_ip_addr,
        ...
        v_sync_field99);
    if v_error_code = "1" then
        SET v_error_code = "tdsecuT.15.25.999";
        if v_mysql_message <> "" then
             SET v_error_info = CONCAT(v_error_info,"#",'调用过程原子_交易证券_同步接口_同步撤单表出现错误！',v_mysql_message);
        end if;
        leave label_pro;
    elseif v_error_code <> "0" then
        leave label_pro;
...
# 事务_交易证券_同步接口_同步预埋订单表
DELIMITER ;;
DROP PROCEDURE IF EXISTS prt_tdsesyn_Synctdsetd_preorder;;
DELIMITER ;;
CREATE PROCEDURE prt_tdsesyn_Synctdsetd_preorder(
    IN p_opor_co_no int,
    IN p_opor_no int,
    IN p_oper_mac varchar(32),
    IN p_oper_ip_addr varchar(32),
...
BEGIN
    ...
    /* 调用【原子_交易证券_同步接口_同步预埋订单表】*/
    call db_tdsecu.pra_tdsesyn_Synctdsetd_preorder(
        v_opor_co_no,
        v_opor_no,
        v_oper_mac,
        v_oper_ip_addr,
        ...
        v_sync_field99);
    if v_error_code = "1" then
        SET v_error_code = "tdsecuT.15.26.999";
        if v_mysql_message <> "" then
             SET v_error_info = CONCAT(v_error_info,"#",'调用过程原子_交易证券_同步接口_同步预埋订单表出现错误！',v_mysql_message);
        end if;
        leave label_pro;
    elseif v_error_code <> "0" then
        leave label_pro;
...
# 事务_交易证券_同步接口_同步篮子订单表
DELIMITER ;;
DROP PROCEDURE IF EXISTS prt_tdsesyn_Synctdsetd_basketorder;;
DELIMITER ;;
CREATE PROCEDURE prt_tdsesyn_Synctdsetd_basketorder(
    IN p_opor_co_no int,
    IN p_opor_no int,
    IN p_oper_mac varchar(32),
    IN p_oper_ip_addr varchar(32),
...
BEGIN
    ...
    /* 调用【原子_交易证券_同步接口_同步篮子订单表】*/
    call db_tdsecu.pra_tdsesyn_Synctdsetd_basketorder(
        v_opor_co_no,
        v_opor_no,
        v_oper_mac,
        v_oper_ip_addr,
        ...
        v_sync_field99);
    if v_error_code = "1" then
        SET v_error_code = "tdsecuT.15.27.999";
        if v_mysql_message <> "" then
             SET v_error_info = CONCAT(v_error_info,"#",'调用过程原子_交易证券_同步接口_同步篮子订单表出现错误！',v_mysql_message);
        end if;
        leave label_pro;
    elseif v_error_code <> "0" then
        leave label_pro;
...
# 事务_交易证券_同步接口_同步改单表
DELIMITER ;;
DROP PROCEDURE IF EXISTS prt_tdsesyn_Synctdsetd_modifyorder;;
DELIMITER ;;
CREATE PROCEDURE prt_tdsesyn_Synctdsetd_modifyorder(
    IN p_opor_co_no int,
    IN p_opor_no int,
    IN p_oper_mac varchar(32),
    IN p_oper_ip_addr varchar(32),
...
BEGIN
    ...
    /* 调用【原子_交易证券_同步接口_同步改单表】*/
    call db_tdsecu.pra_tdsesyn_Synctdsetd_modifyorder(
        v_opor_co_no,
        v_opor_no,
        v_oper_mac,
        v_oper_ip_addr,
        ...
        v_sync_field99);
    if v_error_code = "1" then
        SET v_error_code = "tdsecuT.15.28.999";
        if v_mysql_message <> "" then
             SET v_error_info = CONCAT(v_error_info,"#",'调用过程原子_交易证券_同步接口_同步改单表出现错误！',v_mysql_message);
        end if;
        leave label_pro;
    elseif v_error_code <> "0" then
        leave label_pro;
...
# 事务_交易证券_同步接口_同步待执行订单表
DELIMITER ;;
DROP PROCEDURE IF EXISTS prt_tdsesyn_Synctdsetd_pendorder;;
DELIMITER ;;
CREATE PROCEDURE prt_tdsesyn_Synctdsetd_pendorder(
    IN p_opor_co_no int,
    IN p_opor_no int,
    IN p_oper_mac varchar(32),
    IN p_oper_ip_addr varchar(32),
...
BEGIN
    ...
    /* 调用【原子_交易证券_同步接口_同步待执行订单表】*/
    call db_tdsecu.pra_tdsesyn_Synctdsetd_pendorder(
        v_opor_co_no,
        v_opor_no,
        v_oper_mac,
        v_oper_ip_addr,
        ...
        v_sync_field99);
    if v_error_code = "1" then
        SET v_error_code = "tdsecuT.15.29.999";
        if v_mysql_message <> "" then
             SET v_error_info = CONCAT(v_error_info,"#",'调用过程原子_交易证券_同步接口_同步待执行订单表出现错误！',v_mysql_message);
        end if;
        leave label_pro;
    elseif v_error_code <> "0" then
        leave label_pro;
...
# 事务_交易证券_同步接口_同步订单回报表
DELIMITER ;;
DROP PROCEDURE IF EXISTS prt_tdsesyn_Synctdserp_orderrsp;;
DELIMITER ;;
CREATE PROCEDURE prt_tdsesyn_Synctdserp_orderrsp(
    IN p_opor_co_no int,
    IN p_opor_no int,
    IN p_oper_mac varchar(32),
    IN p_oper_ip_addr varchar(32),
...
BEGIN
    ...
    /* 调用【原子_交易证券_同步接口_同步订单回报表】*/
    call db_tdsecu.pra_tdsesyn_Synctdserp_orderrsp(
        v_opor_co_no,
        v_opor_no,
        v_oper_mac,
        v_oper_ip_addr,
        ...
        v_sync_field99);
    if v_error_code = "1" then
        SET v_error_code = "tdsecuT.15.30.999";
        if v_mysql_message <> "" then
             SET v_error_info = CONCAT(v_error_info,"#",'调用过程原子_交易证券_同步接口_同步订单回报表出现错误！',v_mysql_message);
        end if;
        leave label_pro;
    elseif v_error_code <> "0" then
        leave label_pro;
...
# 事务_交易证券_同步接口_同步成交回报表
DELIMITER ;;
DROP PROCEDURE IF EXISTS prt_tdsesyn_Synctdserp_strikersp;;
DELIMITER ;;
CREATE PROCEDURE prt_tdsesyn_Synctdserp_strikersp(
    IN p_opor_co_no int,
    IN p_opor_no int,
    IN p_oper_mac varchar(32),
    IN p_oper_ip_addr varchar(32),
...
BEGIN
    ...
    /* 调用【原子_交易证券_同步接口_同步成交回报表】*/
    call db_tdsecu.pra_tdsesyn_Synctdserp_strikersp(
        v_opor_co_no,
        v_opor_no,
        v_oper_mac,
        v_oper_ip_addr,
        ...
        v_sync_field99);
    if v_error_code = "1" then
        SET v_error_code = "tdsecuT.15.31.999";
        if v_mysql_message <> "" then
             SET v_error_info = CONCAT(v_error_info,"#",'调用过程原子_交易证券_同步接口_同步成交回报表出现错误！',v_mysql_message);
        end if;
        leave label_pro;
    elseif v_error_code <> "0" then
        leave label_pro;
...
# 事务_交易证券_同步接口_同步成交表
DELIMITER ;;
DROP PROCEDURE IF EXISTS prt_tdsesyn_Synctdserp_strike;;
DELIMITER ;;
CREATE PROCEDURE prt_tdsesyn_Synctdserp_strike(
    IN p_opor_co_no int,
    IN p_opor_no int,
    IN p_oper_mac varchar(32),
    IN p_oper_ip_addr varchar(32),
...
BEGIN
    ...
    /* 调用【原子_交易证券_同步接口_同步成交表】*/
    call db_tdsecu.pra_tdsesyn_Synctdserp_strike(
        v_opor_co_no,
        v_opor_no,
        v_oper_mac,
        v_oper_ip_addr,
        ...
        v_sync_field99);
    if v_error_code = "1" then
        SET v_error_code = "tdsecuT.15.32.999";
        if v_mysql_message <> "" then
             SET v_error_info = CONCAT(v_error_info,"#",'调用过程原子_交易证券_同步接口_同步成交表出现错误！',v_mysql_message);
        end if;
        leave label_pro;
    elseif v_error_code <> "0" then
        leave label_pro;
...
# 事务_交易证券_同步接口_同步操作员阈值设置表
DELIMITER ;;
DROP PROCEDURE IF EXISTS prt_tdsesyn_Synctdset0_opor_tshold_set;;
DELIMITER ;;
CREATE PROCEDURE prt_tdsesyn_Synctdset0_opor_tshold_set(
    IN p_opor_co_no int,
    IN p_opor_no int,
    IN p_oper_mac varchar(32),
    IN p_oper_ip_addr varchar(32),
...
BEGIN
    ...
    /* 调用【原子_交易证券_同步接口_同步操作员阈值设置表】*/
    call db_tdsecu.pra_tdsesyn_Synctdset0_opor_tshold_set(
        v_opor_co_no,
        v_opor_no,
        v_oper_mac,
        v_oper_ip_addr,
        ...
        v_sync_field99);
    if v_error_code = "1" then
        SET v_error_code = "tdsecuT.15.33.999";
        if v_mysql_message <> "" then
             SET v_error_info = CONCAT(v_error_info,"#",'调用过程原子_交易证券_同步接口_同步操作员阈值设置表出现错误！',v_mysql_message);
        end if;
        leave label_pro;
    elseif v_error_code <> "0" then
        leave label_pro;
...
# 事务_交易证券_同步接口_同步操作员参数设置表
DELIMITER ;;
DROP PROCEDURE IF EXISTS prt_tdsesyn_Synctdset0_opor_param_set;;
DELIMITER ;;
CREATE PROCEDURE prt_tdsesyn_Synctdset0_opor_param_set(
    IN p_opor_co_no int,
    IN p_opor_no int,
    IN p_oper_mac varchar(32),
    IN p_oper_ip_addr varchar(32),
...
BEGIN
    ...
    /* 调用【原子_交易证券_同步接口_同步操作员参数设置表】*/
    call db_tdsecu.pra_tdsesyn_Synctdset0_opor_param_set(
        v_opor_co_no,
        v_opor_no,
        v_oper_mac,
        v_oper_ip_addr,
        ...
        v_sync_field99);
    if v_error_code = "1" then
        SET v_error_code = "tdsecuT.15.34.999";
        if v_mysql_message <> "" then
             SET v_error_info = CONCAT(v_error_info,"#",'调用过程原子_交易证券_同步接口_同步操作员参数设置表出现错误！',v_mysql_message);
        end if;
        leave label_pro;
    elseif v_error_code <> "0" then
        leave label_pro;
...
# 事务_交易证券_同步接口_同步证券持仓明细表
DELIMITER ;;
DROP PROCEDURE IF EXISTS prt_tdsesyn_Synctdset0_stock_posi_detail;;
DELIMITER ;;
CREATE PROCEDURE prt_tdsesyn_Synctdset0_stock_posi_detail(
    IN p_opor_co_no int,
    IN p_opor_no int,
    IN p_oper_mac varchar(32),
    IN p_oper_ip_addr varchar(32),
...
BEGIN
    ...
    /* 调用【原子_交易证券_同步接口_同步证券持仓明细表】*/
    call db_tdsecu.pra_tdsesyn_Synctdset0_stock_posi_detail(
        v_opor_co_no,
        v_opor_no,
        v_oper_mac,
        v_oper_ip_addr,
        ...
        v_sync_field99);
    if v_error_code = "1" then
        SET v_error_code = "tdsecuT.15.35.999";
        if v_mysql_message <> "" then
             SET v_error_info = CONCAT(v_error_info,"#",'调用过程原子_交易证券_同步接口_同步证券持仓明细表出现错误！',v_mysql_message);
        end if;
        leave label_pro;
    elseif v_error_code <> "0" then
        leave label_pro;
...
# 事务_交易证券_同步接口_同步证券平仓成交明细表
DELIMITER ;;
DROP PROCEDURE IF EXISTS prt_tdsesyn_Synctdset0_close_posi_strike_detail;;
DELIMITER ;;
CREATE PROCEDURE prt_tdsesyn_Synctdset0_close_posi_strike_detail(
    IN p_opor_co_no int,
    IN p_opor_no int,
    IN p_oper_mac varchar(32),
    IN p_oper_ip_addr varchar(32),
...
BEGIN
    ...
    /* 调用【原子_交易证券_同步接口_同步证券平仓成交明细表】*/
    call db_tdsecu.pra_tdsesyn_Synctdset0_close_posi_strike_detail(
        v_opor_co_no,
        v_opor_no,
        v_oper_mac,
        v_oper_ip_addr,
        ...
        v_sync_field99);
    if v_error_code = "1" then
        SET v_error_code = "tdsecuT.15.36.999";
        if v_mysql_message <> "" then
             SET v_error_info = CONCAT(v_error_info,"#",'调用过程原子_交易证券_同步接口_同步证券平仓成交明细表出现错误！',v_mysql_message);
        end if;
        leave label_pro;
    elseif v_error_code <> "0" then
        leave label_pro;
...
# 事务_交易证券_同步接口_同步操作员券源设置表
DELIMITER ;;
DROP PROCEDURE IF EXISTS prt_tdsesyn_Synctdset0_opor_stock_source;;
DELIMITER ;;
CREATE PROCEDURE prt_tdsesyn_Synctdset0_opor_stock_source(
    IN p_opor_co_no int,
    IN p_opor_no int,
    IN p_oper_mac varchar(32),
    IN p_oper_ip_addr varchar(32),
...
BEGIN
    ...
    /* 调用【原子_交易证券_同步接口_同步操作员券源设置表】*/
    call db_tdsecu.pra_tdsesyn_Synctdset0_opor_stock_source(
        v_opor_co_no,
        v_opor_no,
        v_oper_mac,
        v_oper_ip_addr,
        ...
        v_sync_field99);
    if v_error_code = "1" then
        SET v_error_code = "tdsecuT.15.37.999";
        if v_mysql_message <> "" then
             SET v_error_info = CONCAT(v_error_info,"#",'调用过程原子_交易证券_同步接口_同步操作员券源设置表出现错误！',v_mysql_message);
        end if;
        leave label_pro;
    elseif v_error_code <> "0" then
        leave label_pro;
...
# 事务_交易证券_同步接口_同步证券持仓汇总表
DELIMITER ;;
DROP PROCEDURE IF EXISTS prt_tdsesyn_Synctdset0_stock_posi_sum;;
DELIMITER ;;
CREATE PROCEDURE prt_tdsesyn_Synctdset0_stock_posi_sum(
    IN p_opor_co_no int,
    IN p_opor_no int,
    IN p_oper_mac varchar(32),
    IN p_oper_ip_addr varchar(32),
...
BEGIN
    ...
    /* 调用【原子_交易证券_同步接口_同步证券持仓汇总表】*/
    call db_tdsecu.pra_tdsesyn_Synctdset0_stock_posi_sum(
        v_opor_co_no,
        v_opor_no,
        v_oper_mac,
        v_oper_ip_addr,
        ...
        v_sync_field99);
    if v_error_code = "1" then
        SET v_error_code = "tdsecuT.15.38.999";
        if v_mysql_message <> "" then
             SET v_error_info = CONCAT(v_error_info,"#",'调用过程原子_交易证券_同步接口_同步证券持仓汇总表出现错误！',v_mysql_message);
        end if;
        leave label_pro;
    elseif v_error_code <> "0" then
        leave label_pro;
