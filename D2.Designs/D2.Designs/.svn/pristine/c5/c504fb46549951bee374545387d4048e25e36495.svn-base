...
# 事务_数据同步_产品证券同步_同步资产账户持仓
DELIMITER ;;
DROP PROCEDURE IF EXISTS prt_dcsypse_SyncAsacPosi;;
DELIMITER ;;
CREATE PROCEDURE prt_dcsypse_SyncAsacPosi(
    IN p_opor_co_no int,
    IN p_opor_no int,
...
# 事务_数据同步_产品证券同步_同步资产账户资产
DELIMITER ;;
DROP PROCEDURE IF EXISTS prt_dcsypse_SyncAsacAsset;;
DELIMITER ;;
CREATE PROCEDURE prt_dcsypse_SyncAsacAsset(
    IN p_opor_co_no int,
    IN p_opor_no int,
    IN p_oper_mac varchar(32),
    IN p_oper_ip_addr varchar(32),
...
# 事务_数据同步_产品证券同步_同步证券账户信息表
DELIMITER ;;
DROP PROCEDURE IF EXISTS prt_dcsypse_Syncpdseac_secu_acco;;
DELIMITER ;;
CREATE PROCEDURE prt_dcsypse_Syncpdseac_secu_acco(
    IN p_opor_co_no int,
    IN p_opor_no int,
    IN p_oper_mac varchar(32),
    IN p_oper_ip_addr varchar(32),
...
BEGIN
    ...
    /* 调用【原子_数据同步_产品证券同步_同步证券账户信息表】*/
    call db_dc.pra_dcsypse_Syncpdseac_secu_acco(
        v_opor_co_no,
        v_opor_no,
        v_oper_mac,
        v_oper_ip_addr,
    ...
    if v_error_code = "1" then
        SET v_error_code = "dcsyncT.3.13.999";
        if v_mysql_message <> "" then
             SET v_error_info = CONCAT(v_error_info,"#",'调用过程原子_数据同步_产品证券同步_同步证券账户信息表出现错误！',v_mysql_message);
        end if;
        ROLLBACK;
        leave label_pro;
...
# 事务_数据同步_产品证券同步_同步交易组资金表
DELIMITER ;;
DROP PROCEDURE IF EXISTS prt_dcsypse_Syncpdseca_exgp_capit;;
DELIMITER ;;
CREATE PROCEDURE prt_dcsypse_Syncpdseca_exgp_capit(
    IN p_opor_co_no int,
    IN p_opor_no int,
    IN p_oper_mac varchar(32),
    IN p_oper_ip_addr varchar(32),
...
BEGIN
    ...
    /* 调用【原子_数据同步_产品证券同步_同步交易组资金表】*/
    call db_dc.pra_dcsypse_Syncpdseca_exgp_capit(
        v_opor_co_no,
        v_opor_no,
        v_oper_mac,
        v_oper_ip_addr,
        ...
        v_error_info);
    if v_error_code = "1" then
        SET v_error_code = "dcsyncT.3.14.999";
        if v_mysql_message <> "" then
             SET v_error_info = CONCAT(v_error_info,"#",'调用过程原子_数据同步_产品证券同步_同步交易组资金表出现错误！',v_mysql_message);
        end if;
        ROLLBACK;
        leave label_pro;
    elseif v_error_code <> "0" then
...
# 事务_数据同步_产品证券同步_同步交易组资产表
DELIMITER ;;
DROP PROCEDURE IF EXISTS prt_dcsypse_Syncpdseca_exgp_asset;;
DELIMITER ;;
CREATE PROCEDURE prt_dcsypse_Syncpdseca_exgp_asset(
    IN p_opor_co_no int,
    IN p_opor_no int,
    IN p_oper_mac varchar(32),
    IN p_oper_ip_addr varchar(32),
...
BEGIN
    ...
    /* 调用【原子_数据同步_产品证券同步_同步交易组资产表】*/
    call db_dc.pra_dcsypse_Syncpdseca_exgp_asset(
        v_opor_co_no,
        v_opor_no,
        v_oper_mac,
        v_oper_ip_addr,
        ...
        v_error_info);
    if v_error_code = "1" then
        SET v_error_code = "dcsyncT.3.15.999";
        if v_mysql_message <> "" then
             SET v_error_info = CONCAT(v_error_info,"#",'调用过程原子_数据同步_产品证券同步_同步交易组资产表出现错误！',v_mysql_message);
        end if;
        ROLLBACK;
        leave label_pro;
    elseif v_error_code <> "0" then
...
# 事务_数据同步_产品证券同步_同步资产账户资金表
DELIMITER ;;
DROP PROCEDURE IF EXISTS prt_dcsypse_Syncpdseca_asac_capit;;
DELIMITER ;;
CREATE PROCEDURE prt_dcsypse_Syncpdseca_asac_capit(
    IN p_opor_co_no int,
    IN p_opor_no int,
    IN p_oper_mac varchar(32),
    IN p_oper_ip_addr varchar(32),
...
BEGIN
    ...
    /* 调用【原子_数据同步_产品证券同步_同步资产账户资金表】*/
    call db_dc.pra_dcsypse_Syncpdseca_asac_capit(
        v_opor_co_no,
        v_opor_no,
        v_oper_mac,
        v_oper_ip_addr,
        ...
        v_error_info);
    if v_error_code = "1" then
        SET v_error_code = "dcsyncT.3.16.999";
        if v_mysql_message <> "" then
             SET v_error_info = CONCAT(v_error_info,"#",'调用过程原子_数据同步_产品证券同步_同步资产账户资金表出现错误！',v_mysql_message);
        end if;
        ROLLBACK;
        leave label_pro;
    elseif v_error_code <> "0" then
...
# 事务_数据同步_产品证券同步_同步外部资产账户资金表
DELIMITER ;;
DROP PROCEDURE IF EXISTS prt_dcsypse_Syncpdseca_out_asac_capit;;
DELIMITER ;;
CREATE PROCEDURE prt_dcsypse_Syncpdseca_out_asac_capit(
    IN p_opor_co_no int,
    IN p_opor_no int,
    IN p_oper_mac varchar(32),
    IN p_oper_ip_addr varchar(32),
...
BEGIN
    ...
    /* 调用【原子_数据同步_产品证券同步_同步外部资产账户资金表】*/
    call db_dc.pra_dcsypse_Syncpdseca_out_asac_capit(
        v_opor_co_no,
        v_opor_no,
        v_oper_mac,
        v_oper_ip_addr,
        ...
        v_error_info);
    if v_error_code = "1" then
        SET v_error_code = "dcsyncT.3.17.999";
        if v_mysql_message <> "" then
             SET v_error_info = CONCAT(v_error_info,"#",'调用过程原子_数据同步_产品证券同步_同步外部资产账户资金表出现错误！',v_mysql_message);
        end if;
        ROLLBACK;
        leave label_pro;
    elseif v_error_code <> "0" then
...
# 事务_数据同步_产品证券同步_同步估值外部资产账户资金表
DELIMITER ;;
DROP PROCEDURE IF EXISTS prt_dcsypse_Syncpdseca_evalu_out_asac_capit;;
DELIMITER ;;
CREATE PROCEDURE prt_dcsypse_Syncpdseca_evalu_out_asac_capit(
    IN p_opor_co_no int,
    IN p_opor_no int,
    IN p_oper_mac varchar(32),
    IN p_oper_ip_addr varchar(32),
...
BEGIN
    ...
    /* 调用【原子_数据同步_产品证券同步_同步估值外部资产账户资金表】*/
    call db_dc.pra_dcsypse_Syncpdseca_evalu_out_asac_capit(
        v_opor_co_no,
        v_opor_no,
        v_oper_mac,
        v_oper_ip_addr,
        ...
        v_error_info);
    if v_error_code = "1" then
        SET v_error_code = "dcsyncT.3.18.999";
        if v_mysql_message <> "" then
             SET v_error_info = CONCAT(v_error_info,"#",'调用过程原子_数据同步_产品证券同步_同步估值外部资产账户资金表出现错误！',v_mysql_message);
        end if;
        ROLLBACK;
        leave label_pro;
    elseif v_error_code <> "0" then
...
# 事务_数据同步_产品证券同步_同步交易组持仓表
DELIMITER ;;
DROP PROCEDURE IF EXISTS prt_dcsypse_Syncpdsepo_exgp_posi;;
DELIMITER ;;
CREATE PROCEDURE prt_dcsypse_Syncpdsepo_exgp_posi(
    IN p_opor_co_no int,
    IN p_opor_no int,
    IN p_oper_mac varchar(32),
    IN p_oper_ip_addr varchar(32),
...
BEGIN
    ...
    /* 调用【原子_数据同步_产品证券同步_同步交易组持仓表】*/
    call db_dc.pra_dcsypse_Syncpdsepo_exgp_posi(
        v_opor_co_no,
        v_opor_no,
        v_oper_mac,
        v_oper_ip_addr,
        ...
        v_error_info);
    if v_error_code = "1" then
        SET v_error_code = "dcsyncT.3.19.999";
        if v_mysql_message <> "" then
             SET v_error_info = CONCAT(v_error_info,"#",'调用过程原子_数据同步_产品证券同步_同步交易组持仓表出现错误！',v_mysql_message);
        end if;
        ROLLBACK;
        leave label_pro;
    elseif v_error_code <> "0" then
...
# 事务_数据同步_产品证券同步_同步交易组债券质押表
DELIMITER ;;
DROP PROCEDURE IF EXISTS prt_dcsypse_Syncpdsepo_exgp_bond_pledge;;
DELIMITER ;;
CREATE PROCEDURE prt_dcsypse_Syncpdsepo_exgp_bond_pledge(
    IN p_opor_co_no int,
    IN p_opor_no int,
    IN p_oper_mac varchar(32),
    IN p_oper_ip_addr varchar(32),
...
BEGIN
    ...
    /* 调用【原子_数据同步_产品证券同步_同步交易组债券质押表】*/
    call db_dc.pra_dcsypse_Syncpdsepo_exgp_bond_pledge(
        v_opor_co_no,
        v_opor_no,
        v_oper_mac,
        v_oper_ip_addr,
        ...
        v_error_info);
    if v_error_code = "1" then
        SET v_error_code = "dcsyncT.3.20.999";
        if v_mysql_message <> "" then
             SET v_error_info = CONCAT(v_error_info,"#",'调用过程原子_数据同步_产品证券同步_同步交易组债券质押表出现错误！',v_mysql_message);
        end if;
        ROLLBACK;
        leave label_pro;
    elseif v_error_code <> "0" then
...
# 事务_数据同步_产品证券同步_同步资产账户持仓表
DELIMITER ;;
DROP PROCEDURE IF EXISTS prt_dcsypse_Syncpdsepo_asac_posi;;
DELIMITER ;;
CREATE PROCEDURE prt_dcsypse_Syncpdsepo_asac_posi(
    IN p_opor_co_no int,
    IN p_opor_no int,
    IN p_oper_mac varchar(32),
    IN p_oper_ip_addr varchar(32),
...
BEGIN
    ...
    /* 调用【原子_数据同步_产品证券同步_同步资产账户持仓表】*/
    call db_dc.pra_dcsypse_Syncpdsepo_asac_posi(
        v_opor_co_no,
        v_opor_no,
        v_oper_mac,
        v_oper_ip_addr,
        ...
        v_error_info);
    if v_error_code = "1" then
        SET v_error_code = "dcsyncT.3.21.999";
        if v_mysql_message <> "" then
             SET v_error_info = CONCAT(v_error_info,"#",'调用过程原子_数据同步_产品证券同步_同步资产账户持仓表出现错误！',v_mysql_message);
        end if;
        ROLLBACK;
        leave label_pro;
    elseif v_error_code <> "0" then
...
# 事务_数据同步_产品证券同步_同步资产账户债券质押表
DELIMITER ;;
DROP PROCEDURE IF EXISTS prt_dcsypse_Syncpdsepo_asac_bond_pledge;;
DELIMITER ;;
CREATE PROCEDURE prt_dcsypse_Syncpdsepo_asac_bond_pledge(
    IN p_opor_co_no int,
    IN p_opor_no int,
    IN p_oper_mac varchar(32),
    IN p_oper_ip_addr varchar(32),
...
BEGIN
    ...
    /* 调用【原子_数据同步_产品证券同步_同步资产账户债券质押表】*/
    call db_dc.pra_dcsypse_Syncpdsepo_asac_bond_pledge(
        v_opor_co_no,
        v_opor_no,
        v_oper_mac,
        v_oper_ip_addr,
        ...
        v_error_info);
    if v_error_code = "1" then
        SET v_error_code = "dcsyncT.3.22.999";
        if v_mysql_message <> "" then
             SET v_error_info = CONCAT(v_error_info,"#",'调用过程原子_数据同步_产品证券同步_同步资产账户债券质押表出现错误！',v_mysql_message);
        end if;
        ROLLBACK;
        leave label_pro;
    elseif v_error_code <> "0" then
...
# 事务_数据同步_产品证券同步_同步债券回购表
DELIMITER ;;
DROP PROCEDURE IF EXISTS prt_dcsypse_Syncpdsepo_bond_repo;;
DELIMITER ;;
CREATE PROCEDURE prt_dcsypse_Syncpdsepo_bond_repo(
    IN p_opor_co_no int,
    IN p_opor_no int,
    IN p_oper_mac varchar(32),
    IN p_oper_ip_addr varchar(32),
...
BEGIN
    ...
    /* 调用【原子_数据同步_产品证券同步_同步债券回购表】*/
    call db_dc.pra_dcsypse_Syncpdsepo_bond_repo(
        v_opor_co_no,
        v_opor_no,
        v_oper_mac,
        v_oper_ip_addr,
        ...
        v_error_info);
    if v_error_code = "1" then
        SET v_error_code = "dcsyncT.3.23.999";
        if v_mysql_message <> "" then
             SET v_error_info = CONCAT(v_error_info,"#",'调用过程原子_数据同步_产品证券同步_同步债券回购表出现错误！',v_mysql_message);
        end if;
        ROLLBACK;
        leave label_pro;
    elseif v_error_code <> "0" then
...
# 事务_数据同步_产品证券同步_同步外部资产账户持仓表
DELIMITER ;;
DROP PROCEDURE IF EXISTS prt_dcsypse_Syncpdsepo_out_asac_posi;;
DELIMITER ;;
CREATE PROCEDURE prt_dcsypse_Syncpdsepo_out_asac_posi(
    IN p_opor_co_no int,
    IN p_opor_no int,
    IN p_oper_mac varchar(32),
    IN p_oper_ip_addr varchar(32),
...
BEGIN
    ...
    /* 调用【原子_数据同步_产品证券同步_同步外部资产账户持仓表】*/
    call db_dc.pra_dcsypse_Syncpdsepo_out_asac_posi(
        v_opor_co_no,
        v_opor_no,
        v_oper_mac,
        v_oper_ip_addr,
        ...
        v_error_info);
    if v_error_code = "1" then
        SET v_error_code = "dcsyncT.3.24.999";
        if v_mysql_message <> "" then
             SET v_error_info = CONCAT(v_error_info,"#",'调用过程原子_数据同步_产品证券同步_同步外部资产账户持仓表出现错误！',v_mysql_message);
        end if;
        ROLLBACK;
        leave label_pro;
    elseif v_error_code <> "0" then
...
# 事务_数据同步_产品证券同步_同步估值外部资产账户持仓表
DELIMITER ;;
DROP PROCEDURE IF EXISTS prt_dcsypse_Syncpdsepo_evalu_out_asac_posi;;
DELIMITER ;;
CREATE PROCEDURE prt_dcsypse_Syncpdsepo_evalu_out_asac_posi(
    IN p_opor_co_no int,
    IN p_opor_no int,
    IN p_oper_mac varchar(32),
    IN p_oper_ip_addr varchar(32),
...
BEGIN
    ...
    /* 调用【原子_数据同步_产品证券同步_同步估值外部资产账户持仓表】*/
    call db_dc.pra_dcsypse_Syncpdsepo_evalu_out_asac_posi(
        v_opor_co_no,
        v_opor_no,
        v_oper_mac,
        v_oper_ip_addr,
        ...
        v_error_info);
    if v_error_code = "1" then
        SET v_error_code = "dcsyncT.3.25.999";
        if v_mysql_message <> "" then
             SET v_error_info = CONCAT(v_error_info,"#",'调用过程原子_数据同步_产品证券同步_同步估值外部资产账户持仓表出现错误！',v_mysql_message);
        end if;
        ROLLBACK;
        leave label_pro;
    elseif v_error_code <> "0" then
...
# 事务_数据同步_产品证券同步_同步大宗交易持仓表
DELIMITER ;;
DROP PROCEDURE IF EXISTS prt_dcsypse_Syncpdsepo_block_trade_posi;;
DELIMITER ;;
CREATE PROCEDURE prt_dcsypse_Syncpdsepo_block_trade_posi(
    IN p_opor_co_no int,
    IN p_opor_no int,
    IN p_oper_mac varchar(32),
    IN p_oper_ip_addr varchar(32),
...
BEGIN
    ...
    /* 调用【原子_数据同步_产品证券同步_同步大宗交易持仓表】*/
    call db_dc.pra_dcsypse_Syncpdsepo_block_trade_posi(
        v_opor_co_no,
        v_opor_no,
        v_oper_mac,
        v_oper_ip_addr,
        ...
        v_error_info);
    if v_error_code = "1" then
        SET v_error_code = "dcsyncT.3.26.999";
        if v_mysql_message <> "" then
             SET v_error_info = CONCAT(v_error_info,"#",'调用过程原子_数据同步_产品证券同步_同步大宗交易持仓表出现错误！',v_mysql_message);
        end if;
        ROLLBACK;
        leave label_pro;
    elseif v_error_code <> "0" then
