...
API_EXPORT int LD_CALL_MODE QueryInterface(int iFunIndex, LPBIZ_FUNC_INFO bizFuncInfo)
{
    ...
    if (iFunIndex==0)
    {
        strcpy(bizFuncInfo->szFuncName, "dcsyncL.2.12");
        bizFuncInfo->lpFunc = fnFunc0;
    }
    else if (iFunIndex==1)
    {
        strcpy(bizFuncInfo->szFuncName, "dcsyncL.2.13");
        bizFuncInfo->lpFunc = fnFunc1;
    }
    else if (iFunIndex==2)
    {
        strcpy(bizFuncInfo->szFuncName, "dcsyncL.2.14");
        bizFuncInfo->lpFunc = fnFunc2;
    }
    else if (iFunIndex==3)
    {
        strcpy(bizFuncInfo->szFuncName, "dcsyncL.2.15");
        bizFuncInfo->lpFunc = fnFunc3;
    }
    else if (iFunIndex==4)
    {
        strcpy(bizFuncInfo->szFuncName, "dcsyncL.2.16");
        bizFuncInfo->lpFunc = fnFunc4;
    }
    else if (iFunIndex==5)
    {
        strcpy(bizFuncInfo->szFuncName, "dcsyncL.2.17");
...
int iPriority=lpInBizMsg->GetInt32(LDTAG_PRIORITY);
    ...
    // set @查询表名#="tb_pdacco_pd_info";
    strcpy(v_qry_table,"tb_pdacco_pd_info");
    //调用过程[事务_产品_同步接口_获取同步时间]
    //组织事务请求
    if(lpTSCall1Ans0)
    {
    ...
    lpTSCall1Req0=glpFastMsgFactory->CreateFastMessage("prodT.15.1", 0);
    ...
    if(!lpTSCall1Ans0)  //  超时错误
    {
        ...
        lpOutBizMsg->SetString(LDTAG_ERRORINFO, "[prodT.15.1]subcall timed out!");
        iRet=-2;
        goto ENDSYS;
    }
    ...
    while (v_ctrl_flag)
    {
       ...
       lpTSCall1Req1=glpFastMsgFactory->CreateFastMessage("prodT.15.12", 0);
       ...
       {
           lpOutBizMsg->SetInt32(LDTAG_ERRORNO, -1);
           lpOutBizMsg->SetString(LDTAG_ERRORINFO, "[prodT.15.12]subcall timed out!");
           iRet=-2;
           goto ENDSYS;
       }
       ...
       lpTSCall1Req2=glpFastMsgFactory->CreateFastMessage("dcsyncT.2.12", 0);
       ...
       {
           lpOutBizMsg->SetInt32(LDTAG_ERRORNO, -1);
           lpOutBizMsg->SetString(LDTAG_ERRORINFO, "[dcsyncT.2.12]subcall timed out!");
           iRet=-2;
           goto ENDSYS;
       }
       ...
       GetMaxRowIDFun(v_sync_field1, &v_effect_row_count, &v_row_id);
        ...
        if (v_ctrl_flag==0)
        {
          //完了测试方便,暂时先用这个功能
           ...
           lpTSCall1Req3=glpFastMsgFactory->CreateFastMessage("prodT.15.2", 0);
           ...
           {
               lpOutBizMsg->SetInt32(LDTAG_ERRORNO, -1);
               lpOutBizMsg->SetString(LDTAG_ERRORINFO, "[prodT.15.2]subcall timed out!");
               iRet=-2;
               goto ENDSYS;
           }
...
int iPriority=lpInBizMsg->GetInt32(LDTAG_PRIORITY);
    ...
    // set @查询表名#="tb_pdacco_pd_limit";
    strcpy(v_qry_table,"tb_pdacco_pd_limit");
    //调用过程[事务_产品_同步接口_获取同步时间]
    //组织事务请求
    if(lpTSCall1Ans0)
    {
    ...
    while (v_ctrl_flag)
    {
       ...
       lpTSCall1Req1=glpFastMsgFactory->CreateFastMessage("prodT.15.13", 0);
       lpTSCall1Req1->SetInt32(LDTAG_PRIORITY, iPriority);
       lpTSCall1Req1->SetInt32(LDBIZ_OPOR_CO_NO_INT,v_opor_co_no);
       lpTSCall1Req1->SetInt32(LDBIZ_OPOR_NO_INT,v_opor_no);
       lpTSCall1Req1->SetString(LDBIZ_OPER_MAC_STR,v_oper_mac);
       ...
       {
           lpOutBizMsg->SetInt32(LDTAG_ERRORNO, -1);
           lpOutBizMsg->SetString(LDTAG_ERRORINFO, "[prodT.15.13]subcall timed out!");
           iRet=-2;
           goto ENDSYS;
       }
       else if(lpTSCall1Ans1->GetInt32(LDTAG_ERRORNO)!=0)  //  中间件层面错误
       ...
       lpTSCall1Req2=glpFastMsgFactory->CreateFastMessage("dcsyncT.2.13", 0);
       lpTSCall1Req2->SetInt32(LDTAG_PRIORITY, iPriority);
       lpTSCall1Req2->SetInt32(LDBIZ_OPOR_CO_NO_INT,v_opor_co_no);
       lpTSCall1Req2->SetInt32(LDBIZ_OPOR_NO_INT,v_opor_no);
       lpTSCall1Req2->SetString(LDBIZ_OPER_MAC_STR,v_oper_mac);
       ...
       {
           lpOutBizMsg->SetInt32(LDTAG_ERRORNO, -1);
           lpOutBizMsg->SetString(LDTAG_ERRORINFO, "[dcsyncT.2.13]subcall timed out!");
           iRet=-2;
           goto ENDSYS;
       }
       else if(lpTSCall1Ans2->GetInt32(LDTAG_ERRORNO)!=0)  //  中间件层面错误
...
int iPriority=lpInBizMsg->GetInt32(LDTAG_PRIORITY);
    ...
    // set @查询表名#="tb_pdacco_asset_acco";
    strcpy(v_qry_table,"tb_pdacco_asset_acco");
    //调用过程[事务_产品_同步接口_获取同步时间]
    //组织事务请求
    if(lpTSCall1Ans0)
    {
    ...
    while (v_ctrl_flag)
    {
       ...
       lpTSCall1Req1=glpFastMsgFactory->CreateFastMessage("prodT.15.14", 0);
       lpTSCall1Req1->SetInt32(LDTAG_PRIORITY, iPriority);
       lpTSCall1Req1->SetInt32(LDBIZ_OPOR_CO_NO_INT,v_opor_co_no);
       lpTSCall1Req1->SetInt32(LDBIZ_OPOR_NO_INT,v_opor_no);
       lpTSCall1Req1->SetString(LDBIZ_OPER_MAC_STR,v_oper_mac);
       ...
       {
           lpOutBizMsg->SetInt32(LDTAG_ERRORNO, -1);
           lpOutBizMsg->SetString(LDTAG_ERRORINFO, "[prodT.15.14]subcall timed out!");
           iRet=-2;
           goto ENDSYS;
       }
       else if(lpTSCall1Ans1->GetInt32(LDTAG_ERRORNO)!=0)  //  中间件层面错误
       ...
       lpTSCall1Req2=glpFastMsgFactory->CreateFastMessage("dcsyncT.2.14", 0);
       lpTSCall1Req2->SetInt32(LDTAG_PRIORITY, iPriority);
       lpTSCall1Req2->SetInt32(LDBIZ_OPOR_CO_NO_INT,v_opor_co_no);
       lpTSCall1Req2->SetInt32(LDBIZ_OPOR_NO_INT,v_opor_no);
       lpTSCall1Req2->SetString(LDBIZ_OPER_MAC_STR,v_oper_mac);
       ...
       {
           lpOutBizMsg->SetInt32(LDTAG_ERRORNO, -1);
           lpOutBizMsg->SetString(LDTAG_ERRORINFO, "[dcsyncT.2.14]subcall timed out!");
           iRet=-2;
           goto ENDSYS;
       }
       else if(lpTSCall1Ans2->GetInt32(LDTAG_ERRORNO)!=0)  //  中间件层面错误
...
int iPriority=lpInBizMsg->GetInt32(LDTAG_PRIORITY);
    ...
    // set @查询表名#="tb_pdacco_asset_acco_ch";
    strcpy(v_qry_table,"tb_pdacco_asset_acco_ch");
    //调用过程[事务_产品_同步接口_获取同步时间]
    //组织事务请求
    if(lpTSCall1Ans0)
    {
    ...
    while (v_ctrl_flag)
    {
       ...
       lpTSCall1Req1=glpFastMsgFactory->CreateFastMessage("prodT.15.15", 0);
       lpTSCall1Req1->SetInt32(LDTAG_PRIORITY, iPriority);
       lpTSCall1Req1->SetInt32(LDBIZ_OPOR_CO_NO_INT,v_opor_co_no);
       lpTSCall1Req1->SetInt32(LDBIZ_OPOR_NO_INT,v_opor_no);
       lpTSCall1Req1->SetString(LDBIZ_OPER_MAC_STR,v_oper_mac);
       ...
       {
           lpOutBizMsg->SetInt32(LDTAG_ERRORNO, -1);
           lpOutBizMsg->SetString(LDTAG_ERRORINFO, "[prodT.15.15]subcall timed out!");
           iRet=-2;
           goto ENDSYS;
       }
       else if(lpTSCall1Ans1->GetInt32(LDTAG_ERRORNO)!=0)  //  中间件层面错误
       ...
       lpTSCall1Req2=glpFastMsgFactory->CreateFastMessage("dcsyncT.2.15", 0);
       lpTSCall1Req2->SetInt32(LDTAG_PRIORITY, iPriority);
       lpTSCall1Req2->SetInt32(LDBIZ_OPOR_CO_NO_INT,v_opor_co_no);
       lpTSCall1Req2->SetInt32(LDBIZ_OPOR_NO_INT,v_opor_no);
       lpTSCall1Req2->SetString(LDBIZ_OPER_MAC_STR,v_oper_mac);
       ...
       {
           lpOutBizMsg->SetInt32(LDTAG_ERRORNO, -1);
           lpOutBizMsg->SetString(LDTAG_ERRORINFO, "[dcsyncT.2.15]subcall timed out!");
           iRet=-2;
           goto ENDSYS;
       }
       else if(lpTSCall1Ans2->GetInt32(LDTAG_ERRORNO)!=0)  //  中间件层面错误
...
int iPriority=lpInBizMsg->GetInt32(LDTAG_PRIORITY);
    ...
    // set @查询表名#="tb_pdcapit_pd_capit";
    strcpy(v_qry_table,"tb_pdcapit_pd_capit");
    //调用过程[事务_产品_同步接口_获取同步时间]
    //组织事务请求
    if(lpTSCall1Ans0)
    {
    ...
    while (v_ctrl_flag)
    {
       ...
       lpTSCall1Req1=glpFastMsgFactory->CreateFastMessage("prodT.15.16", 0);
       lpTSCall1Req1->SetInt32(LDTAG_PRIORITY, iPriority);
       lpTSCall1Req1->SetInt32(LDBIZ_OPOR_CO_NO_INT,v_opor_co_no);
       lpTSCall1Req1->SetInt32(LDBIZ_OPOR_NO_INT,v_opor_no);
       lpTSCall1Req1->SetString(LDBIZ_OPER_MAC_STR,v_oper_mac);
       ...
       {
           lpOutBizMsg->SetInt32(LDTAG_ERRORNO, -1);
           lpOutBizMsg->SetString(LDTAG_ERRORINFO, "[prodT.15.16]subcall timed out!");
           iRet=-2;
           goto ENDSYS;
       }
       else if(lpTSCall1Ans1->GetInt32(LDTAG_ERRORNO)!=0)  //  中间件层面错误
       ...
       lpTSCall1Req2=glpFastMsgFactory->CreateFastMessage("dcsyncT.2.16", 0);
       lpTSCall1Req2->SetInt32(LDTAG_PRIORITY, iPriority);
       lpTSCall1Req2->SetInt32(LDBIZ_OPOR_CO_NO_INT,v_opor_co_no);
       lpTSCall1Req2->SetInt32(LDBIZ_OPOR_NO_INT,v_opor_no);
       lpTSCall1Req2->SetString(LDBIZ_OPER_MAC_STR,v_oper_mac);
       ...
       {
           lpOutBizMsg->SetInt32(LDTAG_ERRORNO, -1);
           lpOutBizMsg->SetString(LDTAG_ERRORINFO, "[dcsyncT.2.16]subcall timed out!");
           iRet=-2;
           goto ENDSYS;
       }
       else if(lpTSCall1Ans2->GetInt32(LDTAG_ERRORNO)!=0)  //  中间件层面错误
...
int iPriority=lpInBizMsg->GetInt32(LDTAG_PRIORITY);
    ...
    // set @查询表名#="tb_pdcapit_pd_asset";
    strcpy(v_qry_table,"tb_pdcapit_pd_asset");
    //调用过程[事务_产品_同步接口_获取同步时间]
    //组织事务请求
    if(lpTSCall1Ans0)
    {
    ...
    while (v_ctrl_flag)
    {
       ...
       lpTSCall1Req1=glpFastMsgFactory->CreateFastMessage("prodT.15.17", 0);
       lpTSCall1Req1->SetInt32(LDTAG_PRIORITY, iPriority);
       lpTSCall1Req1->SetInt32(LDBIZ_OPOR_CO_NO_INT,v_opor_co_no);
       lpTSCall1Req1->SetInt32(LDBIZ_OPOR_NO_INT,v_opor_no);
       lpTSCall1Req1->SetString(LDBIZ_OPER_MAC_STR,v_oper_mac);
       ...
       {
           lpOutBizMsg->SetInt32(LDTAG_ERRORNO, -1);
           lpOutBizMsg->SetString(LDTAG_ERRORINFO, "[prodT.15.17]subcall timed out!");
           iRet=-2;
           goto ENDSYS;
       }
       else if(lpTSCall1Ans1->GetInt32(LDTAG_ERRORNO)!=0)  //  中间件层面错误
       ...
       lpTSCall1Req2=glpFastMsgFactory->CreateFastMessage("dcsyncT.2.17", 0);
       lpTSCall1Req2->SetInt32(LDTAG_PRIORITY, iPriority);
       lpTSCall1Req2->SetInt32(LDBIZ_OPOR_CO_NO_INT,v_opor_co_no);
       lpTSCall1Req2->SetInt32(LDBIZ_OPOR_NO_INT,v_opor_no);
       lpTSCall1Req2->SetString(LDBIZ_OPER_MAC_STR,v_oper_mac);
       ...
       {
           lpOutBizMsg->SetInt32(LDTAG_ERRORNO, -1);
           lpOutBizMsg->SetString(LDTAG_ERRORINFO, "[dcsyncT.2.17]subcall timed out!");
           iRet=-2;
           goto ENDSYS;
       }
       else if(lpTSCall1Ans2->GetInt32(LDTAG_ERRORNO)!=0)  //  中间件层面错误
