...
namespace LD.Client.Contract
{
    ...
    public class ReqFuncpdfutuL_10_1DTO : ReqBaseDTO
    {
        public ReqFuncpdfutuL_10_1DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pdfutuL.10.1";
    ...
    public class ReqFuncpdfutuL_10_2DTO : ReqBaseDTO
    {
        public ReqFuncpdfutuL_10_2DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pdfutuL.10.2";
            CommonDTO.func_code = CommonDTO.function_code;
            row_id = 0;
        }
    ...
    public class ReqFuncpdfutuL_10_11DTO : ReqBaseDTO
    {
        public ReqFuncpdfutuL_10_11DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pdfutuL.10.11";
            CommonDTO.func_code = CommonDTO.function_code;
        }
    ...
    public class ReqFuncpdfutuL_10_13DTO : ReqBaseDTO
    {
        public ReqFuncpdfutuL_10_13DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pdfutuL.10.13";
            CommonDTO.func_code = CommonDTO.function_code;
            co_no = 0;
            pd_no = 0;
        }
    ...
    //逻辑_产品期货_资金运维_同步内外差异
    public class ReqFuncpdfutuL_10_12DTO : ReqBaseDTO
    {
        public ReqFuncpdfutuL_10_12DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pdfutuL.10.12";
            CommonDTO.func_code = CommonDTO.function_code;
            co_no = 0;
            pd_no = 0;
        }
    ...
    public class ReqFuncpdfutuL_10_14DTO : ReqBaseDTO
    {
        public ReqFuncpdfutuL_10_14DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pdfutuL.10.14";
            CommonDTO.func_code = CommonDTO.function_code;
            co_no = 0;
            pd_no = 0;
            asset_acco_no = 0;
    ...
    public class ReqFuncpdfutuL_10_15DTO : ReqBaseDTO
    {
        public ReqFuncpdfutuL_10_15DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pdfutuL.10.15";
            CommonDTO.func_code = CommonDTO.function_code;
            co_no = 0;
            pd_no = 0;
            asset_acco_no = 0;
    ...
    public class ReqFuncpdfutuL_10_16DTO : ReqBaseDTO
    {
        public ReqFuncpdfutuL_10_16DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pdfutuL.10.16";
            CommonDTO.func_code = CommonDTO.function_code;
            co_no = 0;
            pd_no = 0;
            asset_acco_no = 0;
    ...
    public class ReqFuncpdfutuL_10_17DTO : ReqBaseDTO
    {
        public ReqFuncpdfutuL_10_17DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pdfutuL.10.17";
            CommonDTO.func_code = CommonDTO.function_code;
            query_date = 0;
            co_no = 0;
            pd_no = 0;
