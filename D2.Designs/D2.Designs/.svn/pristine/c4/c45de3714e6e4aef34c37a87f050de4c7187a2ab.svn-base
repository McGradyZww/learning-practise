...
{
    //逻辑_公共_期货行情服务_请求行情快照
    public class ReqFuncpubL_14_1DTO : ReqBaseDTO
    {
        public ReqFuncpubL_14_1DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.14.1";
    ...
    //逻辑_公共_期货行情服务_主推实时行情
    public class ReqFuncpubL_14_2DTO : ReqBaseDTO
    {
        public ReqFuncpubL_14_2DTO(CommonDTO commonDTO)
        {
            CommonDTO = commonDTO.Copy();
            CommonDTO.function_code = "pubL.14.2";
            CommonDTO.func_code = CommonDTO.function_code;
            exch_no = 0;
            contrc_code = " ";
            quot_price_info = " ";
