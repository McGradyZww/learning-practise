...
API_EXPORT int LD_CALL_MODE QueryInterface(int iFunIndex, LPBIZ_FUNC_INFO bizFuncInfo)
{
    ...
    if (iFunIndex==0)
    {
        strcpy(bizFuncInfo->szFuncName, "pubL.31.1");
        bizFuncInfo->lpFunc = fnFunc0;
    }
    else if (iFunIndex==1)
    {
        strcpy(bizFuncInfo->szFuncName, "pubL.31.2");
        bizFuncInfo->lpFunc = fnFunc1;
    }
    else if (iFunIndex==2)
    {
        strcpy(bizFuncInfo->szFuncName, "pubL.31.3");
        bizFuncInfo->lpFunc = fnFunc2;
    }
    else if (iFunIndex==3)
    {
        strcpy(bizFuncInfo->szFuncName, "pubL.31.4");
...
int LD_CALL_MODE fnFunc0(const char* lpFuncID, IFastMessage* lpInBizMsg, IFastMessage* lpOutBizMsg, IDB_Connection* lpDBConnect)
{
    ...
    char v_func_code[17];
    int v_wanttt_id;
    char v_wanttt_name[256];
    int v_wangtt_stock_code_no;
    int v_wanttt_asset_no;
    int v_wanttt_buy_stock_qty;
    int v_wanttt_sale_stock_qty;
...
int iPriority=lpInBizMsg->GetInt32(LDTAG_PRIORITY);
    ...
    strcpy(v_func_code, " ");
    v_wanttt_id=0;
    strcpy(v_wanttt_name, " ");
    v_wangtt_stock_code_no=0;
    v_wanttt_asset_no=0;
    v_wanttt_buy_stock_qty=0;
    v_wanttt_sale_stock_qty=0;
    ...
    v_func_code[16] = '\0';
    v_wanttt_id = lpInBizMsg->GetInt32(LDBIZ_WANTTT_ID_INT);
    strncpy(v_wanttt_name, lpInBizMsg->GetString(LDBIZ_WANTTT_NAME_STR),255);
    v_wanttt_name[255] = '\0';
    v_wangtt_stock_code_no = lpInBizMsg->GetInt32(LDBIZ_WANGTT_STOCK_CODE_NO_INT);
    v_wanttt_asset_no = lpInBizMsg->GetInt32(LDBIZ_WANTTT_ASSET_NO_INT);
    v_wanttt_buy_stock_qty = lpInBizMsg->GetInt32(LDBIZ_WANTTT_BUY_STOCK_QTY_INT);
    v_wanttt_sale_stock_qty = lpInBizMsg->GetInt32(LDBIZ_WANTTT_SALE_STOCK_QTY_INT);
    ...
    lpTSCall1Req0=glpFastMsgFactory->CreateFastMessage("pubT.31.1", 0);
    ...
    lpTSCall1Req0->SetInt32(LDBIZ_WANTTT_ID_INT,v_wanttt_id);
    lpTSCall1Req0->SetString(LDBIZ_WANTTT_NAME_STR,v_wanttt_name);
    lpTSCall1Req0->SetInt32(LDBIZ_WANGTT_STOCK_CODE_NO_INT,v_wangtt_stock_code_no);
    lpTSCall1Req0->SetInt32(LDBIZ_WANTTT_ASSET_NO_INT,v_wanttt_asset_no);
    lpTSCall1Req0->SetInt32(LDBIZ_WANTTT_BUY_STOCK_QTY_INT,v_wanttt_buy_stock_qty);
    lpTSCall1Req0->SetInt32(LDBIZ_WANTTT_SALE_STOCK_QTY_INT,v_wanttt_sale_stock_qty);
    glpTSSubcallSerives->SubCall(lpTSCall1Req0, &lpTSCall1Ans0, 5000);
    if(!lpTSCall1Ans0)  //  超时错误
    {
        lpOutBizMsg->SetInt32(LDTAG_ERRORNO, -1);
        lpOutBizMsg->SetString(LDTAG_ERRORINFO, "[pubT.31.1]subcall timed out!");
        iRet=-2;
        goto ENDSYS;
    }
...
int iPriority=lpInBizMsg->GetInt32(LDTAG_PRIORITY);
    ...
    lpTSCall1Req0=glpFastMsgFactory->CreateFastMessage("pubT.31.2", 0);
    lpTSCall1Req0->SetInt32(LDTAG_PRIORITY, iPriority);
    lpTSCall1Req0->SetInt32(LDBIZ_OPOR_CO_NO_INT,v_opor_co_no);
    lpTSCall1Req0->SetInt32(LDBIZ_OPOR_NO_INT,v_opor_no);
    lpTSCall1Req0->SetString(LDBIZ_OPER_MAC_STR,v_oper_mac);
    ...
    {
        lpOutBizMsg->SetInt32(LDTAG_ERRORNO, -1);
        lpOutBizMsg->SetString(LDTAG_ERRORINFO, "[pubT.31.2]subcall timed out!");
        iRet=-2;
        goto ENDSYS;
    }
    else if(lpTSCall1Ans0->GetInt32(LDTAG_ERRORNO)!=0)  //  中间件层面错误
...
int iPriority=lpInBizMsg->GetInt32(LDTAG_PRIORITY);
    ...
    lpTSCall1Req0=glpFastMsgFactory->CreateFastMessage("pubT.31.3", 0);
    lpTSCall1Req0->SetInt32(LDTAG_PRIORITY, iPriority);
    lpTSCall1Req0->SetInt32(LDBIZ_OPOR_CO_NO_INT,v_opor_co_no);
    lpTSCall1Req0->SetInt32(LDBIZ_OPOR_NO_INT,v_opor_no);
    lpTSCall1Req0->SetString(LDBIZ_OPER_MAC_STR,v_oper_mac);
    ...
    {
        lpOutBizMsg->SetInt32(LDTAG_ERRORNO, -1);
        lpOutBizMsg->SetString(LDTAG_ERRORINFO, "[pubT.31.3]subcall timed out!");
        iRet=-2;
        goto ENDSYS;
    }
    else if(lpTSCall1Ans0->GetInt32(LDTAG_ERRORNO)!=0)  //  中间件层面错误
...
int iPriority=lpInBizMsg->GetInt32(LDTAG_PRIORITY);
    ...
    lpTSCall1Req0=glpFastMsgFactory->CreateFastMessage("pubT.31.4", 0);
    lpTSCall1Req0->SetInt32(LDTAG_PRIORITY, iPriority);
    lpTSCall1Req0->SetInt32(LDBIZ_OPOR_CO_NO_INT,v_opor_co_no);
    lpTSCall1Req0->SetInt32(LDBIZ_OPOR_NO_INT,v_opor_no);
    lpTSCall1Req0->SetString(LDBIZ_OPER_MAC_STR,v_oper_mac);
    ...
    {
        lpOutBizMsg->SetInt32(LDTAG_ERRORNO, -1);
        lpOutBizMsg->SetString(LDTAG_ERRORINFO, "[pubT.31.4]subcall timed out!");
        iRet=-2;
        goto ENDSYS;
    }
    else if(lpTSCall1Ans0->GetInt32(LDTAG_ERRORNO)!=0)  //  中间件层面错误
