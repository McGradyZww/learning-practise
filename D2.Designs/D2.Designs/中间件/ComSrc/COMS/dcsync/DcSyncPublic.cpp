...
API_EXPORT int LD_CALL_MODE QueryInterface(int iFunIndex, LPBIZ_FUNC_INFO bizFuncInfo)
{
    ...
    if (iFunIndex==0)
    {
        strcpy(bizFuncInfo->szFuncName, "dcsyncL.1.11");
        bizFuncInfo->lpFunc = fnFunc0;
    }
    else if (iFunIndex==1)
    {
        strcpy(bizFuncInfo->szFuncName, "dcsyncL.1.12");
        bizFuncInfo->lpFunc = fnFunc1;
    }
    else if (iFunIndex==2)
    {
        strcpy(bizFuncInfo->szFuncName, "dcsyncL.1.13");
        bizFuncInfo->lpFunc = fnFunc2;
    }
    else if (iFunIndex==3)
    {
        strcpy(bizFuncInfo->szFuncName, "dcsyncL.1.14");
        bizFuncInfo->lpFunc = fnFunc3;
    }
    else if (iFunIndex==4)
    {
        strcpy(bizFuncInfo->szFuncName, "dcsyncL.1.15");
        bizFuncInfo->lpFunc = fnFunc4;
    }
    else if (iFunIndex==5)
    {
        strcpy(bizFuncInfo->szFuncName, "dcsyncL.1.16");
        bizFuncInfo->lpFunc = fnFunc5;
    }
    else if (iFunIndex==6)
    {
        strcpy(bizFuncInfo->szFuncName, "dcsyncL.1.17");
        bizFuncInfo->lpFunc = fnFunc6;
    }
    else if (iFunIndex==7)
    {
        strcpy(bizFuncInfo->szFuncName, "dcsyncL.1.18");
        bizFuncInfo->lpFunc = fnFunc7;
    }
    else if (iFunIndex==8)
    {
        strcpy(bizFuncInfo->szFuncName, "dcsyncL.1.19");
        bizFuncInfo->lpFunc = fnFunc8;
    }
    else if (iFunIndex==9)
    {
        strcpy(bizFuncInfo->szFuncName, "dcsyncL.1.20");
        bizFuncInfo->lpFunc = fnFunc9;
    }
    else if (iFunIndex==10)
    {
        strcpy(bizFuncInfo->szFuncName, "dcsyncL.1.21");
        bizFuncInfo->lpFunc = fnFunc10;
    }
    else if (iFunIndex==11)
    {
        strcpy(bizFuncInfo->szFuncName, "dcsyncL.1.22");
        bizFuncInfo->lpFunc = fnFunc11;
    }
    else if (iFunIndex==12)
    {
        strcpy(bizFuncInfo->szFuncName, "dcsyncL.1.23");
        bizFuncInfo->lpFunc = fnFunc12;
    }
    else if (iFunIndex==13)
    {
        strcpy(bizFuncInfo->szFuncName, "dcsyncL.1.24");
        bizFuncInfo->lpFunc = fnFunc13;
    }
    else if (iFunIndex==14)
    {
        strcpy(bizFuncInfo->szFuncName, "dcsyncL.1.25");
        bizFuncInfo->lpFunc = fnFunc14;
    }
    else if (iFunIndex==15)
    {
        strcpy(bizFuncInfo->szFuncName, "dcsyncL.1.26");
        bizFuncInfo->lpFunc = fnFunc15;
    }
    else if (iFunIndex==16)
    {
        strcpy(bizFuncInfo->szFuncName, "dcsyncL.1.27");
        bizFuncInfo->lpFunc = fnFunc16;
    }
    else if (iFunIndex==17)
    {
        strcpy(bizFuncInfo->szFuncName, "dcsyncL.1.28");
...
int iPriority=lpInBizMsg->GetInt32(LDTAG_PRIORITY);
    ...
    // set @查询表名#="tb_basesedt_stock_tmplat";
    strcpy(v_qry_table,"tb_basesedt_stock_tmplat");
    //调用过程[事务_公共_同步接口_获取同步时间]
    //组织事务请求
    if(lpTSCall1Ans0)
    {
    ...
    lpTSCall1Req0=glpFastMsgFactory->CreateFastMessage("pubT.30.1", 0);
    ...
    if(!lpTSCall1Ans0)  //  超时错误
    {
        ...
        lpOutBizMsg->SetString(LDTAG_ERRORINFO, "[pubT.30.1]subcall timed out!");
        iRet=-2;
        goto ENDSYS;
    }
    ...
    while (v_ctrl_flag)
    {
       ...
       lpTSCall1Req1=glpFastMsgFactory->CreateFastMessage("pubT.30.11", 0);
       ...
       {
           lpOutBizMsg->SetInt32(LDTAG_ERRORNO, -1);
           lpOutBizMsg->SetString(LDTAG_ERRORINFO, "[pubT.30.11]subcall timed out!");
           iRet=-2;
           goto ENDSYS;
       }
       ...
       lpTSCall1Req2=glpFastMsgFactory->CreateFastMessage("dcsyncT.1.11", 0);
       ...
       {
           lpOutBizMsg->SetInt32(LDTAG_ERRORNO, -1);
           lpOutBizMsg->SetString(LDTAG_ERRORINFO, "[dcsyncT.1.11]subcall timed out!");
           iRet=-2;
           goto ENDSYS;
       }
       ...
       GetMaxRowIDFun(v_sync_field1, &v_effect_row_count, &v_row_id);
        ...
        if (v_ctrl_flag==0)
        {
          //完了测试方便,暂时先用这个功能
           ...
           lpTSCall1Req3=glpFastMsgFactory->CreateFastMessage("pubT.30.2", 0);
           ...
           {
               lpOutBizMsg->SetInt32(LDTAG_ERRORNO, -1);
               lpOutBizMsg->SetString(LDTAG_ERRORINFO, "[pubT.30.2]subcall timed out!");
               iRet=-2;
               goto ENDSYS;
           }
...
int iPriority=lpInBizMsg->GetInt32(LDTAG_PRIORITY);
    ...
    // set @查询表名#="tb_basesedt_stock_type";
    strcpy(v_qry_table,"tb_basesedt_stock_type");
    //调用过程[事务_公共_同步接口_获取同步时间]
    //组织事务请求
    if(lpTSCall1Ans0)
    {
    ...
    while (v_ctrl_flag)
    {
       ...
       lpTSCall1Req1=glpFastMsgFactory->CreateFastMessage("pubT.30.12", 0);
       lpTSCall1Req1->SetInt32(LDTAG_PRIORITY, iPriority);
       lpTSCall1Req1->SetInt32(LDBIZ_OPOR_CO_NO_INT,v_opor_co_no);
       lpTSCall1Req1->SetInt32(LDBIZ_OPOR_NO_INT,v_opor_no);
       lpTSCall1Req1->SetString(LDBIZ_OPER_MAC_STR,v_oper_mac);
       ...
       {
           lpOutBizMsg->SetInt32(LDTAG_ERRORNO, -1);
           lpOutBizMsg->SetString(LDTAG_ERRORINFO, "[pubT.30.12]subcall timed out!");
           iRet=-2;
           goto ENDSYS;
       }
       else if(lpTSCall1Ans1->GetInt32(LDTAG_ERRORNO)!=0)  //  中间件层面错误
       ...
       lpTSCall1Req2=glpFastMsgFactory->CreateFastMessage("dcsyncT.1.12", 0);
       lpTSCall1Req2->SetInt32(LDTAG_PRIORITY, iPriority);
       lpTSCall1Req2->SetInt32(LDBIZ_OPOR_CO_NO_INT,v_opor_co_no);
       lpTSCall1Req2->SetInt32(LDBIZ_OPOR_NO_INT,v_opor_no);
       lpTSCall1Req2->SetString(LDBIZ_OPER_MAC_STR,v_oper_mac);
       ...
       {
           lpOutBizMsg->SetInt32(LDTAG_ERRORNO, -1);
           lpOutBizMsg->SetString(LDTAG_ERRORINFO, "[dcsyncT.1.12]subcall timed out!");
           iRet=-2;
           goto ENDSYS;
       }
       else if(lpTSCall1Ans2->GetInt32(LDTAG_ERRORNO)!=0)  //  中间件层面错误
...
int iPriority=lpInBizMsg->GetInt32(LDTAG_PRIORITY);
    ...
    // set @查询表名#="tb_basesedt_stock_type_order_dir";
    strcpy(v_qry_table,"tb_basesedt_stock_type_order_dir");
    //调用过程[事务_公共_同步接口_获取同步时间]
    //组织事务请求
    if(lpTSCall1Ans0)
    {
    ...
    while (v_ctrl_flag)
    {
       ...
       lpTSCall1Req1=glpFastMsgFactory->CreateFastMessage("pubT.30.13", 0);
       lpTSCall1Req1->SetInt32(LDTAG_PRIORITY, iPriority);
       lpTSCall1Req1->SetInt32(LDBIZ_OPOR_CO_NO_INT,v_opor_co_no);
       lpTSCall1Req1->SetInt32(LDBIZ_OPOR_NO_INT,v_opor_no);
       lpTSCall1Req1->SetString(LDBIZ_OPER_MAC_STR,v_oper_mac);
       ...
       {
           lpOutBizMsg->SetInt32(LDTAG_ERRORNO, -1);
           lpOutBizMsg->SetString(LDTAG_ERRORINFO, "[pubT.30.13]subcall timed out!");
           iRet=-2;
           goto ENDSYS;
       }
       else if(lpTSCall1Ans1->GetInt32(LDTAG_ERRORNO)!=0)  //  中间件层面错误
       ...
       lpTSCall1Req2=glpFastMsgFactory->CreateFastMessage("dcsyncT.1.13", 0);
       lpTSCall1Req2->SetInt32(LDTAG_PRIORITY, iPriority);
       lpTSCall1Req2->SetInt32(LDBIZ_OPOR_CO_NO_INT,v_opor_co_no);
       lpTSCall1Req2->SetInt32(LDBIZ_OPOR_NO_INT,v_opor_no);
       lpTSCall1Req2->SetString(LDBIZ_OPER_MAC_STR,v_oper_mac);
       ...
       {
           lpOutBizMsg->SetInt32(LDTAG_ERRORNO, -1);
           lpOutBizMsg->SetString(LDTAG_ERRORINFO, "[dcsyncT.1.13]subcall timed out!");
           iRet=-2;
           goto ENDSYS;
       }
       else if(lpTSCall1Ans2->GetInt32(LDTAG_ERRORNO)!=0)  //  中间件层面错误
...
int iPriority=lpInBizMsg->GetInt32(LDTAG_PRIORITY);
    ...
    // set @查询表名#="tb_basesedt_stock_code_info";
    strcpy(v_qry_table,"tb_basesedt_stock_code_info");
    //调用过程[事务_公共_同步接口_获取同步时间]
    //组织事务请求
    if(lpTSCall1Ans0)
    {
    ...
    while (v_ctrl_flag)
    {
       ...
       lpTSCall1Req1=glpFastMsgFactory->CreateFastMessage("pubT.30.14", 0);
       lpTSCall1Req1->SetInt32(LDTAG_PRIORITY, iPriority);
       lpTSCall1Req1->SetInt32(LDBIZ_OPOR_CO_NO_INT,v_opor_co_no);
       lpTSCall1Req1->SetInt32(LDBIZ_OPOR_NO_INT,v_opor_no);
       lpTSCall1Req1->SetString(LDBIZ_OPER_MAC_STR,v_oper_mac);
       ...
       {
           lpOutBizMsg->SetInt32(LDTAG_ERRORNO, -1);
           lpOutBizMsg->SetString(LDTAG_ERRORINFO, "[pubT.30.14]subcall timed out!");
           iRet=-2;
           goto ENDSYS;
       }
       else if(lpTSCall1Ans1->GetInt32(LDTAG_ERRORNO)!=0)  //  中间件层面错误
       ...
       lpTSCall1Req2=glpFastMsgFactory->CreateFastMessage("dcsyncT.1.14", 0);
       lpTSCall1Req2->SetInt32(LDTAG_PRIORITY, iPriority);
       lpTSCall1Req2->SetInt32(LDBIZ_OPOR_CO_NO_INT,v_opor_co_no);
       lpTSCall1Req2->SetInt32(LDBIZ_OPOR_NO_INT,v_opor_no);
       lpTSCall1Req2->SetString(LDBIZ_OPER_MAC_STR,v_oper_mac);
       ...
       {
           lpOutBizMsg->SetInt32(LDTAG_ERRORNO, -1);
           lpOutBizMsg->SetString(LDTAG_ERRORINFO, "[dcsyncT.1.14]subcall timed out!");
           iRet=-2;
           goto ENDSYS;
       }
       else if(lpTSCall1Ans2->GetInt32(LDTAG_ERRORNO)!=0)  //  中间件层面错误
...
int iPriority=lpInBizMsg->GetInt32(LDTAG_PRIORITY);
    ...
    // set @查询表名#="tb_basesedt_stock_quot";
    strcpy(v_qry_table,"tb_basesedt_stock_quot");
    //调用过程[事务_公共_同步接口_获取同步时间]
    //组织事务请求
    if(lpTSCall1Ans0)
    {
    ...
    while (v_ctrl_flag)
    {
       ...
       lpTSCall1Req1=glpFastMsgFactory->CreateFastMessage("pubT.30.15", 0);
       lpTSCall1Req1->SetInt32(LDTAG_PRIORITY, iPriority);
       lpTSCall1Req1->SetInt32(LDBIZ_OPOR_CO_NO_INT,v_opor_co_no);
       lpTSCall1Req1->SetInt32(LDBIZ_OPOR_NO_INT,v_opor_no);
       lpTSCall1Req1->SetString(LDBIZ_OPER_MAC_STR,v_oper_mac);
       ...
       {
           lpOutBizMsg->SetInt32(LDTAG_ERRORNO, -1);
           lpOutBizMsg->SetString(LDTAG_ERRORINFO, "[pubT.30.15]subcall timed out!");
           iRet=-2;
           goto ENDSYS;
       }
       else if(lpTSCall1Ans1->GetInt32(LDTAG_ERRORNO)!=0)  //  中间件层面错误
       ...
       lpTSCall1Req2=glpFastMsgFactory->CreateFastMessage("dcsyncT.1.15", 0);
       lpTSCall1Req2->SetInt32(LDTAG_PRIORITY, iPriority);
       lpTSCall1Req2->SetInt32(LDBIZ_OPOR_CO_NO_INT,v_opor_co_no);
       lpTSCall1Req2->SetInt32(LDBIZ_OPOR_NO_INT,v_opor_no);
       lpTSCall1Req2->SetString(LDBIZ_OPER_MAC_STR,v_oper_mac);
       ...
       {
           lpOutBizMsg->SetInt32(LDTAG_ERRORNO, -1);
           lpOutBizMsg->SetString(LDTAG_ERRORINFO, "[dcsyncT.1.15]subcall timed out!");
           iRet=-2;
           goto ENDSYS;
       }
       else if(lpTSCall1Ans2->GetInt32(LDTAG_ERRORNO)!=0)  //  中间件层面错误
...
int iPriority=lpInBizMsg->GetInt32(LDTAG_PRIORITY);
    ...
    // set @查询表名#="tb_basesedt_bond_info";
    strcpy(v_qry_table,"tb_basesedt_bond_info");
    //调用过程[事务_公共_同步接口_获取同步时间]
    //组织事务请求
    if(lpTSCall1Ans0)
    {
    ...
    while (v_ctrl_flag)
    {
       ...
       lpTSCall1Req1=glpFastMsgFactory->CreateFastMessage("pubT.30.16", 0);
       lpTSCall1Req1->SetInt32(LDTAG_PRIORITY, iPriority);
       lpTSCall1Req1->SetInt32(LDBIZ_OPOR_CO_NO_INT,v_opor_co_no);
       lpTSCall1Req1->SetInt32(LDBIZ_OPOR_NO_INT,v_opor_no);
       lpTSCall1Req1->SetString(LDBIZ_OPER_MAC_STR,v_oper_mac);
       ...
       {
           lpOutBizMsg->SetInt32(LDTAG_ERRORNO, -1);
           lpOutBizMsg->SetString(LDTAG_ERRORINFO, "[pubT.30.16]subcall timed out!");
           iRet=-2;
           goto ENDSYS;
       }
       else if(lpTSCall1Ans1->GetInt32(LDTAG_ERRORNO)!=0)  //  中间件层面错误
       ...
       lpTSCall1Req2=glpFastMsgFactory->CreateFastMessage("dcsyncT.1.16", 0);
       lpTSCall1Req2->SetInt32(LDTAG_PRIORITY, iPriority);
       lpTSCall1Req2->SetInt32(LDBIZ_OPOR_CO_NO_INT,v_opor_co_no);
       lpTSCall1Req2->SetInt32(LDBIZ_OPOR_NO_INT,v_opor_no);
       lpTSCall1Req2->SetString(LDBIZ_OPER_MAC_STR,v_oper_mac);
       ...
       {
           lpOutBizMsg->SetInt32(LDTAG_ERRORNO, -1);
           lpOutBizMsg->SetString(LDTAG_ERRORINFO, "[dcsyncT.1.16]subcall timed out!");
           iRet=-2;
           goto ENDSYS;
       }
       else if(lpTSCall1Ans2->GetInt32(LDTAG_ERRORNO)!=0)  //  中间件层面错误
...
int iPriority=lpInBizMsg->GetInt32(LDTAG_PRIORITY);
    ...
    // set @查询表名#="tb_base_sys_info";
    strcpy(v_qry_table,"tb_base_sys_info");
    //调用过程[事务_公共_同步接口_获取同步时间]
    //组织事务请求
    if(lpTSCall1Ans0)
    {
    ...
    while (v_ctrl_flag)
    {
       ...
       lpTSCall1Req1=glpFastMsgFactory->CreateFastMessage("pubT.30.17", 0);
       lpTSCall1Req1->SetInt32(LDTAG_PRIORITY, iPriority);
       lpTSCall1Req1->SetInt32(LDBIZ_OPOR_CO_NO_INT,v_opor_co_no);
       lpTSCall1Req1->SetInt32(LDBIZ_OPOR_NO_INT,v_opor_no);
       lpTSCall1Req1->SetString(LDBIZ_OPER_MAC_STR,v_oper_mac);
       ...
       {
           lpOutBizMsg->SetInt32(LDTAG_ERRORNO, -1);
           lpOutBizMsg->SetString(LDTAG_ERRORINFO, "[pubT.30.17]subcall timed out!");
           iRet=-2;
           goto ENDSYS;
       }
       else if(lpTSCall1Ans1->GetInt32(LDTAG_ERRORNO)!=0)  //  中间件层面错误
       ...
       lpTSCall1Req2=glpFastMsgFactory->CreateFastMessage("dcsyncT.1.17", 0);
       lpTSCall1Req2->SetInt32(LDTAG_PRIORITY, iPriority);
       lpTSCall1Req2->SetInt32(LDBIZ_OPOR_CO_NO_INT,v_opor_co_no);
       lpTSCall1Req2->SetInt32(LDBIZ_OPOR_NO_INT,v_opor_no);
       lpTSCall1Req2->SetString(LDBIZ_OPER_MAC_STR,v_oper_mac);
       ...
       {
           lpOutBizMsg->SetInt32(LDTAG_ERRORNO, -1);
           lpOutBizMsg->SetString(LDTAG_ERRORINFO, "[dcsyncT.1.17]subcall timed out!");
           iRet=-2;
           goto ENDSYS;
       }
       else if(lpTSCall1Ans2->GetInt32(LDTAG_ERRORNO)!=0)  //  中间件层面错误
...
int iPriority=lpInBizMsg->GetInt32(LDTAG_PRIORITY);
    ...
    // set @查询表名#="tb_base_co_info";
    strcpy(v_qry_table,"tb_base_co_info");
    //调用过程[事务_公共_同步接口_获取同步时间]
    //组织事务请求
    if(lpTSCall1Ans0)
    {
    ...
    while (v_ctrl_flag)
    {
       ...
       lpTSCall1Req1=glpFastMsgFactory->CreateFastMessage("pubT.30.18", 0);
       lpTSCall1Req1->SetInt32(LDTAG_PRIORITY, iPriority);
       lpTSCall1Req1->SetInt32(LDBIZ_OPOR_CO_NO_INT,v_opor_co_no);
       lpTSCall1Req1->SetInt32(LDBIZ_OPOR_NO_INT,v_opor_no);
       lpTSCall1Req1->SetString(LDBIZ_OPER_MAC_STR,v_oper_mac);
       ...
       {
           lpOutBizMsg->SetInt32(LDTAG_ERRORNO, -1);
           lpOutBizMsg->SetString(LDTAG_ERRORINFO, "[pubT.30.18]subcall timed out!");
           iRet=-2;
           goto ENDSYS;
       }
       else if(lpTSCall1Ans1->GetInt32(LDTAG_ERRORNO)!=0)  //  中间件层面错误
       ...
       lpTSCall1Req2=glpFastMsgFactory->CreateFastMessage("dcsyncT.1.18", 0);
       lpTSCall1Req2->SetInt32(LDTAG_PRIORITY, iPriority);
       lpTSCall1Req2->SetInt32(LDBIZ_OPOR_CO_NO_INT,v_opor_co_no);
       lpTSCall1Req2->SetInt32(LDBIZ_OPOR_NO_INT,v_opor_no);
       lpTSCall1Req2->SetString(LDBIZ_OPER_MAC_STR,v_oper_mac);
       ...
       {
           lpOutBizMsg->SetInt32(LDTAG_ERRORNO, -1);
           lpOutBizMsg->SetString(LDTAG_ERRORINFO, "[dcsyncT.1.18]subcall timed out!");
           iRet=-2;
           goto ENDSYS;
       }
       else if(lpTSCall1Ans2->GetInt32(LDTAG_ERRORNO)!=0)  //  中间件层面错误
...
int iPriority=lpInBizMsg->GetInt32(LDTAG_PRIORITY);
    ...
    // set @查询表名#="tb_base_market_busi_record_no";
    strcpy(v_qry_table,"tb_base_market_busi_record_no");
    //调用过程[事务_公共_同步接口_获取同步时间]
    //组织事务请求
    if(lpTSCall1Ans0)
    {
    ...
    while (v_ctrl_flag)
    {
       ...
       lpTSCall1Req1=glpFastMsgFactory->CreateFastMessage("pubT.30.19", 0);
       lpTSCall1Req1->SetInt32(LDTAG_PRIORITY, iPriority);
       lpTSCall1Req1->SetInt32(LDBIZ_OPOR_CO_NO_INT,v_opor_co_no);
       lpTSCall1Req1->SetInt32(LDBIZ_OPOR_NO_INT,v_opor_no);
       lpTSCall1Req1->SetString(LDBIZ_OPER_MAC_STR,v_oper_mac);
       ...
       {
           lpOutBizMsg->SetInt32(LDTAG_ERRORNO, -1);
           lpOutBizMsg->SetString(LDTAG_ERRORINFO, "[pubT.30.19]subcall timed out!");
           iRet=-2;
           goto ENDSYS;
       }
       else if(lpTSCall1Ans1->GetInt32(LDTAG_ERRORNO)!=0)  //  中间件层面错误
       ...
       lpTSCall1Req2=glpFastMsgFactory->CreateFastMessage("dcsyncT.1.19", 0);
       lpTSCall1Req2->SetInt32(LDTAG_PRIORITY, iPriority);
       lpTSCall1Req2->SetInt32(LDBIZ_OPOR_CO_NO_INT,v_opor_co_no);
       lpTSCall1Req2->SetInt32(LDBIZ_OPOR_NO_INT,v_opor_no);
       lpTSCall1Req2->SetString(LDBIZ_OPER_MAC_STR,v_oper_mac);
       ...
       {
           lpOutBizMsg->SetInt32(LDTAG_ERRORNO, -1);
           lpOutBizMsg->SetString(LDTAG_ERRORINFO, "[dcsyncT.1.19]subcall timed out!");
           iRet=-2;
           goto ENDSYS;
       }
       else if(lpTSCall1Ans2->GetInt32(LDTAG_ERRORNO)!=0)  //  中间件层面错误
...
int iPriority=lpInBizMsg->GetInt32(LDTAG_PRIORITY);
    ...
    // set @查询表名#="tb_base_dictionary";
    strcpy(v_qry_table,"tb_base_dictionary");
    //调用过程[事务_公共_同步接口_获取同步时间]
    //组织事务请求
    if(lpTSCall1Ans0)
    {
    ...
    while (v_ctrl_flag)
    {
       ...
       lpTSCall1Req1=glpFastMsgFactory->CreateFastMessage("pubT.30.20", 0);
       lpTSCall1Req1->SetInt32(LDTAG_PRIORITY, iPriority);
       lpTSCall1Req1->SetInt32(LDBIZ_OPOR_CO_NO_INT,v_opor_co_no);
       lpTSCall1Req1->SetInt32(LDBIZ_OPOR_NO_INT,v_opor_no);
       lpTSCall1Req1->SetString(LDBIZ_OPER_MAC_STR,v_oper_mac);
       ...
       {
           lpOutBizMsg->SetInt32(LDTAG_ERRORNO, -1);
           lpOutBizMsg->SetString(LDTAG_ERRORINFO, "[pubT.30.20]subcall timed out!");
           iRet=-2;
           goto ENDSYS;
       }
       else if(lpTSCall1Ans1->GetInt32(LDTAG_ERRORNO)!=0)  //  中间件层面错误
       ...
       lpTSCall1Req2=glpFastMsgFactory->CreateFastMessage("dcsyncT.1.20", 0);
       lpTSCall1Req2->SetInt32(LDTAG_PRIORITY, iPriority);
       lpTSCall1Req2->SetInt32(LDBIZ_OPOR_CO_NO_INT,v_opor_co_no);
       lpTSCall1Req2->SetInt32(LDBIZ_OPOR_NO_INT,v_opor_no);
       lpTSCall1Req2->SetString(LDBIZ_OPER_MAC_STR,v_oper_mac);
       ...
       {
           lpOutBizMsg->SetInt32(LDTAG_ERRORNO, -1);
           lpOutBizMsg->SetString(LDTAG_ERRORINFO, "[dcsyncT.1.20]subcall timed out!");
           iRet=-2;
           goto ENDSYS;
       }
       else if(lpTSCall1Ans2->GetInt32(LDTAG_ERRORNO)!=0)  //  中间件层面错误
...
int iPriority=lpInBizMsg->GetInt32(LDTAG_PRIORITY);
    ...
    // set @查询表名#="tb_base_hk_exch_rate";
    strcpy(v_qry_table,"tb_base_hk_exch_rate");
    //调用过程[事务_公共_同步接口_获取同步时间]
    //组织事务请求
    if(lpTSCall1Ans0)
    {
    ...
    while (v_ctrl_flag)
    {
       ...
       lpTSCall1Req1=glpFastMsgFactory->CreateFastMessage("pubT.30.21", 0);
       lpTSCall1Req1->SetInt32(LDTAG_PRIORITY, iPriority);
       lpTSCall1Req1->SetInt32(LDBIZ_OPOR_CO_NO_INT,v_opor_co_no);
       lpTSCall1Req1->SetInt32(LDBIZ_OPOR_NO_INT,v_opor_no);
       lpTSCall1Req1->SetString(LDBIZ_OPER_MAC_STR,v_oper_mac);
       ...
       {
           lpOutBizMsg->SetInt32(LDTAG_ERRORNO, -1);
           lpOutBizMsg->SetString(LDTAG_ERRORINFO, "[pubT.30.21]subcall timed out!");
           iRet=-2;
           goto ENDSYS;
       }
       else if(lpTSCall1Ans1->GetInt32(LDTAG_ERRORNO)!=0)  //  中间件层面错误
       ...
       lpTSCall1Req2=glpFastMsgFactory->CreateFastMessage("dcsyncT.1.21", 0);
       lpTSCall1Req2->SetInt32(LDTAG_PRIORITY, iPriority);
       lpTSCall1Req2->SetInt32(LDBIZ_OPOR_CO_NO_INT,v_opor_co_no);
       lpTSCall1Req2->SetInt32(LDBIZ_OPOR_NO_INT,v_opor_no);
       lpTSCall1Req2->SetString(LDBIZ_OPER_MAC_STR,v_oper_mac);
       ...
       {
           lpOutBizMsg->SetInt32(LDTAG_ERRORNO, -1);
           lpOutBizMsg->SetString(LDTAG_ERRORINFO, "[dcsyncT.1.21]subcall timed out!");
           iRet=-2;
           goto ENDSYS;
       }
       else if(lpTSCall1Ans2->GetInt32(LDTAG_ERRORNO)!=0)  //  中间件层面错误
...
int iPriority=lpInBizMsg->GetInt32(LDTAG_PRIORITY);
    ...
    // set @查询表名#="tb_user_opor_info";
    strcpy(v_qry_table,"tb_user_opor_info");
    //调用过程[事务_公共_同步接口_获取同步时间]
    //组织事务请求
    if(lpTSCall1Ans0)
    {
    ...
    while (v_ctrl_flag)
    {
       ...
       lpTSCall1Req1=glpFastMsgFactory->CreateFastMessage("pubT.30.22", 0);
       lpTSCall1Req1->SetInt32(LDTAG_PRIORITY, iPriority);
       lpTSCall1Req1->SetInt32(LDBIZ_OPOR_CO_NO_INT,v_opor_co_no);
       lpTSCall1Req1->SetInt32(LDBIZ_OPOR_NO_INT,v_opor_no);
       lpTSCall1Req1->SetString(LDBIZ_OPER_MAC_STR,v_oper_mac);
       ...
       {
           lpOutBizMsg->SetInt32(LDTAG_ERRORNO, -1);
           lpOutBizMsg->SetString(LDTAG_ERRORINFO, "[pubT.30.22]subcall timed out!");
           iRet=-2;
           goto ENDSYS;
       }
       else if(lpTSCall1Ans1->GetInt32(LDTAG_ERRORNO)!=0)  //  中间件层面错误
       ...
       lpTSCall1Req2=glpFastMsgFactory->CreateFastMessage("dcsyncT.1.22", 0);
       lpTSCall1Req2->SetInt32(LDTAG_PRIORITY, iPriority);
       lpTSCall1Req2->SetInt32(LDBIZ_OPOR_CO_NO_INT,v_opor_co_no);
       lpTSCall1Req2->SetInt32(LDBIZ_OPOR_NO_INT,v_opor_no);
       lpTSCall1Req2->SetString(LDBIZ_OPER_MAC_STR,v_oper_mac);
       ...
       {
           lpOutBizMsg->SetInt32(LDTAG_ERRORNO, -1);
           lpOutBizMsg->SetString(LDTAG_ERRORINFO, "[dcsyncT.1.22]subcall timed out!");
           iRet=-2;
           goto ENDSYS;
       }
       else if(lpTSCall1Ans2->GetInt32(LDTAG_ERRORNO)!=0)  //  中间件层面错误
...
int iPriority=lpInBizMsg->GetInt32(LDTAG_PRIORITY);
    ...
    // set @查询表名#="tb_user_opor_allow_co";
    strcpy(v_qry_table,"tb_user_opor_allow_co");
    //调用过程[事务_公共_同步接口_获取同步时间]
    //组织事务请求
    if(lpTSCall1Ans0)
    {
    ...
    while (v_ctrl_flag)
    {
       ...
       lpTSCall1Req1=glpFastMsgFactory->CreateFastMessage("pubT.30.23", 0);
       lpTSCall1Req1->SetInt32(LDTAG_PRIORITY, iPriority);
       lpTSCall1Req1->SetInt32(LDBIZ_OPOR_CO_NO_INT,v_opor_co_no);
       lpTSCall1Req1->SetInt32(LDBIZ_OPOR_NO_INT,v_opor_no);
       lpTSCall1Req1->SetString(LDBIZ_OPER_MAC_STR,v_oper_mac);
       ...
       {
           lpOutBizMsg->SetInt32(LDTAG_ERRORNO, -1);
           lpOutBizMsg->SetString(LDTAG_ERRORINFO, "[pubT.30.23]subcall timed out!");
           iRet=-2;
           goto ENDSYS;
       }
       else if(lpTSCall1Ans1->GetInt32(LDTAG_ERRORNO)!=0)  //  中间件层面错误
       ...
       lpTSCall1Req2=glpFastMsgFactory->CreateFastMessage("dcsyncT.1.23", 0);
       lpTSCall1Req2->SetInt32(LDTAG_PRIORITY, iPriority);
       lpTSCall1Req2->SetInt32(LDBIZ_OPOR_CO_NO_INT,v_opor_co_no);
       lpTSCall1Req2->SetInt32(LDBIZ_OPOR_NO_INT,v_opor_no);
       lpTSCall1Req2->SetString(LDBIZ_OPER_MAC_STR,v_oper_mac);
       ...
       {
           lpOutBizMsg->SetInt32(LDTAG_ERRORNO, -1);
           lpOutBizMsg->SetString(LDTAG_ERRORINFO, "[dcsyncT.1.23]subcall timed out!");
           iRet=-2;
           goto ENDSYS;
       }
       else if(lpTSCall1Ans2->GetInt32(LDTAG_ERRORNO)!=0)  //  中间件层面错误
...
int iPriority=lpInBizMsg->GetInt32(LDTAG_PRIORITY);
    ...
    // set @查询表名#="tb_user_opor_allow_prod";
    strcpy(v_qry_table,"tb_user_opor_allow_prod");
    //调用过程[事务_公共_同步接口_获取同步时间]
    //组织事务请求
    if(lpTSCall1Ans0)
    {
    ...
    while (v_ctrl_flag)
    {
       ...
       lpTSCall1Req1=glpFastMsgFactory->CreateFastMessage("pubT.30.24", 0);
       lpTSCall1Req1->SetInt32(LDTAG_PRIORITY, iPriority);
       lpTSCall1Req1->SetInt32(LDBIZ_OPOR_CO_NO_INT,v_opor_co_no);
       lpTSCall1Req1->SetInt32(LDBIZ_OPOR_NO_INT,v_opor_no);
       lpTSCall1Req1->SetString(LDBIZ_OPER_MAC_STR,v_oper_mac);
       ...
       {
           lpOutBizMsg->SetInt32(LDTAG_ERRORNO, -1);
           lpOutBizMsg->SetString(LDTAG_ERRORINFO, "[pubT.30.24]subcall timed out!");
           iRet=-2;
           goto ENDSYS;
       }
       else if(lpTSCall1Ans1->GetInt32(LDTAG_ERRORNO)!=0)  //  中间件层面错误
       ...
       lpTSCall1Req2=glpFastMsgFactory->CreateFastMessage("dcsyncT.1.24", 0);
       lpTSCall1Req2->SetInt32(LDTAG_PRIORITY, iPriority);
       lpTSCall1Req2->SetInt32(LDBIZ_OPOR_CO_NO_INT,v_opor_co_no);
       lpTSCall1Req2->SetInt32(LDBIZ_OPOR_NO_INT,v_opor_no);
       lpTSCall1Req2->SetString(LDBIZ_OPER_MAC_STR,v_oper_mac);
       ...
       {
           lpOutBizMsg->SetInt32(LDTAG_ERRORNO, -1);
           lpOutBizMsg->SetString(LDTAG_ERRORINFO, "[dcsyncT.1.24]subcall timed out!");
           iRet=-2;
           goto ENDSYS;
       }
       else if(lpTSCall1Ans2->GetInt32(LDTAG_ERRORNO)!=0)  //  中间件层面错误
...
int iPriority=lpInBizMsg->GetInt32(LDTAG_PRIORITY);
    ...
    // set @查询表名#="tb_user_exch_group_info";
    strcpy(v_qry_table,"tb_user_exch_group_info");
    //调用过程[事务_公共_同步接口_获取同步时间]
    //组织事务请求
    if(lpTSCall1Ans0)
    {
    ...
    while (v_ctrl_flag)
    {
       ...
       lpTSCall1Req1=glpFastMsgFactory->CreateFastMessage("pubT.30.25", 0);
       lpTSCall1Req1->SetInt32(LDTAG_PRIORITY, iPriority);
       lpTSCall1Req1->SetInt32(LDBIZ_OPOR_CO_NO_INT,v_opor_co_no);
       lpTSCall1Req1->SetInt32(LDBIZ_OPOR_NO_INT,v_opor_no);
       lpTSCall1Req1->SetString(LDBIZ_OPER_MAC_STR,v_oper_mac);
       ...
       {
           lpOutBizMsg->SetInt32(LDTAG_ERRORNO, -1);
           lpOutBizMsg->SetString(LDTAG_ERRORINFO, "[pubT.30.25]subcall timed out!");
           iRet=-2;
           goto ENDSYS;
       }
       else if(lpTSCall1Ans1->GetInt32(LDTAG_ERRORNO)!=0)  //  中间件层面错误
       ...
       lpTSCall1Req2=glpFastMsgFactory->CreateFastMessage("dcsyncT.1.25", 0);
       lpTSCall1Req2->SetInt32(LDTAG_PRIORITY, iPriority);
       lpTSCall1Req2->SetInt32(LDBIZ_OPOR_CO_NO_INT,v_opor_co_no);
       lpTSCall1Req2->SetInt32(LDBIZ_OPOR_NO_INT,v_opor_no);
       lpTSCall1Req2->SetString(LDBIZ_OPER_MAC_STR,v_oper_mac);
       ...
       {
           lpOutBizMsg->SetInt32(LDTAG_ERRORNO, -1);
           lpOutBizMsg->SetString(LDTAG_ERRORINFO, "[dcsyncT.1.25]subcall timed out!");
           iRet=-2;
           goto ENDSYS;
       }
       else if(lpTSCall1Ans2->GetInt32(LDTAG_ERRORNO)!=0)  //  中间件层面错误
...
int iPriority=lpInBizMsg->GetInt32(LDTAG_PRIORITY);
    ...
    // set @查询表名#="tb_user_exch_group_asset";
    strcpy(v_qry_table,"tb_user_exch_group_asset");
    //调用过程[事务_公共_同步接口_获取同步时间]
    //组织事务请求
    if(lpTSCall1Ans0)
    {
    ...
    while (v_ctrl_flag)
    {
       ...
       lpTSCall1Req1=glpFastMsgFactory->CreateFastMessage("pubT.30.26", 0);
       lpTSCall1Req1->SetInt32(LDTAG_PRIORITY, iPriority);
       lpTSCall1Req1->SetInt32(LDBIZ_OPOR_CO_NO_INT,v_opor_co_no);
       lpTSCall1Req1->SetInt32(LDBIZ_OPOR_NO_INT,v_opor_no);
       lpTSCall1Req1->SetString(LDBIZ_OPER_MAC_STR,v_oper_mac);
       ...
       {
           lpOutBizMsg->SetInt32(LDTAG_ERRORNO, -1);
           lpOutBizMsg->SetString(LDTAG_ERRORINFO, "[pubT.30.26]subcall timed out!");
           iRet=-2;
           goto ENDSYS;
       }
       else if(lpTSCall1Ans1->GetInt32(LDTAG_ERRORNO)!=0)  //  中间件层面错误
       ...
       lpTSCall1Req2=glpFastMsgFactory->CreateFastMessage("dcsyncT.1.26", 0);
       lpTSCall1Req2->SetInt32(LDTAG_PRIORITY, iPriority);
       lpTSCall1Req2->SetInt32(LDBIZ_OPOR_CO_NO_INT,v_opor_co_no);
       lpTSCall1Req2->SetInt32(LDBIZ_OPOR_NO_INT,v_opor_no);
       lpTSCall1Req2->SetString(LDBIZ_OPER_MAC_STR,v_oper_mac);
       ...
       {
           lpOutBizMsg->SetInt32(LDTAG_ERRORNO, -1);
           lpOutBizMsg->SetString(LDTAG_ERRORINFO, "[dcsyncT.1.26]subcall timed out!");
           iRet=-2;
           goto ENDSYS;
       }
       else if(lpTSCall1Ans2->GetInt32(LDTAG_ERRORNO)!=0)  //  中间件层面错误
...
int iPriority=lpInBizMsg->GetInt32(LDTAG_PRIORITY);
    ...
    // set @查询表名#="tb_user_opor_exch_group";
    strcpy(v_qry_table,"tb_user_opor_exch_group");
    //调用过程[事务_公共_同步接口_获取同步时间]
    //组织事务请求
    if(lpTSCall1Ans0)
    {
    ...
    while (v_ctrl_flag)
    {
       ...
       lpTSCall1Req1=glpFastMsgFactory->CreateFastMessage("pubT.30.27", 0);
       lpTSCall1Req1->SetInt32(LDTAG_PRIORITY, iPriority);
       lpTSCall1Req1->SetInt32(LDBIZ_OPOR_CO_NO_INT,v_opor_co_no);
       lpTSCall1Req1->SetInt32(LDBIZ_OPOR_NO_INT,v_opor_no);
       lpTSCall1Req1->SetString(LDBIZ_OPER_MAC_STR,v_oper_mac);
       ...
       {
           lpOutBizMsg->SetInt32(LDTAG_ERRORNO, -1);
           lpOutBizMsg->SetString(LDTAG_ERRORINFO, "[pubT.30.27]subcall timed out!");
           iRet=-2;
           goto ENDSYS;
       }
       else if(lpTSCall1Ans1->GetInt32(LDTAG_ERRORNO)!=0)  //  中间件层面错误
       ...
       lpTSCall1Req2=glpFastMsgFactory->CreateFastMessage("dcsyncT.1.27", 0);
       lpTSCall1Req2->SetInt32(LDTAG_PRIORITY, iPriority);
       lpTSCall1Req2->SetInt32(LDBIZ_OPOR_CO_NO_INT,v_opor_co_no);
       lpTSCall1Req2->SetInt32(LDBIZ_OPOR_NO_INT,v_opor_no);
       lpTSCall1Req2->SetString(LDBIZ_OPER_MAC_STR,v_oper_mac);
       ...
       {
           lpOutBizMsg->SetInt32(LDTAG_ERRORNO, -1);
           lpOutBizMsg->SetString(LDTAG_ERRORINFO, "[dcsyncT.1.27]subcall timed out!");
           iRet=-2;
           goto ENDSYS;
       }
       else if(lpTSCall1Ans2->GetInt32(LDTAG_ERRORNO)!=0)  //  中间件层面错误
...
int iPriority=lpInBizMsg->GetInt32(LDTAG_PRIORITY);
    ...
    // set @查询表名#="tb_basefudt_futu_quot";
    strcpy(v_qry_table,"tb_basefudt_futu_quot");
    //调用过程[事务_公共_同步接口_获取同步时间]
    //组织事务请求
    if(lpTSCall1Ans0)
    {
    ...
    while (v_ctrl_flag)
    {
       ...
       lpTSCall1Req1=glpFastMsgFactory->CreateFastMessage("pubT.30.28", 0);
       lpTSCall1Req1->SetInt32(LDTAG_PRIORITY, iPriority);
       lpTSCall1Req1->SetInt32(LDBIZ_OPOR_CO_NO_INT,v_opor_co_no);
       lpTSCall1Req1->SetInt32(LDBIZ_OPOR_NO_INT,v_opor_no);
       lpTSCall1Req1->SetString(LDBIZ_OPER_MAC_STR,v_oper_mac);
       ...
       {
           lpOutBizMsg->SetInt32(LDTAG_ERRORNO, -1);
           lpOutBizMsg->SetString(LDTAG_ERRORINFO, "[pubT.30.28]subcall timed out!");
           iRet=-2;
           goto ENDSYS;
       }
       else if(lpTSCall1Ans1->GetInt32(LDTAG_ERRORNO)!=0)  //  中间件层面错误
       ...
       lpTSCall1Req2=glpFastMsgFactory->CreateFastMessage("dcsyncT.1.28", 0);
       lpTSCall1Req2->SetInt32(LDTAG_PRIORITY, iPriority);
       lpTSCall1Req2->SetInt32(LDBIZ_OPOR_CO_NO_INT,v_opor_co_no);
       lpTSCall1Req2->SetInt32(LDBIZ_OPOR_NO_INT,v_opor_no);
       lpTSCall1Req2->SetString(LDBIZ_OPER_MAC_STR,v_oper_mac);
       ...
       {
           lpOutBizMsg->SetInt32(LDTAG_ERRORNO, -1);
           lpOutBizMsg->SetString(LDTAG_ERRORINFO, "[dcsyncT.1.28]subcall timed out!");
           iRet=-2;
           goto ENDSYS;
       }
       else if(lpTSCall1Ans2->GetInt32(LDTAG_ERRORNO)!=0)  //  中间件层面错误
