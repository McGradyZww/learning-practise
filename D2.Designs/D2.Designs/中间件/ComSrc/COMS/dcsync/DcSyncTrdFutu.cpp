...
API_EXPORT int LD_CALL_MODE QueryInterface(int iFunIndex, LPBIZ_FUNC_INFO bizFuncInfo)
{
    ...
    if (iFunIndex==0)
    {
        strcpy(bizFuncInfo->szFuncName, "dcsyncL.6.12");
        bizFuncInfo->lpFunc = fnFunc0;
    }
    else if (iFunIndex==1)
    {
        strcpy(bizFuncInfo->szFuncName, "dcsyncL.6.13");
        bizFuncInfo->lpFunc = fnFunc1;
    }
    else if (iFunIndex==2)
    {
        strcpy(bizFuncInfo->szFuncName, "dcsyncL.6.14");
        bizFuncInfo->lpFunc = fnFunc2;
    }
    else if (iFunIndex==3)
    {
        strcpy(bizFuncInfo->szFuncName, "dcsyncL.6.15");
        bizFuncInfo->lpFunc = fnFunc3;
    }
    else if (iFunIndex==4)
    {
        strcpy(bizFuncInfo->szFuncName, "dcsyncL.6.16");
...
int iPriority=lpInBizMsg->GetInt32(LDTAG_PRIORITY);
    ...
    // set @查询表名#="tb_tdfuac_exgp_busi_capit";
    strcpy(v_qry_table,"tb_tdfuac_exgp_busi_capit");
    //调用过程[事务_交易期货_同步接口_获取同步时间]
    //组织事务请求
    if(lpTSCall1Ans0)
    {
    ...
    lpTSCall1Req0=glpFastMsgFactory->CreateFastMessage("tdfutuT.15.1", 0);
    ...
    if(!lpTSCall1Ans0)  //  超时错误
    {
        ...
        lpOutBizMsg->SetString(LDTAG_ERRORINFO, "[tdfutuT.15.1]subcall timed out!");
        iRet=-2;
        goto ENDSYS;
    }
    ...
    while (v_ctrl_flag)
    {
        ...
        lpTSCall1Req1=glpFastMsgFactory->CreateFastMessage("tdfutuT.15.12", 0);
        ...
        {
            lpOutBizMsg->SetInt32(LDTAG_ERRORNO, -1);
            lpOutBizMsg->SetString(LDTAG_ERRORINFO, "[tdfutuT.15.12]subcall timed out!");
            iRet=-2;
            goto ENDSYS;
        }
        ...
        lpTSCall1Req2=glpFastMsgFactory->CreateFastMessage("tdfutuT.15.12", 0);
        ...
        lpTSCall1Req2->SetInt32(LDBIZ_UPDATE_DATE_INT,v_update_date);
        lpTSCall1Req2->SetInt32(LDBIZ_UPDATE_TIME_INT,v_update_time);
        ...
        strcpy(v_error_code, lpTSCall1Ans2->GetString(LDBIZ_ERROR_CODE_STR));
        strcpy(v_error_info, lpTSCall1Ans2->GetString(LDBIZ_ERROR_INFO_STR));
        strcpy(v_sync_field1, lpTSCall1Ans2->GetString(LDBIZ_SYNC_FIELD1_STR));
        strcpy(v_sync_field2, lpTSCall1Ans2->GetString(LDBIZ_SYNC_FIELD2_STR));
        strcpy(v_sync_field3, lpTSCall1Ans2->GetString(LDBIZ_SYNC_FIELD3_STR));
        strcpy(v_sync_field4, lpTSCall1Ans2->GetString(LDBIZ_SYNC_FIELD4_STR));
        strcpy(v_sync_field5, lpTSCall1Ans2->GetString(LDBIZ_SYNC_FIELD5_STR));
        strcpy(v_sync_field6, lpTSCall1Ans2->GetString(LDBIZ_SYNC_FIELD6_STR));
        strcpy(v_sync_field7, lpTSCall1Ans2->GetString(LDBIZ_SYNC_FIELD7_STR));
        strcpy(v_sync_field8, lpTSCall1Ans2->GetString(LDBIZ_SYNC_FIELD8_STR));
        strcpy(v_sync_field9, lpTSCall1Ans2->GetString(LDBIZ_SYNC_FIELD9_STR));
        strcpy(v_sync_field10, lpTSCall1Ans2->GetString(LDBIZ_SYNC_FIELD10_STR));
        strcpy(v_sync_field11, lpTSCall1Ans2->GetString(LDBIZ_SYNC_FIELD11_STR));
        strcpy(v_sync_field12, lpTSCall1Ans2->GetString(LDBIZ_SYNC_FIELD12_STR));
        strcpy(v_sync_field13, lpTSCall1Ans2->GetString(LDBIZ_SYNC_FIELD13_STR));
        strcpy(v_sync_field14, lpTSCall1Ans2->GetString(LDBIZ_SYNC_FIELD14_STR));
        strcpy(v_sync_field15, lpTSCall1Ans2->GetString(LDBIZ_SYNC_FIELD15_STR));
        strcpy(v_sync_field16, lpTSCall1Ans2->GetString(LDBIZ_SYNC_FIELD16_STR));
        strcpy(v_sync_field17, lpTSCall1Ans2->GetString(LDBIZ_SYNC_FIELD17_STR));
        strcpy(v_sync_field18, lpTSCall1Ans2->GetString(LDBIZ_SYNC_FIELD18_STR));
        strcpy(v_sync_field19, lpTSCall1Ans2->GetString(LDBIZ_SYNC_FIELD19_STR));
        strcpy(v_sync_field20, lpTSCall1Ans2->GetString(LDBIZ_SYNC_FIELD20_STR));
        strcpy(v_sync_field21, lpTSCall1Ans2->GetString(LDBIZ_SYNC_FIELD21_STR));
        strcpy(v_sync_field22, lpTSCall1Ans2->GetString(LDBIZ_SYNC_FIELD22_STR));
        strcpy(v_sync_field23, lpTSCall1Ans2->GetString(LDBIZ_SYNC_FIELD23_STR));
        strcpy(v_sync_field24, lpTSCall1Ans2->GetString(LDBIZ_SYNC_FIELD24_STR));
        strcpy(v_sync_field25, lpTSCall1Ans2->GetString(LDBIZ_SYNC_FIELD25_STR));
        strcpy(v_sync_field26, lpTSCall1Ans2->GetString(LDBIZ_SYNC_FIELD26_STR));
        strcpy(v_sync_field27, lpTSCall1Ans2->GetString(LDBIZ_SYNC_FIELD27_STR));
        strcpy(v_sync_field28, lpTSCall1Ans2->GetString(LDBIZ_SYNC_FIELD28_STR));
        strcpy(v_sync_field29, lpTSCall1Ans2->GetString(LDBIZ_SYNC_FIELD29_STR));
        strcpy(v_sync_field30, lpTSCall1Ans2->GetString(LDBIZ_SYNC_FIELD30_STR));
        strcpy(v_sync_field31, lpTSCall1Ans2->GetString(LDBIZ_SYNC_FIELD31_STR));
        strcpy(v_sync_field32, lpTSCall1Ans2->GetString(LDBIZ_SYNC_FIELD32_STR));
        strcpy(v_sync_field33, lpTSCall1Ans2->GetString(LDBIZ_SYNC_FIELD33_STR));
        strcpy(v_sync_field34, lpTSCall1Ans2->GetString(LDBIZ_SYNC_FIELD34_STR));
        strcpy(v_sync_field35, lpTSCall1Ans2->GetString(LDBIZ_SYNC_FIELD35_STR));
        strcpy(v_sync_field36, lpTSCall1Ans2->GetString(LDBIZ_SYNC_FIELD36_STR));
        strcpy(v_sync_field37, lpTSCall1Ans2->GetString(LDBIZ_SYNC_FIELD37_STR));
        strcpy(v_sync_field38, lpTSCall1Ans2->GetString(LDBIZ_SYNC_FIELD38_STR));
        strcpy(v_sync_field39, lpTSCall1Ans2->GetString(LDBIZ_SYNC_FIELD39_STR));
        strcpy(v_sync_field40, lpTSCall1Ans2->GetString(LDBIZ_SYNC_FIELD40_STR));
        strcpy(v_sync_field41, lpTSCall1Ans2->GetString(LDBIZ_SYNC_FIELD41_STR));
        strcpy(v_sync_field42, lpTSCall1Ans2->GetString(LDBIZ_SYNC_FIELD42_STR));
        strcpy(v_sync_field43, lpTSCall1Ans2->GetString(LDBIZ_SYNC_FIELD43_STR));
        strcpy(v_sync_field44, lpTSCall1Ans2->GetString(LDBIZ_SYNC_FIELD44_STR));
        strcpy(v_sync_field45, lpTSCall1Ans2->GetString(LDBIZ_SYNC_FIELD45_STR));
        strcpy(v_sync_field46, lpTSCall1Ans2->GetString(LDBIZ_SYNC_FIELD46_STR));
        strcpy(v_sync_field47, lpTSCall1Ans2->GetString(LDBIZ_SYNC_FIELD47_STR));
        strcpy(v_sync_field48, lpTSCall1Ans2->GetString(LDBIZ_SYNC_FIELD48_STR));
        strcpy(v_sync_field49, lpTSCall1Ans2->GetString(LDBIZ_SYNC_FIELD49_STR));
        strcpy(v_sync_field50, lpTSCall1Ans2->GetString(LDBIZ_SYNC_FIELD50_STR));
        strcpy(v_sync_field51, lpTSCall1Ans2->GetString(LDBIZ_SYNC_FIELD51_STR));
        strcpy(v_sync_field52, lpTSCall1Ans2->GetString(LDBIZ_SYNC_FIELD52_STR));
        strcpy(v_sync_field53, lpTSCall1Ans2->GetString(LDBIZ_SYNC_FIELD53_STR));
        strcpy(v_sync_field54, lpTSCall1Ans2->GetString(LDBIZ_SYNC_FIELD54_STR));
        strcpy(v_sync_field55, lpTSCall1Ans2->GetString(LDBIZ_SYNC_FIELD55_STR));
        strcpy(v_sync_field56, lpTSCall1Ans2->GetString(LDBIZ_SYNC_FIELD56_STR));
        strcpy(v_sync_field57, lpTSCall1Ans2->GetString(LDBIZ_SYNC_FIELD57_STR));
        strcpy(v_sync_field58, lpTSCall1Ans2->GetString(LDBIZ_SYNC_FIELD58_STR));
        strcpy(v_sync_field59, lpTSCall1Ans2->GetString(LDBIZ_SYNC_FIELD59_STR));
        strcpy(v_sync_field60, lpTSCall1Ans2->GetString(LDBIZ_SYNC_FIELD60_STR));
        strcpy(v_sync_field61, lpTSCall1Ans2->GetString(LDBIZ_SYNC_FIELD61_STR));
        strcpy(v_sync_field62, lpTSCall1Ans2->GetString(LDBIZ_SYNC_FIELD62_STR));
        strcpy(v_sync_field63, lpTSCall1Ans2->GetString(LDBIZ_SYNC_FIELD63_STR));
        strcpy(v_sync_field64, lpTSCall1Ans2->GetString(LDBIZ_SYNC_FIELD64_STR));
        strcpy(v_sync_field65, lpTSCall1Ans2->GetString(LDBIZ_SYNC_FIELD65_STR));
        strcpy(v_sync_field66, lpTSCall1Ans2->GetString(LDBIZ_SYNC_FIELD66_STR));
        strcpy(v_sync_field67, lpTSCall1Ans2->GetString(LDBIZ_SYNC_FIELD67_STR));
        strcpy(v_sync_field68, lpTSCall1Ans2->GetString(LDBIZ_SYNC_FIELD68_STR));
        strcpy(v_sync_field69, lpTSCall1Ans2->GetString(LDBIZ_SYNC_FIELD69_STR));
        strcpy(v_sync_field70, lpTSCall1Ans2->GetString(LDBIZ_SYNC_FIELD70_STR));
        strcpy(v_sync_field71, lpTSCall1Ans2->GetString(LDBIZ_SYNC_FIELD71_STR));
        strcpy(v_sync_field72, lpTSCall1Ans2->GetString(LDBIZ_SYNC_FIELD72_STR));
        strcpy(v_sync_field73, lpTSCall1Ans2->GetString(LDBIZ_SYNC_FIELD73_STR));
        strcpy(v_sync_field74, lpTSCall1Ans2->GetString(LDBIZ_SYNC_FIELD74_STR));
        strcpy(v_sync_field75, lpTSCall1Ans2->GetString(LDBIZ_SYNC_FIELD75_STR));
        strcpy(v_sync_field76, lpTSCall1Ans2->GetString(LDBIZ_SYNC_FIELD76_STR));
        strcpy(v_sync_field77, lpTSCall1Ans2->GetString(LDBIZ_SYNC_FIELD77_STR));
        strcpy(v_sync_field78, lpTSCall1Ans2->GetString(LDBIZ_SYNC_FIELD78_STR));
        strcpy(v_sync_field79, lpTSCall1Ans2->GetString(LDBIZ_SYNC_FIELD79_STR));
        strcpy(v_sync_field80, lpTSCall1Ans2->GetString(LDBIZ_SYNC_FIELD80_STR));
        strcpy(v_sync_field81, lpTSCall1Ans2->GetString(LDBIZ_SYNC_FIELD81_STR));
        strcpy(v_sync_field82, lpTSCall1Ans2->GetString(LDBIZ_SYNC_FIELD82_STR));
        strcpy(v_sync_field83, lpTSCall1Ans2->GetString(LDBIZ_SYNC_FIELD83_STR));
        strcpy(v_sync_field84, lpTSCall1Ans2->GetString(LDBIZ_SYNC_FIELD84_STR));
        strcpy(v_sync_field85, lpTSCall1Ans2->GetString(LDBIZ_SYNC_FIELD85_STR));
        strcpy(v_sync_field86, lpTSCall1Ans2->GetString(LDBIZ_SYNC_FIELD86_STR));
        strcpy(v_sync_field87, lpTSCall1Ans2->GetString(LDBIZ_SYNC_FIELD87_STR));
        strcpy(v_sync_field88, lpTSCall1Ans2->GetString(LDBIZ_SYNC_FIELD88_STR));
        strcpy(v_sync_field89, lpTSCall1Ans2->GetString(LDBIZ_SYNC_FIELD89_STR));
        strcpy(v_sync_field90, lpTSCall1Ans2->GetString(LDBIZ_SYNC_FIELD90_STR));
        strcpy(v_sync_field91, lpTSCall1Ans2->GetString(LDBIZ_SYNC_FIELD91_STR));
        strcpy(v_sync_field92, lpTSCall1Ans2->GetString(LDBIZ_SYNC_FIELD92_STR));
        strcpy(v_sync_field93, lpTSCall1Ans2->GetString(LDBIZ_SYNC_FIELD93_STR));
        strcpy(v_sync_field94, lpTSCall1Ans2->GetString(LDBIZ_SYNC_FIELD94_STR));
        strcpy(v_sync_field95, lpTSCall1Ans2->GetString(LDBIZ_SYNC_FIELD95_STR));
        strcpy(v_sync_field96, lpTSCall1Ans2->GetString(LDBIZ_SYNC_FIELD96_STR));
        strcpy(v_sync_field97, lpTSCall1Ans2->GetString(LDBIZ_SYNC_FIELD97_STR));
        strcpy(v_sync_field98, lpTSCall1Ans2->GetString(LDBIZ_SYNC_FIELD98_STR));
        strcpy(v_sync_field99, lpTSCall1Ans2->GetString(LDBIZ_SYNC_FIELD99_STR));
        ...
        if (v_ctrl_flag==0)
        {
          //完了测试方便,暂时先用这个功能
           ...
           lpTSCall1Req3=glpFastMsgFactory->CreateFastMessage("tdfutuT.15.2", 0);
           ...
           {
               lpOutBizMsg->SetInt32(LDTAG_ERRORNO, -1);
               lpOutBizMsg->SetString(LDTAG_ERRORINFO, "[tdfutuT.15.2]subcall timed out!");
               iRet=-2;
               goto ENDSYS;
           }
...
int iPriority=lpInBizMsg->GetInt32(LDTAG_PRIORITY);
    ...
    // set @查询表名#="tb_tdfuac_asac_busi_capit";
    strcpy(v_qry_table,"tb_tdfuac_asac_busi_capit");
    //调用过程[事务_交易期货_同步接口_获取同步时间]
    //组织事务请求
    if(lpTSCall1Ans0)
    {
    ...
    while (v_ctrl_flag)
    {
       ...
       lpTSCall1Req1=glpFastMsgFactory->CreateFastMessage("tdfutuT.15.13", 0);
       lpTSCall1Req1->SetInt32(LDTAG_PRIORITY, iPriority);
       lpTSCall1Req1->SetInt32(LDBIZ_OPOR_CO_NO_INT,v_opor_co_no);
       lpTSCall1Req1->SetInt32(LDBIZ_OPOR_NO_INT,v_opor_no);
       lpTSCall1Req1->SetString(LDBIZ_OPER_MAC_STR,v_oper_mac);
       ...
       {
           lpOutBizMsg->SetInt32(LDTAG_ERRORNO, -1);
           lpOutBizMsg->SetString(LDTAG_ERRORINFO, "[tdfutuT.15.13]subcall timed out!");
           iRet=-2;
           goto ENDSYS;
       }
       else if(lpTSCall1Ans1->GetInt32(LDTAG_ERRORNO)!=0)  //  中间件层面错误
       ...
       //调用过程[事务_数据同步_交易期货同步_同步资产账户业务资金表]
       //组织事务请求
       if(lpTSCall1Ans2)
       {
         lpTSCall1Ans2->FreeMsg();
       ...
       lpTSCall1Req2=glpFastMsgFactory->CreateFastMessage("dcsyncT.6.13", 0);
       lpTSCall1Req2->SetInt32(LDTAG_PRIORITY, iPriority);
       lpTSCall1Req2->SetInt32(LDBIZ_OPOR_CO_NO_INT,v_opor_co_no);
       lpTSCall1Req2->SetInt32(LDBIZ_OPOR_NO_INT,v_opor_no);
       lpTSCall1Req2->SetString(LDBIZ_OPER_MAC_STR,v_oper_mac);
       ...
       {
           lpOutBizMsg->SetInt32(LDTAG_ERRORNO, -1);
           lpOutBizMsg->SetString(LDTAG_ERRORINFO, "[dcsyncT.6.13]subcall timed out!");
           iRet=-2;
           goto ENDSYS;
       }
       else if(lpTSCall1Ans2->GetInt32(LDTAG_ERRORNO)!=0)  //  中间件层面错误
...
int iPriority=lpInBizMsg->GetInt32(LDTAG_PRIORITY);
    ...
    // set @查询表名#="tb_tdfuac_exgp_busi_posi";
    strcpy(v_qry_table,"tb_tdfuac_exgp_busi_posi");
    //调用过程[事务_交易期货_同步接口_获取同步时间]
    //组织事务请求
    if(lpTSCall1Ans0)
    {
    ...
    while (v_ctrl_flag)
    {
       ...
       lpTSCall1Req1=glpFastMsgFactory->CreateFastMessage("tdfutuT.15.14", 0);
       lpTSCall1Req1->SetInt32(LDTAG_PRIORITY, iPriority);
       lpTSCall1Req1->SetInt32(LDBIZ_OPOR_CO_NO_INT,v_opor_co_no);
       lpTSCall1Req1->SetInt32(LDBIZ_OPOR_NO_INT,v_opor_no);
       lpTSCall1Req1->SetString(LDBIZ_OPER_MAC_STR,v_oper_mac);
       ...
       {
           lpOutBizMsg->SetInt32(LDTAG_ERRORNO, -1);
           lpOutBizMsg->SetString(LDTAG_ERRORINFO, "[tdfutuT.15.14]subcall timed out!");
           iRet=-2;
           goto ENDSYS;
       }
       else if(lpTSCall1Ans1->GetInt32(LDTAG_ERRORNO)!=0)  //  中间件层面错误
       ...
       //调用过程[事务_数据同步_交易期货同步_同步交易组业务持仓表]
       //组织事务请求
       if(lpTSCall1Ans2)
       {
         lpTSCall1Ans2->FreeMsg();
       ...
       lpTSCall1Req2=glpFastMsgFactory->CreateFastMessage("dcsyncT.6.14", 0);
       lpTSCall1Req2->SetInt32(LDTAG_PRIORITY, iPriority);
       lpTSCall1Req2->SetInt32(LDBIZ_OPOR_CO_NO_INT,v_opor_co_no);
       lpTSCall1Req2->SetInt32(LDBIZ_OPOR_NO_INT,v_opor_no);
       lpTSCall1Req2->SetString(LDBIZ_OPER_MAC_STR,v_oper_mac);
       ...
       {
           lpOutBizMsg->SetInt32(LDTAG_ERRORNO, -1);
           lpOutBizMsg->SetString(LDTAG_ERRORINFO, "[dcsyncT.6.14]subcall timed out!");
           iRet=-2;
           goto ENDSYS;
       }
       else if(lpTSCall1Ans2->GetInt32(LDTAG_ERRORNO)!=0)  //  中间件层面错误
...
int iPriority=lpInBizMsg->GetInt32(LDTAG_PRIORITY);
    ...
    // set @查询表名#="tb_tdfuac_asac_busi_posi";
    strcpy(v_qry_table,"tb_tdfuac_asac_busi_posi");
    //调用过程[事务_交易期货_同步接口_获取同步时间]
    //组织事务请求
    if(lpTSCall1Ans0)
    {
    ...
    while (v_ctrl_flag)
    {
       ...
       lpTSCall1Req1=glpFastMsgFactory->CreateFastMessage("tdfutuT.15.15", 0);
       lpTSCall1Req1->SetInt32(LDTAG_PRIORITY, iPriority);
       lpTSCall1Req1->SetInt32(LDBIZ_OPOR_CO_NO_INT,v_opor_co_no);
       lpTSCall1Req1->SetInt32(LDBIZ_OPOR_NO_INT,v_opor_no);
       lpTSCall1Req1->SetString(LDBIZ_OPER_MAC_STR,v_oper_mac);
       ...
       {
           lpOutBizMsg->SetInt32(LDTAG_ERRORNO, -1);
           lpOutBizMsg->SetString(LDTAG_ERRORINFO, "[tdfutuT.15.15]subcall timed out!");
           iRet=-2;
           goto ENDSYS;
       }
       else if(lpTSCall1Ans1->GetInt32(LDTAG_ERRORNO)!=0)  //  中间件层面错误
       ...
       //调用过程[事务_数据同步_交易期货同步_同步资产账户业务持仓表]
       //组织事务请求
       if(lpTSCall1Ans2)
       {
         lpTSCall1Ans2->FreeMsg();
       ...
       lpTSCall1Req2=glpFastMsgFactory->CreateFastMessage("dcsyncT.6.15", 0);
       lpTSCall1Req2->SetInt32(LDTAG_PRIORITY, iPriority);
       lpTSCall1Req2->SetInt32(LDBIZ_OPOR_CO_NO_INT,v_opor_co_no);
       lpTSCall1Req2->SetInt32(LDBIZ_OPOR_NO_INT,v_opor_no);
       lpTSCall1Req2->SetString(LDBIZ_OPER_MAC_STR,v_oper_mac);
       ...
       {
           lpOutBizMsg->SetInt32(LDTAG_ERRORNO, -1);
           lpOutBizMsg->SetString(LDTAG_ERRORINFO, "[dcsyncT.6.15]subcall timed out!");
           iRet=-2;
           goto ENDSYS;
       }
       else if(lpTSCall1Ans2->GetInt32(LDTAG_ERRORNO)!=0)  //  中间件层面错误
...
int iPriority=lpInBizMsg->GetInt32(LDTAG_PRIORITY);
    ...
    // set @查询表名#="tb_tdfuac_exgp_posi_detail";
    strcpy(v_qry_table,"tb_tdfuac_exgp_posi_detail");
    //调用过程[事务_交易期货_同步接口_获取同步时间]
    //组织事务请求
    if(lpTSCall1Ans0)
    {
    ...
    while (v_ctrl_flag)
    {
       ...
       lpTSCall1Req1=glpFastMsgFactory->CreateFastMessage("tdfutuT.15.16", 0);
       lpTSCall1Req1->SetInt32(LDTAG_PRIORITY, iPriority);
       lpTSCall1Req1->SetInt32(LDBIZ_OPOR_CO_NO_INT,v_opor_co_no);
       lpTSCall1Req1->SetInt32(LDBIZ_OPOR_NO_INT,v_opor_no);
       lpTSCall1Req1->SetString(LDBIZ_OPER_MAC_STR,v_oper_mac);
       ...
       {
           lpOutBizMsg->SetInt32(LDTAG_ERRORNO, -1);
           lpOutBizMsg->SetString(LDTAG_ERRORINFO, "[tdfutuT.15.16]subcall timed out!");
           iRet=-2;
           goto ENDSYS;
       }
       else if(lpTSCall1Ans1->GetInt32(LDTAG_ERRORNO)!=0)  //  中间件层面错误
       ...
       //调用过程[事务_数据同步_交易期货同步_同步交易组持仓明细表]
       //组织事务请求
       if(lpTSCall1Ans2)
       {
         lpTSCall1Ans2->FreeMsg();
       ...
       lpTSCall1Req2=glpFastMsgFactory->CreateFastMessage("dcsyncT.6.16", 0);
       lpTSCall1Req2->SetInt32(LDTAG_PRIORITY, iPriority);
       lpTSCall1Req2->SetInt32(LDBIZ_OPOR_CO_NO_INT,v_opor_co_no);
       lpTSCall1Req2->SetInt32(LDBIZ_OPOR_NO_INT,v_opor_no);
       lpTSCall1Req2->SetString(LDBIZ_OPER_MAC_STR,v_oper_mac);
       ...
       {
           lpOutBizMsg->SetInt32(LDTAG_ERRORNO, -1);
           lpOutBizMsg->SetString(LDTAG_ERRORINFO, "[dcsyncT.6.16]subcall timed out!");
           iRet=-2;
           goto ENDSYS;
       }
       else if(lpTSCall1Ans2->GetInt32(LDTAG_ERRORNO)!=0)  //  中间件层面错误
