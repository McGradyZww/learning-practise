...
# 事务_数据同步_产品期货同步_同步交易组资金表
DELIMITER ;;
DROP PROCEDURE IF EXISTS prt_dcsypfu_Syncpdfuca_exgp_capit;;
DELIMITER ;;
CREATE PROCEDURE prt_dcsypfu_Syncpdfuca_exgp_capit(
    IN p_opor_co_no int,
    IN p_opor_no int,
...
BEGIN
    ...
    /* 调用【原子_数据同步_产品期货同步_同步交易组资金表】*/
    call db_dc.pra_dcsypfu_Syncpdfuca_exgp_capit(
        v_opor_co_no,
        v_opor_no,
        v_oper_mac,
        v_oper_ip_addr,
    ...
    if v_error_code = "1" then
        SET v_error_code = "dcsyncT.4.12.999";
        if v_mysql_message <> "" then
             SET v_error_info = CONCAT(v_error_info,"#",'调用过程原子_数据同步_产品期货同步_同步交易组资金表出现错误！',v_mysql_message);
        end if;
        ROLLBACK;
        leave label_pro;
...
# 事务_数据同步_产品期货同步_同步交易组资产表
DELIMITER ;;
DROP PROCEDURE IF EXISTS prt_dcsypfu_Syncpdfuca_exgp_asset;;
DELIMITER ;;
CREATE PROCEDURE prt_dcsypfu_Syncpdfuca_exgp_asset(
    IN p_opor_co_no int,
    IN p_opor_no int,
    IN p_oper_mac varchar(32),
    IN p_oper_ip_addr varchar(32),
...
BEGIN
    ...
    /* 调用【原子_数据同步_产品期货同步_同步交易组资产表】*/
    call db_dc.pra_dcsypfu_Syncpdfuca_exgp_asset(
        v_opor_co_no,
        v_opor_no,
        v_oper_mac,
        v_oper_ip_addr,
        ...
        v_error_info);
    if v_error_code = "1" then
        SET v_error_code = "dcsyncT.4.13.999";
        if v_mysql_message <> "" then
             SET v_error_info = CONCAT(v_error_info,"#",'调用过程原子_数据同步_产品期货同步_同步交易组资产表出现错误！',v_mysql_message);
        end if;
        ROLLBACK;
        leave label_pro;
    elseif v_error_code <> "0" then
...
# 事务_数据同步_产品期货同步_同步资产账户资金表
DELIMITER ;;
DROP PROCEDURE IF EXISTS prt_dcsypfu_Syncpdfuca_asac_capit;;
DELIMITER ;;
CREATE PROCEDURE prt_dcsypfu_Syncpdfuca_asac_capit(
    IN p_opor_co_no int,
    IN p_opor_no int,
    IN p_oper_mac varchar(32),
    IN p_oper_ip_addr varchar(32),
...
BEGIN
    ...
    /* 调用【原子_数据同步_产品期货同步_同步资产账户资金表】*/
    call db_dc.pra_dcsypfu_Syncpdfuca_asac_capit(
        v_opor_co_no,
        v_opor_no,
        v_oper_mac,
        v_oper_ip_addr,
        ...
        v_error_info);
    if v_error_code = "1" then
        SET v_error_code = "dcsyncT.4.14.999";
        if v_mysql_message <> "" then
             SET v_error_info = CONCAT(v_error_info,"#",'调用过程原子_数据同步_产品期货同步_同步资产账户资金表出现错误！',v_mysql_message);
        end if;
        ROLLBACK;
        leave label_pro;
    elseif v_error_code <> "0" then
...
# 事务_数据同步_产品期货同步_同步交易组持仓表
DELIMITER ;;
DROP PROCEDURE IF EXISTS prt_dcsypfu_Syncpdfupo_exgp_posi;;
DELIMITER ;;
CREATE PROCEDURE prt_dcsypfu_Syncpdfupo_exgp_posi(
    IN p_opor_co_no int,
    IN p_opor_no int,
    IN p_oper_mac varchar(32),
    IN p_oper_ip_addr varchar(32),
...
BEGIN
    ...
    /* 调用【原子_数据同步_产品期货同步_同步交易组持仓表】*/
    call db_dc.pra_dcsypfu_Syncpdfupo_exgp_posi(
        v_opor_co_no,
        v_opor_no,
        v_oper_mac,
        v_oper_ip_addr,
        ...
        v_error_info);
    if v_error_code = "1" then
        SET v_error_code = "dcsyncT.4.15.999";
        if v_mysql_message <> "" then
             SET v_error_info = CONCAT(v_error_info,"#",'调用过程原子_数据同步_产品期货同步_同步交易组持仓表出现错误！',v_mysql_message);
        end if;
        ROLLBACK;
        leave label_pro;
    elseif v_error_code <> "0" then
...
# 事务_数据同步_产品期货同步_同步资产账户持仓表
DELIMITER ;;
DROP PROCEDURE IF EXISTS prt_dcsypfu_Syncpdfupo_asac_posi;;
DELIMITER ;;
CREATE PROCEDURE prt_dcsypfu_Syncpdfupo_asac_posi(
    IN p_opor_co_no int,
    IN p_opor_no int,
    IN p_oper_mac varchar(32),
    IN p_oper_ip_addr varchar(32),
...
BEGIN
    ...
    /* 调用【原子_数据同步_产品期货同步_同步资产账户持仓表】*/
    call db_dc.pra_dcsypfu_Syncpdfupo_asac_posi(
        v_opor_co_no,
        v_opor_no,
        v_oper_mac,
        v_oper_ip_addr,
        ...
        v_error_info);
    if v_error_code = "1" then
        SET v_error_code = "dcsyncT.4.16.999";
        if v_mysql_message <> "" then
             SET v_error_info = CONCAT(v_error_info,"#",'调用过程原子_数据同步_产品期货同步_同步资产账户持仓表出现错误！',v_mysql_message);
        end if;
        ROLLBACK;
        leave label_pro;
    elseif v_error_code <> "0" then
