...
cd /d %MakePakePath%
D:\管理端出包\出包工具\ReplaceStr\ReplaceStr.exe "LdNet.ClientF管理端(PB东方).iss" "LdNet.ClientF管理端(PB东方)%Version%.iss" "21.17.1106.3->%Version%"
...
C:\ProgramFiles\InnoSetup5\compil32.exe /cc "%isspath%\LdNet.ClientF管理端(PB东方)%Version%.iss">>D:\管理端出包\日志\gldisslog.txt
...
del /q "%isspath%\LdNet.ClientF管理端(PB东方)%Version%.iss
