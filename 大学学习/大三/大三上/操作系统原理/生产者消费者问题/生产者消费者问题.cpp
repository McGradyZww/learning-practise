...
int main()
{
g_hReadSemaphore  = CreateSemaphore(NULL,1,100,NULL); //创建信号灯，当前可用的资源数为最大
g_hWriteSemaphore = CreateSemaphore(NULL,1,100,NULL); //创建信号灯，当前可用的资源数为最大
